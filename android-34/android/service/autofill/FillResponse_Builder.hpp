...
namespace android::service::autofill
{
	...
	inline android::service::autofill::FillResponse_Builder FillResponse_Builder::setAuthentication(JArray arg0, android::content::IntentSender arg1, android::service::autofill::Presentations arg2) const
	{
		return callObjectMethod(
			"setAuthentication",
			"([Landroid/view/autofill/AutofillId;Landroid/content/IntentSender;Landroid/service/autofill/Presentations;)Landroid/service/autofill/FillResponse$Builder;",
			arg0.object<jarray>(),
			arg1.object(),
			arg2.object()
		);
	...
	inline android::service::autofill::FillResponse_Builder FillResponse_Builder::setDetectedFieldClassifications(JObject arg0) const
	{
		return callObjectMethod(
			"setDetectedFieldClassifications",
			"(Ljava/util/Set;)Landroid/service/autofill/FillResponse$Builder;",
			arg0.object()
		);
	}
	inline android::service::autofill::FillResponse_Builder FillResponse_Builder::setDialogHeader(android::widget::RemoteViews arg0) const
	{
		return callObjectMethod(
			"setDialogHeader",
	...
	inline android::service::autofill::FillResponse_Builder FillResponse_Builder::setFillDialogTriggerIds(JArray arg0) const
	{
		return callObjectMethod(
	...
	inline android::service::autofill::FillResponse_Builder FillResponse_Builder::setIconResourceId(jint arg0) const
	{
		return callObjectMethod(
			"setIconResourceId",
			"(I)Landroid/service/autofill/FillResponse$Builder;",
	...
	inline android::service::autofill::FillResponse_Builder FillResponse_Builder::setServiceDisplayNameResourceId(jint arg0) const
	{
		return callObjectMethod(
	...
	inline android::service::autofill::FillResponse_Builder FillResponse_Builder::setShowFillDialogIcon(jboolean arg0) const
	{
		return callObjectMethod(
			"setShowFillDialogIcon",
			"(Z)Landroid/service/autofill/FillResponse$Builder;",
			arg0
		);
	}
	inline android::service::autofill::FillResponse_Builder FillResponse_Builder::setShowSaveDialogIcon(jboolean arg0) const
	{
		return callObjectMethod(
