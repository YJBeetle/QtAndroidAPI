...
namespace android::service::autofill
{
	...
	public:
		...
		Dataset_Builder(QJniObject obj) : JObject(obj) {}
		
		// Constructors
		Dataset_Builder();
		Dataset_Builder(android::service::autofill::Presentations arg0);
		...
		android::service::autofill::Dataset_Builder setField(android::view::autofill::AutofillId arg0, android::service::autofill::Field arg1) const;
		android::service::autofill::Dataset_Builder setField(JString arg0, android::service::autofill::Field arg1) const;
		android::service::autofill::Dataset_Builder setFieldForAllHints(android::service::autofill::Field arg0) const;
