...
namespace android::service::quickaccesswallet
{
	...
	inline WalletCard_Builder::WalletCard_Builder(JString arg0, jint arg1, android::graphics::drawable::Icon arg2, JString arg3, android::app::PendingIntent arg4)
		: JObject(
			"android.service.quickaccesswallet.WalletCard$Builder",
			"(Ljava/lang/String;ILandroid/graphics/drawable/Icon;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)V",
			arg0.object<jstring>(),
			arg1,
			arg2.object(),
			arg3.object<jstring>(),
	...
	inline android::service::quickaccesswallet::WalletCard_Builder WalletCard_Builder::setCardLocations(JObject arg0) const
	{
		return callObjectMethod(
			"setCardLocations",
			"(Ljava/util/List;)Landroid/service/quickaccesswallet/WalletCard$Builder;",
			arg0.object()
		);
	}
	inline android::service::quickaccesswallet::WalletCard_Builder WalletCard_Builder::setNonPaymentCardSecondaryImage(android::graphics::drawable::Icon arg0) const
	{
		return callObjectMethod(
