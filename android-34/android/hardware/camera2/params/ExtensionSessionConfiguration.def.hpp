...
namespace android::hardware::camera2::params
{
	...
	public:
		...
		android::hardware::camera2::params::OutputConfiguration getPostviewOutputConfiguration() const;
		android::hardware::camera2::CameraExtensionSession_StateCallback getStateCallback() const;
		void setPostviewOutputConfiguration(android::hardware::camera2::params::OutputConfiguration arg0) const;
	};
} // namespace android::hardware::camera2::params
