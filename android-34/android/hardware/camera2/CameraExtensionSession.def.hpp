...
namespace android::hardware::camera2
{
	class CameraExtensionSession_StillCaptureLatency;
}
namespace android::hardware::camera2
{
...
namespace android::hardware::camera2
{
	...
	public:
		...
		CameraExtensionSession(QJniObject obj) : JObject(obj) {}
		...
		android::hardware::camera2::CameraExtensionSession_StillCaptureLatency getRealtimeStillCaptureLatency() const;
