...
namespace android::media::tv
{
	...
	public:
		...
		static jint TABLE_NAME_BAT();
		static jint TABLE_NAME_CAT();
		static jint TABLE_NAME_EIT();
		static jint TABLE_NAME_NIT();
		static jint TABLE_NAME_PAT();
		static jint TABLE_NAME_PMT();
		static jint TABLE_NAME_SDT();
		static jint TABLE_NAME_SIT();
		static jint TABLE_NAME_TDT();
		static jint TABLE_NAME_TOT();
		...
		TableRequest(QJniObject obj) : android::media::tv::BroadcastInfoRequest(obj) {}
