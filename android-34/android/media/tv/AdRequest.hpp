...
namespace android::media::tv
{
	...
	// Constructors
	inline AdRequest::AdRequest(jint arg0, jint arg1, android::net::Uri arg2, jlong arg3, jlong arg4, jlong arg5, android::os::Bundle arg6)
		: JObject(
			"android.media.tv.AdRequest",
			"(IILandroid/net/Uri;JJJLandroid/os/Bundle;)V",
			arg0,
			arg1,
			arg2.object(),
			arg3,
	...
	inline android::net::Uri AdRequest::getUri() const
	{
		return callObjectMethod(
			"getUri",
			"()Landroid/net/Uri;"
