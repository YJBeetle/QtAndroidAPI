...
#include "./interactive/TvInteractiveAppView.def.hpp"
...
namespace android::media::tv
{
	...
	inline void TvRecordingClient::setTvInteractiveAppView(android::media::tv::interactive::TvInteractiveAppView arg0, JString arg1) const
	{
		callMethod<void>(
			"setTvInteractiveAppView",
			"(Landroid/media/tv/interactive/TvInteractiveAppView;Ljava/lang/String;)V",
			arg0.object(),
			arg1.object<jstring>()
		);
	}
