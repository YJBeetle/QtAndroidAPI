...
namespace android::media
{
	...
	inline jint ImageWriter::getDataSpace() const
	{
	...
	inline jint ImageWriter::getHardwareBufferFormat() const
	{
		return callMethod<jint>(
	...
	inline jint ImageWriter::getHeight() const
	{
		return callMethod<jint>(
			"getHeight",
			"()I"
	...
	inline jlong ImageWriter::getUsage() const
	{
	...
	inline jint ImageWriter::getWidth() const
	{
		return callMethod<jint>(
			"getWidth",
			"()I"
