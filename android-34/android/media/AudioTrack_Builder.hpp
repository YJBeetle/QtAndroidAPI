...
namespace android::media
{
	...
	inline android::media::AudioTrack_Builder AudioTrack_Builder::setContext(android::content::Context arg0) const
	{
		return callObjectMethod(
			"setContext",
			"(Landroid/content/Context;)Landroid/media/AudioTrack$Builder;",
			arg0.object()
		);
	}
	inline android::media::AudioTrack_Builder AudioTrack_Builder::setEncapsulationMode(jint arg0) const
	{
		return callObjectMethod(
	...
	inline android::media::AudioTrack_Builder AudioTrack_Builder::setOffloadedPlayback(jboolean arg0) const
	{
		return callObjectMethod(
