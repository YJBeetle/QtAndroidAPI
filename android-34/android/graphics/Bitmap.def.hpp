...
namespace android::graphics
{
	...
	public:
		...
		Bitmap(QJniObject obj) : JObject(obj) {}
		...
		void eraseColor(jlong arg0) const;
		...
		void setColorSpace(android::graphics::ColorSpace arg0) const;
		void setConfig(android::graphics::Bitmap_Config arg0) const;
		void setDensity(jint arg0) const;
		void setGainmap(android::graphics::Gainmap arg0) const;
