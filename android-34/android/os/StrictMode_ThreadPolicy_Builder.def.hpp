...
namespace android::os
{
	...
	public:
		...
		StrictMode_ThreadPolicy_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::os::StrictMode_ThreadPolicy_Builder detectExplicitGc() const;
		...
		android::os::StrictMode_ThreadPolicy_Builder permitExplicitGc() const;
