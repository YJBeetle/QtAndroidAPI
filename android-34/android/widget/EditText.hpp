...
namespace android::widget
{
	...
	inline jboolean EditText::isStyleShortcutEnabled() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean EditText::onKeyShortcut(jint arg0, android::view::KeyEvent arg1) const
	{
		return callMethod<jboolean>(
			"onKeyShortcut",
	...
	inline jboolean EditText::onTextContextMenuItem(jint arg0) const
	{
		return callMethod<jboolean>(
	...
	inline void EditText::setStyleShortcutsEnabled(jboolean arg0) const
	{
		callMethod<void>(
