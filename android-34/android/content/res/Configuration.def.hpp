...
namespace android::content::res
{
	...
	public:
		...
		static jint FONT_WEIGHT_ADJUSTMENT_UNDEFINED();
		static jint GRAMMATICAL_GENDER_FEMININE();
		static jint GRAMMATICAL_GENDER_MASCULINE();
		static jint GRAMMATICAL_GENDER_NEUTRAL();
		static jint GRAMMATICAL_GENDER_NOT_SPECIFIED();
		...
		// Methods
		static android::content::res::Configuration generateDelta(android::content::res::Configuration arg0, android::content::res::Configuration arg1);
		...
		jint getGrammaticalGender() const;
