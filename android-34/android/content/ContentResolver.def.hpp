...
namespace android::content
{
	...
	public:
		...
		static JString SYNC_EXTRAS_SCHEDULE_AS_EXPEDITED_JOB();
		...
		android::content::ContentResolver_MimeTypeInfo getTypeInfo(JString arg0) const;
		...
		android::graphics::Bitmap loadThumbnail(android::net::Uri arg0, android::util::Size arg1, android::os::CancellationSignal arg2) const;
		...
		void notifyChange(JObject arg0, android::database::ContentObserver arg1, jint arg2) const;
