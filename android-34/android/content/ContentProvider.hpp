...
namespace android::content
{
	...
	inline android::content::AttributionSource ContentProvider::getCallingAttributionSource() const
	{
		return callObjectMethod(
	...
	inline JString ContentProvider::getTypeAnonymous(android::net::Uri arg0) const
	{
		return callObjectMethod(
			"getTypeAnonymous",
			"(Landroid/net/Uri;)Ljava/lang/String;",
