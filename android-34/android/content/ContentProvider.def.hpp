...
namespace android::content
{
	...
	public:
		...
		ContentProvider(QJniObject obj) : JObject(obj) {}
		...
		JString getCallingAttributionTag() const;
		JString getCallingPackage() const;
		JString getCallingPackageUnchecked() const;
		...
		void onCallingPackageChanged() const;
		...
		void restoreCallingIdentity(android::content::ContentProvider_CallingIdentity arg0) const;
		void shutdown() const;
