...
namespace android::provider
{
	...
	inline JString MediaStore_PickerMediaColumns::HEIGHT()
	{
		return getStaticObjectField(
			"android.provider.MediaStore$PickerMediaColumns",
			"HEIGHT",
	...
	inline JString MediaStore_PickerMediaColumns::ORIENTATION()
	{
		return getStaticObjectField(
			"android.provider.MediaStore$PickerMediaColumns",
			"ORIENTATION",
	...
	inline JString MediaStore_PickerMediaColumns::WIDTH()
	{
		return getStaticObjectField(
			"android.provider.MediaStore$PickerMediaColumns",
			"WIDTH",
