...
namespace android::view
{
	...
	public:
		...
		ViewConfiguration(QJniObject obj) : JObject(obj) {}
		...
		jfloat getScaledAmbiguousGestureMultiplier() const;
		jint getScaledDoubleTapSlop() const;
		jint getScaledEdgeSlop() const;
		jint getScaledFadingEdgeLength() const;
		jint getScaledHandwritingGestureLineMargin() const;
		jint getScaledHandwritingSlop() const;
		...
		jint getScaledMaximumFlingVelocity(jint arg0, jint arg1, jint arg2) const;
		jint getScaledMinimumFlingVelocity() const;
		jint getScaledMinimumFlingVelocity(jint arg0, jint arg1, jint arg2) const;
		jint getScaledMinimumScalingSpan() const;
