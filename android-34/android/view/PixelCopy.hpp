...
namespace android::view
{
	...
	// Methods
	inline void PixelCopy::request(android::view::PixelCopy_Request arg0, JObject arg1, JObject arg2)
	{
		callStaticMethod<void>(
			"android.view.PixelCopy",
			"request",
			"(Landroid/view/PixelCopy$Request;Ljava/util/concurrent/Executor;Ljava/util/function/Consumer;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
