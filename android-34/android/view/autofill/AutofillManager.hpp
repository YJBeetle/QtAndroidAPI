...
namespace android::view::autofill
{
	...
	inline JString AutofillManager::EXTRA_AUTHENTICATION_RESULT_EPHEMERAL_DATASET()
	{
		return getStaticObjectField(
			"android.view.autofill.AutofillManager",
	...
	inline JString AutofillManager::EXTRA_INLINE_SUGGESTIONS_REQUEST()
	{
		return getStaticObjectField(
			"android.view.autofill.AutofillManager",
	...
	inline void AutofillManager::notifyVirtualViewsReady(android::view::View arg0, android::util::SparseArray arg1) const
	{
		callMethod<void>(
			"notifyVirtualViewsReady",
			"(Landroid/view/View;Landroid/util/SparseArray;)V",
			arg0.object(),
			arg1.object()
		);
	}
	...
	inline jboolean AutofillManager::showAutofillDialog(android::view::View arg0) const
	{
		return callMethod<jboolean>(
			"showAutofillDialog",
	...
	inline jboolean AutofillManager::showAutofillDialog(android::view::View arg0, jint arg1) const
	{
		return callMethod<jboolean>(
			"showAutofillDialog",
