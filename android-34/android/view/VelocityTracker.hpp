...
namespace android::view
{
	...
	inline jfloat VelocityTracker::getAxisVelocity(jint arg0) const
	{
	...
	inline jfloat VelocityTracker::getAxisVelocity(jint arg0, jint arg1) const
	{
		return callMethod<jfloat>(
			"getAxisVelocity",
			"(II)F",
	...
	inline jboolean VelocityTracker::isAxisSupported(jint arg0) const
	{
