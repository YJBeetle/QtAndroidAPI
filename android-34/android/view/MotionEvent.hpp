...
namespace android::view
{
	...
	inline jint MotionEvent::AXIS_GESTURE_PINCH_SCALE_FACTOR()
	{
		return getStaticField<jint>(
			"android.view.MotionEvent",
	...
	inline jint MotionEvent::AXIS_GESTURE_SCROLL_X_DISTANCE()
	{
		return getStaticField<jint>(
			"android.view.MotionEvent",
	...
	inline jint MotionEvent::AXIS_GESTURE_SCROLL_Y_DISTANCE()
	{
		return getStaticField<jint>(
			"android.view.MotionEvent",
	...
	inline jint MotionEvent::AXIS_GESTURE_X_OFFSET()
	{
		return getStaticField<jint>(
			"android.view.MotionEvent",
	...
	inline jint MotionEvent::AXIS_GESTURE_Y_OFFSET()
	{
		return getStaticField<jint>(
			"android.view.MotionEvent",
	...
	inline jint MotionEvent::CLASSIFICATION_PINCH()
	{
		return getStaticField<jint>(
			"android.view.MotionEvent",
	...
	inline jint MotionEvent::CLASSIFICATION_TWO_FINGER_SWIPE()
	{
		return getStaticField<jint>(
			"android.view.MotionEvent",
	...
	inline jint MotionEvent::FLAG_CANCELED()
	{
		return getStaticField<jint>(
			"android.view.MotionEvent",
			"FLAG_CANCELED"
	...
	inline android::view::MotionEvent MotionEvent::obtain(jlong arg0, jlong arg1, jint arg2, jint arg3, JArray arg4, JArray arg5, jint arg6, jint arg7, jfloat arg8, jfloat arg9, jint arg10, jint arg11, jint arg12, jint arg13, jint arg14, jint arg15)
	{
		return callStaticObjectMethod(
			"android.view.MotionEvent",
			"obtain",
			"(JJII[Landroid/view/MotionEvent$PointerProperties;[Landroid/view/MotionEvent$PointerCoords;IIFFIIIIII)Landroid/view/MotionEvent;",
			arg0,
			arg1,
			arg2,
			arg3,
	...
	inline jlong MotionEvent::getEventTimeNanos() const
	{
		return callMethod<jlong>(
			"getEventTimeNanos",
			"()J"
	...
	inline jlong MotionEvent::getHistoricalEventTimeNanos(jint arg0) const
	{
		return callMethod<jlong>(
