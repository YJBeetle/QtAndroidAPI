...
namespace android::view::accessibility
{
	...
	inline jboolean CaptioningManager::isCallCaptioningEnabled() const
	{
	...
	inline jboolean CaptioningManager::isSystemAudioCaptioningEnabled() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean CaptioningManager::isSystemAudioCaptioningUiEnabled() const
	{
		return callMethod<jboolean>(
