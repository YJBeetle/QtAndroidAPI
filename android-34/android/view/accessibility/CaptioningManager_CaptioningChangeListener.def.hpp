...
namespace android::view::accessibility
{
	...
	public:
		...
		CaptioningManager_CaptioningChangeListener(QJniObject obj) : JObject(obj) {}
		...
		void onSystemAudioCaptioningChanged(jboolean arg0) const;
		void onSystemAudioCaptioningUiChanged(jboolean arg0) const;
