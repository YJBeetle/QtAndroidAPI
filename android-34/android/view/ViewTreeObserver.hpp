...
namespace android::view
{
	...
	inline void ViewTreeObserver::addOnWindowVisibilityChangeListener(JObject arg0) const
	{
		callMethod<void>(
			"addOnWindowVisibilityChangeListener",
			"(Landroid/view/ViewTreeObserver$OnWindowVisibilityChangeListener;)V",
			arg0.object()
		);
	}
	...
	inline void ViewTreeObserver::removeOnWindowVisibilityChangeListener(JObject arg0) const
	{
		callMethod<void>(
