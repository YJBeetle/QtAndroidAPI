...
namespace android::view
{
	...
	public:
		...
		ViewTreeObserver(QJniObject obj) : JObject(obj) {}
		...
		void addOnWindowVisibilityChangeListener(JObject arg0) const;
		...
		void removeOnWindowVisibilityChangeListener(JObject arg0) const;
