...
namespace android::view::inputmethod
{
	...
	inline android::view::inputmethod::CursorAnchorInfo_Builder CursorAnchorInfo_Builder::addVisibleLineBounds(jfloat arg0, jfloat arg1, jfloat arg2, jfloat arg3) const
	{
		return callObjectMethod(
			"addVisibleLineBounds",
			"(FFFF)Landroid/view/inputmethod/CursorAnchorInfo$Builder;",
			arg0,
			arg1,
			arg2,
			arg3
	...
	inline android::view::inputmethod::CursorAnchorInfo_Builder CursorAnchorInfo_Builder::clearVisibleLineBounds() const
	{
		return callObjectMethod(
	...
	inline android::view::inputmethod::CursorAnchorInfo_Builder CursorAnchorInfo_Builder::setTextAppearanceInfo(android::view::inputmethod::TextAppearanceInfo arg0) const
	{
		return callObjectMethod(
			"setTextAppearanceInfo",
			"(Landroid/view/inputmethod/TextAppearanceInfo;)Landroid/view/inputmethod/CursorAnchorInfo$Builder;",
			arg0.object()
		);
	}
} // namespace android::view::inputmethod
