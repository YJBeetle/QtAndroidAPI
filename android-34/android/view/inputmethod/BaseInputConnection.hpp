...
namespace android::view::inputmethod
{
	...
	inline android::view::inputmethod::SurroundingText BaseInputConnection::getSurroundingText(jint arg0, jint arg1, jint arg2) const
	{
		return callObjectMethod(
			"getSurroundingText",
	...
	inline jboolean BaseInputConnection::replaceText(jint arg0, jint arg1, JString arg2, jint arg3, android::view::inputmethod::TextAttribute arg4) const
	{
		return callMethod<jboolean>(
			"replaceText",
	...
	inline android::view::inputmethod::TextSnapshot BaseInputConnection::takeSnapshot() const
	{
		return callObjectMethod(
			"takeSnapshot",
