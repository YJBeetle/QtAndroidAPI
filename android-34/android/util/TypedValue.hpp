...
namespace android::util
{
	...
	inline jint TypedValue::sourceResourceId()
	{
		return getField<jint>(
			"sourceResourceId"
		);
	...
	inline jfloat TypedValue::convertDimensionToPixels(jint arg0, jfloat arg1, android::util::DisplayMetrics arg2)
	{
		return callStaticMethod<jfloat>(
			"android.util.TypedValue",
	...
	inline jfloat TypedValue::convertPixelsToDimension(jint arg0, jfloat arg1, android::util::DisplayMetrics arg2)
	{
		return callStaticMethod<jfloat>(
			"android.util.TypedValue",
	...
	inline jfloat TypedValue::deriveDimension(jint arg0, jfloat arg1, android::util::DisplayMetrics arg2)
	{
		return callStaticMethod<jfloat>(
			"android.util.TypedValue",
			"deriveDimension",
	...
	inline jboolean TypedValue::isColorType() const
	{
