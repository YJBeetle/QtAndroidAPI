...
namespace android::telecom
{
	...
	public:
		...
		static jint CAPABILITY_REMOTE_PARTY_SUPPORTS_RTT();
		...
		static JString EXTRA_LAST_KNOWN_CELL_IDENTITY();
		...
		Connection(QJniObject obj) : android::telecom::Conferenceable(obj) {}
		...
		void queryLocationForEmergency(jlong arg0, JString arg1, JObject arg2, JObject arg3) const;
