...
namespace android::telecom
{
	...
	// Methods
	inline android::telecom::Conference Conference::createFailedConference(android::telecom::DisconnectCause arg0, android::telecom::PhoneAccountHandle arg1)
	{
	...
	inline android::telecom::CallEndpoint Conference::getCurrentCallEndpoint() const
	{
		return callObjectMethod(
	...
	inline jboolean Conference::isRingbackRequested() const
	{
		return callMethod<jboolean>(
			"isRingbackRequested",
			"()Z"
	...
	inline void Conference::onAddConferenceParticipants(JObject arg0) const
	{
		callMethod<void>(
	...
	inline void Conference::onAnswer(jint arg0) const
	{
		callMethod<void>(
			"onAnswer",
			"(I)V",
	...
	inline void Conference::onAvailableCallEndpointsChanged(JObject arg0) const
	{
		callMethod<void>(
	...
	inline void Conference::onCallEndpointChanged(android::telecom::CallEndpoint arg0) const
	{
		callMethod<void>(
	...
	inline void Conference::onMuteStateChanged(jboolean arg0) const
	{
		callMethod<void>(
			"onMuteStateChanged",
			"(Z)V",
	...
	inline void Conference::onReject() const
	{
		callMethod<void>(
			"onReject",
			"()V"
	...
	inline void Conference::setRingbackRequested(jboolean arg0) const
	{
		callMethod<void>(
	...
	inline void Conference::setRinging() const
	{
		callMethod<void>(
			"setRinging",
			"()V"
