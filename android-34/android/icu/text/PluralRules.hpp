...
#include "../number/FormattedNumber.def.hpp"
#include "../number/FormattedNumberRange.def.hpp"
...
namespace android::icu::text
{
	...
	inline JString PluralRules::select(android::icu::number::FormattedNumber arg0) const
	{
		return callObjectMethod(
			"select",
	...
	inline JString PluralRules::select(android::icu::number::FormattedNumberRange arg0) const
	{
		return callObjectMethod(
			"select",
			"(Landroid/icu/number/FormattedNumberRange;)Ljava/lang/String;",
			arg0.object()
		);
	}
