...
namespace android::icu::number
{
	...
	inline android::icu::number::NumberFormatter_SignDisplay NumberFormatter_SignDisplay::ACCOUNTING_NEGATIVE()
	{
		return getStaticObjectField(
			"android.icu.number.NumberFormatter$SignDisplay",
			"ACCOUNTING_NEGATIVE",
	...
	inline android::icu::number::NumberFormatter_SignDisplay NumberFormatter_SignDisplay::NEGATIVE()
	{
		return getStaticObjectField(
			"android.icu.number.NumberFormatter$SignDisplay",
			"NEGATIVE",
