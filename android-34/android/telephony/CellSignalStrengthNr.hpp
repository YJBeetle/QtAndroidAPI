...
namespace android::telephony
{
	...
	inline JObject CellSignalStrengthNr::getCsiCqiReport() const
	{
	...
	inline jint CellSignalStrengthNr::getCsiCqiTableIndex() const
	{
		return callMethod<jint>(
			"getCsiCqiTableIndex",
			"()I"
	...
	inline jint CellSignalStrengthNr::getTimingAdvanceMicros() const
	{
		return callMethod<jint>(
