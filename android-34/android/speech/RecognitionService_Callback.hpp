...
namespace android::speech
{
	...
	inline void RecognitionService_Callback::endOfSegmentedSession() const
	{
		callMethod<void>(
	...
	inline void RecognitionService_Callback::languageDetection(android::os::Bundle arg0) const
	{
		callMethod<void>(
			"languageDetection",
	...
	inline void RecognitionService_Callback::segmentResults(android::os::Bundle arg0) const
	{
		callMethod<void>(
			"segmentResults",
			"(Landroid/os/Bundle;)V",
