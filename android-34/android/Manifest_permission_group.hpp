...
namespace android
{
	...
	inline JString Manifest_permission_group::NOTIFICATIONS()
	{
		return getStaticObjectField(
			"android.Manifest$permission_group",
			"NOTIFICATIONS",
	...
	inline JString Manifest_permission_group::READ_MEDIA_AURAL()
	{
		return getStaticObjectField(
			"android.Manifest$permission_group",
			"READ_MEDIA_AURAL",
	...
	inline JString Manifest_permission_group::READ_MEDIA_VISUAL()
	{
		return getStaticObjectField(
			"android.Manifest$permission_group",
			"READ_MEDIA_VISUAL",
