...
namespace android
{
	...
	public:
		...
		static jint accessibilityActionDragCancel();
		static jint accessibilityActionDragDrop();
		static jint accessibilityActionDragStart();
		static jint accessibilityActionHideTooltip();
		static jint accessibilityActionImeEnter();
		...
		static jint accessibilityActionPressAndHold();
		static jint accessibilityActionScrollDown();
		static jint accessibilityActionScrollInDirection();
		...
		static jint accessibilityActionShowTextSuggestions();
		static jint accessibilityActionShowTooltip();
		static jint accessibilitySystemActionBack();
		static jint accessibilitySystemActionHome();
		static jint accessibilitySystemActionLockScreen();
		static jint accessibilitySystemActionNotifications();
		static jint accessibilitySystemActionPowerDialog();
		static jint accessibilitySystemActionQuickSettings();
		static jint accessibilitySystemActionRecents();
		static jint accessibilitySystemActionTakeScreenshot();
		static jint accessibilitySystemActionToggleSplitScreen();
		...
		static jint inputExtractAccessories();
		static jint inputExtractAction();
