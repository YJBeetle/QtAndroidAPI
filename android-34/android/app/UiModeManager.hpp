...
namespace android::app
{
	...
	// Methods
	inline void UiModeManager::addContrastChangeListener(JObject arg0, JObject arg1) const
	{
		callMethod<void>(
			"addContrastChangeListener",
			"(Ljava/util/concurrent/Executor;Landroid/app/UiModeManager$ContrastChangeListener;)V",
			arg0.object(),
			arg1.object()
		);
	}
	...
	inline jfloat UiModeManager::getContrast() const
	{
	...
	inline void UiModeManager::removeContrastChangeListener(JObject arg0) const
	{
		callMethod<void>(
			"removeContrastChangeListener",
			"(Landroid/app/UiModeManager$ContrastChangeListener;)V",
			arg0.object()
		);
	}
