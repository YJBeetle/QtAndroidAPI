...
namespace android::app
{
	...
	inline android::app::Notification_MediaStyle Notification_MediaStyle::setRemotePlaybackInfo(JString arg0, jint arg1, android::app::PendingIntent arg2) const
	{
		return callObjectMethod(
			"setRemotePlaybackInfo",
			"(Ljava/lang/CharSequence;ILandroid/app/PendingIntent;)Landroid/app/Notification$MediaStyle;",
			arg0.object<jstring>(),
			arg1,
			arg2.object()
		);
