...
namespace android::app::admin
{
	...
	inline android::app::admin::PreferentialNetworkServiceConfig_Builder PreferentialNetworkServiceConfig_Builder::setShouldBlockNonMatchingNetworks(jboolean arg0) const
	{
		return callObjectMethod(
