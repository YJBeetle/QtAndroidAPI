...
{
	// Fields
	inline JString DeviceAdminReceiver::ACTION_CHOOSE_PRIVATE_KEY_ALIAS()
	{
	...
	inline JString DeviceAdminReceiver::ACTION_NETWORK_LOGS_AVAILABLE()
	{
		return getStaticObjectField(
			"android.app.admin.DeviceAdminReceiver",
	...
	inline JString DeviceAdminReceiver::ACTION_SECURITY_LOGS_AVAILABLE()
	{
		return getStaticObjectField(
			"android.app.admin.DeviceAdminReceiver",
	...
	inline void DeviceAdminReceiver::onComplianceAcknowledgementRequired(android::content::Context arg0, android::content::Intent arg1) const
	{
		callMethod<void>(
	...
	inline void DeviceAdminReceiver::onOperationSafetyStateChanged(android::content::Context arg0, jint arg1, jboolean arg2) const
	{
		callMethod<void>(
