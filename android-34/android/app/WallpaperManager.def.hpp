...
namespace android::app
{
	...
	public:
		...
		WallpaperManager(QJniObject obj) : JObject(obj) {}
		...
		android::graphics::drawable::Drawable getFastDrawable(jint arg0) const;
		...
		android::app::WallpaperInfo getWallpaperInfo(jint arg0) const;
		...
		android::graphics::drawable::Drawable peekDrawable(jint arg0) const;
		android::graphics::drawable::Drawable peekFastDrawable() const;
		android::graphics::drawable::Drawable peekFastDrawable(jint arg0) const;
