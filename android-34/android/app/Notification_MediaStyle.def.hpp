...
namespace android::app
{
	...
	public:
		...
		Notification_MediaStyle(QJniObject obj) : android::app::Notification_Style(obj) {}
		...
		android::app::Notification_MediaStyle setRemotePlaybackInfo(JString arg0, jint arg1, android::app::PendingIntent arg2) const;
