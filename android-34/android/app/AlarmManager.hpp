...
namespace android::app
{
	...
	inline void AlarmManager::cancelAll() const
	{
		callMethod<void>(
			"cancelAll",
			"()V"
	...
	inline void AlarmManager::setWindow(jint arg0, jlong arg1, jlong arg2, JString arg3, JObject arg4, JObject arg5) const
	{
		callMethod<void>(
			"setWindow",
			"(IJJLjava/lang/String;Ljava/util/concurrent/Executor;Landroid/app/AlarmManager$OnAlarmListener;)V",
			arg0,
			arg1,
			arg2,
			arg3.object<jstring>(),
