...
namespace android::app::appsearch
{
	...
	inline android::app::appsearch::AppSearchSchema_StringPropertyConfig_Builder AppSearchSchema_StringPropertyConfig_Builder::setJoinableValueType(jint arg0) const
	{
		return callObjectMethod(
