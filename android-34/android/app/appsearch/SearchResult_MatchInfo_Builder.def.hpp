...
namespace android::app::appsearch
{
	...
	public:
		...
		SearchResult_MatchInfo_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::app::appsearch::SearchResult_MatchInfo_Builder setSubmatchRange(android::app::appsearch::SearchResult_MatchRange arg0) const;
	};
} // namespace android::app::appsearch
