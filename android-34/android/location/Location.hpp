...
namespace android::location
{
	...
	inline jboolean Location::equals(JObject arg0) const
	{
	...
	inline jlong Location::getElapsedRealtimeAgeMillis() const
	{
	...
	inline jlong Location::getElapsedRealtimeAgeMillis(jlong arg0) const
	{
		return callMethod<jlong>(
			"getElapsedRealtimeAgeMillis",
			"(J)J",
	...
	inline jlong Location::getElapsedRealtimeMillis() const
	{
		return callMethod<jlong>(
	...
	inline jdouble Location::getElapsedRealtimeUncertaintyNanos() const
	{
		return callMethod<jdouble>(
	...
	inline jfloat Location::getMslAltitudeAccuracyMeters() const
	{
		return callMethod<jfloat>(
	...
	inline jdouble Location::getMslAltitudeMeters() const
	{
		return callMethod<jdouble>(
	...
	inline jboolean Location::hasElapsedRealtimeUncertaintyNanos() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean Location::hasMslAltitude() const
	{
		return callMethod<jboolean>(
			"hasMslAltitude",
			"()Z"
	...
	inline jboolean Location::hasMslAltitudeAccuracy() const
	{
		return callMethod<jboolean>(
	...
	inline jint Location::hashCode() const
	{
		return callMethod<jint>(
			"hashCode",
			"()I"
	...
	inline jboolean Location::isComplete() const
	{
		return callMethod<jboolean>(
			"isComplete",
			"()Z"
	...
	inline jboolean Location::isMock() const
	{
		return callMethod<jboolean>(
			"isMock",
			"()Z"
	...
	inline void Location::removeBearingAccuracy() const
	{
		callMethod<void>(
	...
	inline void Location::removeElapsedRealtimeUncertaintyNanos() const
	{
		callMethod<void>(
	...
	inline void Location::removeMslAltitude() const
	{
		callMethod<void>(
			"removeMslAltitude",
			"()V"
	...
	inline void Location::removeMslAltitudeAccuracy() const
	{
		callMethod<void>(
	...
	inline void Location::removeSpeedAccuracy() const
	{
		callMethod<void>(
			"removeSpeedAccuracy",
			"()V"
	...
	inline void Location::removeVerticalAccuracy() const
	{
		callMethod<void>(
	...
	inline void Location::setElapsedRealtimeUncertaintyNanos(jdouble arg0) const
	{
		callMethod<void>(
	...
	inline void Location::setMock(jboolean arg0) const
	{
		callMethod<void>(
			"setMock",
			"(Z)V",
	...
	inline void Location::setMslAltitudeAccuracyMeters(jfloat arg0) const
	{
		callMethod<void>(
	...
	inline void Location::setMslAltitudeMeters(jdouble arg0) const
	{
		callMethod<void>(
