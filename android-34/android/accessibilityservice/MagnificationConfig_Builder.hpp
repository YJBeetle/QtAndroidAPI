...
namespace android::accessibilityservice
{
	...
	inline android::accessibilityservice::MagnificationConfig_Builder MagnificationConfig_Builder::setActivated(jboolean arg0) const
	{
		return callObjectMethod(
			"setActivated",
			"(Z)Landroid/accessibilityservice/MagnificationConfig$Builder;",
			arg0
		);
	}
