...
namespace android::accessibilityservice
{
	...
	inline jint AccessibilityServiceInfo::FLAG_INPUT_METHOD_EDITOR()
	{
		return getStaticField<jint>(
			"android.accessibilityservice.AccessibilityServiceInfo",
	...
	inline jint AccessibilityServiceInfo::FLAG_REQUEST_2_FINGER_PASSTHROUGH()
	{
		return getStaticField<jint>(
			"android.accessibilityservice.AccessibilityServiceInfo",
	...
	inline jint AccessibilityServiceInfo::FLAG_SEND_MOTION_EVENTS()
	{
		return getStaticField<jint>(
			"android.accessibilityservice.AccessibilityServiceInfo",
	...
	inline jint AccessibilityServiceInfo::getMotionEventSources() const
	{
		return callMethod<jint>(
	...
	inline JString AccessibilityServiceInfo::getTileServiceName() const
	{
		return callObjectMethod(
			"getTileServiceName",
			"()Ljava/lang/String;"
	...
	inline jboolean AccessibilityServiceInfo::isAccessibilityTool() const
	{
		return callMethod<jboolean>(
			"isAccessibilityTool",
			"()Z"
	...
	inline JString AccessibilityServiceInfo::loadIntro(android::content::pm::PackageManager arg0) const
	{
		return callObjectMethod(
			"loadIntro",
	...
	inline void AccessibilityServiceInfo::setMotionEventSources(jint arg0) const
	{
		callMethod<void>(
