...
namespace android::net::wifi::aware
{
	...
	inline jint Characteristics::WIFI_AWARE_CIPHER_SUITE_NCS_PK_PASN_128()
	{
		return getStaticField<jint>(
			"android.net.wifi.aware.Characteristics",
	...
	inline jint Characteristics::WIFI_AWARE_CIPHER_SUITE_NCS_PK_PASN_256()
	{
		return getStaticField<jint>(
			"android.net.wifi.aware.Characteristics",
	...
	inline jint Characteristics::getSupportedPairingCipherSuites() const
	{
		return callMethod<jint>(
	...
	inline jboolean Characteristics::isAwarePairingSupported() const
	{
	...
	inline jboolean Characteristics::isSuspensionSupported() const
	{
		return callMethod<jboolean>(
