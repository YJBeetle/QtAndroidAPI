...
namespace android::net::wifi::aware
{
	...
	inline void WifiAwareManager::getPairedDevices(JObject arg0, JObject arg1) const
	{
		callMethod<void>(
			"getPairedDevices",
	...
	inline void WifiAwareManager::isOpportunisticModeEnabled(JObject arg0, JObject arg1) const
	{
		callMethod<void>(
	...
	inline void WifiAwareManager::removePairedDevice(JString arg0) const
	{
		callMethod<void>(
			"removePairedDevice",
			"(Ljava/lang/String;)V",
	...
	inline void WifiAwareManager::resetPairedDevices() const
	{
		callMethod<void>(
			"resetPairedDevices",
			"()V"
	...
	inline void WifiAwareManager::setOpportunisticModeEnabled(jboolean arg0) const
	{
		callMethod<void>(
