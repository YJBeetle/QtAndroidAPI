...
namespace android::net::wifi
{
	...
	public:
		...
		static jint TLS_V1_0();
		static jint TLS_V1_1();
		static jint TLS_V1_2();
		static jint TLS_V1_3();
		...
		void enableTrustOnFirstUse(jboolean arg0) const;
		...
		jint getMinimumTlsVersion() const;
		...
		jboolean hasCaCertificate() const;
		...
		jboolean isTrustOnFirstUseEnabled() const;
		...
		void setMinimumTlsVersion(jint arg0) const;
