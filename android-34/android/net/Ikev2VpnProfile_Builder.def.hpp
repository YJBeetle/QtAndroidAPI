...
namespace android::net
{
	...
	public:
		...
		// Constructors
		Ikev2VpnProfile_Builder(android::net::ipsec::ike::IkeTunnelConnectionParams arg0);
		...
		android::net::Ikev2VpnProfile_Builder setAutomaticIpVersionSelectionEnabled(jboolean arg0) const;
		android::net::Ikev2VpnProfile_Builder setAutomaticNattKeepaliveTimerEnabled(jboolean arg0) const;
		android::net::Ikev2VpnProfile_Builder setBypassable(jboolean arg0) const;
		android::net::Ikev2VpnProfile_Builder setLocalRoutesExcluded(jboolean arg0) const;
		...
		android::net::Ikev2VpnProfile_Builder setRequiresInternetValidation(jboolean arg0) const;
	};
} // namespace android::net
