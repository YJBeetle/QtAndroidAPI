...
namespace android::net
{
	...
	inline android::net::Ikev2VpnProfile_Builder Ikev2VpnProfile_Builder::setAutomaticIpVersionSelectionEnabled(jboolean arg0) const
	{
		return callObjectMethod(
	...
	inline android::net::Ikev2VpnProfile_Builder Ikev2VpnProfile_Builder::setAutomaticNattKeepaliveTimerEnabled(jboolean arg0) const
	{
		return callObjectMethod(
