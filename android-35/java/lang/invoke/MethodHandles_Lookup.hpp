...
namespace java::lang::invoke
{
	...
	inline java::lang::invoke::VarHandle MethodHandles_Lookup::findStaticVarHandle(JClass arg0, JString arg1, JClass arg2) const
	{
		return callObjectMethod(
			"findStaticVarHandle",
	...
	inline java::lang::invoke::VarHandle MethodHandles_Lookup::findVarHandle(JClass arg0, JString arg1, JClass arg2) const
	{
		return callObjectMethod(
			"findVarHandle",
			"(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/invoke/VarHandle;",
	...
	inline java::lang::invoke::VarHandle MethodHandles_Lookup::unreflectVarHandle(java::lang::reflect::Field arg0) const
	{
		return callObjectMethod(
			"unreflectVarHandle",
