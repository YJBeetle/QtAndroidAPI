...
namespace android::graphics::drawable
{
	...
	inline jboolean LayerDrawable::hasFocusStateSpecified() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean LayerDrawable::isProjected() const
	{
		return callMethod<jboolean>(
			"isProjected",
			"()Z"
	...
	inline void LayerDrawable::setTintBlendMode(android::graphics::BlendMode arg0) const
	{
		callMethod<void>(
			"setTintBlendMode",
