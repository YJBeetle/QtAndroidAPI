...
namespace android::graphics
{
	...
	inline android::graphics::Gainmap Bitmap::getGainmap() const
	{
		return callObjectMethod(
			"getGainmap",
	...
	inline jboolean Bitmap::hasGainmap() const
	{
		return callMethod<jboolean>(
			"hasGainmap",
			"()Z"
	...
	inline void Bitmap::setGainmap(android::graphics::Gainmap arg0) const
	{
		callMethod<void>(
			"setGainmap",
			"(Landroid/graphics/Gainmap;)V",
			arg0.object()
		);
	}
