...
namespace android::adservices::adselection
{
	...
	inline void TestAdSelectionManager::overrideAdSelectionFromOutcomesConfigRemoteInfo(android::adservices::adselection::AddAdSelectionFromOutcomesOverrideRequest arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"overrideAdSelectionFromOutcomesConfigRemoteInfo",
			"(Landroid/adservices/adselection/AddAdSelectionFromOutcomesOverrideRequest;Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
	...
	inline void TestAdSelectionManager::removeAdSelectionFromOutcomesConfigRemoteInfoOverride(android::adservices::adselection::RemoveAdSelectionFromOutcomesOverrideRequest arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"removeAdSelectionFromOutcomesConfigRemoteInfoOverride",
			"(Landroid/adservices/adselection/RemoveAdSelectionFromOutcomesOverrideRequest;Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
	...
	inline void TestAdSelectionManager::resetAllAdSelectionFromOutcomesConfigRemoteOverrides(JObject arg0, JObject arg1) const
	{
		callMethod<void>(
