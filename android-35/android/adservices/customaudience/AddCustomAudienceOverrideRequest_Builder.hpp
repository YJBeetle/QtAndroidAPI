...
namespace android::adservices::customaudience
{
	...
	inline android::adservices::customaudience::AddCustomAudienceOverrideRequest_Builder AddCustomAudienceOverrideRequest_Builder::setBiddingLogicJsVersion(jlong arg0) const
	{
		return callObjectMethod(
			"setBiddingLogicJsVersion",
			"(J)Landroid/adservices/customaudience/AddCustomAudienceOverrideRequest$Builder;",
			arg0
		);
	}
