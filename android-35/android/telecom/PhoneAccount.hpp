...
{
	// Fields
	inline jint PhoneAccount::CAPABILITY_ADHOC_CONFERENCE_CALLING()
	{
	...
	inline jint PhoneAccount::CAPABILITY_CALL_COMPOSER()
	{
		return getStaticField<jint>(
			"android.telecom.PhoneAccount",
	...
	inline jint PhoneAccount::CAPABILITY_SUPPORTS_CALL_STREAMING()
	{
		return getStaticField<jint>(
			"android.telecom.PhoneAccount",
	...
	inline jint PhoneAccount::CAPABILITY_SUPPORTS_TRANSACTIONAL_OPERATIONS()
	{
		return getStaticField<jint>(
			"android.telecom.PhoneAccount",
	...
	inline jint PhoneAccount::CAPABILITY_SUPPORTS_VOICE_CALLING_INDICATIONS()
	{
		return getStaticField<jint>(
			"android.telecom.PhoneAccount",
	...
	inline jint PhoneAccount::CAPABILITY_VOICE_CALLING_AVAILABLE()
	{
		return getStaticField<jint>(
			"android.telecom.PhoneAccount",
	...
	inline JString PhoneAccount::EXTRA_ADD_SELF_MANAGED_CALLS_TO_INCALLSERVICE()
	{
		return getStaticObjectField(
			"android.telecom.PhoneAccount",
	...
	inline JString PhoneAccount::EXTRA_ALWAYS_USE_VOIP_AUDIO_MODE()
	{
		return getStaticObjectField(
			"android.telecom.PhoneAccount",
	...
	inline jboolean PhoneAccount::equals(JObject arg0) const
	{
	...
	inline JObject PhoneAccount::getSimultaneousCallingRestriction() const
	{
		return callObjectMethod(
	...
	inline jboolean PhoneAccount::hasSimultaneousCallingRestriction() const
	{
		return callMethod<jboolean>(
	...
	inline jint PhoneAccount::hashCode() const
	{
		return callMethod<jint>(
			"hashCode",
			"()I"
