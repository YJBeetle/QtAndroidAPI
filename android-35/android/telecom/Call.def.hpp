...
namespace android::telecom
{
	...
	public:
		...
		static JString EXTRA_ASSERTED_DISPLAY_NAME();
		static JString EXTRA_DIAGNOSTIC_MESSAGE();
		static JString EXTRA_DIAGNOSTIC_MESSAGE_ID();
		static JString EXTRA_IS_BUSINESS_CALL();
		static JString EXTRA_IS_SUPPRESSED_BY_DO_NOT_DISTURB();
		...
		static jint STATE_AUDIO_PROCESSING();
		...
		Call(QJniObject obj) : JObject(obj) {}
		...
		android::telecom::Call getGenericConferenceActiveChildCall() const;
