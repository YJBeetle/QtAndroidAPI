...
namespace android::telecom
{
	...
	inline void CallControl::requestMuteState(jboolean arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"requestMuteState",
			"(ZLjava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V",
			arg0,
			arg1.object(),
			arg2.object()
		);
	}
	inline void CallControl::requestVideoState(jint arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"requestVideoState",
			"(ILjava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V",
