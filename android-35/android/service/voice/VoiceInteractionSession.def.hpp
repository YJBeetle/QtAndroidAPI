...
namespace android::service::voice
{
	...
	public:
		// Fields
		static JString KEY_FOREGROUND_ACTIVITIES();
		static JString KEY_SHOW_SESSION_ID();
		...
		VoiceInteractionSession(QJniObject obj) : JObject(obj) {}
		...
		void registerVisibleActivityCallback(JObject arg0, JObject arg1) const;
		...
		void startAssistantActivity(android::content::Intent arg0, android::os::Bundle arg1) const;
		void startVoiceActivity(android::content::Intent arg0) const;
		void unregisterVisibleActivityCallback(JObject arg0) const;
	};
} // namespace android::service::voice
