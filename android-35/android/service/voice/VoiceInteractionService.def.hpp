...
namespace android::service::voice
{
	...
	public:
		...
		VoiceInteractionService(QJniObject obj) : android::app::Service(obj) {}
		...
		void onPrepareToShowSession(android::os::Bundle arg0, jint arg1) const;
		void onReady() const;
		void onShowSessionFailed(android::os::Bundle arg0) const;
