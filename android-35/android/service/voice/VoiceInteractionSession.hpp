...
{
	// Fields
	inline JString VoiceInteractionSession::KEY_FOREGROUND_ACTIVITIES()
	{
	...
	inline JString VoiceInteractionSession::KEY_SHOW_SESSION_ID()
	{
		return getStaticObjectField(
			"android.service.voice.VoiceInteractionSession",
			"KEY_SHOW_SESSION_ID",
	...
	inline void VoiceInteractionSession::startAssistantActivity(android::content::Intent arg0, android::os::Bundle arg1) const
	{
		callMethod<void>(
			"startAssistantActivity",
