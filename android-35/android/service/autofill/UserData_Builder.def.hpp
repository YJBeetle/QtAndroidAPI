...
namespace android::service::autofill
{
	...
	public:
		...
		UserData_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::service::autofill::UserData_Builder setFieldClassificationAlgorithmForCategory(JString arg0, JString arg1, android::os::Bundle arg2) const;
	};
} // namespace android::service::autofill
