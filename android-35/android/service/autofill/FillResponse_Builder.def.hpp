...
namespace android::service::autofill
{
	...
	public:
		...
		android::service::autofill::FillResponse_Builder setDetectedFieldClassifications(JObject arg0) const;
		...
		android::service::autofill::FillResponse_Builder setIconResourceId(jint arg0) const;
		...
		android::service::autofill::FillResponse_Builder setServiceDisplayNameResourceId(jint arg0) const;
		android::service::autofill::FillResponse_Builder setShowFillDialogIcon(jboolean arg0) const;
		android::service::autofill::FillResponse_Builder setShowSaveDialogIcon(jboolean arg0) const;
