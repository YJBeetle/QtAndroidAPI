...
namespace android::service::notification
{
	...
	inline JString StatusBarNotification::getOpPkg() const
	{
		return callObjectMethod(
			"getOpPkg",
			"()Ljava/lang/String;"
	...
	inline jint StatusBarNotification::getUid() const
	{
		return callMethod<jint>(
			"getUid",
			"()I"
	...
	inline jboolean StatusBarNotification::isAppGroup() const
	{
