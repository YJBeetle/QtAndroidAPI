...
{
	// Fields
	inline jint ControlsProviderService::CONTROLS_SURFACE_ACTIVITY_PANEL()
	{
	...
	inline jint ControlsProviderService::CONTROLS_SURFACE_DREAM()
	{
		return getStaticField<jint>(
			"android.service.controls.ControlsProviderService",
	...
	inline JString ControlsProviderService::EXTRA_CONTROLS_SURFACE()
	{
	...
	inline JString ControlsProviderService::EXTRA_LOCKSCREEN_ALLOW_TRIVIAL_CONTROLS()
	{
		return getStaticObjectField(
			"android.service.controls.ControlsProviderService",
	...
	inline JString ControlsProviderService::META_DATA_PANEL_ACTIVITY()
	{
		return getStaticObjectField(
			"android.service.controls.ControlsProviderService",
