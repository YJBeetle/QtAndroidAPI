...
namespace android::telephony
{
	...
	inline jint PreciseDataConnectionState::NETWORK_VALIDATION_FAILURE()
	{
	...
	inline jint PreciseDataConnectionState::NETWORK_VALIDATION_IN_PROGRESS()
	{
		return getStaticField<jint>(
			"android.telephony.PreciseDataConnectionState",
	...
	inline jint PreciseDataConnectionState::NETWORK_VALIDATION_NOT_REQUESTED()
	{
		return getStaticField<jint>(
			"android.telephony.PreciseDataConnectionState",
	...
	inline jint PreciseDataConnectionState::NETWORK_VALIDATION_SUCCESS()
	{
		return getStaticField<jint>(
			"android.telephony.PreciseDataConnectionState",
	...
	inline jint PreciseDataConnectionState::NETWORK_VALIDATION_UNSUPPORTED()
	{
		return getStaticField<jint>(
			"android.telephony.PreciseDataConnectionState",
	...
	inline jint PreciseDataConnectionState::getNetworkValidationStatus() const
	{
		return callMethod<jint>(
