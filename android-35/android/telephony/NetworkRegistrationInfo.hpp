...
namespace android::telephony
{
	...
	inline jint NetworkRegistrationInfo::SERVICE_TYPE_MMS()
	{
		return getStaticField<jint>(
			"android.telephony.NetworkRegistrationInfo",
			"SERVICE_TYPE_MMS"
	...
	inline jint NetworkRegistrationInfo::getRejectCause() const
	{
		return callMethod<jint>(
			"getRejectCause",
			"()I"
	...
	inline jboolean NetworkRegistrationInfo::isNetworkRegistered() const
	{
		return callMethod<jboolean>(
			"isNetworkRegistered",
			"()Z"
	...
	inline jboolean NetworkRegistrationInfo::isNetworkRoaming() const
	{
		return callMethod<jboolean>(
			"isNetworkRoaming",
			"()Z"
	...
	inline jboolean NetworkRegistrationInfo::isNetworkSearching() const
	{
		return callMethod<jboolean>(
			"isNetworkSearching",
			"()Z"
	...
	inline jboolean NetworkRegistrationInfo::isNonTerrestrialNetwork() const
	{
		return callMethod<jboolean>(
