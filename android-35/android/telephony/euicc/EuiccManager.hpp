...
namespace android::telephony::euicc
{
	...
	inline jint EuiccManager::ERROR_INVALID_PORT()
	{
		return getStaticField<jint>(
			"android.telephony.euicc.EuiccManager",
			"ERROR_INVALID_PORT"
	...
	inline jlong EuiccManager::EUICC_MEMORY_FIELD_UNAVAILABLE()
	{
	...
	inline jlong EuiccManager::getAvailableMemoryInBytes() const
	{
	...
	inline jboolean EuiccManager::isSimPortAvailable(jint arg0) const
	{
		return callMethod<jboolean>(
			"isSimPortAvailable",
			"(I)Z",
	...
	inline void EuiccManager::switchToSubscription(jint arg0, jint arg1, android::app::PendingIntent arg2) const
	{
		callMethod<void>(
			"switchToSubscription",
