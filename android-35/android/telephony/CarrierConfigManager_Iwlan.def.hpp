...
namespace android::telephony
{
	...
	public:
		...
		static jint EPDG_ADDRESS_IPV4_ONLY();
		static jint EPDG_ADDRESS_IPV4_PREFERRED();
		static jint EPDG_ADDRESS_IPV6_PREFERRED();
		static jint EPDG_ADDRESS_PCO();
		static jint EPDG_ADDRESS_PLMN();
		static jint EPDG_ADDRESS_STATIC();
		static jint EPDG_ADDRESS_VISITED_COUNTRY();
		...
		static JString KEY_CHILD_SESSION_AES_GCM_KEY_SIZE_INT_ARRAY();
		static JString KEY_DIFFIE_HELLMAN_GROUPS_INT_ARRAY();
		static JString KEY_DPD_TIMER_SEC_INT();
		static JString KEY_EPDG_ADDRESS_IP_TYPE_PREFERENCE_INT();
		...
		static JString KEY_IKE_SESSION_AES_GCM_KEY_SIZE_INT_ARRAY();
		...
		static JString KEY_SUPPORTED_CHILD_SESSION_AEAD_ALGORITHMS_INT_ARRAY();
		static JString KEY_SUPPORTED_CHILD_SESSION_ENCRYPTION_ALGORITHMS_INT_ARRAY();
		static JString KEY_SUPPORTED_IKE_SESSION_AEAD_ALGORITHMS_INT_ARRAY();
		...
		static JString KEY_SUPPORTS_CHILD_SESSION_MULTIPLE_SA_PROPOSALS_BOOL();
		static JString KEY_SUPPORTS_EAP_AKA_FAST_REAUTH_BOOL();
		static JString KEY_SUPPORTS_IKE_SESSION_MULTIPLE_SA_PROPOSALS_BOOL();
		...
		CarrierConfigManager_Iwlan(QJniObject obj) : JObject(obj) {}
