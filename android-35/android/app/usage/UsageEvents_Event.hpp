...
{
	// Fields
	inline jint UsageEvents_Event::ACTIVITY_PAUSED()
	{
	...
	inline jint UsageEvents_Event::ACTIVITY_RESUMED()
	{
		return getStaticField<jint>(
			"android.app.usage.UsageEvents$Event",
			"ACTIVITY_RESUMED"
	...
	inline jint UsageEvents_Event::ACTIVITY_STOPPED()
	{
		return getStaticField<jint>(
			"android.app.usage.UsageEvents$Event",
			"ACTIVITY_STOPPED"
	...
	inline jint UsageEvents_Event::DEVICE_SHUTDOWN()
	{
		return getStaticField<jint>(
			"android.app.usage.UsageEvents$Event",
			"DEVICE_SHUTDOWN"
	...
	inline jint UsageEvents_Event::DEVICE_STARTUP()
	{
		return getStaticField<jint>(
			"android.app.usage.UsageEvents$Event",
			"DEVICE_STARTUP"
	...
	inline jint UsageEvents_Event::FOREGROUND_SERVICE_START()
	{
		return getStaticField<jint>(
			"android.app.usage.UsageEvents$Event",
	...
	inline jint UsageEvents_Event::FOREGROUND_SERVICE_STOP()
	{
		return getStaticField<jint>(
			"android.app.usage.UsageEvents$Event",
	...
	inline android::os::PersistableBundle UsageEvents_Event::getExtras() const
	{
		return callObjectMethod(
			"getExtras",
