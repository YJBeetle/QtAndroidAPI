...
namespace android::app
{
	...
	public:
		...
		ActivityManager(QJniObject obj) : JObject(obj) {}
		...
		void addApplicationStartInfoCompletionListener(JObject arg0, JObject arg1) const;
		void addStartInfoTimestamp(jint arg0, jlong arg1) const;
		void appNotResponding(JString arg0) const;
		...
		JObject getHistoricalProcessExitReasons(JString arg0, jint arg1, jint arg2) const;
		JObject getHistoricalProcessStartReasons(jint arg0) const;
		...
		jboolean isActivityStartAllowedOnDisplay(android::content::Context arg0, jint arg1, android::content::Intent arg2) const;
		...
		void removeApplicationStartInfoCompletionListener(JObject arg0) const;
		void restartPackage(JString arg0) const;
		void setProcessStateSummary(JByteArray arg0) const;
