...
namespace android::app
{
	...
	public:
		...
		Instrumentation(QJniObject obj) : JObject(obj) {}
		...
		void callActivityOnNewIntent(android::app::Activity arg0, android::content::Intent arg1, android::app::ComponentCaller arg2) const;
