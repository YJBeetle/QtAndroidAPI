...
namespace android::app
{
	...
	inline jint UiAutomation::FLAG_DONT_USE_ACCESSIBILITY()
	{
		return getStaticField<jint>(
			"android.app.UiAutomation",
	...
	// Methods
	inline void UiAutomation::adoptShellPermissionIdentity() const
	{
		callMethod<void>(
	...
	inline void UiAutomation::adoptShellPermissionIdentity(JArray arg0) const
	{
		callMethod<void>(
			"adoptShellPermissionIdentity",
			"([Ljava/lang/String;)V",
	...
	inline jboolean UiAutomation::clearCache() const
	{
	...
	inline void UiAutomation::dropShellPermissionIdentity() const
	{
		callMethod<void>(
	...
	inline JArray UiAutomation::executeShellCommandRw(JString arg0) const
	{
		return callObjectMethod(
	...
	inline JArray UiAutomation::executeShellCommandRwe(JString arg0) const
	{
		return callObjectMethod(
	...
	inline android::util::SparseArray UiAutomation::getWindowsOnAllDisplays() const
	{
		return callObjectMethod(
	...
	inline void UiAutomation::setAnimationScale(jfloat arg0) const
	{
		callMethod<void>(
			"setAnimationScale",
			"(F)V",
	...
	inline android::graphics::Bitmap UiAutomation::takeScreenshot(android::view::Window arg0) const
	{
		return callObjectMethod(
			"takeScreenshot",
	...
	inline JString UiAutomation::toString() const
	{
		return callObjectMethod(
			"toString",
			"()Ljava/lang/String;"
