...
namespace android::app
{
	...
	inline jint ApplicationExitInfo::REASON_FREEZER()
	{
		return getStaticField<jint>(
			"android.app.ApplicationExitInfo",
			"REASON_FREEZER"
	...
	inline jint ApplicationExitInfo::REASON_PACKAGE_STATE_CHANGE()
	{
		return getStaticField<jint>(
			"android.app.ApplicationExitInfo",
	...
	inline jint ApplicationExitInfo::REASON_PACKAGE_UPDATED()
	{
		return getStaticField<jint>(
			"android.app.ApplicationExitInfo",
