...
namespace android::app::appsearch
{
	...
	public:
		...
		PutDocumentsRequest_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::app::appsearch::PutDocumentsRequest_Builder addTakenActionGenericDocuments(JArray arg0) const;
		android::app::appsearch::PutDocumentsRequest_Builder addTakenActionGenericDocuments(JObject arg0) const;
