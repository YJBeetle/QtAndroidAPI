...
namespace android::app::appsearch
{
	...
	public:
		...
		AppSearchSchema_DocumentPropertyConfig_Builder(QJniObject obj) : JObject(obj) {}
		
		// Constructors
		AppSearchSchema_DocumentPropertyConfig_Builder(JString arg0, JString arg1);
		
		// Methods
		android::app::appsearch::AppSearchSchema_DocumentPropertyConfig_Builder addIndexableNestedProperties(JArray arg0) const;
		android::app::appsearch::AppSearchSchema_DocumentPropertyConfig_Builder addIndexableNestedProperties(JObject arg0) const;
		android::app::appsearch::AppSearchSchema_DocumentPropertyConfig_Builder addIndexableNestedPropertyPaths(JArray arg0) const;
		android::app::appsearch::AppSearchSchema_DocumentPropertyConfig_Builder addIndexableNestedPropertyPaths(JObject arg0) const;
