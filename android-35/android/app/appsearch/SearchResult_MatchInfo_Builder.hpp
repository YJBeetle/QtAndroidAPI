...
namespace android::app::appsearch
{
	...
	inline android::app::appsearch::SearchResult_MatchInfo_Builder SearchResult_MatchInfo_Builder::setSubmatchRange(android::app::appsearch::SearchResult_MatchRange arg0) const
	{
		return callObjectMethod(
			"setSubmatchRange",
			"(Landroid/app/appsearch/SearchResult$MatchRange;)Landroid/app/appsearch/SearchResult$MatchInfo$Builder;",
