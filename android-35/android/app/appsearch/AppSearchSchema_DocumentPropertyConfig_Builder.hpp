...
namespace android::app::appsearch
{
	...
	// Methods
	inline android::app::appsearch::AppSearchSchema_DocumentPropertyConfig_Builder AppSearchSchema_DocumentPropertyConfig_Builder::addIndexableNestedProperties(JArray arg0) const
	{
		return callObjectMethod(
			"addIndexableNestedProperties",
			"([Ljava/lang/String;)Landroid/app/appsearch/AppSearchSchema$DocumentPropertyConfig$Builder;",
			arg0.object<jarray>()
		);
	}
	inline android::app::appsearch::AppSearchSchema_DocumentPropertyConfig_Builder AppSearchSchema_DocumentPropertyConfig_Builder::addIndexableNestedProperties(JObject arg0) const
	{
		return callObjectMethod(
			"addIndexableNestedProperties",
			"(Ljava/util/Collection;)Landroid/app/appsearch/AppSearchSchema$DocumentPropertyConfig$Builder;",
			arg0.object()
		);
	}
	inline android::app::appsearch::AppSearchSchema_DocumentPropertyConfig_Builder AppSearchSchema_DocumentPropertyConfig_Builder::addIndexableNestedPropertyPaths(JArray arg0) const
	{
		return callObjectMethod(
			"addIndexableNestedPropertyPaths",
			"([Landroid/app/appsearch/PropertyPath;)Landroid/app/appsearch/AppSearchSchema$DocumentPropertyConfig$Builder;",
			arg0.object<jarray>()
		);
	}
	inline android::app::appsearch::AppSearchSchema_DocumentPropertyConfig_Builder AppSearchSchema_DocumentPropertyConfig_Builder::addIndexableNestedPropertyPaths(JObject arg0) const
	{
		return callObjectMethod(
			"addIndexableNestedPropertyPaths",
			"(Ljava/util/Collection;)Landroid/app/appsearch/AppSearchSchema$DocumentPropertyConfig$Builder;",
