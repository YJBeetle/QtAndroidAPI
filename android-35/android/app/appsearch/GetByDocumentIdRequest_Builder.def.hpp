...
namespace android::app::appsearch
{
	...
	public:
		...
		GetByDocumentIdRequest_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::app::appsearch::GetByDocumentIdRequest_Builder addProjectionPaths(JString arg0, JObject arg1) const;
