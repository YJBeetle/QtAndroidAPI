...
namespace android::app
{
	...
	public:
		// Fields
		static jint CALL_TYPE_INCOMING();
		static jint CALL_TYPE_ONGOING();
		static jint CALL_TYPE_SCREENING();
		static jint CALL_TYPE_UNKNOWN();
		...
		Notification_CallStyle(QJniObject obj) : android::app::Notification_Style(obj) {}
