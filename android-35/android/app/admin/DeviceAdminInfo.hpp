...
namespace android::app::admin
{
	...
	inline jint DeviceAdminInfo::HEADLESS_DEVICE_OWNER_MODE_AFFILIATED()
	{
	...
	inline jint DeviceAdminInfo::HEADLESS_DEVICE_OWNER_MODE_SINGLE_USER()
	{
		return getStaticField<jint>(
			"android.app.admin.DeviceAdminInfo",
	...
	inline jint DeviceAdminInfo::HEADLESS_DEVICE_OWNER_MODE_UNSUPPORTED()
	{
		return getStaticField<jint>(
			"android.app.admin.DeviceAdminInfo",
	...
	inline jint DeviceAdminInfo::getHeadlessDeviceOwnerMode() const
	{
		return callMethod<jint>(
