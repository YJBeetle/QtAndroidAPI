...
namespace android::app
{
	...
	inline jint PendingIntent::FLAG_ALLOW_UNSAFE_IMPLICIT_INTENT()
	{
	...
	inline jint PendingIntent::FLAG_MUTABLE()
	{
		return getStaticField<jint>(
			"android.app.PendingIntent",
			"FLAG_MUTABLE"
	...
	inline jboolean PendingIntent::isActivity() const
	{
		return callMethod<jboolean>(
			"isActivity",
			"()Z"
	...
	inline jboolean PendingIntent::isBroadcast() const
	{
		return callMethod<jboolean>(
			"isBroadcast",
			"()Z"
	...
	inline jboolean PendingIntent::isForegroundService() const
	{
		return callMethod<jboolean>(
			"isForegroundService",
			"()Z"
	...
	inline jboolean PendingIntent::isImmutable() const
	{
		return callMethod<jboolean>(
			"isImmutable",
			"()Z"
	...
	inline jboolean PendingIntent::isService() const
	{
		return callMethod<jboolean>(
			"isService",
			"()Z"
	...
	inline void PendingIntent::send(android::os::Bundle arg0) const
	{
		callMethod<void>(
			"send",
