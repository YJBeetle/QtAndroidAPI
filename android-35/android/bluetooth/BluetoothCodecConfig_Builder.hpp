...
namespace android::bluetooth
{
	...
	inline android::bluetooth::BluetoothCodecConfig_Builder BluetoothCodecConfig_Builder::setExtendedCodecType(android::bluetooth::BluetoothCodecType arg0) const
	{
		return callObjectMethod(
			"setExtendedCodecType",
			"(Landroid/bluetooth/BluetoothCodecType;)Landroid/bluetooth/BluetoothCodecConfig$Builder;",
			arg0.object()
		);
	}
