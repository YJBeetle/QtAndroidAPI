...
namespace android::system
{
	...
	public:
		...
		static jint IFA_F_MANAGETEMPADDR();
		static jint IFA_F_NODAD();
		static jint IFA_F_NOPREFIXROUTE();
		...
		static jint PACKET_IGNORE_OUTGOING();
		static jint POLLERR();
		static jint POLLHUP();
		static jint POLLIN();
		...
		OsConstants(QJniObject obj) : JObject(obj) {}
