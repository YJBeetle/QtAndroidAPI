...
namespace android::security::keystore
{
	...
	inline android::security::keystore::KeyProtection_Builder KeyProtection_Builder::setIsStrongBoxBacked(jboolean arg0) const
	{
		return callObjectMethod(
	...
	inline android::security::keystore::KeyProtection_Builder KeyProtection_Builder::setMaxUsageCount(jint arg0) const
	{
		return callObjectMethod(
			"setMaxUsageCount",
	...
	inline android::security::keystore::KeyProtection_Builder KeyProtection_Builder::setMgf1Digests(JArray arg0) const
	{
		return callObjectMethod(
			"setMgf1Digests",
			"([Ljava/lang/String;)Landroid/security/keystore/KeyProtection$Builder;",
