...
namespace android::security::keystore
{
	...
	inline jint KeyProtection::getMaxUsageCount() const
	{
	...
	inline JObject KeyProtection::getMgf1Digests() const
	{
		return callObjectMethod(
			"getMgf1Digests",
			"()Ljava/util/Set;"
	...
	inline jboolean KeyProtection::isMgf1DigestsSpecified() const
	{
		return callMethod<jboolean>(
