...
namespace android::location
{
	...
	public:
		...
		static jint TYPE_BDS_CNAV1();
		static jint TYPE_BDS_CNAV2();
		...
		static jint TYPE_IRN_L1();
		static jint TYPE_IRN_L5();
		static jint TYPE_IRN_L5CA();
		static jint TYPE_QZS_L1CA();
		...
		GnssNavigationMessage(QJniObject obj) : JObject(obj) {}
