...
namespace android::location
{
	...
	inline JObject GnssMeasurementsEvent::getGnssAutomaticGainControls() const
	{
		return callObjectMethod(
	...
	inline jboolean GnssMeasurementsEvent::hasIsFullTracking() const
	{
	...
	inline jboolean GnssMeasurementsEvent::isFullTracking() const
	{
		return callMethod<jboolean>(
			"isFullTracking",
			"()Z"
