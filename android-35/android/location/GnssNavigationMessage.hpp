...
namespace android::location
{
	...
	inline jint GnssNavigationMessage::TYPE_BDS_CNAV1()
	{
		return getStaticField<jint>(
			"android.location.GnssNavigationMessage",
			"TYPE_BDS_CNAV1"
	...
	inline jint GnssNavigationMessage::TYPE_BDS_CNAV2()
	{
		return getStaticField<jint>(
			"android.location.GnssNavigationMessage",
			"TYPE_BDS_CNAV2"
	...
	inline jint GnssNavigationMessage::TYPE_IRN_L1()
	{
		return getStaticField<jint>(
			"android.location.GnssNavigationMessage",
			"TYPE_IRN_L1"
	...
	inline jint GnssNavigationMessage::TYPE_IRN_L5()
	{
		return getStaticField<jint>(
			"android.location.GnssNavigationMessage",
			"TYPE_IRN_L5"
	...
	inline jint GnssNavigationMessage::TYPE_IRN_L5CA()
	{
		return getStaticField<jint>(
			"android.location.GnssNavigationMessage",
			"TYPE_IRN_L5CA"
	...
	inline jint GnssNavigationMessage::TYPE_QZS_L1CA()
	{
		return getStaticField<jint>(
			"android.location.GnssNavigationMessage",
			"TYPE_QZS_L1CA"
	...
	inline jint GnssNavigationMessage::TYPE_SBS()
	{
		return getStaticField<jint>(
			"android.location.GnssNavigationMessage",
			"TYPE_SBS"
