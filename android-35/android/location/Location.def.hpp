...
namespace android::location
{
	...
	public:
		...
		Location(QJniObject obj) : JObject(obj) {}
		...
		jlong getElapsedRealtimeAgeMillis() const;
		jlong getElapsedRealtimeAgeMillis(jlong arg0) const;
		jlong getElapsedRealtimeMillis() const;
		...
		jfloat getMslAltitudeAccuracyMeters() const;
		jdouble getMslAltitudeMeters() const;
		...
		jboolean hasMslAltitude() const;
		jboolean hasMslAltitudeAccuracy() const;
		jboolean hasSpeed() const;
		jboolean hasSpeedAccuracy() const;
		jboolean hasVerticalAccuracy() const;
		jint hashCode() const;
		jboolean isComplete() const;
		jboolean isFromMockProvider() const;
		jboolean isMock() const;
		void removeAccuracy() const;
		void removeAltitude() const;
		void removeBearing() const;
		void removeBearingAccuracy() const;
		void removeElapsedRealtimeUncertaintyNanos() const;
		void removeMslAltitude() const;
		void removeMslAltitudeAccuracy() const;
		void removeSpeed() const;
		void removeSpeedAccuracy() const;
		void removeVerticalAccuracy() const;
		void reset() const;
		...
		void setElapsedRealtimeUncertaintyNanos(jdouble arg0) const;
		void setExtras(android::os::Bundle arg0) const;
		void setLatitude(jdouble arg0) const;
		void setLongitude(jdouble arg0) const;
		void setMock(jboolean arg0) const;
		void setMslAltitudeAccuracyMeters(jfloat arg0) const;
		void setMslAltitudeMeters(jdouble arg0) const;
