...
namespace android::hardware::camera2
{
	...
	// Methods
	inline JObject CameraExtensionCharacteristics::get(jint arg0, android::hardware::camera2::CameraCharacteristics_Key arg1) const
	{
		return callObjectMethod(
			"get",
			"(ILandroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;",
			arg0,
			arg1.object()
		);
	}
	...
	inline JObject CameraExtensionCharacteristics::getKeys(jint arg0) const
	{
		return callObjectMethod(
			"getKeys",
			"(I)Ljava/util/Set;",
	...
	inline JObject CameraExtensionCharacteristics::getPostviewSupportedSizes(jint arg0, android::util::Size arg1, jint arg2) const
	{
		return callObjectMethod(
			"getPostviewSupportedSizes",
			"(ILandroid/util/Size;I)Ljava/util/List;",
			arg0,
			arg1.object(),
			arg2
		);
	...
	inline jboolean CameraExtensionCharacteristics::isCaptureProcessProgressAvailable(jint arg0) const
	{
	...
	inline jboolean CameraExtensionCharacteristics::isPostviewAvailable(jint arg0) const
	{
		return callMethod<jboolean>(
			"isPostviewAvailable",
			"(I)Z",
