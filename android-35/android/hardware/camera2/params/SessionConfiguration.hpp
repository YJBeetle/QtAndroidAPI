...
namespace android::hardware::camera2::params
{
	...
	// Constructors
	inline SessionConfiguration::SessionConfiguration(jint arg0, JObject arg1)
		: JObject(
			"android.hardware.camera2.params.SessionConfiguration",
			"(ILjava/util/List;)V",
			arg0,
	...
	// Methods
	inline void SessionConfiguration::clearColorSpace() const
	{
		callMethod<void>(
			"clearColorSpace",
			"()V"
	...
	inline android::graphics::ColorSpace SessionConfiguration::getColorSpace() const
	{
	...
	inline void SessionConfiguration::setColorSpace(android::graphics::ColorSpace_Named arg0) const
	{
		callMethod<void>(
			"setColorSpace",
	...
	inline void SessionConfiguration::setStateCallback(JObject arg0, android::hardware::camera2::CameraCaptureSession_StateCallback arg1) const
	{
		callMethod<void>(
			"setStateCallback",
			"(Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraCaptureSession$StateCallback;)V",
			arg0.object(),
			arg1.object()
		);
	}
