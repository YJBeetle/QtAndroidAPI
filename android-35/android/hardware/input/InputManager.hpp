...
#include "../../view/InputDevice_ViewBehavior.def.hpp"
...
namespace android::hardware::input
{
	...
	inline android::view::InputDevice_ViewBehavior InputManager::getInputDeviceViewBehavior(jint arg0) const
	{
		return callObjectMethod(
			"getInputDeviceViewBehavior",
			"(I)Landroid/view/InputDevice$ViewBehavior;",
			arg0
		);
	}
