...
namespace android::hardware::input
{
	...
	public:
		...
		InputManager(QJniObject obj) : JObject(obj) {}
		
		// Constructors
		
		// Methods
		android::hardware::input::HostUsiVersion getHostUsiVersion(android::view::Display arg0) const;
		android::view::InputDevice getInputDevice(jint arg0) const;
		JIntArray getInputDeviceIds() const;
		android::view::InputDevice_ViewBehavior getInputDeviceViewBehavior(jint arg0) const;
		jfloat getMaximumObscuringOpacityForTouch() const;
		jboolean isStylusPointerIconEnabled() const;
