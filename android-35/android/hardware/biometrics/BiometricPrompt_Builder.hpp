...
namespace android::hardware::biometrics
{
	...
	inline android::hardware::biometrics::BiometricPrompt_Builder BiometricPrompt_Builder::setAllowedAuthenticators(jint arg0) const
	{
		return callObjectMethod(
	...
	inline android::hardware::biometrics::BiometricPrompt_Builder BiometricPrompt_Builder::setContentView(JObject arg0) const
	{
		return callObjectMethod(
			"setContentView",
			"(Landroid/hardware/biometrics/PromptContentView;)Landroid/hardware/biometrics/BiometricPrompt$Builder;",
			arg0.object()
		);
	}
	...
	inline android::hardware::biometrics::BiometricPrompt_Builder BiometricPrompt_Builder::setLogoBitmap(android::graphics::Bitmap arg0) const
	{
		return callObjectMethod(
			"setLogoBitmap",
			"(Landroid/graphics/Bitmap;)Landroid/hardware/biometrics/BiometricPrompt$Builder;",
			arg0.object()
		);
	}
	inline android::hardware::biometrics::BiometricPrompt_Builder BiometricPrompt_Builder::setLogoDescription(JString arg0) const
	{
		return callObjectMethod(
			"setLogoDescription",
			"(Ljava/lang/String;)Landroid/hardware/biometrics/BiometricPrompt$Builder;",
			arg0.object<jstring>()
		);
	}
	inline android::hardware::biometrics::BiometricPrompt_Builder BiometricPrompt_Builder::setLogoRes(jint arg0) const
	{
		return callObjectMethod(
			"setLogoRes",
			"(I)Landroid/hardware/biometrics/BiometricPrompt$Builder;",
