...
namespace android::hardware::biometrics
{
	...
	public:
		...
		android::hardware::biometrics::BiometricPrompt_Builder setContentView(JObject arg0) const;
		...
		android::hardware::biometrics::BiometricPrompt_Builder setLogoBitmap(android::graphics::Bitmap arg0) const;
		android::hardware::biometrics::BiometricPrompt_Builder setLogoDescription(JString arg0) const;
		android::hardware::biometrics::BiometricPrompt_Builder setLogoRes(jint arg0) const;
