...
namespace android::provider
{
	...
	inline jint DocumentsContract_Document::FLAG_DIR_BLOCKS_OPEN_DOCUMENT_TREE()
	{
	...
	inline jint DocumentsContract_Document::FLAG_PARTIAL()
	{
		return getStaticField<jint>(
			"android.provider.DocumentsContract$Document",
			"FLAG_PARTIAL"
	...
	inline jint DocumentsContract_Document::FLAG_SUPPORTS_METADATA()
	{
		return getStaticField<jint>(
			"android.provider.DocumentsContract$Document",
