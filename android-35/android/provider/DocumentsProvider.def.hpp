...
namespace android::provider
{
	...
	public:
		...
		DocumentsProvider(QJniObject obj) : android::content::ContentProvider(obj) {}
		...
		android::os::Bundle getDocumentMetadata(JString arg0) const;
		...
		JString getTypeAnonymous(android::net::Uri arg0) const;
		...
		JObject queryRecentDocuments(JString arg0, JArray arg1, android::os::Bundle arg2, android::os::CancellationSignal arg3) const;
		JObject queryRoots(JArray arg0) const;
		JObject querySearchDocuments(JString arg0, JArray arg1, android::os::Bundle arg2) const;
