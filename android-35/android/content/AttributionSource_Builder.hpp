...
namespace android::content
{
	...
	inline android::content::AttributionSource_Builder AttributionSource_Builder::setDeviceId(jint arg0) const
	{
		return callObjectMethod(
			"setDeviceId",
			"(I)Landroid/content/AttributionSource$Builder;",
			arg0
		);
	}
	...
	inline android::content::AttributionSource_Builder AttributionSource_Builder::setPid(jint arg0) const
	{
		return callObjectMethod(
			"setPid",
			"(I)Landroid/content/AttributionSource$Builder;",
