...
namespace android::content
{
	...
	// Methods
	inline jboolean ContextWrapper::bindIsolatedService(android::content::Intent arg0, jint arg1, JString arg2, JObject arg3, JObject arg4) const
	{
	...
	inline jboolean ContextWrapper::bindService(android::content::Intent arg0, JObject arg1, android::content::Context_BindServiceFlags arg2) const
	{
		return callMethod<jboolean>(
			"bindService",
	...
	inline jboolean ContextWrapper::bindService(android::content::Intent arg0, android::content::Context_BindServiceFlags arg1, JObject arg2, JObject arg3) const
	{
		return callMethod<jboolean>(
			"bindService",
	...
	inline jboolean ContextWrapper::bindService(android::content::Intent arg0, jint arg1, JObject arg2, JObject arg3) const
	{
		return callMethod<jboolean>(
			"bindService",
	...
	inline jboolean ContextWrapper::bindServiceAsUser(android::content::Intent arg0, JObject arg1, android::content::Context_BindServiceFlags arg2, android::os::UserHandle arg3) const
	{
		return callMethod<jboolean>(
			"bindServiceAsUser",
	...
	inline jboolean ContextWrapper::bindServiceAsUser(android::content::Intent arg0, JObject arg1, jint arg2, android::os::UserHandle arg3) const
	{
		return callMethod<jboolean>(
			"bindServiceAsUser",
	...
	inline JIntArray ContextWrapper::checkCallingOrSelfUriPermissions(JObject arg0, jint arg1) const
	{
	...
	inline JIntArray ContextWrapper::checkCallingUriPermissions(JObject arg0, jint arg1) const
	{
		return callObjectMethod(
	...
	inline jint ContextWrapper::checkContentUriPermissionFull(android::net::Uri arg0, jint arg1, jint arg2, jint arg3) const
	{
		return callMethod<jint>(
	...
	inline JIntArray ContextWrapper::checkUriPermissions(JObject arg0, jint arg1, jint arg2, jint arg3) const
	{
		return callObjectMethod(
			"checkUriPermissions",
	...
	inline android::content::Context ContextWrapper::createAttributionContext(JString arg0) const
	{
		return callObjectMethod(
	...
	inline android::content::Context ContextWrapper::createContext(android::content::ContextParams arg0) const
	{
		return callObjectMethod(
			"createContext",
	...
	inline android::content::Context ContextWrapper::createDeviceContext(jint arg0) const
	{
		return callObjectMethod(
			"createDeviceContext",
	...
	inline android::content::Context ContextWrapper::createWindowContext(jint arg0, android::os::Bundle arg1) const
	{
		return callObjectMethod(
			"createWindowContext",
	...
	inline android::content::Context ContextWrapper::createWindowContext(android::view::Display arg0, jint arg1, android::os::Bundle arg2) const
	{
		return callObjectMethod(
			"createWindowContext",
	...
	inline android::content::AttributionSource ContextWrapper::getAttributionSource() const
	{
		return callObjectMethod(
	...
	inline JString ContextWrapper::getAttributionTag() const
	{
		return callObjectMethod(
			"getAttributionTag",
			"()Ljava/lang/String;"
	...
	inline jint ContextWrapper::getDeviceId() const
	{
		return callMethod<jint>(
			"getDeviceId",
			"()I"
	...
	inline android::view::Display ContextWrapper::getDisplay() const
	{
		return callObjectMethod(
			"getDisplay",
	...
	inline JString ContextWrapper::getOpPackageName() const
	{
		return callObjectMethod(
			"getOpPackageName",
			"()Ljava/lang/String;"
	...
	inline android::content::ContextParams ContextWrapper::getParams() const
	{
		return callObjectMethod(
			"getParams",
	...
	inline jboolean ContextWrapper::isUiContext() const
	{
		return callMethod<jboolean>(
			"isUiContext",
			"()Z"
	...
	inline void ContextWrapper::registerComponentCallbacks(JObject arg0) const
	{
		callMethod<void>(
	...
	inline void ContextWrapper::registerDeviceIdChangeListener(JObject arg0, JObject arg1) const
	{
		callMethod<void>(
	...
	inline void ContextWrapper::revokeSelfPermissionsOnKill(JObject arg0) const
	{
		callMethod<void>(
	...
	inline void ContextWrapper::sendBroadcast(android::content::Intent arg0, JString arg1, android::os::Bundle arg2) const
	{
		callMethod<void>(
			"sendBroadcast",
	...
	inline void ContextWrapper::sendOrderedBroadcast(android::content::Intent arg0, JString arg1, android::os::Bundle arg2) const
	{
		callMethod<void>(
			"sendOrderedBroadcast",
			"(Landroid/content/Intent;Ljava/lang/String;Landroid/os/Bundle;)V",
	...
	inline void ContextWrapper::sendOrderedBroadcast(android::content::Intent arg0, JString arg1, android::os::Bundle arg2, android::content::BroadcastReceiver arg3, android::os::Handler arg4, jint arg5, JString arg6, android::os::Bundle arg7) const
	{
		callMethod<void>(
			"sendOrderedBroadcast",
	...
	inline void ContextWrapper::sendOrderedBroadcast(android::content::Intent arg0, JString arg1, JString arg2, android::content::BroadcastReceiver arg3, android::os::Handler arg4, jint arg5, JString arg6, android::os::Bundle arg7) const
	{
		callMethod<void>(
			"sendOrderedBroadcast",
	...
	inline void ContextWrapper::sendOrderedBroadcast(android::content::Intent arg0, jint arg1, JString arg2, JString arg3, android::content::BroadcastReceiver arg4, android::os::Handler arg5, JString arg6, android::os::Bundle arg7, android::os::Bundle arg8) const
	{
		callMethod<void>(
			"sendOrderedBroadcast",
			"(Landroid/content/Intent;ILjava/lang/String;Ljava/lang/String;Landroid/content/BroadcastReceiver;Landroid/os/Handler;Ljava/lang/String;Landroid/os/Bundle;Landroid/os/Bundle;)V",
			arg0.object(),
			arg1,
			arg2.object<jstring>(),
			arg3.object<jstring>(),
	...
	inline void ContextWrapper::sendStickyBroadcast(android::content::Intent arg0, android::os::Bundle arg1) const
	{
		callMethod<void>(
			"sendStickyBroadcast",
	...
	inline void ContextWrapper::unregisterComponentCallbacks(JObject arg0) const
	{
		callMethod<void>(
	...
	inline void ContextWrapper::unregisterDeviceIdChangeListener(JObject arg0) const
	{
		callMethod<void>(
	...
	inline void ContextWrapper::updateServiceGroup(JObject arg0, jint arg1, jint arg2) const
	{
		callMethod<void>(
			"updateServiceGroup",
