...
#include "../../../java/nio/channels/FileChannel.def.hpp"
...
namespace android::content::res
{
	...
	inline void AssetFileDescriptor_AutoCloseInputStream::close() const
	{
		callMethod<void>(
			"close",
			"()V"
	...
	inline java::nio::channels::FileChannel AssetFileDescriptor_AutoCloseInputStream::getChannel() const
	{
