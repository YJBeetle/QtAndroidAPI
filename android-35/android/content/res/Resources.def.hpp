...
namespace android::content::res
{
	...
	public:
		...
		Resources(QJniObject obj) : JObject(obj) {}
		...
		static void registerResourcePaths(JString arg0, android::content::pm::ApplicationInfo arg1);
		void addLoaders(JArray arg0) const;
		...
		void removeLoaders(JArray arg0) const;
