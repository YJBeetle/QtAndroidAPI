...
namespace android::content
{
	...
	inline android::content::ContextParams_Builder ContextParams_Builder::setShouldRegisterAttributionSource(jboolean arg0) const
	{
		return callObjectMethod(
			"setShouldRegisterAttributionSource",
			"(Z)Landroid/content/ContextParams$Builder;",
			arg0
		);
	}
} // namespace android::content
