...
namespace android::content::pm
{
	...
	public:
		...
		CrossProfileApps(QJniObject obj) : JObject(obj) {}
		...
		jboolean isManagedProfile(android::os::UserHandle arg0) const;
		jboolean isProfile(android::os::UserHandle arg0) const;
		...
		void startMainActivity(android::content::ComponentName arg0, android::os::UserHandle arg1, android::app::Activity arg2, android::os::Bundle arg3) const;
	};
} // namespace android::content::pm
