...
namespace android::content::pm
{
	...
	public:
		...
		static jint FLAG_ALLOW_SHARED_ISOLATED_PROCESS();
		...
		static jint FOREGROUND_SERVICE_TYPE_HEALTH();
		...
		static jint FOREGROUND_SERVICE_TYPE_MEDIA_PROCESSING();
		...
		static jint FOREGROUND_SERVICE_TYPE_REMOTE_MESSAGING();
		static jint FOREGROUND_SERVICE_TYPE_SHORT_SERVICE();
		static jint FOREGROUND_SERVICE_TYPE_SPECIAL_USE();
		static jint FOREGROUND_SERVICE_TYPE_SYSTEM_EXEMPTED();
		jint flags();
		JString permission();
		...
		ServiceInfo(QJniObject obj) : android::content::pm::ComponentInfo(obj) {}
