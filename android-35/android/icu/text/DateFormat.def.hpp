...
namespace android::icu::text
{
	...
	public:
		...
		DateFormat(QJniObject obj) : android::icu::text::UFormat(obj) {}
		...
		static android::icu::text::DateFormat getInstance(android::icu::util::Calendar arg0, android::icu::util::ULocale arg1);
