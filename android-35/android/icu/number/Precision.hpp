...
namespace android::icu::number
{
	...
	inline android::icu::number::Precision Precision::trailingZeroDisplay(android::icu::number::NumberFormatter_TrailingZeroDisplay arg0) const
	{
		return callObjectMethod(
			"trailingZeroDisplay",
			"(Landroid/icu/number/NumberFormatter$TrailingZeroDisplay;)Landroid/icu/number/Precision;",
			arg0.object()
		);
	}
} // namespace android::icu::number
