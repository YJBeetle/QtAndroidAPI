...
#include "../text/DisplayOptions.def.hpp"
...
namespace android::icu::number
{
	...
	inline android::icu::number::NumberFormatterSettings NumberFormatterSettings::displayOptions(android::icu::text::DisplayOptions arg0) const
	{
		return callObjectMethod(
			"displayOptions",
			"(Landroid/icu/text/DisplayOptions;)Landroid/icu/number/NumberFormatterSettings;",
			arg0.object()
		);
	}
	...
	inline android::icu::number::NumberFormatterSettings NumberFormatterSettings::usage(JString arg0) const
	{
		return callObjectMethod(
			"usage",
			"(Ljava/lang/String;)Landroid/icu/number/NumberFormatterSettings;",
			arg0.object<jstring>()
		);
	}
} // namespace android::icu::number
