...
namespace android::database::sqlite
{
	...
	inline void SQLiteDatabase::beginTransactionReadOnly() const
	{
		callMethod<void>(
	...
	inline void SQLiteDatabase::beginTransactionWithListenerReadOnly(JObject arg0) const
	{
		callMethod<void>(
	...
	inline android::database::sqlite::SQLiteRawStatement SQLiteDatabase::createRawStatement(JString arg0) const
	{
		return callObjectMethod(
			"createRawStatement",
			"(Ljava/lang/String;)Landroid/database/sqlite/SQLiteRawStatement;",
			arg0.object<jstring>()
		);
	}
	...
	inline jlong SQLiteDatabase::getLastChangedRowCount() const
	{
	...
	inline jlong SQLiteDatabase::getLastInsertRowId() const
	{
		return callMethod<jlong>(
			"getLastInsertRowId",
			"()J"
	...
	inline jlong SQLiteDatabase::getTotalChangedRowCount() const
	{
		return callMethod<jlong>(
