...
namespace android::database::sqlite
{
	...
	public:
		...
		static JString JOURNAL_MODE_DELETE();
		static JString JOURNAL_MODE_MEMORY();
		static JString JOURNAL_MODE_OFF();
		static JString JOURNAL_MODE_PERSIST();
		static JString JOURNAL_MODE_TRUNCATE();
		static JString JOURNAL_MODE_WAL();
		...
		static JString SYNC_MODE_EXTRA();
		static JString SYNC_MODE_FULL();
		static JString SYNC_MODE_NORMAL();
		static JString SYNC_MODE_OFF();
		...
		SQLiteDatabase(QJniObject obj) : android::database::sqlite::SQLiteClosable(obj) {}
		...
		void setCustomAggregateFunction(JString arg0, JObject arg1) const;
		void setCustomScalarFunction(JString arg0, JObject arg1) const;
