...
namespace android::media::midi
{
	...
	inline jint MidiDeviceInfo::PROTOCOL_UMP_MIDI_1_0_UP_TO_128_BITS()
	{
	...
	inline jint MidiDeviceInfo::PROTOCOL_UMP_MIDI_1_0_UP_TO_128_BITS_AND_JRTS()
	{
		return getStaticField<jint>(
			"android.media.midi.MidiDeviceInfo",
	...
	inline jint MidiDeviceInfo::PROTOCOL_UMP_MIDI_1_0_UP_TO_64_BITS()
	{
		return getStaticField<jint>(
			"android.media.midi.MidiDeviceInfo",
	...
	inline jint MidiDeviceInfo::PROTOCOL_UMP_MIDI_1_0_UP_TO_64_BITS_AND_JRTS()
	{
		return getStaticField<jint>(
			"android.media.midi.MidiDeviceInfo",
	...
	inline jint MidiDeviceInfo::PROTOCOL_UMP_MIDI_2_0()
	{
		return getStaticField<jint>(
			"android.media.midi.MidiDeviceInfo",
	...
	inline jint MidiDeviceInfo::PROTOCOL_UMP_MIDI_2_0_AND_JRTS()
	{
		return getStaticField<jint>(
			"android.media.midi.MidiDeviceInfo",
	...
	inline jint MidiDeviceInfo::PROTOCOL_UMP_USE_MIDI_CI()
	{
		return getStaticField<jint>(
			"android.media.midi.MidiDeviceInfo",
	...
	inline jint MidiDeviceInfo::PROTOCOL_UNKNOWN()
	{
		return getStaticField<jint>(
			"android.media.midi.MidiDeviceInfo",
			"PROTOCOL_UNKNOWN"
	...
	inline jint MidiDeviceInfo::getDefaultProtocol() const
	{
		return callMethod<jint>(
			"getDefaultProtocol",
			"()I"
