...
namespace android::media
{
	...
	public:
		...
		static android::media::MediaRouter2 getInstance(android::content::Context arg0, JString arg1, JObject arg2, JObject arg3);
		void cancelScanRequest(android::media::MediaRouter2_ScanToken arg0) const;
		android::media::MediaRouter2_RoutingController getController(JString arg0) const;
		JObject getControllers() const;
		android::media::RouteListingPreference getRouteListingPreference() const;
		...
		void registerRouteListingPreferenceUpdatedCallback(JObject arg0, JObject arg1) const;
		void registerTransferCallback(JObject arg0, android::media::MediaRouter2_TransferCallback arg1) const;
		android::media::MediaRouter2_ScanToken requestScan(android::media::MediaRouter2_ScanRequest arg0) const;
		...
		void setRouteVolume(android::media::MediaRoute2Info arg0, jint arg1) const;
		...
		void unregisterRouteListingPreferenceUpdatedCallback(JObject arg0) const;
