...
namespace android::media
{
	...
	inline jint RoutingSessionInfo::TRANSFER_REASON_APP()
	{
	...
	inline jint RoutingSessionInfo::TRANSFER_REASON_FALLBACK()
	{
		return getStaticField<jint>(
			"android.media.RoutingSessionInfo",
	...
	inline jint RoutingSessionInfo::TRANSFER_REASON_SYSTEM_REQUEST()
	{
		return getStaticField<jint>(
			"android.media.RoutingSessionInfo",
	...
	inline jint RoutingSessionInfo::getTransferReason() const
	{
		return callMethod<jint>(
			"getTransferReason",
			"()I"
