...
namespace android::media
{
	...
	inline JObject MediaRouter2_RoutingController::getTransferableRoutes() const
	{
		return callObjectMethod(
	...
	inline jboolean MediaRouter2_RoutingController::wasTransferInitiatedBySelf() const
	{
		return callMethod<jboolean>(
