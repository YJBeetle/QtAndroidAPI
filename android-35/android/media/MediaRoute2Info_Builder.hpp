...
namespace android::media
{
	...
	inline android::media::MediaRoute2Info_Builder MediaRoute2Info_Builder::setDeduplicationIds(JObject arg0) const
	{
		return callObjectMethod(
			"setDeduplicationIds",
			"(Ljava/util/Set;)Landroid/media/MediaRoute2Info$Builder;",
			arg0.object()
		);
	}
	...
	inline android::media::MediaRoute2Info_Builder MediaRoute2Info_Builder::setSuitabilityStatus(jint arg0) const
	{
		return callObjectMethod(
	...
	inline android::media::MediaRoute2Info_Builder MediaRoute2Info_Builder::setType(jint arg0) const
	{
		return callObjectMethod(
			"setType",
			"(I)Landroid/media/MediaRoute2Info$Builder;",
	...
	inline android::media::MediaRoute2Info_Builder MediaRoute2Info_Builder::setVisibilityPublic() const
	{
		return callObjectMethod(
			"setVisibilityPublic",
			"()Landroid/media/MediaRoute2Info$Builder;"
	...
	inline android::media::MediaRoute2Info_Builder MediaRoute2Info_Builder::setVisibilityRestricted(JObject arg0) const
	{
		return callObjectMethod(
