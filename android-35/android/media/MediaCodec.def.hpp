...
namespace android::media
{
	...
	public:
		...
		static jint CONFIGURE_FLAG_DETACHED_SURFACE();
		...
		static JString PARAMETER_KEY_QP_OFFSET_MAP();
		static JString PARAMETER_KEY_QP_OFFSET_RECTS();
		...
		void detachOutputSurface() const;
		void flush() const;
		...
		void queueInputBuffers(jint arg0, java::util::ArrayDeque arg1) const;
		void queueSecureInputBuffer(jint arg0, jint arg1, android::media::MediaCodec_CryptoInfo arg2, jlong arg3, jint arg4) const;
		void queueSecureInputBuffers(jint arg0, java::util::ArrayDeque arg1, java::util::ArrayDeque arg2) const;
		void release() const;
