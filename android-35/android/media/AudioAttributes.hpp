...
{
	// Fields
	inline jint AudioAttributes::ALLOW_CAPTURE_BY_ALL()
	{
	...
	inline jint AudioAttributes::ALLOW_CAPTURE_BY_NONE()
	{
		return getStaticField<jint>(
			"android.media.AudioAttributes",
	...
	inline jint AudioAttributes::ALLOW_CAPTURE_BY_SYSTEM()
	{
		return getStaticField<jint>(
			"android.media.AudioAttributes",
	...
	inline jint AudioAttributes::SPATIALIZATION_BEHAVIOR_AUTO()
	{
		return getStaticField<jint>(
			"android.media.AudioAttributes",
	...
	inline jint AudioAttributes::SPATIALIZATION_BEHAVIOR_NEVER()
	{
		return getStaticField<jint>(
			"android.media.AudioAttributes",
	...
	// Methods
	inline jboolean AudioAttributes::areHapticChannelsMuted() const
	{
	...
	inline jint AudioAttributes::getAllowedCapturePolicy() const
	{
		return callMethod<jint>(
	...
	inline jint AudioAttributes::getSpatializationBehavior() const
	{
		return callMethod<jint>(
	...
	inline jboolean AudioAttributes::isContentSpatialized() const
	{
		return callMethod<jboolean>(
