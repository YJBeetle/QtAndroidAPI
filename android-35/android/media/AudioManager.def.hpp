...
namespace android::media
{
	...
	public:
		...
		static jint DIRECT_PLAYBACK_BITSTREAM_SUPPORTED();
		static jint DIRECT_PLAYBACK_NOT_SUPPORTED();
		static jint DIRECT_PLAYBACK_OFFLOAD_GAPLESS_SUPPORTED();
		static jint DIRECT_PLAYBACK_OFFLOAD_SUPPORTED();
		static jint ENCODED_SURROUND_OUTPUT_ALWAYS();
		static jint ENCODED_SURROUND_OUTPUT_AUTO();
		static jint ENCODED_SURROUND_OUTPUT_MANUAL();
		static jint ENCODED_SURROUND_OUTPUT_NEVER();
		static jint ENCODED_SURROUND_OUTPUT_UNKNOWN();
		static jint ERROR();
		...
		static jint MODE_CALL_REDIRECT();
		static jint MODE_CALL_SCREENING();
		static jint MODE_COMMUNICATION_REDIRECT();
		...
		static jint PLAYBACK_OFFLOAD_GAPLESS_SUPPORTED();
		static jint PLAYBACK_OFFLOAD_NOT_SUPPORTED();
		static jint PLAYBACK_OFFLOAD_SUPPORTED();
		...
		AudioManager(QJniObject obj) : JObject(obj) {}
		
		// Constructors
		
		// Methods
		static jint getDirectPlaybackSupport(android::media::AudioFormat arg0, android::media::AudioAttributes arg1);
		...
		void addOnCommunicationDeviceChangedListener(JObject arg0, JObject arg1) const;
		void addOnModeChangedListener(JObject arg0, JObject arg1) const;
		void addOnPreferredMixerAttributesChangedListener(JObject arg0, JObject arg1) const;
		...
		void adjustVolumeGroupVolume(jint arg0, jint arg1, jint arg2) const;
		void clearCommunicationDevice() const;
		jboolean clearPreferredMixerAttributes(android::media::AudioAttributes arg0, android::media::AudioDeviceInfo arg1) const;
		...
		JObject getAudioDevicesForAttributes(android::media::AudioAttributes arg0) const;
		jint getAudioHwSyncForSession(jint arg0) const;
		JObject getAvailableCommunicationDevices() const;
		android::media::AudioDeviceInfo getCommunicationDevice() const;
		JArray getDevices(jint arg0) const;
		JObject getDirectProfilesForAttributes(android::media::AudioAttributes arg0) const;
		jint getEncodedSurroundMode() const;
		JObject getMicrophones() const;
		jint getMode() const;
		JString getParameters(JString arg0) const;
		android::media::AudioMixerAttributes getPreferredMixerAttributes(android::media::AudioAttributes arg0, android::media::AudioDeviceInfo arg1) const;
		JString getProperty(JString arg0) const;
		jint getRingerMode() const;
		jint getRouting(jint arg0) const;
		android::media::Spatializer getSpatializer() const;
		...
		JObject getSupportedDeviceTypes(jint arg0) const;
		JObject getSupportedMixerAttributes(android::media::AudioDeviceInfo arg0) const;
		jint getVibrateSetting(jint arg0) const;
		jint getVolumeGroupIdForAttributes(android::media::AudioAttributes arg0) const;
		...
		jboolean isRampingRingerEnabled() const;
		jboolean isSpeakerphoneOn() const;
		jboolean isStreamMute(jint arg0) const;
		jboolean isSurroundFormatEnabled(jint arg0) const;
		jboolean isVolumeFixed() const;
		jboolean isVolumeGroupMuted(jint arg0) const;
		...
		void removeOnCommunicationDeviceChangedListener(JObject arg0) const;
		void removeOnModeChangedListener(JObject arg0) const;
		void removeOnPreferredMixerAttributesChangedListener(JObject arg0) const;
		...
		jboolean setCommunicationDevice(android::media::AudioDeviceInfo arg0) const;
		jboolean setEncodedSurroundMode(jint arg0) const;
		void setMicrophoneMute(jboolean arg0) const;
		void setMode(jint arg0) const;
		void setParameters(JString arg0) const;
		jboolean setPreferredMixerAttributes(android::media::AudioAttributes arg0, android::media::AudioDeviceInfo arg1, android::media::AudioMixerAttributes arg2) const;
		...
		jboolean setSurroundFormatEnabled(jint arg0, jboolean arg1) const;
