...
namespace android::text
{
	...
	public:
		...
		StaticLayout_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::text::StaticLayout_Builder setMinimumFontMetrics(android::graphics::Paint_FontMetrics arg0) const;
		android::text::StaticLayout_Builder setShiftDrawingOffsetForStartOverhang(jboolean arg0) const;
		...
		android::text::StaticLayout_Builder setUseBoundsForWidth(jboolean arg0) const;
