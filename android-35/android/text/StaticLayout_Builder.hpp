...
namespace android::text
{
	...
	inline android::text::StaticLayout_Builder StaticLayout_Builder::setMinimumFontMetrics(android::graphics::Paint_FontMetrics arg0) const
	{
		return callObjectMethod(
			"setMinimumFontMetrics",
			"(Landroid/graphics/Paint$FontMetrics;)Landroid/text/StaticLayout$Builder;",
			arg0.object()
		);
	}
	inline android::text::StaticLayout_Builder StaticLayout_Builder::setShiftDrawingOffsetForStartOverhang(jboolean arg0) const
	{
		return callObjectMethod(
	...
	inline android::text::StaticLayout_Builder StaticLayout_Builder::setUseBoundsForWidth(jboolean arg0) const
	{
		return callObjectMethod(
