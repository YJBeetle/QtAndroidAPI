...
namespace android::text
{
	...
	inline BoringLayout::BoringLayout(JString arg0, android::text::TextPaint arg1, jint arg2, android::text::Layout_Alignment arg3, jfloat arg4, jfloat arg5, android::text::BoringLayout_Metrics arg6, jboolean arg7, android::text::TextUtils_TruncateAt arg8, jint arg9, jboolean arg10)
		: android::text::Layout(
			"android.text.BoringLayout",
			"(Ljava/lang/CharSequence;Landroid/text/TextPaint;ILandroid/text/Layout$Alignment;FFLandroid/text/BoringLayout$Metrics;ZLandroid/text/TextUtils$TruncateAt;IZ)V",
			arg0.object<jstring>(),
			arg1.object(),
			arg2,
			arg3.object(),
	...
	inline android::text::BoringLayout_Metrics BoringLayout::isBoring(JString arg0, android::text::TextPaint arg1, JObject arg2, jboolean arg3, android::text::BoringLayout_Metrics arg4)
	{
		return callStaticObjectMethod(
			"android.text.BoringLayout",
			"isBoring",
			"(Ljava/lang/CharSequence;Landroid/text/TextPaint;Landroid/text/TextDirectionHeuristic;ZLandroid/text/BoringLayout$Metrics;)Landroid/text/BoringLayout$Metrics;",
			arg0.object<jstring>(),
			arg1.object(),
			arg2.object(),
			arg3,
	...
	inline android::text::BoringLayout BoringLayout::make(JString arg0, android::text::TextPaint arg1, jint arg2, android::text::Layout_Alignment arg3, android::text::BoringLayout_Metrics arg4, jboolean arg5, android::text::TextUtils_TruncateAt arg6, jint arg7, jboolean arg8)
	{
		return callStaticObjectMethod(
			"android.text.BoringLayout",
			"make",
			"(Ljava/lang/CharSequence;Landroid/text/TextPaint;ILandroid/text/Layout$Alignment;Landroid/text/BoringLayout$Metrics;ZLandroid/text/TextUtils$TruncateAt;IZ)Landroid/text/BoringLayout;",
			arg0.object<jstring>(),
			arg1.object(),
			arg2,
			arg3.object(),
	...
	inline android::graphics::RectF BoringLayout::computeDrawingBoundingBox() const
	{
	...
	inline jboolean BoringLayout::isFallbackLineSpacingEnabled() const
	{
		return callMethod<jboolean>(
	...
	inline android::text::BoringLayout BoringLayout::replaceOrMake(JString arg0, android::text::TextPaint arg1, jint arg2, android::text::Layout_Alignment arg3, android::text::BoringLayout_Metrics arg4, jboolean arg5, android::text::TextUtils_TruncateAt arg6, jint arg7, jboolean arg8) const
	{
		return callObjectMethod(
			"replaceOrMake",
			"(Ljava/lang/CharSequence;Landroid/text/TextPaint;ILandroid/text/Layout$Alignment;Landroid/text/BoringLayout$Metrics;ZLandroid/text/TextUtils$TruncateAt;IZ)Landroid/text/BoringLayout;",
