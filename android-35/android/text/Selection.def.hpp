...
namespace android::text
{
	...
	public:
		...
		Selection(QJniObject obj) : JObject(obj) {}
		...
		static jboolean extendToParagraphEnd(JObject arg0);
		static jboolean extendToParagraphStart(JObject arg0);
		...
		static jboolean moveToParagraphEnd(JObject arg0, android::text::Layout arg1);
		static jboolean moveToParagraphStart(JObject arg0, android::text::Layout arg1);
