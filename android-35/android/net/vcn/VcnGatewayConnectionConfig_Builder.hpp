...
namespace android::net::vcn
{
	...
	inline android::net::vcn::VcnGatewayConnectionConfig_Builder VcnGatewayConnectionConfig_Builder::addGatewayOption(jint arg0) const
	{
		return callObjectMethod(
			"addGatewayOption",
			"(I)Landroid/net/vcn/VcnGatewayConnectionConfig$Builder;",
	...
	inline android::net::vcn::VcnGatewayConnectionConfig_Builder VcnGatewayConnectionConfig_Builder::removeGatewayOption(jint arg0) const
	{
		return callObjectMethod(
			"removeGatewayOption",
			"(I)Landroid/net/vcn/VcnGatewayConnectionConfig$Builder;",
	...
	inline android::net::vcn::VcnGatewayConnectionConfig_Builder VcnGatewayConnectionConfig_Builder::setMinUdpPort4500NatTimeoutSeconds(jint arg0) const
	{
		return callObjectMethod(
	...
	inline android::net::vcn::VcnGatewayConnectionConfig_Builder VcnGatewayConnectionConfig_Builder::setSafeModeEnabled(jboolean arg0) const
	{
		return callObjectMethod(
			"setSafeModeEnabled",
			"(Z)Landroid/net/vcn/VcnGatewayConnectionConfig$Builder;",
			arg0
		);
	}
	inline android::net::vcn::VcnGatewayConnectionConfig_Builder VcnGatewayConnectionConfig_Builder::setVcnUnderlyingNetworkPriorities(JObject arg0) const
	{
		return callObjectMethod(
			"setVcnUnderlyingNetworkPriorities",
			"(Ljava/util/List;)Landroid/net/vcn/VcnGatewayConnectionConfig$Builder;",
			arg0.object()
		);
	}
} // namespace android::net::vcn
