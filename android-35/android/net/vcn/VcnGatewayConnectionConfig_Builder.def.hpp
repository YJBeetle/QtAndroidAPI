...
namespace android::net::vcn
{
	...
	public:
		...
		VcnGatewayConnectionConfig_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::net::vcn::VcnGatewayConnectionConfig_Builder addGatewayOption(jint arg0) const;
		...
		android::net::vcn::VcnGatewayConnectionConfig_Builder removeGatewayOption(jint arg0) const;
		android::net::vcn::VcnGatewayConnectionConfig_Builder setMaxMtu(jint arg0) const;
		android::net::vcn::VcnGatewayConnectionConfig_Builder setMinUdpPort4500NatTimeoutSeconds(jint arg0) const;
		android::net::vcn::VcnGatewayConnectionConfig_Builder setRetryIntervalsMillis(JLongArray arg0) const;
		android::net::vcn::VcnGatewayConnectionConfig_Builder setSafeModeEnabled(jboolean arg0) const;
		android::net::vcn::VcnGatewayConnectionConfig_Builder setVcnUnderlyingNetworkPriorities(JObject arg0) const;
	};
} // namespace android::net::vcn
