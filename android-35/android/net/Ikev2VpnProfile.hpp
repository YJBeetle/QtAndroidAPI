...
namespace android::net
{
	...
	inline android::net::ipsec::ike::IkeTunnelConnectionParams Ikev2VpnProfile::getIkeTunnelConnectionParams() const
	{
		return callObjectMethod(
	...
	inline jboolean Ikev2VpnProfile::isAutomaticIpVersionSelectionEnabled() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean Ikev2VpnProfile::isAutomaticNattKeepaliveTimerEnabled() const
	{
		return callMethod<jboolean>(
	...
	inline JString Ikev2VpnProfile::toString() const
	{
		return callObjectMethod(
			"toString",
			"()Ljava/lang/String;"
