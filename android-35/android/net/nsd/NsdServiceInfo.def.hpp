...
namespace android::net::nsd
{
	...
	public:
		...
		NsdServiceInfo(QJniObject obj) : JObject(obj) {}
		...
		void setHostAddresses(JObject arg0) const;
		void setNetwork(android::net::Network arg0) const;
		void setPort(jint arg0) const;
		void setServiceName(JString arg0) const;
		void setServiceType(JString arg0) const;
		void setSubtypes(JObject arg0) const;
