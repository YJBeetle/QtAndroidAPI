...
namespace android::net::wifi
{
	...
	inline jint WifiNetworkSpecifier::getBand() const
	{
		return callMethod<jint>(
			"getBand",
			"()I"
	...
	inline JIntArray WifiNetworkSpecifier::getPreferredChannelFrequenciesMhz() const
	{
	...
	inline android::net::NetworkSpecifier WifiNetworkSpecifier::redact() const
	{
		return callObjectMethod(
			"redact",
