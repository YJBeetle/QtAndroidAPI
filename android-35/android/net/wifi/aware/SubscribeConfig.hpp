...
namespace android::net::wifi::aware
{
	...
	inline jint SubscribeConfig::getInstantCommunicationBand() const
	{
		return callMethod<jint>(
	...
	inline android::net::wifi::aware::AwarePairingConfig SubscribeConfig::getPairingConfig() const
	{
	...
	inline jboolean SubscribeConfig::isInstantCommunicationModeEnabled() const
	{
		return callMethod<jboolean>(
