...
namespace android::net::wifi::aware
{
	...
	// Methods
	inline void DiscoverySessionCallback::onBootstrappingFailed(android::net::wifi::aware::PeerHandle arg0) const
	{
		callMethod<void>(
	...
	inline void DiscoverySessionCallback::onBootstrappingSucceeded(android::net::wifi::aware::PeerHandle arg0, jint arg1) const
	{
		callMethod<void>(
	...
	inline void DiscoverySessionCallback::onPairingSetupFailed(android::net::wifi::aware::PeerHandle arg0) const
	{
		callMethod<void>(
	...
	inline void DiscoverySessionCallback::onPairingSetupRequestReceived(android::net::wifi::aware::PeerHandle arg0, jint arg1) const
	{
		callMethod<void>(
	...
	inline void DiscoverySessionCallback::onPairingSetupSucceeded(android::net::wifi::aware::PeerHandle arg0, JString arg1) const
	{
		callMethod<void>(
			"onPairingSetupSucceeded",
			"(Landroid/net/wifi/aware/PeerHandle;Ljava/lang/String;)V",
			arg0.object(),
			arg1.object<jstring>()
		);
	}
	inline void DiscoverySessionCallback::onPairingVerificationFailed(android::net::wifi::aware::PeerHandle arg0) const
	{
		callMethod<void>(
	...
	inline void DiscoverySessionCallback::onPairingVerificationSucceed(android::net::wifi::aware::PeerHandle arg0, JString arg1) const
	{
		callMethod<void>(
	...
	inline void DiscoverySessionCallback::onServiceDiscovered(android::net::wifi::aware::ServiceDiscoveryInfo arg0) const
	{
		callMethod<void>(
			"onServiceDiscovered",
			"(Landroid/net/wifi/aware/ServiceDiscoveryInfo;)V",
			arg0.object()
		);
	}
	...
	inline void DiscoverySessionCallback::onServiceDiscoveredWithinRange(android::net::wifi::aware::ServiceDiscoveryInfo arg0, jint arg1) const
	{
		callMethod<void>(
			"onServiceDiscoveredWithinRange",
			"(Landroid/net/wifi/aware/ServiceDiscoveryInfo;I)V",
			arg0.object(),
			arg1
		);
	}
