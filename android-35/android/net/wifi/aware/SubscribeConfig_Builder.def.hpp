...
namespace android::net::wifi::aware
{
	...
	public:
		...
		SubscribeConfig_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::net::wifi::aware::SubscribeConfig_Builder setPairingConfig(android::net::wifi::aware::AwarePairingConfig arg0) const;
