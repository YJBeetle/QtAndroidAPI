...
namespace android::net
{
	...
	inline android::net::VpnService_Builder VpnService_Builder::addRoute(android::net::IpPrefix arg0) const
	{
		return callObjectMethod(
			"addRoute",
			"(Landroid/net/IpPrefix;)Landroid/net/VpnService$Builder;",
			arg0.object()
		);
	}
	...
	inline android::net::VpnService_Builder VpnService_Builder::excludeRoute(android::net::IpPrefix arg0) const
	{
		return callObjectMethod(
			"excludeRoute",
			"(Landroid/net/IpPrefix;)Landroid/net/VpnService$Builder;",
