...
namespace android::net::eap
{
	...
	inline android::net::eap::EapSessionConfig_Builder EapSessionConfig_Builder::setEapAkaConfig(jint arg0, jint arg1, android::net::eap::EapSessionConfig_EapAkaOption arg2) const
	{
		return callObjectMethod(
			"setEapAkaConfig",
			"(IILandroid/net/eap/EapSessionConfig$EapAkaOption;)Landroid/net/eap/EapSessionConfig$Builder;",
			arg0,
			arg1,
			arg2.object()
		);
