...
namespace android::net::ipsec::ike
{
	...
	public:
		...
		IkeSessionConfiguration_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::net::ipsec::ike::IkeSessionConfiguration_Builder setEapInfo(android::net::eap::EapInfo arg0) const;
