...
{
	// Fields
	inline jint IkeSessionParams::IKE_DPD_DELAY_SEC_DISABLED()
	{
	...
	inline jint IkeSessionParams::IKE_OPTION_INITIAL_CONTACT()
	{
		return getStaticField<jint>(
			"android.net.ipsec.ike.IkeSessionParams",
	...
	inline JObject IkeSessionParams::getIkeOptions() const
	{
