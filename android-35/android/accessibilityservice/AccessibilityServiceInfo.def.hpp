...
namespace android::accessibilityservice
{
	...
	public:
		...
		static jint FLAG_INPUT_METHOD_EDITOR();
		static jint FLAG_REPORT_VIEW_IDS();
		static jint FLAG_REQUEST_2_FINGER_PASSTHROUGH();
		...
		static jint FLAG_SEND_MOTION_EVENTS();
		...
		jint getMotionEventSources() const;
