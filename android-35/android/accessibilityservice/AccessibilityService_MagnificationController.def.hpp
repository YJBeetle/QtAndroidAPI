...
namespace android::accessibilityservice
{
	...
	public:
		...
		android::graphics::Region getCurrentMagnificationRegion() const;
		android::accessibilityservice::MagnificationConfig getMagnificationConfig() const;
		...
		jboolean resetCurrentMagnification(jboolean arg0) const;
		jboolean setCenter(jfloat arg0, jfloat arg1, jboolean arg2) const;
		jboolean setMagnificationConfig(android::accessibilityservice::MagnificationConfig arg0, jboolean arg1) const;
