...
namespace android::animation
{
	...
	inline jfloat ValueAnimator::getDurationScale()
	{
	...
	inline jboolean ValueAnimator::registerDurationScaleChangeListener(JObject arg0)
	{
		return callStaticMethod<jboolean>(
			"android.animation.ValueAnimator",
			"registerDurationScaleChangeListener",
			"(Landroid/animation/ValueAnimator$DurationScaleChangeListener;)Z",
			arg0.object()
		);
	}
	...
	inline jboolean ValueAnimator::unregisterDurationScaleChangeListener(JObject arg0)
	{
		return callStaticMethod<jboolean>(
			"android.animation.ValueAnimator",
