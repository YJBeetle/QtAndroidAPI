...
namespace android::view::contentcapture
{
	...
	public:
		...
		ContentCaptureSession(QJniObject obj) : JObject(obj) {}
		...
		void notifySessionPaused() const;
		void notifySessionResumed() const;
		...
		void notifyViewInsetsChanged(android::graphics::Insets arg0) const;
		void notifyViewTextChanged(android::view::autofill::AutofillId arg0, JString arg1) const;
		void notifyViewsAppeared(JObject arg0) const;
