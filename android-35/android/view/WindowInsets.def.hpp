...
namespace android::view
{
	...
	public:
		...
		JObject getBoundingRects(jint arg0) const;
		JObject getBoundingRectsIgnoringVisibility(jint arg0) const;
		android::view::DisplayCutout getDisplayCutout() const;
		android::view::DisplayShape getDisplayShape() const;
		android::util::Size getFrame() const;
