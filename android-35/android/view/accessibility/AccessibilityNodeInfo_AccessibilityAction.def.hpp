...
namespace android::view::accessibility
{
	...
	public:
		...
		static android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction ACTION_DRAG_CANCEL();
		static android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction ACTION_DRAG_DROP();
		static android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction ACTION_DRAG_START();
		...
		static android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction ACTION_SCROLL_IN_DIRECTION();
		...
		static android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction ACTION_SHOW_TEXT_SUGGESTIONS();
		...
		AccessibilityNodeInfo_AccessibilityAction(QJniObject obj) : JObject(obj) {}
