...
namespace android::view
{
	...
	inline android::view::WindowInsets_Builder WindowInsets_Builder::setBoundingRects(jint arg0, JObject arg1) const
	{
		return callObjectMethod(
			"setBoundingRects",
			"(ILjava/util/List;)Landroid/view/WindowInsets$Builder;",
			arg0,
			arg1.object()
		);
	}
	inline android::view::WindowInsets_Builder WindowInsets_Builder::setBoundingRectsIgnoringVisibility(jint arg0, JObject arg1) const
	{
		return callObjectMethod(
	...
	inline android::view::WindowInsets_Builder WindowInsets_Builder::setDisplayShape(android::view::DisplayShape arg0) const
	{
		return callObjectMethod(
			"setDisplayShape",
			"(Landroid/view/DisplayShape;)Landroid/view/WindowInsets$Builder;",
			arg0.object()
		);
	}
	inline android::view::WindowInsets_Builder WindowInsets_Builder::setFrame(jint arg0, jint arg1) const
	{
		return callObjectMethod(
			"setFrame",
			"(II)Landroid/view/WindowInsets$Builder;",
			arg0,
			arg1
		);
	}
	...
	inline android::view::WindowInsets_Builder WindowInsets_Builder::setPrivacyIndicatorBounds(android::graphics::Rect arg0) const
	{
		return callObjectMethod(
	...
	inline android::view::WindowInsets_Builder WindowInsets_Builder::setRoundedCorner(jint arg0, android::view::RoundedCorner arg1) const
	{
		return callObjectMethod(
			"setRoundedCorner",
