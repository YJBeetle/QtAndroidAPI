...
namespace android::view
{
	...
	inline jfloat ViewConfiguration::getAmbiguousGestureMultiplier()
	{
	...
	inline jint ViewConfiguration::getMultiPressTimeout()
	{
		return callStaticMethod<jint>(
			"android.view.ViewConfiguration",
	...
	inline jfloat ViewConfiguration::getScaledAmbiguousGestureMultiplier() const
	{
	...
	inline jint ViewConfiguration::getScaledHandwritingGestureLineMargin() const
	{
		return callMethod<jint>(
	...
	inline jint ViewConfiguration::getScaledHandwritingSlop() const
	{
		return callMethod<jint>(
	...
	inline jint ViewConfiguration::getScaledMaximumFlingVelocity(jint arg0, jint arg1, jint arg2) const
	{
		return callMethod<jint>(
			"getScaledMaximumFlingVelocity",
			"(III)I",
	...
	inline jint ViewConfiguration::getScaledMinimumFlingVelocity(jint arg0, jint arg1, jint arg2) const
	{
		return callMethod<jint>(
			"getScaledMinimumFlingVelocity",
			"(III)I",
	...
	inline jint ViewConfiguration::getScaledMinimumScalingSpan() const
	{
		return callMethod<jint>(
