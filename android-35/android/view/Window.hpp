...
namespace android::view
{
	...
	inline jfloat Window::getDesiredHdrHeadroom() const
	{
	...
	inline jboolean Window::getFrameRateBoostOnTouchEnabled() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean Window::isFrameRatePowerSavingsBalanced() const
	{
		return callMethod<jboolean>(
	...
	inline void Window::setDesiredHdrHeadroom(jfloat arg0) const
	{
		callMethod<void>(
	...
	inline void Window::setFrameRateBoostOnTouchEnabled(jboolean arg0) const
	{
		callMethod<void>(
	...
	inline void Window::setFrameRatePowerSavingsBalanced(jboolean arg0) const
	{
		callMethod<void>(
