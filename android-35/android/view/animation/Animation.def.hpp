...
namespace android::view::animation
{
	...
	public:
		...
		Animation(QJniObject obj) : JObject(obj) {}
		...
		jboolean getShowBackdrop() const;
		...
		void setBackdropColor(jint arg0) const;
		...
		void setShowBackdrop(jboolean arg0) const;
