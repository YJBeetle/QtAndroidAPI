...
{
	// Fields
	inline jint InputMethodManager::HANDWRITING_DELEGATE_FLAG_HOME_DELEGATOR_ALLOWED()
	{
	...
	// Methods
	inline jboolean InputMethodManager::acceptStylusHandwritingDelegation(android::view::View arg0) const
	{
	...
	inline jboolean InputMethodManager::acceptStylusHandwritingDelegation(android::view::View arg0, JString arg1) const
	{
		return callMethod<jboolean>(
			"acceptStylusHandwritingDelegation",
	...
	inline void InputMethodManager::acceptStylusHandwritingDelegation(android::view::View arg0, JString arg1, JObject arg2, JObject arg3) const
	{
		callMethod<void>(
			"acceptStylusHandwritingDelegation",
			"(Landroid/view/View;Ljava/lang/String;Ljava/util/concurrent/Executor;Ljava/util/function/Consumer;)V",
			arg0.object(),
			arg1.object<jstring>(),
			arg2.object(),
			arg3.object()
	...
	inline void InputMethodManager::acceptStylusHandwritingDelegation(android::view::View arg0, JString arg1, jint arg2, JObject arg3, JObject arg4) const
	{
		callMethod<void>(
			"acceptStylusHandwritingDelegation",
			"(Landroid/view/View;Ljava/lang/String;ILjava/util/concurrent/Executor;Ljava/util/function/Consumer;)V",
			arg0.object(),
			arg1.object<jstring>(),
			arg2,
			arg3.object(),
	...
	inline android::view::inputmethod::InputMethodInfo InputMethodManager::getCurrentInputMethodInfo() const
	{
	...
	inline void InputMethodManager::invalidateInput(android::view::View arg0) const
	{
		callMethod<void>(
			"invalidateInput",
	...
	inline jboolean InputMethodManager::isConnectionlessStylusHandwritingAvailable() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean InputMethodManager::isStylusHandwritingAvailable() const
	{
		return callMethod<jboolean>(
	...
	inline void InputMethodManager::prepareStylusHandwritingDelegation(android::view::View arg0) const
	{
		callMethod<void>(
	...
	inline void InputMethodManager::prepareStylusHandwritingDelegation(android::view::View arg0, JString arg1) const
	{
		callMethod<void>(
			"prepareStylusHandwritingDelegation",
	...
	inline void InputMethodManager::setExplicitlyEnabledInputMethodSubtypes(JString arg0, JIntArray arg1) const
	{
		callMethod<void>(
	...
	inline void InputMethodManager::startConnectionlessStylusHandwriting(android::view::View arg0, android::view::inputmethod::CursorAnchorInfo arg1, JObject arg2, JObject arg3) const
	{
		callMethod<void>(
			"startConnectionlessStylusHandwriting",
			"(Landroid/view/View;Landroid/view/inputmethod/CursorAnchorInfo;Ljava/util/concurrent/Executor;Landroid/view/inputmethod/ConnectionlessHandwritingCallback;)V",
			arg0.object(),
			arg1.object(),
			arg2.object(),
			arg3.object()
	...
	inline void InputMethodManager::startConnectionlessStylusHandwritingForDelegation(android::view::View arg0, android::view::inputmethod::CursorAnchorInfo arg1, JObject arg2, JObject arg3) const
	{
		callMethod<void>(
	...
	inline void InputMethodManager::startConnectionlessStylusHandwritingForDelegation(android::view::View arg0, android::view::inputmethod::CursorAnchorInfo arg1, JString arg2, JObject arg3, JObject arg4) const
	{
		callMethod<void>(
			"startConnectionlessStylusHandwritingForDelegation",
			"(Landroid/view/View;Landroid/view/inputmethod/CursorAnchorInfo;Ljava/lang/String;Ljava/util/concurrent/Executor;Landroid/view/inputmethod/ConnectionlessHandwritingCallback;)V",
			arg0.object(),
			arg1.object(),
			arg2.object<jstring>(),
			arg3.object(),
	...
	inline void InputMethodManager::startStylusHandwriting(android::view::View arg0) const
	{
		callMethod<void>(
