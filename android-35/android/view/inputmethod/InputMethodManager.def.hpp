...
namespace android::view::inputmethod
{
	...
	public:
		// Fields
		static jint HANDWRITING_DELEGATE_FLAG_HOME_DELEGATOR_ALLOWED();
		...
		InputMethodManager(QJniObject obj) : JObject(obj) {}
		
		// Constructors
		
		// Methods
		jboolean acceptStylusHandwritingDelegation(android::view::View arg0) const;
		jboolean acceptStylusHandwritingDelegation(android::view::View arg0, JString arg1) const;
		void acceptStylusHandwritingDelegation(android::view::View arg0, JString arg1, JObject arg2, JObject arg3) const;
		void acceptStylusHandwritingDelegation(android::view::View arg0, JString arg1, jint arg2, JObject arg3, JObject arg4) const;
		...
		android::view::inputmethod::InputMethodInfo getCurrentInputMethodInfo() const;
		...
		void invalidateInput(android::view::View arg0) const;
		jboolean isAcceptingText() const;
		jboolean isActive() const;
		jboolean isActive(android::view::View arg0) const;
		jboolean isConnectionlessStylusHandwritingAvailable() const;
		jboolean isFullscreenMode() const;
		jboolean isInputMethodSuppressingSpellChecker() const;
		jboolean isStylusHandwritingAvailable() const;
		jboolean isWatchingCursor(android::view::View arg0) const;
		void prepareStylusHandwritingDelegation(android::view::View arg0) const;
		void prepareStylusHandwritingDelegation(android::view::View arg0, JString arg1) const;
		...
		void setExplicitlyEnabledInputMethodSubtypes(JString arg0, JIntArray arg1) const;
		...
		void startConnectionlessStylusHandwriting(android::view::View arg0, android::view::inputmethod::CursorAnchorInfo arg1, JObject arg2, JObject arg3) const;
		void startConnectionlessStylusHandwritingForDelegation(android::view::View arg0, android::view::inputmethod::CursorAnchorInfo arg1, JObject arg2, JObject arg3) const;
		void startConnectionlessStylusHandwritingForDelegation(android::view::View arg0, android::view::inputmethod::CursorAnchorInfo arg1, JString arg2, JObject arg3, JObject arg4) const;
		void startStylusHandwriting(android::view::View arg0) const;
