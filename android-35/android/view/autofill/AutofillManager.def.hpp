...
namespace android::view::autofill
{
	...
	public:
		...
		static JString EXTRA_AUTHENTICATION_RESULT_EPHEMERAL_DATASET();
		...
		void notifyVirtualViewsReady(android::view::View arg0, android::util::SparseArray arg1) const;
		...
		jboolean showAutofillDialog(android::view::View arg0) const;
		jboolean showAutofillDialog(android::view::View arg0, jint arg1) const;
