...
namespace android::view
{
	...
	public:
		...
		WindowInsets_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::view::WindowInsets_Builder setBoundingRects(jint arg0, JObject arg1) const;
		android::view::WindowInsets_Builder setBoundingRectsIgnoringVisibility(jint arg0, JObject arg1) const;
		android::view::WindowInsets_Builder setDisplayCutout(android::view::DisplayCutout arg0) const;
		android::view::WindowInsets_Builder setDisplayShape(android::view::DisplayShape arg0) const;
		android::view::WindowInsets_Builder setFrame(jint arg0, jint arg1) const;
