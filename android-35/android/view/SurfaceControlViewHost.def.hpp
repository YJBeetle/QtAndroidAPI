...
namespace android::view
{
	...
	public:
		...
		SurfaceControlViewHost(QJniObject obj) : JObject(obj) {}
		
		// Constructors
		SurfaceControlViewHost(android::content::Context arg0, android::view::Display arg1, JObject arg2);
		SurfaceControlViewHost(android::content::Context arg0, android::view::Display arg1, android::window::InputTransferToken arg2);
		...
		jboolean transferTouchGestureToHost() const;
	};
} // namespace android::view
