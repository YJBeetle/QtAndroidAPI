...
namespace android::os
{
	...
	inline android::os::StrictMode_ThreadPolicy_Builder StrictMode_ThreadPolicy_Builder::detectExplicitGc() const
	{
		return callObjectMethod(
			"detectExplicitGc",
			"()Landroid/os/StrictMode$ThreadPolicy$Builder;"
	...
	inline android::os::StrictMode_ThreadPolicy_Builder StrictMode_ThreadPolicy_Builder::permitExplicitGc() const
	{
		return callObjectMethod(
			"permitExplicitGc",
			"()Landroid/os/StrictMode$ThreadPolicy$Builder;"
