...
namespace android::os
{
	...
	public:
		...
		static jboolean isIsolatedUid(jint arg0);
		static jboolean isSdkSandbox();
		static jboolean isSdkSandboxUid(jint arg0);
