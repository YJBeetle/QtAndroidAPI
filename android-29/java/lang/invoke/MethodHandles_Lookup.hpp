...
namespace java::lang::invoke
{
	...
	public:
		...
		// Constructors
		MethodHandles_Lookup() = default;
		
		// Methods
		jclass accessClass(jclass arg0);
		QAndroidJniObject bind(jobject arg0, jstring arg1, java::lang::invoke::MethodType arg2);
		QAndroidJniObject bind(jobject arg0, const QString &arg1, java::lang::invoke::MethodType arg2);
		...
		QAndroidJniObject findSpecial(jclass arg0, const QString &arg1, java::lang::invoke::MethodType arg2, jclass arg3);
		QAndroidJniObject findStatic(jclass arg0, jstring arg1, java::lang::invoke::MethodType arg2);
		QAndroidJniObject findStatic(jclass arg0, const QString &arg1, java::lang::invoke::MethodType arg2);
		...
		QAndroidJniObject findVirtual(jclass arg0, const QString &arg1, java::lang::invoke::MethodType arg2);
