...
namespace java::security
{
	...
	QAndroidJniObject KeyStoreSpi::engineGetEntry(const QString &arg0, __JniBaseClass arg1)
	{
		return __thiz.callObjectMethod(
			"engineGetEntry",
			"(Ljava/lang/String;Ljava/security/KeyStore$ProtectionParameter;)Ljava/security/KeyStore$Entry;",
	...
	void KeyStoreSpi::engineSetCertificateEntry(const QString &arg0, java::security::cert::Certificate arg1)
	{
		__thiz.callMethod<void>(
			"engineSetCertificateEntry",
			"(Ljava/lang/String;Ljava/security/cert/Certificate;)V",
	...
	void KeyStoreSpi::engineSetEntry(const QString &arg0, __JniBaseClass arg1, __JniBaseClass arg2)
	{
		__thiz.callMethod<void>(
			"engineSetEntry",
			"(Ljava/lang/String;Ljava/security/KeyStore$Entry;Ljava/security/KeyStore$ProtectionParameter;)V",
	...
	void KeyStoreSpi::engineSetKeyEntry(const QString &arg0, __JniBaseClass arg1, jcharArray arg2, jarray arg3)
	{
		__thiz.callMethod<void>(
			"engineSetKeyEntry",
			"(Ljava/lang/String;Ljava/security/Key;[C[Ljava/security/cert/Certificate;)V",
