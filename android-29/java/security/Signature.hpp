...
namespace __jni_impl::java::security
{
	...
	QAndroidJniObject Signature::clone()
	{
		return __thiz.callObjectMethod(
			"clone",
			"()Ljava/lang/Object;");
	...
	QAndroidJniObject Signature::sign()
	{
		return __thiz.callObjectMethod(
			"sign",
			"()[B");
	...
	QAndroidJniObject Signature::getAlgorithm()
	{
		return __thiz.callObjectMethod(
			"getAlgorithm",
			"()Ljava/lang/String;");
	...
	QAndroidJniObject Signature::getParameter(jstring arg0)
	{
		return __thiz.callObjectMethod(
			"getParameter",
