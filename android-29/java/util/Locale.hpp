...
namespace __jni_impl::java::util
{
	...
	public:
		...
		static QAndroidJniObject lookupTag(__jni_impl::__JniBaseClass arg0, __jni_impl::__JniBaseClass arg1);
		...
		QAndroidJniObject getDisplayLanguage(__jni_impl::java::util::Locale arg0);
		QAndroidJniObject getDisplayScript(__jni_impl::java::util::Locale arg0);
		QAndroidJniObject getDisplayScript();
		QAndroidJniObject getDisplayCountry(__jni_impl::java::util::Locale arg0);
		QAndroidJniObject getDisplayCountry();
		QAndroidJniObject getDisplayVariant(__jni_impl::java::util::Locale arg0);
...
namespace __jni_impl::java::util
{
	...
	QAndroidJniObject Locale::toString()
	{
	...
	QAndroidJniObject Locale::clone()
	{
		return __thiz.callObjectMethod(
			"clone",
			"()Ljava/lang/Object;");
	...
	QAndroidJniObject Locale::getLanguage()
	{
		return __thiz.callObjectMethod(
			"getLanguage",
			"()Ljava/lang/String;");
	}
	QAndroidJniObject Locale::lookupTag(__jni_impl::__JniBaseClass arg0, __jni_impl::__JniBaseClass arg1)
	{
		return QAndroidJniObject::callStaticObjectMethod(
			"java.util.Locale",
			"lookupTag",
	...
	QAndroidJniObject Locale::getAvailableLocales()
	{
		return QAndroidJniObject::callStaticObjectMethod(
			"java.util.Locale",
			"getAvailableLocales",
	...
	QAndroidJniObject Locale::getISOCountries()
	{
		return QAndroidJniObject::callStaticObjectMethod(
			"java.util.Locale",
			"getISOCountries",
	...
	QAndroidJniObject Locale::getISOLanguages()
	{
		return QAndroidJniObject::callStaticObjectMethod(
			"java.util.Locale",
			"getISOLanguages",
	...
	QAndroidJniObject Locale::getExtension(jchar arg0)
	{
		return __thiz.callObjectMethod(
			"getExtension",
			"(C)Ljava/lang/String;",
	...
	QAndroidJniObject Locale::toLanguageTag()
	{
		return __thiz.callObjectMethod(
			"toLanguageTag",
			"()Ljava/lang/String;");
	...
	QAndroidJniObject Locale::getISO3Language()
	{
		return __thiz.callObjectMethod(
			"getISO3Language",
			"()Ljava/lang/String;");
	}
	QAndroidJniObject Locale::getISO3Country()
	{
		return __thiz.callObjectMethod(
			"getISO3Country",
			"()Ljava/lang/String;");
	}
	QAndroidJniObject Locale::getScript()
	{
		return __thiz.callObjectMethod(
			"getScript",
			"()Ljava/lang/String;");
	}
	QAndroidJniObject Locale::getCountry()
	{
		return __thiz.callObjectMethod(
			"getCountry",
			"()Ljava/lang/String;");
	}
	QAndroidJniObject Locale::getVariant()
	{
		return __thiz.callObjectMethod(
			"getVariant",
			"()Ljava/lang/String;");
	...
	QAndroidJniObject Locale::getUnicodeLocaleType(jstring arg0)
	{
		return __thiz.callObjectMethod(
	...
	QAndroidJniObject Locale::getDisplayLanguage()
	{
		return __thiz.callObjectMethod(
			"getDisplayLanguage",
			"()Ljava/lang/String;");
	}
	QAndroidJniObject Locale::getDisplayLanguage(__jni_impl::java::util::Locale arg0)
	{
		return __thiz.callObjectMethod(
			"getDisplayLanguage",
	...
	QAndroidJniObject Locale::getDisplayScript(__jni_impl::java::util::Locale arg0)
	{
		return __thiz.callObjectMethod(
			"getDisplayScript",
			"(Ljava/util/Locale;)Ljava/lang/String;",
	...
	QAndroidJniObject Locale::getDisplayScript()
	{
		return __thiz.callObjectMethod(
			"getDisplayScript",
			"()Ljava/lang/String;");
	}
	QAndroidJniObject Locale::getDisplayCountry(__jni_impl::java::util::Locale arg0)
	{
		return __thiz.callObjectMethod(
			"getDisplayCountry",
			"(Ljava/util/Locale;)Ljava/lang/String;",
	...
	QAndroidJniObject Locale::getDisplayCountry()
	{
		return __thiz.callObjectMethod(
			"getDisplayCountry",
			"()Ljava/lang/String;");
	}
	QAndroidJniObject Locale::getDisplayVariant(__jni_impl::java::util::Locale arg0)
	{
		return __thiz.callObjectMethod(
			"getDisplayVariant",
			"(Ljava/util/Locale;)Ljava/lang/String;",
	...
	QAndroidJniObject Locale::getDisplayVariant()
	{
		return __thiz.callObjectMethod(
			"getDisplayVariant",
			"()Ljava/lang/String;");
	}
	QAndroidJniObject Locale::getDisplayName()
	{
		return __thiz.callObjectMethod(
			"getDisplayName",
			"()Ljava/lang/String;");
	}
	QAndroidJniObject Locale::getDisplayName(__jni_impl::java::util::Locale arg0)
	{
		return __thiz.callObjectMethod(
			"getDisplayName",
			"(Ljava/util/Locale;)Ljava/lang/String;",
