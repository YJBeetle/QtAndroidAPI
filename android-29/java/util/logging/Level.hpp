...
namespace __jni_impl::java::util::logging
{
	...
	public:
		...
		QAndroidJniObject getLocalizedName();
	};
} // namespace __jni_impl::java::util::logging
...
namespace __jni_impl::java::util::logging
{
	...
	// Methods
	QAndroidJniObject Level::getName()
	{
	...
	QAndroidJniObject Level::toString()
	{
		return __thiz.callObjectMethod(
			"toString",
			"()Ljava/lang/String;");
	...
	QAndroidJniObject Level::getResourceBundleName()
	{
		return __thiz.callObjectMethod(
			"getResourceBundleName",
			"()Ljava/lang/String;");
	}
	QAndroidJniObject Level::getLocalizedName()
	{
		return __thiz.callObjectMethod(
			"getLocalizedName",
			"()Ljava/lang/String;");
