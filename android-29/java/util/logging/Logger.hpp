...
namespace __jni_impl::java::util::logging
{
	...
	public:
		// Fields
		static QAndroidJniObject GLOBAL_LOGGER_NAME();
...
{
	// Fields
	QAndroidJniObject Logger::GLOBAL_LOGGER_NAME()
	{
	...
	// Methods
	QAndroidJniObject Logger::getName()
	{
	...
	QAndroidJniObject Logger::getResourceBundleName()
	{
		return __thiz.callObjectMethod(
	...
	QAndroidJniObject Logger::getHandlers()
	{
		return __thiz.callObjectMethod(
			"getHandlers",
