...
namespace __jni_impl::java::util::prefs
{
	...
	// Methods
	QAndroidJniObject Preferences::name()
	{
	...
	QAndroidJniObject Preferences::get(jstring arg0, jstring arg1)
	{
		return __thiz.callObjectMethod(
			"get",
	...
	QAndroidJniObject Preferences::toString()
	{
		return __thiz.callObjectMethod(
			"toString",
			"()Ljava/lang/String;");
	...
	QAndroidJniObject Preferences::keys()
	{
		return __thiz.callObjectMethod(
			"keys",
			"()[Ljava/lang/String;");
	...
	QAndroidJniObject Preferences::getByteArray(jstring arg0, jbyteArray arg1)
	{
		return __thiz.callObjectMethod(
			"getByteArray",
	...
	QAndroidJniObject Preferences::childrenNames()
	{
		return __thiz.callObjectMethod(
			"childrenNames",
			"()[Ljava/lang/String;");
	...
	QAndroidJniObject Preferences::absolutePath()
	{
		return __thiz.callObjectMethod(
			"absolutePath",
			"()Ljava/lang/String;");
