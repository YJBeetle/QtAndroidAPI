...
namespace __jni_impl::java::time
{
	...
	QAndroidJniObject ZonedDateTime::toString()
	{
	...
	QAndroidJniObject ZonedDateTime::format(__jni_impl::java::time::format::DateTimeFormatter arg0)
	{
		return __thiz.callObjectMethod(
			"format",
	...
	QAndroidJniObject ZonedDateTime::query(__jni_impl::__JniBaseClass arg0)
	{
		return __thiz.callObjectMethod(
			"query",
