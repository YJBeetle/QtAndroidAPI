...
namespace __jni_impl::java::time
{
	...
	QAndroidJniObject MonthDay::toString()
	{
	...
	QAndroidJniObject MonthDay::format(__jni_impl::java::time::format::DateTimeFormatter arg0)
	{
		return __thiz.callObjectMethod(
			"format",
	...
	QAndroidJniObject MonthDay::query(__jni_impl::__JniBaseClass arg0)
	{
		return __thiz.callObjectMethod(
			"query",
