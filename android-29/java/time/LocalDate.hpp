...
namespace __jni_impl::java::time
{
	...
	QAndroidJniObject LocalDate::toString()
	{
	...
	QAndroidJniObject LocalDate::format(__jni_impl::java::time::format::DateTimeFormatter arg0)
	{
		return __thiz.callObjectMethod(
			"format",
	...
	QAndroidJniObject LocalDate::query(__jni_impl::__JniBaseClass arg0)
	{
		return __thiz.callObjectMethod(
			"query",
