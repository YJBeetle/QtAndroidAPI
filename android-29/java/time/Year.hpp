...
namespace __jni_impl::java::time
{
	...
	QAndroidJniObject Year::toString()
	{
	...
	QAndroidJniObject Year::format(__jni_impl::java::time::format::DateTimeFormatter arg0)
	{
		return __thiz.callObjectMethod(
			"format",
	...
	QAndroidJniObject Year::query(__jni_impl::__JniBaseClass arg0)
	{
		return __thiz.callObjectMethod(
			"query",
