...
namespace __jni_impl::java::time
{
	...
	QAndroidJniObject OffsetDateTime::toString()
	{
	...
	QAndroidJniObject OffsetDateTime::format(__jni_impl::java::time::format::DateTimeFormatter arg0)
	{
		return __thiz.callObjectMethod(
			"format",
	...
	QAndroidJniObject OffsetDateTime::query(__jni_impl::__JniBaseClass arg0)
	{
		return __thiz.callObjectMethod(
			"query",
