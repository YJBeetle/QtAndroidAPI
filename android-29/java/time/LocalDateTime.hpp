...
#ifndef JAVA_TIME_LOCALDATETIME
#define JAVA_TIME_LOCALDATETIME
...
namespace __jni_impl::java::time
{
	...
	QAndroidJniObject LocalDateTime::toString()
	{
	...
	QAndroidJniObject LocalDateTime::format(__jni_impl::java::time::format::DateTimeFormatter arg0)
	{
		return __thiz.callObjectMethod(
			"format",
	...
	QAndroidJniObject LocalDateTime::query(__jni_impl::__JniBaseClass arg0)
	{
		return __thiz.callObjectMethod(
			"query",
