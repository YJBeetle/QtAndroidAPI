...
namespace __jni_impl::java::io
{
	...
	public:
		...
		static QAndroidJniObject separator();
		static jchar pathSeparatorChar();
		static QAndroidJniObject pathSeparator();
		...
		QAndroidJniObject list(__jni_impl::__JniBaseClass arg0);
		jboolean isAbsolute();
		...
		QAndroidJniObject getAbsolutePath();
		QAndroidJniObject getCanonicalPath();
		...
		static QAndroidJniObject listRoots();
		...
		void deleteOnExit();
		QAndroidJniObject listFiles();
		QAndroidJniObject listFiles(__jni_impl::__JniBaseClass arg0);
...
namespace __jni_impl::java::io
{
	...
	QAndroidJniObject File::separator()
	{
	...
	QAndroidJniObject File::pathSeparator()
	{
		return QAndroidJniObject::getStaticObjectField(
			"java.io.File",
			"pathSeparator",
	...
	// Methods
	QAndroidJniObject File::getName()
	{
	...
	QAndroidJniObject File::toString()
	{
		return __thiz.callObjectMethod(
			"toString",
			"()Ljava/lang/String;");
	...
	QAndroidJniObject File::list()
	{
		return __thiz.callObjectMethod(
			"list",
			"()[Ljava/lang/String;");
	}
	QAndroidJniObject File::list(__jni_impl::__JniBaseClass arg0)
	{
		return __thiz.callObjectMethod(
			"list",
	...
	QAndroidJniObject File::getParent()
	{
		return __thiz.callObjectMethod(
			"getParent",
			"()Ljava/lang/String;");
	...
	QAndroidJniObject File::getPath()
	{
		return __thiz.callObjectMethod(
			"getPath",
			"()Ljava/lang/String;");
	...
	QAndroidJniObject File::getAbsolutePath()
	{
		return __thiz.callObjectMethod(
			"getAbsolutePath",
			"()Ljava/lang/String;");
	}
	QAndroidJniObject File::getCanonicalPath()
	{
		return __thiz.callObjectMethod(
			"getCanonicalPath",
			"()Ljava/lang/String;");
	...
	QAndroidJniObject File::listRoots()
	{
	...
	QAndroidJniObject File::listFiles()
	{
		return __thiz.callObjectMethod(
			"listFiles",
			"()[Ljava/io/File;");
	}
	QAndroidJniObject File::listFiles(__jni_impl::__JniBaseClass arg0)
	{
		return __thiz.callObjectMethod(
			"listFiles",
