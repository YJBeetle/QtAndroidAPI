...
namespace __jni_impl::java::io
{
	...
	public:
		...
		jchar readChar();
		QAndroidJniObject readUnshared();
...
namespace __jni_impl::java::io
{
	...
	QAndroidJniObject ObjectInputStream::readObject()
	{
	...
	QAndroidJniObject ObjectInputStream::readLine()
	{
		return __thiz.callObjectMethod(
			"readLine",
			"()Ljava/lang/String;");
	...
	QAndroidJniObject ObjectInputStream::readUTF()
	{
		return __thiz.callObjectMethod(
			"readUTF",
			"()Ljava/lang/String;");
	...
	QAndroidJniObject ObjectInputStream::readUnshared()
	{
		return __thiz.callObjectMethod(
			"readUnshared",
			"()Ljava/lang/Object;");
