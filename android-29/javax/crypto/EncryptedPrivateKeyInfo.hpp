...
namespace __jni_impl::javax::crypto
{
	...
	public:
		...
		QAndroidJniObject getAlgName();
		QAndroidJniObject getAlgParameters();
		QAndroidJniObject getEncryptedData();
...
namespace __jni_impl::javax::crypto
{
	...
	// Methods
	QAndroidJniObject EncryptedPrivateKeyInfo::getEncoded()
	{
		return __thiz.callObjectMethod(
			"getEncoded",
			"()[B");
	}
	QAndroidJniObject EncryptedPrivateKeyInfo::getAlgName()
	{
		return __thiz.callObjectMethod(
			"getAlgName",
			"()Ljava/lang/String;");
	...
	QAndroidJniObject EncryptedPrivateKeyInfo::getEncryptedData()
	{
		return __thiz.callObjectMethod(
			"getEncryptedData",
			"()[B");
