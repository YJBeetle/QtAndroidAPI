...
namespace __jni_impl::android::preference
{
	...
	public:
		// Fields
		static QAndroidJniObject KEY_HAS_SET_DEFAULT_VALUES();
		static QAndroidJniObject METADATA_KEY_PREFERENCES();
		...
		QAndroidJniObject getSharedPreferencesName();
		...
		static QAndroidJniObject getDefaultSharedPreferencesName(__jni_impl::android::content::Context arg0);
...
{
	// Fields
	QAndroidJniObject PreferenceManager::KEY_HAS_SET_DEFAULT_VALUES()
	{
	...
	QAndroidJniObject PreferenceManager::METADATA_KEY_PREFERENCES()
	{
		return QAndroidJniObject::getStaticObjectField(
			"android.preference.PreferenceManager",
	...
	QAndroidJniObject PreferenceManager::getSharedPreferencesName()
	{
		return __thiz.callObjectMethod(
	...
	QAndroidJniObject PreferenceManager::getDefaultSharedPreferencesName(__jni_impl::android::content::Context arg0)
	{
		return QAndroidJniObject::callStaticObjectMethod(
			"android.preference.PreferenceManager",
