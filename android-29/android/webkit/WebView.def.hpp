...
#include "../widget/AbsoluteLayout.def.hpp"
...
namespace android::webkit
{
	...
	public:
		...
		WebView(QJniObject obj) : android::widget::AbsoluteLayout(obj) {}
		...
		android::webkit::WebViewRenderProcess getWebViewRenderProcess() const;
		android::webkit::WebViewRenderProcessClient getWebViewRenderProcessClient() const;
		void goBack() const;
		...
		void setWebViewRenderProcessClient(android::webkit::WebViewRenderProcessClient arg0) const;
		void setWebViewRenderProcessClient(JObject arg0, android::webkit::WebViewRenderProcessClient arg1) const;
