...
namespace android::view
{
	...
	public:
		...
		static QAndroidJniObject inflate(android::content::Context arg0, jint arg1, android::view::ViewGroup arg2);
		...
		void clearFocus();
		void computeScroll();
		QAndroidJniObject computeSystemWindowInsets(android::view::WindowInsets arg0, android::graphics::Rect arg1);
		...
		QAndroidJniObject keyboardNavigationClusterSearch(android::view::View arg0, jint arg1);
		...
		QAndroidJniObject onApplyWindowInsets(android::view::WindowInsets arg0);
		...
		QAndroidJniObject startActionMode(__JniBaseClass arg0);
		QAndroidJniObject startActionMode(__JniBaseClass arg0, jint arg1);
