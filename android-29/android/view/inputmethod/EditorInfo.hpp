...
namespace __jni_impl::android::view::inputmethod
{
	...
	public:
		...
		jint actionId();
		QAndroidJniObject actionLabel();
		QAndroidJniObject contentMimeTypes();
		QAndroidJniObject extras();
		jint fieldId();
		QAndroidJniObject fieldName();
		QAndroidJniObject hintLocales();
		QAndroidJniObject hintText();
		jint imeOptions();
		...
		QAndroidJniObject privateImeOptions();
...
namespace __jni_impl::android::view::inputmethod
{
	...
	QAndroidJniObject EditorInfo::actionLabel()
	{
		return __thiz.getObjectField(
			"actionLabel",
			"Ljava/lang/CharSequence;");
	}
	QAndroidJniObject EditorInfo::contentMimeTypes()
	{
		return __thiz.getObjectField(
			"contentMimeTypes",
			"[Ljava/lang/String;");
	...
	QAndroidJniObject EditorInfo::fieldName()
	{
		return __thiz.getObjectField(
			"fieldName",
			"Ljava/lang/String;");
	...
	QAndroidJniObject EditorInfo::hintText()
	{
		return __thiz.getObjectField(
			"hintText",
			"Ljava/lang/CharSequence;");
	...
	QAndroidJniObject EditorInfo::label()
	{
		return __thiz.getObjectField(
			"label",
			"Ljava/lang/CharSequence;");
	}
	QAndroidJniObject EditorInfo::packageName()
	{
		return __thiz.getObjectField(
			"packageName",
			"Ljava/lang/String;");
	}
	QAndroidJniObject EditorInfo::privateImeOptions()
	{
		return __thiz.getObjectField(
			"privateImeOptions",
			"Ljava/lang/String;");
