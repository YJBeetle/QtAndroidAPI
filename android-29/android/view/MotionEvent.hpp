...
namespace __jni_impl::android::view
{
	...
	public:
		...
		static QAndroidJniObject actionToString(jint arg0);
		static QAndroidJniObject axisToString(jint arg0);
...
namespace __jni_impl::android::view
{
	...
	// Methods
	QAndroidJniObject MotionEvent::toString()
	{
	...
	QAndroidJniObject MotionEvent::actionToString(jint arg0)
	{
		return QAndroidJniObject::callStaticObjectMethod(
			"android.view.MotionEvent",
			"actionToString",
	...
	QAndroidJniObject MotionEvent::axisToString(jint arg0)
	{
		return QAndroidJniObject::callStaticObjectMethod(
			"android.view.MotionEvent",
			"axisToString",
