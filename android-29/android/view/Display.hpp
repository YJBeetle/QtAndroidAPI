...
namespace __jni_impl::android::view
{
	...
	public:
		...
		QAndroidJniObject getSupportedRefreshRates();
		QAndroidJniObject getSupportedModes();
...
namespace __jni_impl::android::view
{
	...
	// Methods
	QAndroidJniObject Display::getName()
	{
		return __thiz.callObjectMethod(
			"getName",
			"()Ljava/lang/String;");
	}
	QAndroidJniObject Display::toString()
	{
		return __thiz.callObjectMethod(
			"toString",
			"()Ljava/lang/String;");
	...
	QAndroidJniObject Display::getSupportedRefreshRates()
	{
		return __thiz.callObjectMethod(
			"getSupportedRefreshRates",
			"()[F");
	}
	QAndroidJniObject Display::getSupportedModes()
	{
		return __thiz.callObjectMethod(
			"getSupportedModes",
