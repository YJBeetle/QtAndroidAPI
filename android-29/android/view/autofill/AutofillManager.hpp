...
namespace __jni_impl::android::view::autofill
{
	...
	public:
		// Fields
		static QAndroidJniObject EXTRA_ASSIST_STRUCTURE();
		static QAndroidJniObject EXTRA_AUTHENTICATION_RESULT();
		static QAndroidJniObject EXTRA_CLIENT_STATE();
		...
		QAndroidJniObject getUserDataId();
		jboolean isFieldClassificationEnabled();
		QAndroidJniObject getDefaultFieldClassificationAlgorithm();
...
{
	// Fields
	QAndroidJniObject AutofillManager::EXTRA_ASSIST_STRUCTURE()
	{
	...
	QAndroidJniObject AutofillManager::EXTRA_AUTHENTICATION_RESULT()
	{
		return QAndroidJniObject::getStaticObjectField(
			"android.view.autofill.AutofillManager",
	...
	QAndroidJniObject AutofillManager::EXTRA_CLIENT_STATE()
	{
		return QAndroidJniObject::getStaticObjectField(
			"android.view.autofill.AutofillManager",
			"EXTRA_CLIENT_STATE",
	...
	QAndroidJniObject AutofillManager::getUserDataId()
	{
		return __thiz.callObjectMethod(
			"getUserDataId",
			"()Ljava/lang/String;");
	...
	QAndroidJniObject AutofillManager::getDefaultFieldClassificationAlgorithm()
	{
		return __thiz.callObjectMethod(
