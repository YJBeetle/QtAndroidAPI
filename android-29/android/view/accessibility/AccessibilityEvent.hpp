...
namespace __jni_impl::android::view::accessibility
{
	...
	// Methods
	QAndroidJniObject AccessibilityEvent::toString()
	{
		return __thiz.callObjectMethod(
			"toString",
			"()Ljava/lang/String;");
	}
	QAndroidJniObject AccessibilityEvent::getPackageName()
	{
		return __thiz.callObjectMethod(
			"getPackageName",
	...
	QAndroidJniObject AccessibilityEvent::eventTypeToString(jint arg0)
	{
		return QAndroidJniObject::callStaticObjectMethod(
			"android.view.accessibility.AccessibilityEvent",
			"eventTypeToString",
