...
namespace __jni_impl::android::media
{
	...
	// Methods
	QAndroidJniObject MediaRouter_RouteInfo::getName(__jni_impl::android::content::Context arg0)
	{
	...
	QAndroidJniObject MediaRouter_RouteInfo::getName()
	{
		return __thiz.callObjectMethod(
			"getName",
			"()Ljava/lang/CharSequence;");
	}
	QAndroidJniObject MediaRouter_RouteInfo::toString()
	{
		return __thiz.callObjectMethod(
			"toString",
			"()Ljava/lang/String;");
	...
	QAndroidJniObject MediaRouter_RouteInfo::getTag()
	{
		return __thiz.callObjectMethod(
			"getTag",
			"()Ljava/lang/Object;");
