...
namespace __jni_impl::android::security::keystore
{
	...
	public:
		...
		QAndroidJniObject getAttestationChallenge();
...
namespace __jni_impl::android::security::keystore
{
	...
	QAndroidJniObject KeyGenParameterSpec::getKeystoreAlias()
	{
		return __thiz.callObjectMethod(
			"getKeystoreAlias",
			"()Ljava/lang/String;");
	...
	QAndroidJniObject KeyGenParameterSpec::getDigests()
	{
		return __thiz.callObjectMethod(
			"getDigests",
			"()[Ljava/lang/String;");
	...
	QAndroidJniObject KeyGenParameterSpec::getEncryptionPaddings()
	{
		return __thiz.callObjectMethod(
			"getEncryptionPaddings",
			"()[Ljava/lang/String;");
	}
	QAndroidJniObject KeyGenParameterSpec::getSignaturePaddings()
	{
		return __thiz.callObjectMethod(
			"getSignaturePaddings",
			"()[Ljava/lang/String;");
	}
	QAndroidJniObject KeyGenParameterSpec::getBlockModes()
	{
		return __thiz.callObjectMethod(
			"getBlockModes",
			"()[Ljava/lang/String;");
	...
	QAndroidJniObject KeyGenParameterSpec::getAttestationChallenge()
	{
		return __thiz.callObjectMethod(
