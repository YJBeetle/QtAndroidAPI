...
namespace __jni_impl::android::telephony
{
	...
	void SmsManager::downloadMultimediaMessage(__jni_impl::android::content::Context arg0, const QString &arg1, __jni_impl::android::net::Uri arg2, __jni_impl::android::os::Bundle arg3, __jni_impl::android::app::PendingIntent arg4)
	{
		__thiz.callMethod<void>(
			"downloadMultimediaMessage",
			"(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;Landroid/os/Bundle;Landroid/app/PendingIntent;)V",
