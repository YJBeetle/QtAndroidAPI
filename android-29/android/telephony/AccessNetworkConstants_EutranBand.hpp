...
{
	class AccessNetworkConstants_EutranBand : public __JniBaseClass
	{
	public:
		// Fields
		static jint BAND_1();
...
namespace __jni_impl::android::telephony
{
	...
	// Constructors
	void AccessNetworkConstants_EutranBand::__constructor()
	{
...
{
	class AccessNetworkConstants_EutranBand : public __jni_impl::android::telephony::AccessNetworkConstants_EutranBand
	{
	public:
		AccessNetworkConstants_EutranBand(QAndroidJniObject obj) { __thiz = obj; }
		AccessNetworkConstants_EutranBand()
		{
			__constructor();
		}
	};
