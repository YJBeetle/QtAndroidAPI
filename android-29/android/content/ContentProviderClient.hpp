...
namespace __jni_impl::android::content
{
	...
	QAndroidJniObject ContentProviderClient::getType(__jni_impl::android::net::Uri arg0)
	{
	...
	QAndroidJniObject ContentProviderClient::getStreamTypes(__jni_impl::android::net::Uri arg0, jstring arg1)
	{
		return __thiz.callObjectMethod(
			"getStreamTypes",
	...
	QAndroidJniObject ContentProviderClient::applyBatch(jstring arg0, __jni_impl::java::util::ArrayList arg1)
	{
		return __thiz.callObjectMethod(
			"applyBatch",
	...
	QAndroidJniObject ContentProviderClient::applyBatch(__jni_impl::java::util::ArrayList arg0)
	{
		return __thiz.callObjectMethod(
			"applyBatch",
