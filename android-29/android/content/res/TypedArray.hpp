...
namespace __jni_impl::android::content::res
{
	...
	QAndroidJniObject TypedArray::toString()
	{
	...
	QAndroidJniObject TypedArray::getString(jint arg0)
	{
		return __thiz.callObjectMethod(
			"getString",
			"(I)Ljava/lang/String;",
	...
	QAndroidJniObject TypedArray::getText(jint arg0)
	{
		return __thiz.callObjectMethod(
			"getText",
	...
	QAndroidJniObject TypedArray::getTextArray(jint arg0)
	{
		return __thiz.callObjectMethod(
			"getTextArray",
			"(I)[Ljava/lang/CharSequence;",
