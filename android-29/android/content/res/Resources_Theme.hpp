...
namespace __jni_impl::android::content::res
{
	...
	public:
		...
		QAndroidJniObject getAttributeResolutionStack(jint arg0, jint arg1, jint arg2);
...
namespace __jni_impl::android::content::res
{
	...
	QAndroidJniObject Resources_Theme::getAttributeResolutionStack(jint arg0, jint arg1, jint arg2)
	{
		return __thiz.callObjectMethod(
