...
namespace __jni_impl::android::content::pm
{
	...
	public:
		...
		QAndroidJniObject getProfileSwitchingLabel(__jni_impl::android::os::UserHandle arg0);
...
namespace __jni_impl::android::content::pm
{
	...
	QAndroidJniObject CrossProfileApps::getProfileSwitchingLabel(__jni_impl::android::os::UserHandle arg0)
	{
		return __thiz.callObjectMethod(
