...
namespace android::content::pm
{
	...
	public:
		...
		QAndroidJniObject getActivityBanner(android::content::ComponentName arg0);
		QAndroidJniObject getActivityBanner(android::content::Intent arg0);
		QAndroidJniObject getActivityIcon(android::content::ComponentName arg0);
		QAndroidJniObject getActivityIcon(android::content::Intent arg0);
		QAndroidJniObject getActivityInfo(android::content::ComponentName arg0, jint arg1);
		QAndroidJniObject getActivityLogo(android::content::ComponentName arg0);
		QAndroidJniObject getActivityLogo(android::content::Intent arg0);
		QAndroidJniObject getAllPermissionGroups(jint arg0);
		QAndroidJniObject getApplicationBanner(android::content::pm::ApplicationInfo arg0);
		...
		QAndroidJniObject getApplicationIcon(android::content::pm::ApplicationInfo arg0);
		...
		QAndroidJniObject getApplicationLogo(android::content::pm::ApplicationInfo arg0);
		...
		QAndroidJniObject getDrawable(jstring arg0, jint arg1, android::content::pm::ApplicationInfo arg2);
		QAndroidJniObject getDrawable(const QString &arg0, jint arg1, android::content::pm::ApplicationInfo arg2);
		...
		QAndroidJniObject getInstrumentationInfo(android::content::ComponentName arg0, jint arg1);
		...
		QAndroidJniObject getPackageInfo(android::content::pm::VersionedPackage arg0, jint arg1);
		...
		jint getPreferredActivities(__JniBaseClass arg0, __JniBaseClass arg1, const QString &arg2);
		QAndroidJniObject getPreferredPackages(jint arg0);
		QAndroidJniObject getProviderInfo(android::content::ComponentName arg0, jint arg1);
		QAndroidJniObject getReceiverInfo(android::content::ComponentName arg0, jint arg1);
		QAndroidJniObject getResourcesForActivity(android::content::ComponentName arg0);
		QAndroidJniObject getResourcesForApplication(android::content::pm::ApplicationInfo arg0);
		QAndroidJniObject getResourcesForApplication(jstring arg0);
		QAndroidJniObject getResourcesForApplication(const QString &arg0);
		QAndroidJniObject getServiceInfo(android::content::ComponentName arg0, jint arg1);
		...
		jstring getText(const QString &arg0, jint arg1, android::content::pm::ApplicationInfo arg2);
		QAndroidJniObject getUserBadgedDrawableForDensity(android::graphics::drawable::Drawable arg0, android::os::UserHandle arg1, android::graphics::Rect arg2, jint arg3);
		QAndroidJniObject getUserBadgedIcon(android::graphics::drawable::Drawable arg0, android::os::UserHandle arg1);
		jstring getUserBadgedLabel(jstring arg0, android::os::UserHandle arg1);
		jstring getUserBadgedLabel(const QString &arg0, android::os::UserHandle arg1);
		...
		QAndroidJniObject getXml(jstring arg0, jint arg1, android::content::pm::ApplicationInfo arg2);
		QAndroidJniObject getXml(const QString &arg0, jint arg1, android::content::pm::ApplicationInfo arg2);
		...
		jboolean isSafeMode();
		QAndroidJniObject queryBroadcastReceivers(android::content::Intent arg0, jint arg1);
		...
		QAndroidJniObject queryIntentActivities(android::content::Intent arg0, jint arg1);
		QAndroidJniObject queryIntentActivityOptions(android::content::ComponentName arg0, jarray arg1, android::content::Intent arg2, jint arg3);
		QAndroidJniObject queryIntentContentProviders(android::content::Intent arg0, jint arg1);
		QAndroidJniObject queryIntentServices(android::content::Intent arg0, jint arg1);
		...
		QAndroidJniObject resolveActivity(android::content::Intent arg0, jint arg1);
		...
		QAndroidJniObject resolveService(android::content::Intent arg0, jint arg1);
