...
namespace __jni_impl::android::content::pm
{
	...
	public:
		...
		QAndroidJniObject appComponentFactory();
		QAndroidJniObject backupAgentName();
		jint category();
		QAndroidJniObject className();
		jint compatibleWidthLimitDp();
		QAndroidJniObject dataDir();
		jint descriptionRes();
		QAndroidJniObject deviceProtectedDataDir();
		jboolean enabled();
		jint flags();
		jint largestWidthLimitDp();
		QAndroidJniObject manageSpaceActivityName();
		jint minSdkVersion();
		QAndroidJniObject nativeLibraryDir();
		QAndroidJniObject permission();
		QAndroidJniObject processName();
		QAndroidJniObject publicSourceDir();
		jint requiresSmallestWidthDp();
		QAndroidJniObject sharedLibraryFiles();
		...
		QAndroidJniObject taskAffinity();
		jint theme();
		jint uiOptions();
		jint uid();
		...
		static QAndroidJniObject getCategoryTitle(__jni_impl::android::content::Context arg0, jint arg1);
...
namespace __jni_impl::android::content::pm
{
	...
	QAndroidJniObject ApplicationInfo::appComponentFactory()
	{
		return __thiz.getObjectField(
			"appComponentFactory",
			"Ljava/lang/String;");
	}
	QAndroidJniObject ApplicationInfo::backupAgentName()
	{
		return __thiz.getObjectField(
			"backupAgentName",
			"Ljava/lang/String;");
	...
	QAndroidJniObject ApplicationInfo::className()
	{
		return __thiz.getObjectField(
			"className",
			"Ljava/lang/String;");
	...
	QAndroidJniObject ApplicationInfo::dataDir()
	{
		return __thiz.getObjectField(
			"dataDir",
			"Ljava/lang/String;");
	...
	QAndroidJniObject ApplicationInfo::deviceProtectedDataDir()
	{
		return __thiz.getObjectField(
	...
	QAndroidJniObject ApplicationInfo::manageSpaceActivityName()
	{
		return __thiz.getObjectField(
	...
	QAndroidJniObject ApplicationInfo::nativeLibraryDir()
	{
		return __thiz.getObjectField(
			"nativeLibraryDir",
			"Ljava/lang/String;");
	}
	QAndroidJniObject ApplicationInfo::permission()
	{
		return __thiz.getObjectField(
			"permission",
			"Ljava/lang/String;");
	}
	QAndroidJniObject ApplicationInfo::processName()
	{
		return __thiz.getObjectField(
			"processName",
			"Ljava/lang/String;");
	}
	QAndroidJniObject ApplicationInfo::publicSourceDir()
	{
		return __thiz.getObjectField(
			"publicSourceDir",
			"Ljava/lang/String;");
	...
	QAndroidJniObject ApplicationInfo::sharedLibraryFiles()
	{
		return __thiz.getObjectField(
			"sharedLibraryFiles",
			"[Ljava/lang/String;");
	}
	QAndroidJniObject ApplicationInfo::sourceDir()
	{
		return __thiz.getObjectField(
			"sourceDir",
			"Ljava/lang/String;");
	}
	QAndroidJniObject ApplicationInfo::splitNames()
	{
		return __thiz.getObjectField(
			"splitNames",
			"[Ljava/lang/String;");
	}
	QAndroidJniObject ApplicationInfo::splitPublicSourceDirs()
	{
		return __thiz.getObjectField(
			"splitPublicSourceDirs",
			"[Ljava/lang/String;");
	}
	QAndroidJniObject ApplicationInfo::splitSourceDirs()
	{
		return __thiz.getObjectField(
			"splitSourceDirs",
			"[Ljava/lang/String;");
	...
	QAndroidJniObject ApplicationInfo::taskAffinity()
	{
		return __thiz.getObjectField(
			"taskAffinity",
			"Ljava/lang/String;");
	...
	// Methods
	QAndroidJniObject ApplicationInfo::toString()
	{
		return __thiz.callObjectMethod(
			"toString",
			"()Ljava/lang/String;");
	}
	QAndroidJniObject ApplicationInfo::getCategoryTitle(__jni_impl::android::content::Context arg0, jint arg1)
	{
	...
	QAndroidJniObject ApplicationInfo::loadDescription(__jni_impl::android::content::pm::PackageManager arg0)
	{
		return __thiz.callObjectMethod(
			"loadDescription",
