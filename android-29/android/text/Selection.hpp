...
namespace __jni_impl::android::text
{
	...
	public:
		// Fields
		static QAndroidJniObject SELECTION_END();
		static QAndroidJniObject SELECTION_START();
...
{
	// Fields
	QAndroidJniObject Selection::SELECTION_END()
	{
	...
	QAndroidJniObject Selection::SELECTION_START()
	{
		return QAndroidJniObject::getStaticObjectField(
			"android.text.Selection",
			"SELECTION_START",
