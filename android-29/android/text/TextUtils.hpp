...
namespace android::text
{
	...
	inline jint TextUtils::SAFE_STRING_FLAG_FIRST_LINE()
	{
		return getStaticField<jint>(
			"android.text.TextUtils",
	...
	inline jint TextUtils::SAFE_STRING_FLAG_SINGLE_LINE()
	{
		return getStaticField<jint>(
			"android.text.TextUtils",
	...
	inline jint TextUtils::SAFE_STRING_FLAG_TRIM()
	{
		return getStaticField<jint>(
			"android.text.TextUtils",
	...
	inline JString TextUtils::makeSafeForPresentation(JString arg0, jint arg1, jfloat arg2, jint arg3)
	{
		return callStaticObjectMethod(
			"android.text.TextUtils",
