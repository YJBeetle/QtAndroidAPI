...
namespace __jni_impl::android::bluetooth
{
	...
	public:
		...
		QAndroidJniObject getStringValue(jint arg0);
	};
} // namespace __jni_impl::android::bluetooth
...
namespace __jni_impl::android::bluetooth
{
	...
	// Methods
	QAndroidJniObject BluetoothGattCharacteristic::getValue()
	{
	...
	QAndroidJniObject BluetoothGattCharacteristic::getStringValue(jint arg0)
	{
		return __thiz.callObjectMethod(
			"getStringValue",
			"(I)Ljava/lang/String;",
