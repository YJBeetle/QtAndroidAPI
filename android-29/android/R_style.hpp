...
namespace __jni_impl::android
{
	...
	public:
		...
		static jint ThemeOverlay_DeviceDefault_Accent_DayNight();
		...
		static jint Theme_DeviceDefault_DayNight();
...
namespace android
{
	class R_style : public __jni_impl::android::R_style
	{
	public:
		R_style(QAndroidJniObject obj) { __thiz = obj; }
		R_style()
		{
			__constructor();
		}
