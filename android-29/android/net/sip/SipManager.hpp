...
namespace __jni_impl::android::net::sip
{
	...
	public:
		// Fields
		static QAndroidJniObject EXTRA_CALL_ID();
		static QAndroidJniObject EXTRA_OFFER_SD();
		...
		static QAndroidJniObject getCallId(__jni_impl::android::content::Intent arg0);
		...
		static QAndroidJniObject getOfferSessionDescription(__jni_impl::android::content::Intent arg0);
...
{
	// Fields
	QAndroidJniObject SipManager::EXTRA_CALL_ID()
	{
	...
	QAndroidJniObject SipManager::EXTRA_OFFER_SD()
	{
		return QAndroidJniObject::getStaticObjectField(
			"android.net.sip.SipManager",
			"EXTRA_OFFER_SD",
	...
	QAndroidJniObject SipManager::getCallId(__jni_impl::android::content::Intent arg0)
	{
		return QAndroidJniObject::callStaticObjectMethod(
			"android.net.sip.SipManager",
			"getCallId",
	...
	QAndroidJniObject SipManager::getOfferSessionDescription(__jni_impl::android::content::Intent arg0)
	{
		return QAndroidJniObject::callStaticObjectMethod(
			"android.net.sip.SipManager",
