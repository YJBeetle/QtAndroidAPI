...
namespace android::net::sip
{
	...
	public:
		...
		QAndroidJniObject makeAudioCall(const QString &arg0, const QString &arg1, android::net::sip::SipAudioCall_Listener arg2, jint arg3);
		...
		void setRegistrationListener(const QString &arg0, __JniBaseClass arg1);
