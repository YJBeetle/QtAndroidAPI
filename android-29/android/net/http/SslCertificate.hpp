...
namespace __jni_impl::android::net::http
{
	...
	public:
		...
		QAndroidJniObject getValidNotBefore();
		QAndroidJniObject getValidNotAfterDate();
		QAndroidJniObject getValidNotAfter();
...
namespace __jni_impl::android::net::http
{
	...
	// Methods
	QAndroidJniObject SslCertificate::toString()
	{
	...
	QAndroidJniObject SslCertificate::getValidNotBefore()
	{
		return __thiz.callObjectMethod(
			"getValidNotBefore",
			"()Ljava/lang/String;");
	...
	QAndroidJniObject SslCertificate::getValidNotAfter()
	{
		return __thiz.callObjectMethod(
			"getValidNotAfter",
			"()Ljava/lang/String;");
