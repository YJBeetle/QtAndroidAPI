...
namespace __jni_impl::android::net
{
	...
	public:
		...
		QAndroidJniObject getNpnSelectedProtocol(__jni_impl::java::net::Socket arg0);
...
namespace __jni_impl::android::net
{
	...
	QAndroidJniObject SSLCertificateSocketFactory::getNpnSelectedProtocol(__jni_impl::java::net::Socket arg0)
	{
		return __thiz.callObjectMethod(
	...
	QAndroidJniObject SSLCertificateSocketFactory::getDefaultCipherSuites()
	{
		return __thiz.callObjectMethod(
