...
#ifndef ANDROID_ICU_UTIL_MEASUREUNIT
#define ANDROID_ICU_UTIL_MEASUREUNIT
...
namespace __jni_impl::android::icu::util
{
	...
	// Constructors
	void MeasureUnit::__constructor()
	{
...
{
	class MeasureUnit : public __jni_impl::android::icu::util::MeasureUnit
	{
	public:
		MeasureUnit(QAndroidJniObject obj) { __thiz = obj; }
		MeasureUnit()
		{
			__constructor();
		}
...
#endif // ANDROID_ICU_UTIL_MEASUREUNIT
