...
namespace android::icu::text
{
	...
	QAndroidJniObject CaseMap_Upper::apply(java::util::Locale arg0, const QString &arg1, __JniBaseClass arg2, android::icu::text::Edits arg3)
	{
		return __thiz.callObjectMethod(
			"apply",
			"(Ljava/util/Locale;Ljava/lang/CharSequence;Ljava/lang/Appendable;Landroid/icu/text/Edits;)Ljava/lang/Appendable;",
	...
	jstring CaseMap_Upper::apply(java::util::Locale arg0, const QString &arg1)
	{
		return __thiz.callObjectMethod(
			"apply",
			"(Ljava/util/Locale;Ljava/lang/CharSequence;)Ljava/lang/String;",
