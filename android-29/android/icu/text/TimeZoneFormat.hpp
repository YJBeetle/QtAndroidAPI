...
namespace android::icu::text
{
	...
	public:
		...
		QAndroidJniObject parse(android::icu::text::TimeZoneFormat_Style arg0, const QString &arg1, java::text::ParsePosition arg2, android::icu::util::Output arg3);
		...
		QAndroidJniObject parse(android::icu::text::TimeZoneFormat_Style arg0, const QString &arg1, java::text::ParsePosition arg2, java::util::EnumSet arg3, android::icu::util::Output arg4);
		...
		jint parseOffsetISO8601(const QString &arg0, java::text::ParsePosition arg1);
		jint parseOffsetLocalizedGMT(jstring arg0, java::text::ParsePosition arg1);
		jint parseOffsetLocalizedGMT(const QString &arg0, java::text::ParsePosition arg1);
		jint parseOffsetShortLocalizedGMT(jstring arg0, java::text::ParsePosition arg1);
		jint parseOffsetShortLocalizedGMT(const QString &arg0, java::text::ParsePosition arg1);
		...
		QAndroidJniObject setGMTOffsetPattern(android::icu::text::TimeZoneFormat_GMTOffsetPatternType arg0, const QString &arg1);
