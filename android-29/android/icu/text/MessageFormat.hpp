...
namespace android::icu::text
{
	...
	public:
		...
		java::lang::StringBuffer format(__JniBaseClass arg0, java::lang::StringBuffer arg1, java::text::FieldPosition arg2);
		__JniBaseClass formatToCharacterIterator(jobject arg0);
		android::icu::text::MessagePattern_ApostropheMode getApostropheMode();
		__JniBaseClass getArgumentNames();
		...
		__JniBaseClass parseToMap(jstring arg0);
		__JniBaseClass parseToMap(jstring arg0, java::text::ParsePosition arg1);
