...
namespace __jni_impl::android::icu::math
{
	...
	public:
		...
		QAndroidJniObject format(jint arg0, jint arg1);
		QAndroidJniObject format(jint arg0, jint arg1, jint arg2, jint arg3, jint arg4, jint arg5);
		jint signum();
...
namespace __jni_impl::android::icu::math
{
	...
	QAndroidJniObject BigDecimal::toCharArray()
	{
		return __thiz.callObjectMethod(
			"toCharArray",
			"()[C");
	}
	QAndroidJniObject BigDecimal::format(jint arg0, jint arg1)
	{
		return __thiz.callObjectMethod(
			"format",
	...
	QAndroidJniObject BigDecimal::format(jint arg0, jint arg1, jint arg2, jint arg3, jint arg4, jint arg5)
	{
		return __thiz.callObjectMethod(
			"format",
