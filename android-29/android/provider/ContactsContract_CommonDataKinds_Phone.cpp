...
namespace android::provider
{
	...
	ContactsContract_CommonDataKinds_Phone::ContactsContract_CommonDataKinds_Phone(QAndroidJniObject obj) { __thiz = obj; }
	// Constructors
	...
	jstring ContactsContract_CommonDataKinds_Phone::getTypeLabel(android::content::res::Resources arg0, jint arg1, const QString &arg2)
	{
		return QAndroidJniObject::callStaticObjectMethod(
			"android.provider.ContactsContract$CommonDataKinds$Phone",
			"getTypeLabel",
