...
#ifndef ANDROID_PROVIDER_USERDICTIONARY
#define ANDROID_PROVIDER_USERDICTIONARY
...
{
	// Fields
	QAndroidJniObject UserDictionary::AUTHORITY()
	{
...
#endif // ANDROID_PROVIDER_USERDICTIONARY
