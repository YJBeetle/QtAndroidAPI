...
{
	// Fields
	QAndroidJniObject MediaStore_Audio_Artists::CONTENT_TYPE()
	{
	...
	QAndroidJniObject MediaStore_Audio_Artists::DEFAULT_SORT_ORDER()
	{
		return QAndroidJniObject::getStaticObjectField(
			"android.provider.MediaStore$Audio$Artists",
			"DEFAULT_SORT_ORDER",
	...
	QAndroidJniObject MediaStore_Audio_Artists::ENTRY_CONTENT_TYPE()
	{
		return QAndroidJniObject::getStaticObjectField(
			"android.provider.MediaStore$Audio$Artists",
			"ENTRY_CONTENT_TYPE",
