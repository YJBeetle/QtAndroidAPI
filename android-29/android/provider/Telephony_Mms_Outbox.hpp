...
#ifndef ANDROID_PROVIDER_TELEPHONY_MMS_OUTBOX
#define ANDROID_PROVIDER_TELEPHONY_MMS_OUTBOX
...
namespace __jni_impl::android::provider
{
	...
	QAndroidJniObject Telephony_Mms_Outbox::DEFAULT_SORT_ORDER()
	{
		return QAndroidJniObject::getStaticObjectField(
			"android.provider.Telephony$Mms$Outbox",
			"DEFAULT_SORT_ORDER",
...
#endif // ANDROID_PROVIDER_TELEPHONY_MMS_OUTBOX
