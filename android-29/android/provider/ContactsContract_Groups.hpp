...
#ifndef ANDROID_PROVIDER_CONTACTSCONTRACT_GROUPS
#define ANDROID_PROVIDER_CONTACTSCONTRACT_GROUPS
...
{
	// Fields
	QAndroidJniObject ContactsContract_Groups::CONTENT_ITEM_TYPE()
	{
	...
	QAndroidJniObject ContactsContract_Groups::CONTENT_TYPE()
	{
		return QAndroidJniObject::getStaticObjectField(
			"android.provider.ContactsContract$Groups",
			"CONTENT_TYPE",
...
#endif // ANDROID_PROVIDER_CONTACTSCONTRACT_GROUPS
