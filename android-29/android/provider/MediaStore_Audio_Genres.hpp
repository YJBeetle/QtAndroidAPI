...
{
	// Fields
	QAndroidJniObject MediaStore_Audio_Genres::CONTENT_TYPE()
	{
	...
	QAndroidJniObject MediaStore_Audio_Genres::DEFAULT_SORT_ORDER()
	{
		return QAndroidJniObject::getStaticObjectField(
			"android.provider.MediaStore$Audio$Genres",
			"DEFAULT_SORT_ORDER",
	...
	QAndroidJniObject MediaStore_Audio_Genres::ENTRY_CONTENT_TYPE()
	{
		return QAndroidJniObject::getStaticObjectField(
			"android.provider.MediaStore$Audio$Genres",
			"ENTRY_CONTENT_TYPE",
