...
namespace android::widget
{
	...
	void SimpleCursorAdapter::setViewImage(android::widget::ImageView arg0, const QString &arg1)
	{
		__thiz.callMethod<void>(
			"setViewImage",
			"(Landroid/widget/ImageView;Ljava/lang/String;)V",
	...
	void SimpleCursorAdapter::setViewText(android::widget::TextView arg0, const QString &arg1)
	{
		__thiz.callMethod<void>(
			"setViewText",
			"(Landroid/widget/TextView;Ljava/lang/String;)V",
