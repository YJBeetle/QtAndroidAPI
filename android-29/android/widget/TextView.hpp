...
namespace __jni_impl::android::widget
{
	...
	public:
		...
		QAndroidJniObject getAutoSizeTextAvailableSizes();
		...
		QAndroidJniObject getCompoundDrawables();
		QAndroidJniObject getCompoundDrawablesRelative();
		...
		QAndroidJniObject getImeActionLabel();
		jint getImeActionId();
		...
		QAndroidJniObject getPrivateImeOptions();
...
namespace __jni_impl::android::widget
{
	...
	QAndroidJniObject TextView::getText()
	{
	...
	QAndroidJniObject TextView::getAutoSizeTextAvailableSizes()
	{
		return __thiz.callObjectMethod(
	...
	QAndroidJniObject TextView::getCompoundDrawables()
	{
		return __thiz.callObjectMethod(
			"getCompoundDrawables",
			"()[Landroid/graphics/drawable/Drawable;");
	}
	QAndroidJniObject TextView::getCompoundDrawablesRelative()
	{
		return __thiz.callObjectMethod(
	...
	QAndroidJniObject TextView::getUrls()
	{
		return __thiz.callObjectMethod(
			"getUrls",
	...
	QAndroidJniObject TextView::getImeActionLabel()
	{
		return __thiz.callObjectMethod(
			"getImeActionLabel",
			"()Ljava/lang/CharSequence;");
	...
	QAndroidJniObject TextView::getPrivateImeOptions()
	{
		return __thiz.callObjectMethod(
	...
	QAndroidJniObject TextView::getError()
	{
		return __thiz.callObjectMethod(
			"getError",
			"()Ljava/lang/CharSequence;");
	...
	QAndroidJniObject TextView::getFilters()
	{
		return __thiz.callObjectMethod(
			"getFilters",
	...
	QAndroidJniObject TextView::getAccessibilityClassName()
	{
		return __thiz.callObjectMethod(
