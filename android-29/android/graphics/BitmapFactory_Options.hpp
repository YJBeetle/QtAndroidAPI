...
namespace __jni_impl::android::graphics
{
	...
	public:
		...
		QAndroidJniObject inTempStorage();
		jboolean mCancel();
		QAndroidJniObject outColorSpace();
		QAndroidJniObject outConfig();
		jint outHeight();
		QAndroidJniObject outMimeType();
		jint outWidth();
...
namespace __jni_impl::android::graphics
{
	...
	QAndroidJniObject BitmapFactory_Options::inTempStorage()
	{
		return __thiz.getObjectField(
			"inTempStorage",
			"[B");
	...
	QAndroidJniObject BitmapFactory_Options::outMimeType()
	{
		return __thiz.getObjectField(
			"outMimeType",
			"Ljava/lang/String;");
