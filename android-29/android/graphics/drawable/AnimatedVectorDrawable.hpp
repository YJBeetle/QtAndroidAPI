...
namespace android::graphics::drawable
{
	...
	inline android::graphics::Insets AnimatedVectorDrawable::getOpticalInsets() const
	{
		return callObjectMethod(
			"getOpticalInsets",
	...
	inline void AnimatedVectorDrawable::setTintBlendMode(android::graphics::BlendMode arg0) const
	{
		callMethod<void>(
			"setTintBlendMode",
