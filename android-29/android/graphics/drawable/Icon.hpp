...
#ifndef ANDROID_GRAPHICS_DRAWABLE_ICON
#define ANDROID_GRAPHICS_DRAWABLE_ICON
...
namespace __jni_impl::android::graphics::drawable
{
	...
	public:
		...
		jint getType();
		QAndroidJniObject getResPackage();
		jint getResId();
...
namespace __jni_impl::android::graphics::drawable
{
	...
	// Methods
	QAndroidJniObject Icon::toString()
	{
	...
	QAndroidJniObject Icon::getResPackage()
	{
		return __thiz.callObjectMethod(
			"getResPackage",
			"()Ljava/lang/String;");
...
#endif // ANDROID_GRAPHICS_DRAWABLE_ICON
