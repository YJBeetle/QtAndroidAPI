...
namespace android::nfc::cardemulation
{
	...
	public:
		...
		QAndroidJniObject getAidsForService(android::content::ComponentName arg0, const QString &arg1);
		...
		jboolean isDefaultServiceForAid(android::content::ComponentName arg0, const QString &arg1);
		jboolean isDefaultServiceForCategory(android::content::ComponentName arg0, jstring arg1);
		jboolean isDefaultServiceForCategory(android::content::ComponentName arg0, const QString &arg1);
		jboolean registerAidsForService(android::content::ComponentName arg0, jstring arg1, __JniBaseClass arg2);
		jboolean registerAidsForService(android::content::ComponentName arg0, const QString &arg1, __JniBaseClass arg2);
		jboolean removeAidsForService(android::content::ComponentName arg0, jstring arg1);
		jboolean removeAidsForService(android::content::ComponentName arg0, const QString &arg1);
		jboolean setOffHostForService(android::content::ComponentName arg0, jstring arg1);
		jboolean setOffHostForService(android::content::ComponentName arg0, const QString &arg1);
