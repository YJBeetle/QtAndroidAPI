...
namespace __jni_impl::android::nfc::cardemulation
{
	...
	public:
		...
		QAndroidJniObject processNfcFPacket(jbyteArray arg0, __jni_impl::android::os::Bundle arg1);
...
namespace __jni_impl::android::nfc::cardemulation
{
	...
	QAndroidJniObject HostNfcFService::SERVICE_INTERFACE()
	{
	...
	QAndroidJniObject HostNfcFService::SERVICE_META_DATA()
	{
		return QAndroidJniObject::getStaticObjectField(
			"android.nfc.cardemulation.HostNfcFService",
			"SERVICE_META_DATA",
	...
	QAndroidJniObject HostNfcFService::processNfcFPacket(jbyteArray arg0, __jni_impl::android::os::Bundle arg1)
	{
		return __thiz.callObjectMethod(
			"processNfcFPacket",
