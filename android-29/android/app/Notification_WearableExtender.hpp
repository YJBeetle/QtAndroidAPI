...
namespace __jni_impl::android::app
{
	...
	public:
		...
		QAndroidJniObject getDismissalId();
		QAndroidJniObject setBridgeTag(jstring arg0);
		QAndroidJniObject getBridgeTag();
	};
} // namespace __jni_impl::android::app
...
namespace __jni_impl::android::app
{
	...
	QAndroidJniObject Notification_WearableExtender::getDismissalId()
	{
		return __thiz.callObjectMethod(
			"getDismissalId",
			"()Ljava/lang/String;");
	...
	QAndroidJniObject Notification_WearableExtender::getBridgeTag()
	{
		return __thiz.callObjectMethod(
			"getBridgeTag",
			"()Ljava/lang/String;");
