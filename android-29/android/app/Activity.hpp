...
namespace android::app
{
	...
	public:
		...
		QAndroidJniObject createPendingResult(jint arg0, android::content::Intent arg1, jint arg2);
		...
		QAndroidJniObject requestDragAndDropPermissions(android::view::DragEvent arg0);
