...
namespace __jni_impl::android::app
{
	...
	public:
		// Fields
		static QAndroidJniObject REPORT_KEY_IDENTIFIER();
		static QAndroidJniObject REPORT_KEY_STREAMRESULT();
...
{
	// Fields
	QAndroidJniObject Instrumentation::REPORT_KEY_IDENTIFIER()
	{
	...
	QAndroidJniObject Instrumentation::REPORT_KEY_STREAMRESULT()
	{
		return QAndroidJniObject::getStaticObjectField(
			"android.app.Instrumentation",
