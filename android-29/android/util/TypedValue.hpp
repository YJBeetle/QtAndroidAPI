...
namespace __jni_impl::android::util
{
	...
	public:
		...
		QAndroidJniObject coerceToString();
		static QAndroidJniObject coerceToString(jint arg0, jint arg1);
...
namespace __jni_impl::android::util
{
	...
	QAndroidJniObject TypedValue::string()
	{
	...
	// Methods
	QAndroidJniObject TypedValue::toString()
	{
	...
	QAndroidJniObject TypedValue::coerceToString()
	{
		return __thiz.callObjectMethod(
			"coerceToString",
			"()Ljava/lang/CharSequence;");
	}
	QAndroidJniObject TypedValue::coerceToString(jint arg0, jint arg1)
	{
