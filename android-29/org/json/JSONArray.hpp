...
namespace __jni_impl::org::json
{
	...
	public:
		...
		QAndroidJniObject join(jstring arg0);
		jboolean isNull(jint arg0);
		QAndroidJniObject getString(jint arg0);
		QAndroidJniObject opt(jint arg0);
		...
		QAndroidJniObject optString(jint arg0);
		QAndroidJniObject optString(jint arg0, jstring arg1);
...
namespace __jni_impl::org::json
{
	...
	// Methods
	QAndroidJniObject JSONArray::remove(jint arg0)
	{
	...
	QAndroidJniObject JSONArray::get(jint arg0)
	{
		return __thiz.callObjectMethod(
			"get",
			"(I)Ljava/lang/Object;",
	...
	QAndroidJniObject JSONArray::toString()
	{
		return __thiz.callObjectMethod(
			"toString",
			"()Ljava/lang/String;");
	}
	QAndroidJniObject JSONArray::toString(jint arg0)
	{
		return __thiz.callObjectMethod(
			"toString",
			"(I)Ljava/lang/String;",
	...
	QAndroidJniObject JSONArray::join(jstring arg0)
	{
		return __thiz.callObjectMethod(
			"join",
	...
	QAndroidJniObject JSONArray::getString(jint arg0)
	{
		return __thiz.callObjectMethod(
			"getString",
			"(I)Ljava/lang/String;",
	...
	QAndroidJniObject JSONArray::opt(jint arg0)
	{
		return __thiz.callObjectMethod(
			"opt",
			"(I)Ljava/lang/Object;",
	...
	QAndroidJniObject JSONArray::optString(jint arg0)
	{
		return __thiz.callObjectMethod(
			"optString",
			"(I)Ljava/lang/String;",
	...
	QAndroidJniObject JSONArray::optString(jint arg0, jstring arg1)
	{
		return __thiz.callObjectMethod(
			"optString",
