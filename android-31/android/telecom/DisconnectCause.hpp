...
namespace android::telecom
{
	...
	inline JString DisconnectCause::REASON_EMERGENCY_CALL_PLACED()
	{
		return getStaticObjectField(
			"android.telecom.DisconnectCause",
	...
	inline JString DisconnectCause::REASON_EMULATING_SINGLE_CALL()
	{
		return getStaticObjectField(
			"android.telecom.DisconnectCause",
	...
	inline JString DisconnectCause::REASON_IMS_ACCESS_BLOCKED()
	{
		return getStaticObjectField(
			"android.telecom.DisconnectCause",
	...
	inline JString DisconnectCause::REASON_WIFI_ON_BUT_WFC_OFF()
	{
		return getStaticObjectField(
			"android.telecom.DisconnectCause",
