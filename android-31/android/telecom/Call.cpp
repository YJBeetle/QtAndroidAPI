...
namespace android::telecom
{
	...
	jstring Call::EVENT_CLEAR_DIAGNOSTIC_MESSAGE()
	{
		return getStaticObjectField(
			"android.telecom.Call",
	...
	jstring Call::EVENT_DISPLAY_DIAGNOSTIC_MESSAGE()
	{
		return getStaticObjectField(
			"android.telecom.Call",
	...
	jstring Call::EXTRA_DIAGNOSTIC_MESSAGE()
	{
		return getStaticObjectField(
			"android.telecom.Call",
	...
	jstring Call::EXTRA_DIAGNOSTIC_MESSAGE_ID()
	{
		return getStaticObjectField(
			"android.telecom.Call",
	...
	// Methods
	void Call::addConferenceParticipants(__JniBaseClass arg0)
	{
		callMethod<void>(
