...
{
	// Fields
	jint Call_Details::CAPABILITY_ADD_PARTICIPANT()
	{
	...
	jint Call_Details::PROPERTY_ASSISTED_DIALING()
	{
		return getStaticField<jint>(
			"android.telecom.Call$Details",
	...
	jint Call_Details::PROPERTY_CROSS_SIM()
	{
		return getStaticField<jint>(
			"android.telecom.Call$Details",
			"PROPERTY_CROSS_SIM"
	...
	jint Call_Details::PROPERTY_IS_ADHOC_CONFERENCE()
	{
		return getStaticField<jint>(
			"android.telecom.Call$Details",
	...
	jint Call_Details::getCallerNumberVerificationStatus() const
	{
		return callMethod<jint>(
	...
	JString Call_Details::getContactDisplayName() const
	{
		return callObjectMethod(
	...
	jint Call_Details::getState() const
	{
		return callMethod<jint>(
			"getState",
			"()I"
