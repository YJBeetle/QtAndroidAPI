...
#include "./provider/ProviderProperties.hpp"
...
{
	// Fields
	JString LocationManager::ACTION_GNSS_CAPABILITIES_CHANGED()
	{
	...
	JString LocationManager::EXTRA_GNSS_CAPABILITIES()
	{
		return getStaticObjectField(
			"android.location.LocationManager",
	...
	JString LocationManager::FUSED_PROVIDER()
	{
		return getStaticObjectField(
			"android.location.LocationManager",
			"FUSED_PROVIDER",
	...
	JString LocationManager::KEY_FLUSH_COMPLETE()
	{
		return getStaticObjectField(
			"android.location.LocationManager",
			"KEY_FLUSH_COMPLETE",
	...
	JString LocationManager::KEY_LOCATIONS()
	{
		return getStaticObjectField(
			"android.location.LocationManager",
			"KEY_LOCATIONS",
	...
	void LocationManager::addTestProvider(JString arg0, android::location::provider::ProviderProperties arg1) const
	{
		callMethod<void>(
			"addTestProvider",
	...
	void LocationManager::addTestProvider(JString arg0, android::location::provider::ProviderProperties arg1, JObject arg2) const
	{
		callMethod<void>(
			"addTestProvider",
	...
	void LocationManager::getCurrentLocation(JString arg0, android::location::LocationRequest arg1, android::os::CancellationSignal arg2, JObject arg3, JObject arg4) const
	{
		callMethod<void>(
			"getCurrentLocation",
	...
	JObject LocationManager::getGnssAntennaInfos() const
	{
		return callObjectMethod(
			"getGnssAntennaInfos",
			"()Ljava/util/List;"
	...
	android::location::provider::ProviderProperties LocationManager::getProviderProperties(JString arg0) const
	{
		return callObjectMethod(
	...
	jboolean LocationManager::hasProvider(JString arg0) const
	{
		return callMethod<jboolean>(
			"hasProvider",
			"(Ljava/lang/String;)Z",
	...
	jboolean LocationManager::registerGnssMeasurementsCallback(android::location::GnssMeasurementRequest arg0, JObject arg1, android::location::GnssMeasurementsEvent_Callback arg2) const
	{
		return callMethod<jboolean>(
			"registerGnssMeasurementsCallback",
	...
	void LocationManager::requestFlush(JString arg0, android::app::PendingIntent arg1, jint arg2) const
	{
		callMethod<void>(
			"requestFlush",
	...
	void LocationManager::requestFlush(JString arg0, JObject arg1, jint arg2) const
	{
		callMethod<void>(
			"requestFlush",
	...
	void LocationManager::requestLocationUpdates(JString arg0, android::location::LocationRequest arg1, android::app::PendingIntent arg2) const
	{
		callMethod<void>(
	...
	void LocationManager::requestLocationUpdates(JString arg0, android::location::LocationRequest arg1, JObject arg2, JObject arg3) const
	{
		callMethod<void>(
			"requestLocationUpdates",
