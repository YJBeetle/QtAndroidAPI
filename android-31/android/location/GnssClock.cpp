...
namespace android::location
{
	...
	jdouble GnssClock::getReferenceCarrierFrequencyHzForIsb() const
	{
		return callMethod<jdouble>(
	...
	JString GnssClock::getReferenceCodeTypeForIsb() const
	{
	...
	jint GnssClock::getReferenceConstellationTypeForIsb() const
	{
		return callMethod<jint>(
	...
	jboolean GnssClock::hasReferenceCarrierFrequencyHzForIsb() const
	{
		return callMethod<jboolean>(
	...
	jboolean GnssClock::hasReferenceCodeTypeForIsb() const
	{
		return callMethod<jboolean>(
	...
	jboolean GnssClock::hasReferenceConstellationTypeForIsb() const
	{
		return callMethod<jboolean>(
