...
namespace android::location
{
	...
	jdouble GnssClock::getReferenceCarrierFrequencyHzForIsb()
	{
		return callMethod<jdouble>(
	...
	jboolean GnssClock::hasReferenceCarrierFrequencyHzForIsb()
	{
		return callMethod<jboolean>(
	...
	jboolean GnssClock::hasReferenceCodeTypeForIsb()
	{
		return callMethod<jboolean>(
	...
	jboolean GnssClock::hasReferenceConstellationTypeForIsb()
	{
		return callMethod<jboolean>(
