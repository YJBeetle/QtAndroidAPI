...
namespace android::location
{
	...
	public:
		...
		GnssMeasurement(QJniObject obj) : JObject(obj) {}
		...
		jdouble getBasebandCn0DbHz() const;
		...
		jdouble getFullInterSignalBiasNanos() const;
		jdouble getFullInterSignalBiasUncertaintyNanos() const;
		...
		jdouble getSatelliteInterSignalBiasNanos() const;
		jdouble getSatelliteInterSignalBiasUncertaintyNanos() const;
		jdouble getSnrInDb() const;
		jint getState() const;
		jint getSvid() const;
		jdouble getTimeOffsetNanos() const;
		jboolean hasAutomaticGainControlLevelDb() const;
		jboolean hasBasebandCn0DbHz() const;
		...
		jboolean hasFullInterSignalBiasNanos() const;
		jboolean hasFullInterSignalBiasUncertaintyNanos() const;
		jboolean hasSatelliteInterSignalBiasNanos() const;
		jboolean hasSatelliteInterSignalBiasUncertaintyNanos() const;
