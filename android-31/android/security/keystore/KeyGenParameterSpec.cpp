...
namespace android::security::keystore
{
	...
	JString KeyGenParameterSpec::getAttestKeyAlias() const
	{
		return callObjectMethod(
			"getAttestKeyAlias",
			"()Ljava/lang/String;"
	...
	jint KeyGenParameterSpec::getMaxUsageCount() const
	{
		return callMethod<jint>(
			"getMaxUsageCount",
			"()I"
	...
	jboolean KeyGenParameterSpec::isDevicePropertiesAttestationIncluded() const
	{
