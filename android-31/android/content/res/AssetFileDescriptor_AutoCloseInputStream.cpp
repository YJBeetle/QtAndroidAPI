...
namespace android::content::res
{
	...
	// QJniObject forward
	AssetFileDescriptor_AutoCloseInputStream::AssetFileDescriptor_AutoCloseInputStream(QJniObject obj) : android::os::ParcelFileDescriptor_AutoCloseInputStream(obj) {}
