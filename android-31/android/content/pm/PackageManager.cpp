...
namespace android::content::pm
{
	...
	JObject PackageManager::TRUST_ALL()
	{
		return getStaticObjectField(
			"android.content.pm.PackageManager",
			"TRUST_ALL",
	...
	JObject PackageManager::TRUST_NONE()
	{
		return getStaticObjectField(
			"android.content.pm.PackageManager",
			"TRUST_NONE",
	...
	PackageManager::PackageManager(QAndroidJniObject obj) : JObject(obj) {}
	...
	void PackageManager::getGroupOfPlatformPermission(JString arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
	...
	void PackageManager::getPlatformPermissionsForGroup(JString arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
	...
	android::content::pm::PackageManager_Property PackageManager::getProperty(JString arg0, android::content::ComponentName arg1) const
	{
		return callObjectMethod(
			"getProperty",
	...
	android::content::pm::PackageManager_Property PackageManager::getProperty(JString arg0, JString arg1) const
	{
		return callObjectMethod(
			"getProperty",
	...
	android::content::res::Resources PackageManager::getResourcesForApplication(android::content::pm::ApplicationInfo arg0, android::content::res::Configuration arg1) const
	{
		return callObjectMethod(
			"getResourcesForApplication",
	...
	jint PackageManager::getTargetSdkVersion(JString arg0) const
	{
		return callMethod<jint>(
			"getTargetSdkVersion",
			"(Ljava/lang/String;)I",
	...
	JObject PackageManager::queryActivityProperty(JString arg0) const
	{
		return callObjectMethod(
	...
	JObject PackageManager::queryApplicationProperty(JString arg0) const
	{
		return callObjectMethod(
	...
	JObject PackageManager::queryProviderProperty(JString arg0) const
	{
		return callObjectMethod(
	...
	JObject PackageManager::queryReceiverProperty(JString arg0) const
	{
		return callObjectMethod(
	...
	JObject PackageManager::queryServiceProperty(JString arg0) const
	{
		return callObjectMethod(
	...
	void PackageManager::requestChecksums(JString arg0, jboolean arg1, jint arg2, JObject arg3, JObject arg4) const
	{
		callMethod<void>(
			"requestChecksums",
