...
namespace android::content::pm
{
	...
	public:
		...
		jstring getBackgroundPermissionOptionLabel();
		...
		jint getTargetSdkVersion(jstring arg0);
		...
		jboolean isAutoRevokeWhitelisted();
		jboolean isAutoRevokeWhitelisted(jstring arg0);
		jboolean isDefaultApplicationIcon(android::graphics::drawable::Drawable arg0);
