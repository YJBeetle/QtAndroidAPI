...
namespace android::content
{
	...
	jboolean Context::bindServiceAsUser(android::content::Intent arg0, __JniBaseClass arg1, jint arg2, android::os::UserHandle arg3)
	{
		return callMethod<jboolean>(
			"bindServiceAsUser",
	...
	jintArray Context::checkCallingOrSelfUriPermissions(__JniBaseClass arg0, jint arg1)
	{
	...
	jintArray Context::checkCallingUriPermissions(__JniBaseClass arg0, jint arg1)
	{
		return callObjectMethod(
	...
	jintArray Context::checkUriPermissions(__JniBaseClass arg0, jint arg1, jint arg2, jint arg3)
	{
		return callObjectMethod(
			"checkUriPermissions",
	...
	android::content::Context Context::createContext(android::content::ContextParams arg0)
	{
		return callObjectMethod(
			"createContext",
	...
	android::content::Context Context::createWindowContext(android::view::Display arg0, jint arg1, android::os::Bundle arg2)
	{
		return callObjectMethod(
			"createWindowContext",
	...
	android::content::AttributionSource Context::getAttributionSource()
	{
		return callObjectMethod(
	...
	android::content::ContextParams Context::getParams()
	{
		return callObjectMethod(
			"getParams",
	...
	void Context::sendStickyBroadcast(android::content::Intent arg0, android::os::Bundle arg1)
	{
		callMethod<void>(
			"sendStickyBroadcast",
