...
namespace android::content
{
	...
	public:
		...
		static jstring ACTION_MANAGE_UNUSED_APPS();
		...
		static jstring ACTION_PROFILE_ACCESSIBLE();
		static jstring ACTION_PROFILE_INACCESSIBLE();
		...
		static jstring ACTION_VIEW_PERMISSION_USAGE_FOR_PERIOD();
		...
		static jstring EXTRA_ATTRIBUTION_TAGS();
		...
		static jstring EXTRA_PERMISSION_GROUP_NAME();
		...
		static jstring EXTRA_START_TIME();
		...
		static jstring EXTRA_USER_INITIATED();
		...
		java::util::ArrayList getCharSequenceArrayListExtra(jstring arg0);
		...
		java::util::ArrayList getIntegerArrayListExtra(jstring arg0);
		...
		java::util::ArrayList getStringArrayListExtra(jstring arg0);
		...
		android::content::Intent putCharSequenceArrayListExtra(jstring arg0, java::util::ArrayList arg1);
		android::content::Intent putExtra(jstring arg0, jbyteArray arg1);
		android::content::Intent putExtra(jstring arg0, jcharArray arg1);
		android::content::Intent putExtra(jstring arg0, jdoubleArray arg1);
		android::content::Intent putExtra(jstring arg0, jfloatArray arg1);
		android::content::Intent putExtra(jstring arg0, jintArray arg1);
		android::content::Intent putExtra(jstring arg0, jlongArray arg1);
		android::content::Intent putExtra(jstring arg0, jarray arg1);
		...
		android::content::Intent putExtra(jstring arg0, jdouble arg1);
		android::content::Intent putExtra(jstring arg0, jfloat arg1);
		android::content::Intent putExtra(jstring arg0, jint arg1);
		android::content::Intent putExtra(jstring arg0, jstring arg1);
		android::content::Intent putExtra(jstring arg0, jlong arg1);
		android::content::Intent putExtra(jstring arg0, jshort arg1);
		android::content::Intent putExtras(android::content::Intent arg0);
		android::content::Intent putExtras(android::os::Bundle arg0);
		android::content::Intent putIntegerArrayListExtra(jstring arg0, java::util::ArrayList arg1);
		android::content::Intent putParcelableArrayListExtra(jstring arg0, java::util::ArrayList arg1);
		android::content::Intent putStringArrayListExtra(jstring arg0, java::util::ArrayList arg1);
		void readFromParcel(android::os::Parcel arg0);
		void removeCategory(jstring arg0);
		void removeExtra(jstring arg0);
		void removeFlags(jint arg0);
		android::content::Intent replaceExtras(android::content::Intent arg0);
		android::content::Intent replaceExtras(android::os::Bundle arg0);
		android::content::ComponentName resolveActivity(android::content::pm::PackageManager arg0);
		android::content::pm::ActivityInfo resolveActivityInfo(android::content::pm::PackageManager arg0, jint arg1);
		...
		android::content::Intent setAction(jstring arg0);
		android::content::Intent setClass(android::content::Context arg0, jclass arg1);
		android::content::Intent setClassName(android::content::Context arg0, jstring arg1);
		android::content::Intent setClassName(jstring arg0, jstring arg1);
		void setClipData(android::content::ClipData arg0);
		android::content::Intent setComponent(android::content::ComponentName arg0);
		android::content::Intent setData(android::net::Uri arg0);
		android::content::Intent setDataAndNormalize(android::net::Uri arg0);
		android::content::Intent setDataAndType(android::net::Uri arg0, jstring arg1);
		android::content::Intent setDataAndTypeAndNormalize(android::net::Uri arg0, jstring arg1);
		void setExtrasClassLoader(java::lang::ClassLoader arg0);
		android::content::Intent setFlags(jint arg0);
		android::content::Intent setIdentifier(jstring arg0);
		android::content::Intent setPackage(jstring arg0);
		void setSelector(android::content::Intent arg0);
		void setSourceBounds(android::graphics::Rect arg0);
		android::content::Intent setType(jstring arg0);
		android::content::Intent setTypeAndNormalize(jstring arg0);
		jstring toString();
		jstring toURI();
