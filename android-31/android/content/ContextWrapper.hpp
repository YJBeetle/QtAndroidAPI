...
namespace android::content
{
	...
	public:
		...
		jboolean bindServiceAsUser(android::content::Intent arg0, JObject arg1, jint arg2, android::os::UserHandle arg3);
		jint checkCallingOrSelfPermission(JString arg0);
		jint checkCallingOrSelfUriPermission(android::net::Uri arg0, jint arg1);
		JIntArray checkCallingOrSelfUriPermissions(JObject arg0, jint arg1);
		jint checkCallingPermission(JString arg0);
		jint checkCallingUriPermission(android::net::Uri arg0, jint arg1);
		JIntArray checkCallingUriPermissions(JObject arg0, jint arg1);
		...
		JIntArray checkUriPermissions(JObject arg0, jint arg1, jint arg2, jint arg3);
		void clearWallpaper();
