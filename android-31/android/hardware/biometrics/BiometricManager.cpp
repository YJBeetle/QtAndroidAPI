...
namespace android::hardware::biometrics
{
	...
	// QJniObject forward
	BiometricManager::BiometricManager(QJniObject obj) : __JniBaseClass(obj) {}
	...
	android::hardware::biometrics::BiometricManager_Strings BiometricManager::getStrings(jint arg0)
	{
