...
namespace android::hardware::camera2
{
	...
	CameraManager::CameraManager(QAndroidJniObject obj) : JObject(obj) {}
	...
	android::hardware::camera2::CameraExtensionCharacteristics CameraManager::getCameraExtensionCharacteristics(JString arg0) const
	{
		return callObjectMethod(
	...
	JObject CameraManager::getConcurrentCameraIds() const
	{
		return callObjectMethod(
	...
	jboolean CameraManager::isConcurrentSessionConfigurationSupported(JObject arg0) const
	{
