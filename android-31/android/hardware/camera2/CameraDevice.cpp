...
#include "./params/ExtensionSessionConfiguration.hpp"
...
{
	// Fields
	jint CameraDevice::AUDIO_RESTRICTION_NONE()
	{
	...
	jint CameraDevice::AUDIO_RESTRICTION_VIBRATION()
	{
		return getStaticField<jint>(
			"android.hardware.camera2.CameraDevice",
	...
	jint CameraDevice::AUDIO_RESTRICTION_VIBRATION_SOUND()
	{
		return getStaticField<jint>(
			"android.hardware.camera2.CameraDevice",
	...
	// QJniObject forward
	CameraDevice::CameraDevice(QJniObject obj) : __JniBaseClass(obj) {}
	...
	void CameraDevice::createExtensionSession(android::hardware::camera2::params::ExtensionSessionConfiguration arg0)
	{
		callMethod<void>(
