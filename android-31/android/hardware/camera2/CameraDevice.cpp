...
namespace android::hardware::camera2
{
	...
	// QJniObject forward
	CameraDevice::CameraDevice(QJniObject obj) : JObject(obj) {}
	...
	void CameraDevice::createExtensionSession(android::hardware::camera2::params::ExtensionSessionConfiguration arg0) const
	{
		callMethod<void>(
