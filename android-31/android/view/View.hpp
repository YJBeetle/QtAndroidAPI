...
namespace android::view
{
	...
	public:
		...
		void dispatchScrollCaptureSearch(android::graphics::Rect arg0, android::graphics::Point arg1, __JniBaseClass arg2);
		...
		void generateDisplayHash(jstring arg0, android::graphics::Rect arg1, __JniBaseClass arg2, __JniBaseClass arg3);
		...
		android::graphics::BlendMode getBackgroundTintBlendMode();
		...
		android::graphics::BlendMode getForegroundTintBlendMode();
		...
		android::graphics::drawable::Drawable getHorizontalScrollbarThumbDrawable();
		android::graphics::drawable::Drawable getHorizontalScrollbarTrackDrawable();
		jint getId();
		jint getImportantForAccessibility();
		jint getImportantForAutofill();
		jint getImportantForContentCapture();
		...
		android::graphics::drawable::Drawable getVerticalScrollbarThumbDrawable();
		android::graphics::drawable::Drawable getVerticalScrollbarTrackDrawable();
		jint getVerticalScrollbarWidth();
		android::view::translation::ViewTranslationResponse getViewTranslationResponse();
		android::view::ViewTreeObserver getViewTreeObserver();
		jint getVisibility();
		jint getWidth();
		android::view::WindowId getWindowId();
		__JniBaseClass getWindowInsetsController();
		...
		jboolean hasOnLongClickListeners();
		...
		jboolean isImportantForContentCapture();
		...
		jboolean isSelected();
		jboolean isShowingLayoutBounds();
		jboolean isShown();
		...
		void onScrollCaptureSearch(android::graphics::Rect arg0, android::graphics::Point arg1, __JniBaseClass arg2);
		...
		void onVirtualViewTranslationResponses(android::util::LongSparseArray arg0);
		...
		android::view::ContentInfo performReceiveContent(android::view::ContentInfo arg0);
		...
		void requestUnbufferedDispatch(jint arg0);
		...
		void setAllowClickWhenDisabled(jboolean arg0);
		...
		void setBackgroundTintBlendMode(android::graphics::BlendMode arg0);
		...
		void setForegroundTintBlendMode(android::graphics::BlendMode arg0);
		...
		void setHorizontalScrollbarThumbDrawable(android::graphics::drawable::Drawable arg0);
		void setHorizontalScrollbarTrackDrawable(android::graphics::drawable::Drawable arg0);
		...
		void setImportantForContentCapture(jint arg0);
		...
		void setOnReceiveContentListener(jarray arg0, __JniBaseClass arg1);
		...
		void setRenderEffect(android::graphics::RenderEffect arg0);
		...
		void setScrollCaptureCallback(__JniBaseClass arg0);
		void setScrollCaptureHint(jint arg0);
		...
		void setVerticalScrollbarThumbDrawable(android::graphics::drawable::Drawable arg0);
		void setVerticalScrollbarTrackDrawable(android::graphics::drawable::Drawable arg0);
		void setViewTranslationCallback(__JniBaseClass arg0);
