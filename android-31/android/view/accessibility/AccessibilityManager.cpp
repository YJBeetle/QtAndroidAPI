...
namespace android::view::accessibility
{
	...
	// QJniObject forward
	AccessibilityManager::AccessibilityManager(QJniObject obj) : JObject(obj) {}
	...
	jint AccessibilityManager::getAccessibilityFocusColor()
	{
	...
	jint AccessibilityManager::getAccessibilityFocusStrokeWidth()
	{
		return callMethod<jint>(
