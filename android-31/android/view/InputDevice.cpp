...
#include "../hardware/BatteryState.hpp"
#include "../hardware/SensorManager.hpp"
#include "../hardware/lights/LightsManager.hpp"
#include "../os/Parcel.hpp"
#include "../os/Vibrator.hpp"
#include "../os/VibratorManager.hpp"
...
namespace android::view
{
	...
	jint InputDevice::SOURCE_SENSOR()
	{
		return getStaticField<jint>(
			"android.view.InputDevice",
			"SOURCE_SENSOR"
	...
	// QJniObject forward
	InputDevice::InputDevice(QJniObject obj) : JObject(obj) {}
	...
	android::hardware::BatteryState InputDevice::getBatteryState() const
	{
	...
	android::hardware::lights::LightsManager InputDevice::getLightsManager() const
	{
		return callObjectMethod(
			"getLightsManager",
	...
	android::hardware::SensorManager InputDevice::getSensorManager() const
	{
		return callObjectMethod(
			"getSensorManager",
	...
	android::os::VibratorManager InputDevice::getVibratorManager() const
	{
		return callObjectMethod(
			"getVibratorManager",
