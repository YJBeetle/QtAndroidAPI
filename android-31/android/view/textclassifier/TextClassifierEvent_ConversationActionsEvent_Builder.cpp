...
namespace android::view::textclassifier
{
	...
	// QJniObject forward
	TextClassifierEvent_ConversationActionsEvent_Builder::TextClassifierEvent_ConversationActionsEvent_Builder(QJniObject obj) : android::view::textclassifier::TextClassifierEvent_Builder(obj) {}
