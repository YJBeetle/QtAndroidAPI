...
namespace android::view::inputmethod
{
	...
	inline android::view::inputmethod::InlineSuggestionsRequest_Builder InlineSuggestionsRequest_Builder::setInlineTooltipPresentationSpec(android::widget::inline_::InlinePresentationSpec arg0) const
	{
		return callObjectMethod(
