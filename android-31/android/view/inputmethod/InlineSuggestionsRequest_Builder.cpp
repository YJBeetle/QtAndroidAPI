...
namespace android::view::inputmethod
{
	...
	InlineSuggestionsRequest_Builder::InlineSuggestionsRequest_Builder(QAndroidJniObject obj) : JObject(obj) {}
	...
	android::view::inputmethod::InlineSuggestionsRequest_Builder InlineSuggestionsRequest_Builder::setInlineTooltipPresentationSpec(android::widget::inline::InlinePresentationSpec arg0)
	{
		return callObjectMethod(
