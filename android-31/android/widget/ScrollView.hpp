...
namespace android::widget
{
	...
	inline jint ScrollView::getBottomEdgeEffectColor() const
	{
	...
	inline jint ScrollView::getTopEdgeEffectColor() const
	{
		return callMethod<jint>(
	...
	inline void ScrollView::scrollToDescendant(android::view::View arg0) const
	{
		callMethod<void>(
			"scrollToDescendant",
			"(Landroid/view/View;)V",
	...
	inline void ScrollView::setBottomEdgeEffectColor(jint arg0) const
	{
		callMethod<void>(
	...
	inline void ScrollView::setEdgeEffectColor(jint arg0) const
	{
		callMethod<void>(
			"setEdgeEffectColor",
			"(I)V",
	...
	inline void ScrollView::setTopEdgeEffectColor(jint arg0) const
	{
		callMethod<void>(
