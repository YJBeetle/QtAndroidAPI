...
namespace android::widget
{
	...
	inline void Toast::addCallback(android::widget::Toast_Callback arg0) const
	{
		callMethod<void>(
			"addCallback",
			"(Landroid/widget/Toast$Callback;)V",
			arg0.object()
		);
	}
	...
	inline void Toast::removeCallback(android::widget::Toast_Callback arg0) const
	{
		callMethod<void>(
			"removeCallback",
			"(Landroid/widget/Toast$Callback;)V",
