...
namespace android::widget
{
	...
	public:
		...
		Switch(QAndroidJniObject obj) : android::widget::CompoundButton(obj) {}
		...
		void setThumbIcon(android::graphics::drawable::Icon arg0) const;
		...
		void setTrackIcon(android::graphics::drawable::Icon arg0) const;
