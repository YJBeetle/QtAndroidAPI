...
namespace android::provider
{
	...
	inline jint Telephony_Sms_Intents::RESULT_SMS_DATABASE_ERROR()
	{
	...
	inline jint Telephony_Sms_Intents::RESULT_SMS_DISPATCH_FAILURE()
	{
		return getStaticField<jint>(
			"android.provider.Telephony$Sms$Intents",
	...
	inline jint Telephony_Sms_Intents::RESULT_SMS_INVALID_URI()
	{
		return getStaticField<jint>(
			"android.provider.Telephony$Sms$Intents",
	...
	inline jint Telephony_Sms_Intents::RESULT_SMS_NULL_MESSAGE()
	{
		return getStaticField<jint>(
			"android.provider.Telephony$Sms$Intents",
	...
	inline jint Telephony_Sms_Intents::RESULT_SMS_NULL_PDU()
	{
		return getStaticField<jint>(
			"android.provider.Telephony$Sms$Intents",
			"RESULT_SMS_NULL_PDU"
	...
	inline jint Telephony_Sms_Intents::RESULT_SMS_RECEIVED_WHILE_ENCRYPTED()
	{
		return getStaticField<jint>(
			"android.provider.Telephony$Sms$Intents",
