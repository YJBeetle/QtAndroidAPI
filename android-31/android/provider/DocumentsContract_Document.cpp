...
namespace android::provider
{
	...
	jint DocumentsContract_Document::FLAG_DIR_BLOCKS_OPEN_DOCUMENT_TREE()
	{
	...
	// QJniObject forward
	DocumentsContract_Document::DocumentsContract_Document(QJniObject obj) : __JniBaseClass(obj) {}
