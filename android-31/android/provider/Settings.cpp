...
namespace android::provider
{
	...
	JString Settings::ACTION_APP_OPEN_BY_DEFAULT_SETTINGS()
	{
		return getStaticObjectField(
			"android.provider.Settings",
	...
	JString Settings::ACTION_AUTO_ROTATE_SETTINGS()
	{
		return getStaticObjectField(
			"android.provider.Settings",
	...
	JString Settings::ACTION_MANAGE_ALL_SIM_PROFILES_SETTINGS()
	{
		return getStaticObjectField(
			"android.provider.Settings",
	...
	JString Settings::ACTION_REQUEST_MANAGE_MEDIA()
	{
		return getStaticObjectField(
			"android.provider.Settings",
	...
	JString Settings::ACTION_REQUEST_SCHEDULE_EXACT_ALARM()
	{
		return getStaticObjectField(
			"android.provider.Settings",
	...
	JString Settings::EXTRA_CHANNEL_FILTER_LIST()
	{
		return getStaticObjectField(
			"android.provider.Settings",
	...
	// QJniObject forward
	Settings::Settings(QJniObject obj) : JObject(obj) {}
