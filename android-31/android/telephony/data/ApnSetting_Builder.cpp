...
namespace android::telephony::data
{
	...
	ApnSetting_Builder::ApnSetting_Builder(QAndroidJniObject obj) : JObject(obj) {}
	...
	android::telephony::data::ApnSetting_Builder ApnSetting_Builder::setCarrierId(jint arg0) const
	{
		return callObjectMethod(
			"setCarrierId",
			"(I)Landroid/telephony/data/ApnSetting$Builder;",
	...
	android::telephony::data::ApnSetting_Builder ApnSetting_Builder::setMmsProxyAddress(JString arg0) const
	{
		return callObjectMethod(
			"setMmsProxyAddress",
			"(Ljava/lang/String;)Landroid/telephony/data/ApnSetting$Builder;",
	...
	android::telephony::data::ApnSetting_Builder ApnSetting_Builder::setProxyAddress(JString arg0) const
	{
		return callObjectMethod(
			"setProxyAddress",
			"(Ljava/lang/String;)Landroid/telephony/data/ApnSetting$Builder;",
