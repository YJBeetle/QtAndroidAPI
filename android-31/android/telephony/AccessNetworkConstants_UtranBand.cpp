#include "./AccessNetworkConstants_UtranBand.hpp"
...
namespace android::telephony
{
	...
	jint AccessNetworkConstants_UtranBand::BAND_A()
	{
		return getStaticField<jint>(
			"android.telephony.AccessNetworkConstants$UtranBand",
			"BAND_A"
	...
	jint AccessNetworkConstants_UtranBand::BAND_B()
	{
		return getStaticField<jint>(
			"android.telephony.AccessNetworkConstants$UtranBand",
			"BAND_B"
	...
	jint AccessNetworkConstants_UtranBand::BAND_C()
	{
		return getStaticField<jint>(
			"android.telephony.AccessNetworkConstants$UtranBand",
			"BAND_C"
	...
	jint AccessNetworkConstants_UtranBand::BAND_D()
	{
		return getStaticField<jint>(
			"android.telephony.AccessNetworkConstants$UtranBand",
			"BAND_D"
	...
	jint AccessNetworkConstants_UtranBand::BAND_E()
	{
		return getStaticField<jint>(
			"android.telephony.AccessNetworkConstants$UtranBand",
			"BAND_E"
	...
	jint AccessNetworkConstants_UtranBand::BAND_F()
	{
		return getStaticField<jint>(
			"android.telephony.AccessNetworkConstants$UtranBand",
			"BAND_F"
	...
	AccessNetworkConstants_UtranBand::AccessNetworkConstants_UtranBand(QAndroidJniObject obj) : __JniBaseClass(obj) {}
