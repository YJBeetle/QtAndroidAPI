...
{
	// Fields
	__JniBaseClass CellIdentityGsm::CREATOR()
	{
	...
	// QJniObject forward
	CellIdentityGsm::CellIdentityGsm(QJniObject obj) : android::telephony::CellIdentity(obj) {}
	...
	__JniBaseClass CellIdentityGsm::getAdditionalPlmns()
	{
