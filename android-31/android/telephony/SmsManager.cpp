...
namespace android::telephony
{
	...
	android::telephony::SmsManager SmsManager::createForSubscriptionId(jint arg0) const
	{
		return callObjectMethod(
	...
	void SmsManager::downloadMultimediaMessage(android::content::Context arg0, JString arg1, android::net::Uri arg2, android::os::Bundle arg3, android::app::PendingIntent arg4, jlong arg5) const
	{
		callMethod<void>(
			"downloadMultimediaMessage",
	...
	jint SmsManager::getSmsCapacityOnIcc() const
	{
	...
	void SmsManager::sendMultimediaMessage(android::content::Context arg0, android::net::Uri arg1, JString arg2, android::os::Bundle arg3, android::app::PendingIntent arg4, jlong arg5) const
	{
		callMethod<void>(
			"sendMultimediaMessage",
