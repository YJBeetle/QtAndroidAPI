...
namespace android::telephony
{
	...
	jint AccessNetworkConstants_AccessNetworkType::NGRAN()
	{
		return getStaticField<jint>(
			"android.telephony.AccessNetworkConstants$AccessNetworkType",
			"NGRAN"
	...
	// QJniObject forward
	AccessNetworkConstants_AccessNetworkType::AccessNetworkConstants_AccessNetworkType(QJniObject obj) : JObject(obj) {}
