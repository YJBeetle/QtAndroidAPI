...
namespace android::telephony
{
	...
	JObject CellIdentityLte::getAdditionalPlmns() const
	{
	...
	JIntArray CellIdentityLte::getBands() const
	{
		return callObjectMethod(
			"getBands",
			"()[I"
	...
	android::telephony::ClosedSubscriberGroupInfo CellIdentityLte::getClosedSubscriberGroupInfo() const
	{
		return callObjectMethod(
