...
namespace android::media
{
	...
	public:
		...
		static jint STREAM_TYPE_EXIF_DATA_ONLY();
		static jint STREAM_TYPE_FULL_IMAGE_DATA();
		...
		static JString TAG_OFFSET_TIME();
		static JString TAG_OFFSET_TIME_DIGITIZED();
		static JString TAG_OFFSET_TIME_ORIGINAL();
		...
		static JString TAG_THUMBNAIL_ORIENTATION();
		...
		ExifInterface(QAndroidJniObject obj) : JObject(obj) {}
		...
		ExifInterface(java::io::InputStream arg0, jint arg1);
		
		// Methods
		static jboolean isSupportedMimeType(JString arg0);
		...
		jlong getDateTime() const;
		jlong getDateTimeDigitized() const;
		jlong getDateTimeOriginal() const;
		jlong getGpsDateTime() const;
