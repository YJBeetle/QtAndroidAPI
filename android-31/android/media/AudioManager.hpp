...
namespace android::media
{
	...
	public:
		...
		jboolean isSurroundFormatEnabled(jint arg0);
		...
		jboolean setCommunicationDevice(android::media::AudioDeviceInfo arg0);
		jboolean setEncodedSurroundMode(jint arg0);
		...
		jboolean setSurroundFormatEnabled(jint arg0, jboolean arg1);
