...
namespace android::media::tv
{
	...
	jstring TvContract_Channels::COLUMN_BROADCAST_GENRE()
	{
		return getStaticObjectField(
			"android.media.tv.TvContract$Channels",
	...
	jstring TvContract_Channels::COLUMN_CHANNEL_LIST_ID()
	{
		return getStaticObjectField(
			"android.media.tv.TvContract$Channels",
	...
	jstring TvContract_Channels::COLUMN_GLOBAL_CONTENT_ID()
	{
		return getStaticObjectField(
			"android.media.tv.TvContract$Channels",
	...
	jstring TvContract_Channels::COLUMN_REMOTE_CONTROL_KEY_PRESET_NUMBER()
	{
		return getStaticObjectField(
			"android.media.tv.TvContract$Channels",
	...
	jstring TvContract_Channels::COLUMN_SCRAMBLED()
	{
		return getStaticObjectField(
			"android.media.tv.TvContract$Channels",
			"COLUMN_SCRAMBLED",
	...
	jstring TvContract_Channels::COLUMN_VIDEO_RESOLUTION()
	{
		return getStaticObjectField(
			"android.media.tv.TvContract$Channels",
	...
	jstring TvContract_Channels::TYPE_ATSC3_T()
	{
		return getStaticObjectField(
			"android.media.tv.TvContract$Channels",
			"TYPE_ATSC3_T",
	...
	// QJniObject forward
	TvContract_Channels::TvContract_Channels(QJniObject obj) : JObject(obj) {}
