...
namespace android::media::tv
{
	...
	JString TvTrackInfo::getEncoding() const
	{
		return callObjectMethod(
			"getEncoding",
			"()Ljava/lang/String;"
	...
	jboolean TvTrackInfo::isAudioDescription() const
	{
		return callMethod<jboolean>(
			"isAudioDescription",
			"()Z"
	...
	jboolean TvTrackInfo::isEncrypted() const
	{
		return callMethod<jboolean>(
			"isEncrypted",
			"()Z"
	...
	jboolean TvTrackInfo::isHardOfHearing() const
	{
		return callMethod<jboolean>(
			"isHardOfHearing",
			"()Z"
	...
	jboolean TvTrackInfo::isSpokenSubtitle() const
	{
		return callMethod<jboolean>(
			"isSpokenSubtitle",
			"()Z"
