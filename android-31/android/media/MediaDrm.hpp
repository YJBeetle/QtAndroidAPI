...
namespace android::media
{
	...
	public:
		...
		android::media::MediaDrm_PlaybackComponent getPlaybackComponent(JByteArray arg0) const;
		...
		jboolean requiresSecureDecoder(JString arg0) const;
		jboolean requiresSecureDecoder(JString arg0, jint arg1) const;
