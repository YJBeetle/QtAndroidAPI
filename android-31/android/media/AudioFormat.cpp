...
namespace android::media
{
	...
	jint AudioFormat::ENCODING_DTS_UHD()
	{
		return getStaticField<jint>(
			"android.media.AudioFormat",
			"ENCODING_DTS_UHD"
	...
	jint AudioFormat::ENCODING_MPEGH_BL_L3()
	{
		return getStaticField<jint>(
			"android.media.AudioFormat",
	...
	jint AudioFormat::ENCODING_MPEGH_BL_L4()
	{
		return getStaticField<jint>(
			"android.media.AudioFormat",
	...
	jint AudioFormat::ENCODING_MPEGH_LC_L3()
	{
		return getStaticField<jint>(
			"android.media.AudioFormat",
	...
	jint AudioFormat::ENCODING_MPEGH_LC_L4()
	{
		return getStaticField<jint>(
			"android.media.AudioFormat",
	...
	jint AudioFormat::ENCODING_PCM_24BIT_PACKED()
	{
		return getStaticField<jint>(
			"android.media.AudioFormat",
	...
	jint AudioFormat::ENCODING_PCM_32BIT()
	{
		return getStaticField<jint>(
			"android.media.AudioFormat",
			"ENCODING_PCM_32BIT"
	...
	AudioFormat::AudioFormat(QAndroidJniObject obj) : JObject(obj) {}
