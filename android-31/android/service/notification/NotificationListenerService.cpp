...
{
	// Fields
	jint NotificationListenerService::FLAG_FILTER_TYPE_ALERTING()
	{
	...
	jint NotificationListenerService::FLAG_FILTER_TYPE_CONVERSATIONS()
	{
		return getStaticField<jint>(
			"android.service.notification.NotificationListenerService",
	...
	jint NotificationListenerService::FLAG_FILTER_TYPE_ONGOING()
	{
		return getStaticField<jint>(
			"android.service.notification.NotificationListenerService",
	...
	jint NotificationListenerService::FLAG_FILTER_TYPE_SILENT()
	{
		return getStaticField<jint>(
			"android.service.notification.NotificationListenerService",
	...
	jint NotificationListenerService::REASON_CHANNEL_REMOVED()
	{
		return getStaticField<jint>(
			"android.service.notification.NotificationListenerService",
	...
	jint NotificationListenerService::REASON_CLEAR_DATA()
	{
		return getStaticField<jint>(
			"android.service.notification.NotificationListenerService",
			"REASON_CLEAR_DATA"
	...
	void NotificationListenerService::migrateNotificationFilter(jint arg0, __JniBaseClass arg1)
	{
		callMethod<void>(
