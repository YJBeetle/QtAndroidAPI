...
namespace android::service::notification
{
	...
	ZenPolicy_Builder::ZenPolicy_Builder(QAndroidJniObject obj) : JObject(obj) {}
	...
	android::service::notification::ZenPolicy_Builder ZenPolicy_Builder::allowConversations(jint arg0) const
	{
		return callObjectMethod(
			"allowConversations",
			"(I)Landroid/service/notification/ZenPolicy$Builder;",
