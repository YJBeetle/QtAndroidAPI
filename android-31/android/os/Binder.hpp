...
namespace android::os
{
	...
	inline Binder::Binder(JString arg0)
		: JObject(
			"android.os.Binder",
			"(Ljava/lang/String;)V",
			arg0.object<jstring>()
	...
	inline jlong Binder::clearCallingWorkSource()
	{
		return callStaticMethod<jlong>(
			"android.os.Binder",
	...
	inline jint Binder::getCallingUidOrThrow()
	{
		return callStaticMethod<jint>(
			"android.os.Binder",
	...
	inline jint Binder::getCallingWorkSourceUid()
	{
		return callStaticMethod<jint>(
			"android.os.Binder",
	...
	inline void Binder::restoreCallingWorkSource(jlong arg0)
	{
		callStaticMethod<void>(
			"android.os.Binder",
	...
	inline jlong Binder::setCallingWorkSourceUid(jint arg0)
	{
		return callStaticMethod<jlong>(
			"android.os.Binder",
