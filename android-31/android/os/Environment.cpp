...
namespace android::os
{
	...
	jstring Environment::DIRECTORY_RECORDINGS()
	{
		return getStaticObjectField(
			"android.os.Environment",
	...
	java::io::File Environment::getStorageDirectory()
	{
		return callStaticObjectMethod(
			"android.os.Environment",
			"getStorageDirectory",
	...
	jboolean Environment::isExternalStorageManager()
	{
		return callStaticMethod<jboolean>(
			"android.os.Environment",
	...
	jboolean Environment::isExternalStorageManager(java::io::File arg0)
	{
		return callStaticMethod<jboolean>(
			"android.os.Environment",
			"isExternalStorageManager",
