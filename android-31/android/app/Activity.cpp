...
namespace android::app
{
	...
	JObject Activity::getSplashScreen() const
	{
		return callObjectMethod(
			"getSplashScreen",
	...
	jboolean Activity::isLaunchedFromBubble() const
	{
		return callMethod<jboolean>(
	...
	jboolean Activity::onPictureInPictureRequested() const
	{
		return callMethod<jboolean>(
	...
	void Activity::onPictureInPictureUiStateChanged(android::app::PictureInPictureUiState arg0) const
	{
		callMethod<void>(
	...
	void Activity::setLocusContext(android::content::LocusId arg0, android::os::Bundle arg1) const
	{
		callMethod<void>(
			"setLocusContext",
	...
	jboolean Activity::setTranslucent(jboolean arg0) const
	{
		return callMethod<jboolean>(
			"setTranslucent",
			"(Z)Z",
