...
namespace android::app
{
	...
	jboolean Activity::isLaunchedFromBubble()
	{
		return callMethod<jboolean>(
	...
	jboolean Activity::onPictureInPictureRequested()
	{
		return callMethod<jboolean>(
	...
	void Activity::onPictureInPictureUiStateChanged(android::app::PictureInPictureUiState arg0)
	{
		callMethod<void>(
	...
	void Activity::setLocusContext(android::content::LocusId arg0, android::os::Bundle arg1)
	{
		callMethod<void>(
			"setLocusContext",
	...
	jboolean Activity::setTranslucent(jboolean arg0)
	{
		return callMethod<jboolean>(
			"setTranslucent",
			"(Z)Z",
