...
namespace android::app::admin
{
	...
	public:
		...
		void onComplianceAcknowledgementRequired(android::content::Context arg0, android::content::Intent arg1) const;
		...
		void onOperationSafetyStateChanged(android::content::Context arg0, jint arg1, jboolean arg2) const;
