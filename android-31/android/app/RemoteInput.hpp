...
namespace android::app
{
	...
	inline jint RemoteInput::EDIT_CHOICES_BEFORE_SENDING_AUTO()
	{
	...
	inline jint RemoteInput::EDIT_CHOICES_BEFORE_SENDING_DISABLED()
	{
		return getStaticField<jint>(
			"android.app.RemoteInput",
	...
	inline jint RemoteInput::EDIT_CHOICES_BEFORE_SENDING_ENABLED()
	{
		return getStaticField<jint>(
			"android.app.RemoteInput",
	...
	inline jint RemoteInput::getEditChoicesBeforeSending() const
	{
		return callMethod<jint>(
