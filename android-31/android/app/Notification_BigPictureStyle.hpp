...
namespace android::app
{
	...
	inline android::app::Notification_BigPictureStyle Notification_BigPictureStyle::bigPicture(android::graphics::drawable::Icon arg0) const
	{
		return callObjectMethod(
			"bigPicture",
			"(Landroid/graphics/drawable/Icon;)Landroid/app/Notification$BigPictureStyle;",
	...
	inline android::app::Notification_BigPictureStyle Notification_BigPictureStyle::setContentDescription(JString arg0) const
	{
		return callObjectMethod(
	...
	inline android::app::Notification_BigPictureStyle Notification_BigPictureStyle::showBigPictureWhenCollapsed(jboolean arg0) const
	{
		return callObjectMethod(
