...
namespace android::database
{
	...
	public:
		...
		AbstractCursor(QJniObject obj) : JObject(obj) {}
		...
		JObject getNotificationUris() const;
		...
		void setNotificationUris(android::content::ContentResolver arg0, JObject arg1) const;
