...
namespace android::inputmethodservice
{
	...
	public:
		...
		InputMethodService_InputMethodSessionImpl(QAndroidJniObject obj) : android::inputmethodservice::AbstractInputMethodService_AbstractInputMethodSessionImpl(obj) {}
