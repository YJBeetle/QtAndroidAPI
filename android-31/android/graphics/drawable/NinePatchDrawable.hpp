...
namespace android::graphics::drawable
{
	...
	inline android::graphics::Insets NinePatchDrawable::getOpticalInsets() const
	{
		return callObjectMethod(
			"getOpticalInsets",
	...
	inline jboolean NinePatchDrawable::hasFocusStateSpecified() const
	{
		return callMethod<jboolean>(
	...
	inline void NinePatchDrawable::setTintBlendMode(android::graphics::BlendMode arg0) const
	{
		callMethod<void>(
			"setTintBlendMode",
