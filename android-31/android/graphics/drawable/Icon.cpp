...
namespace android::graphics::drawable
{
	...
	jint Icon::TYPE_URI_ADAPTIVE_BITMAP()
	{
		return getStaticField<jint>(
			"android.graphics.drawable.Icon",
	...
	Icon::Icon(QAndroidJniObject obj) : JObject(obj) {}
	...
	android::graphics::drawable::Icon Icon::createWithAdaptiveBitmapContentUri(android::net::Uri arg0)
	{
		return callStaticObjectMethod(
			"android.graphics.drawable.Icon",
	...
	android::graphics::drawable::Icon Icon::createWithAdaptiveBitmapContentUri(JString arg0)
	{
		return callStaticObjectMethod(
			"android.graphics.drawable.Icon",
			"createWithAdaptiveBitmapContentUri",
