...
namespace android::bluetooth
{
	...
	inline jboolean BluetoothHeadset::isNoiseReductionSupported(android::bluetooth::BluetoothDevice arg0) const
	{
		return callMethod<jboolean>(
	...
	inline jboolean BluetoothHeadset::isVoiceRecognitionSupported(android::bluetooth::BluetoothDevice arg0) const
	{
		return callMethod<jboolean>(
