...
namespace android::bluetooth
{
	...
	// QJniObject forward
	BluetoothGattCallback::BluetoothGattCallback(QJniObject obj) : JObject(obj) {}
	...
	void BluetoothGattCallback::onServiceChanged(android::bluetooth::BluetoothGatt arg0) const
	{
		callMethod<void>(
			"onServiceChanged",
