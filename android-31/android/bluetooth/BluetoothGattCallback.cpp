...
namespace android::bluetooth
{
	...
	BluetoothGattCallback::BluetoothGattCallback(QAndroidJniObject obj) : __JniBaseClass(obj) {}
	...
	void BluetoothGattCallback::onServiceChanged(android::bluetooth::BluetoothGatt arg0)
	{
		callMethod<void>(
			"onServiceChanged",
