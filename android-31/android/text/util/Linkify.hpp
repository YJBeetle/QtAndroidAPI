...
namespace android::text::util
{
	...
	inline jboolean Linkify::addLinks(JObject arg0, jint arg1, JObject arg2)
	{
		return callStaticMethod<jboolean>(
			"android.text.util.Linkify",
			"addLinks",
	...
	inline jboolean Linkify::addLinks(JObject arg0, java::util::regex::Pattern arg1, JString arg2, JArray arg3, JObject arg4, JObject arg5, JObject arg6)
	{
		return callStaticMethod<jboolean>(
			"android.text.util.Linkify",
			"addLinks",
