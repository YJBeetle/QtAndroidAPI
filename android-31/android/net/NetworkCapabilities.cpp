...
namespace android::net
{
	...
	jint NetworkCapabilities::NET_CAPABILITY_ENTERPRISE()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
	...
	jint NetworkCapabilities::NET_CAPABILITY_HEAD_UNIT()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
	...
	jint NetworkCapabilities::TRANSPORT_USB()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
			"TRANSPORT_USB"
	...
	JIntArray NetworkCapabilities::getCapabilities() const
	{
	...
	android::net::NetworkSpecifier NetworkCapabilities::getNetworkSpecifier() const
	{
		return callObjectMethod(
			"getNetworkSpecifier",
	...
	jint NetworkCapabilities::getOwnerUid() const
	{
		return callMethod<jint>(
			"getOwnerUid",
			"()I"
	...
	jint NetworkCapabilities::getSignalStrength() const
	{
		return callMethod<jint>(
			"getSignalStrength",
			"()I"
	...
	JObject NetworkCapabilities::getTransportInfo() const
	{
		return callObjectMethod(
			"getTransportInfo",
