...
namespace android::net::wifi
{
	...
	jint WifiConfiguration_GroupCipher::GCMP_128()
	{
		return getStaticField<jint>(
			"android.net.wifi.WifiConfiguration$GroupCipher",
			"GCMP_128"
	...
	jint WifiConfiguration_GroupCipher::SMS4()
	{
		return getStaticField<jint>(
			"android.net.wifi.WifiConfiguration$GroupCipher",
			"SMS4"
	...
	// QJniObject forward
	WifiConfiguration_GroupCipher::WifiConfiguration_GroupCipher(QJniObject obj) : __JniBaseClass(obj) {}
