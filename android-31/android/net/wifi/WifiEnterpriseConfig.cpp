...
namespace android::net::wifi
{
	...
	JString WifiEnterpriseConfig::getClientKeyPairAlias() const
	{
		return callObjectMethod(
	...
	JString WifiEnterpriseConfig::getDecoratedIdentityPrefix() const
	{
		return callObjectMethod(
	...
	jboolean WifiEnterpriseConfig::isEapMethodServerCertUsed() const
	{
		return callMethod<jboolean>(
	...
	jboolean WifiEnterpriseConfig::isServerCertValidationEnabled() const
	{
		return callMethod<jboolean>(
	...
	void WifiEnterpriseConfig::setClientKeyPairAlias(JString arg0) const
	{
		callMethod<void>(
	...
	void WifiEnterpriseConfig::setDecoratedIdentityPrefix(JString arg0) const
	{
		callMethod<void>(
