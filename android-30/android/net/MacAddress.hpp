...
namespace android::net
{
	...
	inline java::net::Inet6Address MacAddress::getLinkLocalIpv6FromEui48Mac() const
	{
	...
	inline jboolean MacAddress::matches(android::net::MacAddress arg0, android::net::MacAddress arg1) const
	{
		return callMethod<jboolean>(
			"matches",
