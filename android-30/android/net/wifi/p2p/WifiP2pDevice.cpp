...
namespace android::net::wifi::p2p
{
	...
	android::net::wifi::p2p::WifiP2pWfdInfo WifiP2pDevice::getWfdInfo() const
	{
	...
	jint WifiP2pDevice::hashCode() const
	{
		return callMethod<jint>(
			"hashCode",
			"()I"
	...
	void WifiP2pDevice::update(android::net::wifi::p2p::WifiP2pDevice arg0) const
	{
		callMethod<void>(
			"update",
			"(Landroid/net/wifi/p2p/WifiP2pDevice;)V",
