...
namespace android::widget
{
	...
	public:
		...
		ScrollView(QAndroidJniObject obj) : android::widget::FrameLayout(obj) {}
		...
		void scrollToDescendant(android::view::View arg0) const;
		void setBottomEdgeEffectColor(jint arg0) const;
		...
		void setTopEdgeEffectColor(jint arg0) const;
