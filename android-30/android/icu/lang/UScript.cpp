...
namespace android::icu::lang
{
	...
	jint UScript::KHITAN_SMALL_SCRIPT()
	{
		return getStaticField<jint>(
			"android.icu.lang.UScript",
			"KHITAN_SMALL_SCRIPT"
	...
	jint UScript::NYIAKENG_PUACHUE_HMONG()
	{
		return getStaticField<jint>(
			"android.icu.lang.UScript",
	...
	// QJniObject forward
	UScript::UScript(QJniObject obj) : JObject(obj) {}
