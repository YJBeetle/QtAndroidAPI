...
namespace android::service::autofill
{
	...
	inline android::service::autofill::UserData_Builder UserData_Builder::setFieldClassificationAlgorithmForCategory(JString arg0, JString arg1, android::os::Bundle arg2) const
	{
		return callObjectMethod(
