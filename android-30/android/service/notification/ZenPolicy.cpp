...
{
	// Fields
	jint ZenPolicy::CONVERSATION_SENDERS_ANYONE()
	{
	...
	jint ZenPolicy::CONVERSATION_SENDERS_IMPORTANT()
	{
		return getStaticField<jint>(
			"android.service.notification.ZenPolicy",
	...
	jint ZenPolicy::CONVERSATION_SENDERS_NONE()
	{
		return getStaticField<jint>(
			"android.service.notification.ZenPolicy",
	...
	jint ZenPolicy::CONVERSATION_SENDERS_UNSET()
	{
		return getStaticField<jint>(
			"android.service.notification.ZenPolicy",
