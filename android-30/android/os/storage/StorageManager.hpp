...
namespace android::os::storage
{
	...
	public:
		...
		__JniBaseClass getRecentStorageVolumes();
		...
		void registerStorageVolumeCallback(__JniBaseClass arg0, android::os::storage::StorageManager_StorageVolumeCallback arg1);
