...
namespace android::content
{
	...
	// QJniObject forward
	ContentProviderOperation::ContentProviderOperation(QJniObject obj) : JObject(obj) {}
	...
	jboolean ContentProviderOperation::isCall()
	{
		return callMethod<jboolean>(
			"isCall",
			"()Z"
	...
	jboolean ContentProviderOperation::isExceptionAllowed()
	{
		return callMethod<jboolean>(
			"isExceptionAllowed",
			"()Z"
