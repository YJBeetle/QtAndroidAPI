...
namespace android::content
{
	...
	jint SyncStats::describeContents() const
	{
	...
	JString SyncStats::toString() const
	{
	...
	void SyncStats::writeToParcel(android::os::Parcel arg0, jint arg1) const
	{
		callMethod<void>(
			"writeToParcel",
