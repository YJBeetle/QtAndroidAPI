...
namespace android::content::pm
{
	...
	inline jint LauncherApps_ShortcutQuery::FLAG_MATCH_CACHED()
	{
		return getStaticField<jint>(
			"android.content.pm.LauncherApps$ShortcutQuery",
			"FLAG_MATCH_CACHED"
	...
	inline android::content::pm::LauncherApps_ShortcutQuery LauncherApps_ShortcutQuery::setLocusIds(JObject arg0) const
	{
		return callObjectMethod(
			"setLocusIds",
