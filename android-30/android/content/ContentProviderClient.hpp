...
namespace android::content
{
	...
	inline JArray ContentProviderClient::applyBatch(JString arg0, java::util::ArrayList arg1) const
	{
		return callObjectMethod(
			"applyBatch",
	...
	inline android::os::Bundle ContentProviderClient::call(JString arg0, JString arg1, JString arg2, android::os::Bundle arg3) const
	{
		return callObjectMethod(
			"call",
	...
	inline jint ContentProviderClient::delete_(android::net::Uri arg0, android::os::Bundle arg1) const
	{
		return callMethod<jint>(
			"delete",
	...
	inline android::net::Uri ContentProviderClient::insert(android::net::Uri arg0, android::content::ContentValues arg1, android::os::Bundle arg2) const
	{
		return callObjectMethod(
			"insert",
	...
	inline android::content::res::AssetFileDescriptor ContentProviderClient::openTypedAssetFile(android::net::Uri arg0, JString arg1, android::os::Bundle arg2, android::os::CancellationSignal arg3) const
	{
		return callObjectMethod(
			"openTypedAssetFile",
	...
	inline jint ContentProviderClient::update(android::net::Uri arg0, android::content::ContentValues arg1, android::os::Bundle arg2) const
	{
		return callMethod<jint>(
			"update",
