...
namespace android::media::tv
{
	...
	jstring TvContract_RecordedPrograms::COLUMN_SPLIT_ID()
	{
		return getStaticObjectField(
			"android.media.tv.TvContract$RecordedPrograms",
			"COLUMN_SPLIT_ID",
	...
	android::net::Uri TvContract_RecordedPrograms::CONTENT_URI()
	{
		return getStaticObjectField(
			"android.media.tv.TvContract$RecordedPrograms",
			"CONTENT_URI",
	...
	TvContract_RecordedPrograms::TvContract_RecordedPrograms(QAndroidJniObject obj) : __JniBaseClass(obj) {}
