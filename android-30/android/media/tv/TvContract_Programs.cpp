...
namespace android::media::tv
{
	...
	JString TvContract_Programs::COLUMN_EVENT_ID()
	{
		return getStaticObjectField(
			"android.media.tv.TvContract$Programs",
			"COLUMN_EVENT_ID",
	...
	JString TvContract_Programs::COLUMN_GLOBAL_CONTENT_ID()
	{
		return getStaticObjectField(
			"android.media.tv.TvContract$Programs",
	...
	JString TvContract_Programs::COLUMN_SPLIT_ID()
	{
		return getStaticObjectField(
			"android.media.tv.TvContract$Programs",
			"COLUMN_SPLIT_ID",
	...
	TvContract_Programs::TvContract_Programs(QAndroidJniObject obj) : JObject(obj) {}
