...
namespace android::media
{
	...
	// QJniObject forward
	AudioAttributes_Builder::AudioAttributes_Builder(QJniObject obj) : JObject(obj) {}
	...
	android::media::AudioAttributes_Builder AudioAttributes_Builder::setAllowedCapturePolicy(jint arg0) const
	{
		return callObjectMethod(
	...
	android::media::AudioAttributes_Builder AudioAttributes_Builder::setHapticChannelsMuted(jboolean arg0) const
	{
		return callObjectMethod(
