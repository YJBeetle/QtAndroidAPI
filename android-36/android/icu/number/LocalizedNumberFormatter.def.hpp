...
namespace android::icu::number
{
	...
	public:
		...
		LocalizedNumberFormatter(QJniObject obj) : android::icu::number::NumberFormatterSettings(obj) {}
		...
		android::icu::number::UnlocalizedNumberFormatter withoutLocale() const;
	};
} // namespace android::icu::number
