...
namespace android::icu::number
{
	...
	public:
		...
		android::icu::number::NumberFormatterSettings displayOptions(android::icu::text::DisplayOptions arg0) const;
		...
		android::icu::number::NumberFormatterSettings usage(JString arg0) const;
	};
} // namespace android::icu::number
