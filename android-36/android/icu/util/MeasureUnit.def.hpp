...
namespace android::icu::util
{
	class MeasureUnit_MeasurePrefix;
}
namespace android::icu::util
{
	class TimeUnit;
...
namespace android::icu::util
{
	...
	public:
		...
		static android::icu::util::MeasureUnit BEAUFORT();
		...
		static android::icu::util::MeasureUnit GASOLINE_ENERGY_DENSITY();
		...
		static android::icu::util::MeasureUnit ITEM();
		...
		static android::icu::util::MeasureUnit KILOWATT_HOUR_PER_100_KILOMETER();
		...
		static android::icu::util::MeasureUnit MILLIGRAM_OFGLUCOSE_PER_DECILITER();
		...
		static android::icu::util::MeasureUnit QUARTER();
		...
		static android::icu::util::MeasureUnit TONNE();
		...
		MeasureUnit(QJniObject obj) : JObject(obj) {}
		...
		android::icu::util::MeasureUnit_MeasurePrefix getPrefix() const;
		...
		android::icu::util::MeasureUnit withPrefix(android::icu::util::MeasureUnit_MeasurePrefix arg0) const;
	};
} // namespace android::icu::util
