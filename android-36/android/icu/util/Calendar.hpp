...
namespace android::icu::util
{
	...
	inline jint Calendar::ORDINAL_MONTH()
	{
		return getStaticField<jint>(
			"android.icu.util.Calendar",
			"ORDINAL_MONTH"
	...
	inline JString Calendar::getTemporalMonthCode() const
	{
		return callObjectMethod(
	...
	inline jboolean Calendar::inTemporalLeapYear() const
	{
		return callMethod<jboolean>(
			"inTemporalLeapYear",
			"()Z"
	...
	inline void Calendar::setTemporalMonthCode(JString arg0) const
	{
		callMethod<void>(
