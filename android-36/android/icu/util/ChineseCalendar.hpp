...
namespace android::icu::util
{
	...
	inline JString ChineseCalendar::getTemporalMonthCode() const
	{
	...
	inline jboolean ChineseCalendar::inTemporalLeapYear() const
	{
	...
	inline void ChineseCalendar::setTemporalMonthCode(JString arg0) const
	{
		callMethod<void>(
