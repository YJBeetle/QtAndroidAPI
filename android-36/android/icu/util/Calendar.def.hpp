...
namespace android::icu::util
{
	...
	public:
		...
		Calendar(QJniObject obj) : JObject(obj) {}
		...
		JString getTemporalMonthCode() const;
		...
		jint hashCode() const;
		jboolean inTemporalLeapYear() const;
		...
		void setTemporalMonthCode(JString arg0) const;
