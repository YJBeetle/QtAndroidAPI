...
namespace android::icu::util
{
	...
	inline JString HebrewCalendar::getTemporalMonthCode() const
	{
	...
	inline jboolean HebrewCalendar::inTemporalLeapYear() const
	{
	...
	inline void HebrewCalendar::setTemporalMonthCode(JString arg0) const
	{
		callMethod<void>(
