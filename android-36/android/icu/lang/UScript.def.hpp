...
namespace android::icu::lang
{
	...
	public:
		...
		static jint KHITAN_SMALL_SCRIPT();
		static jint KHMER();
		static jint KHOJKI();
		static jint KHUDAWADI();
		static jint KHUTSURI();
		static jint KIRAT_RAI();
		static jint KOREAN();
		static jint KPELLE();
		static jint LANNA();
		static jint LAO();
		...
		static jint NAG_MUNDARI();
		static jint NAKHI_GEBA();
		static jint NANDINAGARI();
		static jint NEWA();
		static jint NEW_TAI_LUE();
		static jint NKO();
		static jint NUSHU();
		static jint NYIAKENG_PUACHUE_HMONG();
		static jint OGHAM();
		...
		UScript(QJniObject obj) : JObject(obj) {}
