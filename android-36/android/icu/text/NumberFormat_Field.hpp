...
{
	// Fields
	inline android::icu::text::NumberFormat_Field NumberFormat_Field::APPROXIMATELY_SIGN()
	{
	...
	inline android::icu::text::NumberFormat_Field NumberFormat_Field::COMPACT()
	{
		return getStaticObjectField(
			"android.icu.text.NumberFormat$Field",
			"COMPACT",
	...
	inline android::icu::text::NumberFormat_Field NumberFormat_Field::MEASURE_UNIT()
	{
		return getStaticObjectField(
			"android.icu.text.NumberFormat$Field",
			"MEASURE_UNIT",
