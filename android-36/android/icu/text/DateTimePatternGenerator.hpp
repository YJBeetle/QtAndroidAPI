...
namespace android::icu::text
{
	...
	inline JString DateTimePatternGenerator::getDateTimeFormat(jint arg0) const
	{
		return callObjectMethod(
			"getDateTimeFormat",
			"(I)Ljava/lang/String;",
	...
	inline android::icu::text::DateFormat_HourCycle DateTimePatternGenerator::getDefaultHourCycle() const
	{
		return callObjectMethod(
			"getDefaultHourCycle",
	...
	inline void DateTimePatternGenerator::setDateTimeFormat(jint arg0, JString arg1) const
	{
		callMethod<void>(
			"setDateTimeFormat",
			"(ILjava/lang/String;)V",
