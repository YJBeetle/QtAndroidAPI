...
namespace android::icu::text
{
	...
	public:
		...
		DateTimePatternGenerator(QJniObject obj) : JObject(obj) {}
		...
		JString getDateTimeFormat(jint arg0) const;
		JString getDecimal() const;
		android::icu::text::DateFormat_HourCycle getDefaultHourCycle() const;
		JString getFieldDisplayName(jint arg0, android::icu::text::DateTimePatternGenerator_DisplayWidth arg1) const;
		...
		void setDateTimeFormat(jint arg0, JString arg1) const;
