...
namespace android::companion
{
	...
	inline android::companion::AssociationRequest_Builder AssociationRequest_Builder::setDisplayName(JString arg0) const
	{
		return callObjectMethod(
			"setDisplayName",
			"(Ljava/lang/CharSequence;)Landroid/companion/AssociationRequest$Builder;",
			arg0.object<jstring>()
		);
	}
	inline android::companion::AssociationRequest_Builder AssociationRequest_Builder::setForceConfirmation(jboolean arg0) const
	{
		return callObjectMethod(
	...
	inline android::companion::AssociationRequest_Builder AssociationRequest_Builder::setSelfManaged(jboolean arg0) const
	{
		return callObjectMethod(
			"setSelfManaged",
			"(Z)Landroid/companion/AssociationRequest$Builder;",
