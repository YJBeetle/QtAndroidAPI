...
namespace android::companion
{
	...
	inline jint CompanionDeviceManager::RESULT_SECURITY_ERROR()
	{
		return getStaticField<jint>(
			"android.companion.CompanionDeviceManager",
	...
	inline jboolean CompanionDeviceManager::isPermissionTransferUserConsented(jint arg0) const
	{
		return callMethod<jboolean>(
	...
	inline jboolean CompanionDeviceManager::removeBond(jint arg0) const
	{
		return callMethod<jboolean>(
			"removeBond",
			"(I)Z",
	...
	inline void CompanionDeviceManager::setDeviceId(jint arg0, android::companion::DeviceId arg1) const
	{
		callMethod<void>(
			"setDeviceId",
			"(ILandroid/companion/DeviceId;)V",
			arg0,
			arg1.object()
		);
	}
	inline void CompanionDeviceManager::startObservingDevicePresence(android::companion::ObservingDevicePresenceRequest arg0) const
	{
		callMethod<void>(
			"startObservingDevicePresence",
			"(Landroid/companion/ObservingDevicePresenceRequest;)V",
			arg0.object()
		);
	}
	...
	inline void CompanionDeviceManager::stopObservingDevicePresence(android::companion::ObservingDevicePresenceRequest arg0) const
	{
		callMethod<void>(
