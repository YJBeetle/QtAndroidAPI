...
namespace android::companion
{
	...
	public:
		...
		jboolean isPermissionTransferUserConsented(jint arg0) const;
		jboolean removeBond(jint arg0) const;
		void requestNotificationAccess(android::content::ComponentName arg0) const;
		void setDeviceId(jint arg0, android::companion::DeviceId arg1) const;
		void startObservingDevicePresence(android::companion::ObservingDevicePresenceRequest arg0) const;
		...
		void stopObservingDevicePresence(android::companion::ObservingDevicePresenceRequest arg0) const;
