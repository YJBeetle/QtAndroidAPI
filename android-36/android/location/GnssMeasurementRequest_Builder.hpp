...
namespace android::location
{
	...
	inline android::location::GnssMeasurementRequest_Builder GnssMeasurementRequest_Builder::setIntervalMillis(jint arg0) const
	{
		return callObjectMethod(
			"setIntervalMillis",
			"(I)Landroid/location/GnssMeasurementRequest$Builder;",
			arg0
		);
	}
} // namespace android::location
