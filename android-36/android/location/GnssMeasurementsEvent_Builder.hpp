...
namespace android::location
{
	...
	inline android::location::GnssMeasurementsEvent_Builder GnssMeasurementsEvent_Builder::clearIsFullTracking() const
	{
		return callObjectMethod(
			"clearIsFullTracking",
	...
	inline android::location::GnssMeasurementsEvent_Builder GnssMeasurementsEvent_Builder::setIsFullTracking(jboolean arg0) const
	{
		return callObjectMethod(
			"setIsFullTracking",
			"(Z)Landroid/location/GnssMeasurementsEvent$Builder;",
			arg0
		);
	}
