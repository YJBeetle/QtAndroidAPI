...
namespace android::telephony::ims
{
	...
	inline jboolean ImsMmTelManager::isCrossSimCallingEnabled() const
	{
		return callMethod<jboolean>(
	...
	inline void ImsMmTelManager::registerImsStateCallback(JObject arg0, android::telephony::ims::ImsStateCallback arg1) const
	{
		callMethod<void>(
	...
	inline void ImsMmTelManager::unregisterImsStateCallback(android::telephony::ims::ImsStateCallback arg0) const
	{
		callMethod<void>(
