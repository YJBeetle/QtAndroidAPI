...
namespace android::telephony
{
	...
	inline android::telephony::SubscriptionPlan_Builder SubscriptionPlan_Builder::resetNetworkTypes() const
	{
		return callObjectMethod(
			"resetNetworkTypes",
	...
	inline android::telephony::SubscriptionPlan_Builder SubscriptionPlan_Builder::setNetworkTypes(JIntArray arg0) const
	{
		return callObjectMethod(
			"setNetworkTypes",
	...
	inline android::telephony::SubscriptionPlan_Builder SubscriptionPlan_Builder::setSubscriptionStatus(jint arg0) const
	{
		return callObjectMethod(
