...
namespace android::telephony
{
	...
	public:
		...
		static jint NETWORK_VALIDATION_FAILURE();
		static jint NETWORK_VALIDATION_IN_PROGRESS();
		static jint NETWORK_VALIDATION_NOT_REQUESTED();
		static jint NETWORK_VALIDATION_SUCCESS();
		static jint NETWORK_VALIDATION_UNSUPPORTED();
		...
		PreciseDataConnectionState(QJniObject obj) : JObject(obj) {}
		...
		jint getNetworkValidationStatus() const;
		jint getState() const;
