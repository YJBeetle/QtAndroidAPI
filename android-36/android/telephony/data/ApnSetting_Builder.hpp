...
namespace android::telephony::data
{
	...
	inline android::telephony::data::ApnSetting_Builder ApnSetting_Builder::setAlwaysOn(jboolean arg0) const
	{
		return callObjectMethod(
			"setAlwaysOn",
	...
	inline android::telephony::data::ApnSetting_Builder ApnSetting_Builder::setCarrierId(jint arg0) const
	{
		return callObjectMethod(
			"setCarrierId",
			"(I)Landroid/telephony/data/ApnSetting$Builder;",
	...
	inline android::telephony::data::ApnSetting_Builder ApnSetting_Builder::setMmsProxyAddress(JString arg0) const
	{
		return callObjectMethod(
			"setMmsProxyAddress",
			"(Ljava/lang/String;)Landroid/telephony/data/ApnSetting$Builder;",
	...
	inline android::telephony::data::ApnSetting_Builder ApnSetting_Builder::setMtuV4(jint arg0) const
	{
		return callObjectMethod(
			"setMtuV4",
			"(I)Landroid/telephony/data/ApnSetting$Builder;",
	...
	inline android::telephony::data::ApnSetting_Builder ApnSetting_Builder::setMtuV6(jint arg0) const
	{
		return callObjectMethod(
			"setMtuV6",
			"(I)Landroid/telephony/data/ApnSetting$Builder;",
	...
	inline android::telephony::data::ApnSetting_Builder ApnSetting_Builder::setPersistent(jboolean arg0) const
	{
		return callObjectMethod(
			"setPersistent",
			"(Z)Landroid/telephony/data/ApnSetting$Builder;",
	...
	inline android::telephony::data::ApnSetting_Builder ApnSetting_Builder::setProfileId(jint arg0) const
	{
		return callObjectMethod(
			"setProfileId",
			"(I)Landroid/telephony/data/ApnSetting$Builder;",
	...
	inline android::telephony::data::ApnSetting_Builder ApnSetting_Builder::setProxyAddress(JString arg0) const
	{
		return callObjectMethod(
			"setProxyAddress",
			"(Ljava/lang/String;)Landroid/telephony/data/ApnSetting$Builder;",
