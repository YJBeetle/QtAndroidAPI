...
namespace android::telephony::data
{
	...
	public:
		...
		static jint TYPE_OEM_PAID();
		static jint TYPE_OEM_PRIVATE();
		static jint TYPE_RCS();
		...
		ApnSetting(QJniObject obj) : JObject(obj) {}
