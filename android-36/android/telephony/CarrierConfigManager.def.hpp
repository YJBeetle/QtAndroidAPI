...
namespace android::telephony
{
	...
	public:
		...
		static JString KEY_ADDITIONAL_SETTINGS_CALLER_ID_VISIBILITY_BOOL();
		static JString KEY_ADDITIONAL_SETTINGS_CALL_WAITING_VISIBILITY_BOOL();
		...
		static JString KEY_CAPABILITIES_EXEMPT_FROM_SINGLE_DC_CHECK_INT_ARRAY();
		...
		static JString KEY_CARRIER_METERED_APN_TYPES_STRINGS();
		static JString KEY_CARRIER_METERED_ROAMING_APN_TYPES_STRINGS();
		...
		static JString KEY_CARRIER_ROAMING_NTN_EMERGENCY_CALL_TO_SATELLITE_HANDOVER_TYPE_INT();
		static JString KEY_CARRIER_SERVICE_NAME_STRING_ARRAY();
		static JString KEY_CARRIER_SERVICE_NUMBER_STRING_ARRAY();
		static JString KEY_CARRIER_SETTINGS_ACTIVITY_COMPONENT_NAME_STRING();
		static JString KEY_CARRIER_SETTINGS_ENABLE_BOOL();
		static JString KEY_CARRIER_SUPPORTED_SATELLITE_SERVICES_PER_PROVIDER_BUNDLE();
		static JString KEY_CARRIER_SUPPORTS_OPP_DATA_AUTO_PROVISIONING_BOOL();
		static JString KEY_CARRIER_SUPPORTS_SS_OVER_UT_BOOL();
		static JString KEY_CARRIER_SUPPORTS_TETHERING_BOOL();
		...
		static JString KEY_CELLULAR_SERVICE_CAPABILITIES_INT_ARRAY();
		static JString KEY_CELLULAR_USAGE_SETTING_INT();
		...
		static JString KEY_DATA_SWITCH_VALIDATION_MIN_INTERVAL_MILLIS_LONG();
		...
		static JString KEY_ENABLE_CROSS_SIM_CALLING_ON_OPPORTUNISTIC_DATA_BOOL();
		...
		static JString KEY_ESIM_DOWNLOAD_RETRY_BACKOFF_TIMER_SEC_INT();
		static JString KEY_ESIM_MAX_DOWNLOAD_RETRY_ATTEMPTS_INT();
		...
		static JString KEY_INCLUDE_LTE_FOR_NR_ADVANCED_THRESHOLD_BANDWIDTH_BOOL();
		static JString KEY_IS_IMS_CONFERENCE_SIZE_ENFORCED_BOOL();
		static JString KEY_IS_OPPORTUNISTIC_SUBSCRIPTION_BOOL();
		...
		static JString KEY_MMS_NETWORK_RELEASE_TIMEOUT_MILLIS_INT();
		...
		static JString KEY_NTN_LTE_RSRP_THRESHOLDS_INT_ARRAY();
		static JString KEY_NTN_LTE_RSRQ_THRESHOLDS_INT_ARRAY();
		static JString KEY_NTN_LTE_RSSNR_THRESHOLDS_INT_ARRAY();
		...
		static JString KEY_PARAMETERS_USED_FOR_NTN_LTE_SIGNAL_BAR_INT();
		static JString KEY_PING_TEST_BEFORE_DATA_SWITCH_BOOL();
		static JString KEY_PREFER_2G_BOOL();
		static JString KEY_PREFER_3G_VISIBILITY_BOOL();
		static JString KEY_PREMIUM_CAPABILITY_MAXIMUM_DAILY_NOTIFICATION_COUNT_INT();
		static JString KEY_PREMIUM_CAPABILITY_MAXIMUM_MONTHLY_NOTIFICATION_COUNT_INT();
		static JString KEY_PREMIUM_CAPABILITY_NETWORK_SETUP_TIME_MILLIS_LONG();
		static JString KEY_PREMIUM_CAPABILITY_NOTIFICATION_BACKOFF_HYSTERESIS_TIME_MILLIS_LONG();
		static JString KEY_PREMIUM_CAPABILITY_NOTIFICATION_DISPLAY_TIMEOUT_MILLIS_LONG();
		static JString KEY_PREMIUM_CAPABILITY_PURCHASE_CONDITION_BACKOFF_HYSTERESIS_TIME_MILLIS_LONG();
		static JString KEY_PREMIUM_CAPABILITY_PURCHASE_URL_STRING();
		static JString KEY_PREMIUM_CAPABILITY_SUPPORTED_ON_LTE_BOOL();
		...
		static JString KEY_RATCHET_NR_ADVANCED_BANDWIDTH_IF_RRC_IDLE_BOOL();
		...
		static JString KEY_SATELLITE_ATTACH_SUPPORTED_BOOL();
		static JString KEY_SATELLITE_CONNECTION_HYSTERESIS_SEC_INT();
		static JString KEY_SATELLITE_ENTITLEMENT_STATUS_REFRESH_DAYS_INT();
		static JString KEY_SATELLITE_ENTITLEMENT_SUPPORTED_BOOL();
		static JString KEY_SATELLITE_ESOS_SUPPORTED_BOOL();
		static JString KEY_SATELLITE_ROAMING_ESOS_INACTIVITY_TIMEOUT_SEC_INT();
		static JString KEY_SATELLITE_ROAMING_P2P_SMS_INACTIVITY_TIMEOUT_SEC_INT();
		static JString KEY_SATELLITE_ROAMING_P2P_SMS_SUPPORTED_BOOL();
		static JString KEY_SATELLITE_ROAMING_SCREEN_OFF_INACTIVITY_TIMEOUT_SEC_INT();
		...
		static JString KEY_SHOW_ROAMING_INDICATOR_BOOL();
		...
		static JString KEY_SIM_COUNTRY_ISO_OVERRIDE_STRING();
		static JString KEY_SIM_NETWORK_UNLOCK_ALLOW_DISMISS_BOOL();
		static JString KEY_SMDP_SERVER_ADDRESS_STRING();
		static JString KEY_SMS_REQUIRES_DESTINATION_NUMBER_CONVERSION_BOOL();
		static JString KEY_SUBSCRIPTION_GROUP_UUID_STRING();
		static JString KEY_SUPPORTED_PREMIUM_CAPABILITIES_INT_ARRAY();
		static JString KEY_SUPPORTS_BUSINESS_CALL_COMPOSER_BOOL();
		...
		static JString KEY_VONR_ENABLED_BOOL();
		static JString KEY_VONR_ON_BY_DEFAULT_BOOL();
		static JString KEY_VONR_SETTING_VISIBILITY_BOOL();
		...
		static JString REMOVE_GROUP_UUID_STRING();
		...
		CarrierConfigManager(QJniObject obj) : JObject(obj) {}
		...
		android::os::PersistableBundle getConfig(JArray arg0) const;
		...
		android::os::PersistableBundle getConfigForSubId(jint arg0, JArray arg1) const;
		void notifyConfigChangedForSubId(jint arg0) const;
		void registerCarrierConfigChangeListener(JObject arg0, JObject arg1) const;
		void unregisterCarrierConfigChangeListener(JObject arg0) const;
	};
} // namespace android::telephony
