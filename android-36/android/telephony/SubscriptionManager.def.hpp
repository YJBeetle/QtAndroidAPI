...
namespace android::telephony
{
	...
	public:
		...
		static jint PHONE_NUMBER_SOURCE_CARRIER();
		static jint PHONE_NUMBER_SOURCE_IMS();
		static jint PHONE_NUMBER_SOURCE_UICC();
		static jint SERVICE_CAPABILITY_DATA();
		static jint SERVICE_CAPABILITY_SMS();
		static jint SERVICE_CAPABILITY_VOICE();
		static jint SUBSCRIPTION_TYPE_LOCAL_SIM();
		static jint SUBSCRIPTION_TYPE_REMOTE_SIM();
		static jint USAGE_SETTING_DATA_CENTRIC();
		static jint USAGE_SETTING_DEFAULT();
		static jint USAGE_SETTING_UNKNOWN();
		static jint USAGE_SETTING_VOICE_CENTRIC();
		...
		SubscriptionManager(QJniObject obj) : JObject(obj) {}
		...
		static jint getSubscriptionId(jint arg0);
		...
		JObject getAllSubscriptionInfoList() const;
		JObject getCompleteActiveSubscriptionInfoList() const;
		JObject getDeviceToDeviceStatusSharingContacts(jint arg0) const;
		jint getDeviceToDeviceStatusSharingPreference(jint arg0) const;
		JObject getOpportunisticSubscriptions() const;
		JString getPhoneNumber(jint arg0) const;
		JString getPhoneNumber(jint arg0, jint arg1) const;
		...
		void setCarrierPhoneNumber(jint arg0, JString arg1) const;
		void setDeviceToDeviceStatusSharingContacts(jint arg0, JObject arg1) const;
		void setDeviceToDeviceStatusSharingPreference(jint arg0, jint arg1) const;
		...
		void setSubscriptionOverrideCongested(jint arg0, jboolean arg1, JIntArray arg2, jlong arg3) const;
		void setSubscriptionOverrideUnmetered(jint arg0, jboolean arg1, jlong arg2) const;
		void setSubscriptionOverrideUnmetered(jint arg0, jboolean arg1, JIntArray arg2, jlong arg3) const;
		void setSubscriptionPlans(jint arg0, JObject arg1) const;
		void setSubscriptionPlans(jint arg0, JObject arg1, jlong arg2) const;
