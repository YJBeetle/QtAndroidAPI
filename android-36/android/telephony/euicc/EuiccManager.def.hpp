...
namespace android::telephony::euicc
{
	...
	public:
		...
		static jlong EUICC_MEMORY_FIELD_UNAVAILABLE();
		...
		EuiccManager(QJniObject obj) : JObject(obj) {}
		...
		jlong getAvailableMemoryInBytes() const;
		JString getEid() const;
		android::telephony::euicc::EuiccInfo getEuiccInfo() const;
		jboolean isEnabled() const;
		jboolean isSimPortAvailable(jint arg0) const;
		...
		void switchToSubscription(jint arg0, jint arg1, android::app::PendingIntent arg2) const;
