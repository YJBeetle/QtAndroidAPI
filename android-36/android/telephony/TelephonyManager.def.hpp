...
namespace android::telephony
{
	...
	public:
		...
		static JString ACTION_RESET_MOBILE_NETWORK_SETTINGS();
		...
		static jint ALLOWED_NETWORK_TYPES_REASON_CARRIER();
		static jint ALLOWED_NETWORK_TYPES_REASON_USER();
		...
		static jint AUTHTYPE_GBA_BOOTSTRAP();
		static jint AUTHTYPE_GBA_NAF_KEY_EXTERNAL();
		static jint CALL_COMPOSER_STATUS_BUSINESS_ONLY();
		...
		static jint CARRIER_RESTRICTION_STATUS_NOT_RESTRICTED();
		static jint CARRIER_RESTRICTION_STATUS_RESTRICTED();
		static jint CARRIER_RESTRICTION_STATUS_RESTRICTED_TO_CALLER();
		static jint CARRIER_RESTRICTION_STATUS_UNKNOWN();
		...
		static jint DATA_ENABLED_REASON_OVERRIDE();
		static jint DATA_ENABLED_REASON_POLICY();
		static jint DATA_ENABLED_REASON_THERMAL();
		static jint DATA_ENABLED_REASON_UNKNOWN();
		static jint DATA_ENABLED_REASON_USER();
		static jint DATA_HANDOVER_IN_PROGRESS();
		static jint DATA_SUSPENDED();
		static jint DATA_UNKNOWN();
		static jint DEFAULT_PORT_INDEX();
		static jint ERI_FLASH();
		static jint ERI_OFF();
		static jint ERI_ON();
		static JString EVENT_DISPLAY_EMERGENCY_MESSAGE();
		...
		static JString EXTRA_EMERGENCY_CALL_TO_SATELLITE_HANDOVER_TYPE();
		static JString EXTRA_EMERGENCY_CALL_TO_SATELLITE_LAUNCH_INTENT();
		static JString EXTRA_HIDE_PUBLIC_SETTINGS();
		static JString EXTRA_INCOMING_NUMBER();
		static JString EXTRA_IS_REFRESH();
		static JString EXTRA_LAST_KNOWN_NETWORK_COUNTRY();
		...
		static jint INCLUDE_LOCATION_DATA_COARSE();
		static jint INCLUDE_LOCATION_DATA_FINE();
		static jint INCLUDE_LOCATION_DATA_NONE();
		...
		static jlong NETWORK_TYPE_BITMASK_1xRTT();
		static jlong NETWORK_TYPE_BITMASK_CDMA();
		static jlong NETWORK_TYPE_BITMASK_EDGE();
		static jlong NETWORK_TYPE_BITMASK_EHRPD();
		static jlong NETWORK_TYPE_BITMASK_EVDO_0();
		static jlong NETWORK_TYPE_BITMASK_EVDO_A();
		static jlong NETWORK_TYPE_BITMASK_EVDO_B();
		static jlong NETWORK_TYPE_BITMASK_GPRS();
		static jlong NETWORK_TYPE_BITMASK_GSM();
		static jlong NETWORK_TYPE_BITMASK_HSDPA();
		static jlong NETWORK_TYPE_BITMASK_HSPA();
		static jlong NETWORK_TYPE_BITMASK_HSPAP();
		static jlong NETWORK_TYPE_BITMASK_HSUPA();
		static jlong NETWORK_TYPE_BITMASK_IWLAN();
		static jlong NETWORK_TYPE_BITMASK_LTE();
		static jlong NETWORK_TYPE_BITMASK_LTE_CA();
		static jlong NETWORK_TYPE_BITMASK_NR();
		static jlong NETWORK_TYPE_BITMASK_TD_SCDMA();
		static jlong NETWORK_TYPE_BITMASK_UMTS();
		static jlong NETWORK_TYPE_BITMASK_UNKNOWN();
		...
		static jint PREMIUM_CAPABILITY_PRIORITIZE_LATENCY();
		static jint PURCHASE_PREMIUM_CAPABILITY_RESULT_ALREADY_IN_PROGRESS();
		static jint PURCHASE_PREMIUM_CAPABILITY_RESULT_ALREADY_PURCHASED();
		static jint PURCHASE_PREMIUM_CAPABILITY_RESULT_CARRIER_DISABLED();
		static jint PURCHASE_PREMIUM_CAPABILITY_RESULT_CARRIER_ERROR();
		static jint PURCHASE_PREMIUM_CAPABILITY_RESULT_ENTITLEMENT_CHECK_FAILED();
		static jint PURCHASE_PREMIUM_CAPABILITY_RESULT_FEATURE_NOT_SUPPORTED();
		static jint PURCHASE_PREMIUM_CAPABILITY_RESULT_NETWORK_NOT_AVAILABLE();
		static jint PURCHASE_PREMIUM_CAPABILITY_RESULT_NOT_DEFAULT_DATA_SUBSCRIPTION();
		static jint PURCHASE_PREMIUM_CAPABILITY_RESULT_NOT_FOREGROUND();
		static jint PURCHASE_PREMIUM_CAPABILITY_RESULT_PENDING_NETWORK_SETUP();
		static jint PURCHASE_PREMIUM_CAPABILITY_RESULT_REQUEST_FAILED();
		static jint PURCHASE_PREMIUM_CAPABILITY_RESULT_SUCCESS();
		static jint PURCHASE_PREMIUM_CAPABILITY_RESULT_THROTTLED();
		static jint PURCHASE_PREMIUM_CAPABILITY_RESULT_TIMEOUT();
		static jint PURCHASE_PREMIUM_CAPABILITY_RESULT_USER_CANCELED();
		static jint PURCHASE_PREMIUM_CAPABILITY_RESULT_USER_DISABLED();
		...
		jlong getAllowedNetworkTypesForReason(jint arg0) const;
		...
		void getCarrierRestrictionStatus(JObject arg0, JObject arg1) const;
		...
		JString getPrimaryImei() const;
		android::telephony::ServiceState getServiceState() const;
		android::telephony::ServiceState getServiceState(jint arg0) const;
		...
		jlong getSupportedRadioAccessFamily() const;
		...
		jboolean isDeviceSmsCapable() const;
		jboolean isDeviceVoiceCapable() const;
		...
		jboolean isPremiumCapabilityAvailableForPurchase(jint arg0) const;
		...
		void purchasePremiumCapability(jint arg0, JObject arg1, JObject arg2) const;
		void rebootModem() const;
		void registerTelephonyCallback(JObject arg0, android::telephony::TelephonyCallback arg1) const;
		void registerTelephonyCallback(jint arg0, JObject arg1, android::telephony::TelephonyCallback arg2) const;
		...
		android::telephony::NetworkScan requestNetworkScan(jint arg0, android::telephony::NetworkScanRequest arg1, JObject arg2, android::telephony::TelephonyScanManager_NetworkScanCallback arg3) const;
		...
		void setAllowedNetworkTypesForReason(jint arg0, jlong arg1) const;
