...
namespace android::telephony
{
	...
	public:
		...
		static jint SUBSCRIPTION_STATUS_ACTIVE();
		static jint SUBSCRIPTION_STATUS_INACTIVE();
		static jint SUBSCRIPTION_STATUS_SUSPENDED();
		static jint SUBSCRIPTION_STATUS_TRIAL();
		static jint SUBSCRIPTION_STATUS_UNKNOWN();
		...
		SubscriptionPlan(QJniObject obj) : JObject(obj) {}
		...
		java::time::ZonedDateTime getPlanEndDate() const;
		jint getSubscriptionStatus() const;
