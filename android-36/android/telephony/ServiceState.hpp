...
namespace android::telephony
{
	...
	inline JObject ServiceState::getNetworkRegistrationInfoList() const
	{
		return callObjectMethod(
	...
	inline jboolean ServiceState::isSearching() const
	{
		return callMethod<jboolean>(
			"isSearching",
			"()Z"
	...
	inline jboolean ServiceState::isUsingNonTerrestrialNetwork() const
	{
		return callMethod<jboolean>(
