...
namespace android::telephony
{
	...
	inline jint SubscriptionPlan::SUBSCRIPTION_STATUS_ACTIVE()
	{
		return getStaticField<jint>(
			"android.telephony.SubscriptionPlan",
	...
	inline jint SubscriptionPlan::SUBSCRIPTION_STATUS_INACTIVE()
	{
		return getStaticField<jint>(
			"android.telephony.SubscriptionPlan",
	...
	inline jint SubscriptionPlan::SUBSCRIPTION_STATUS_SUSPENDED()
	{
		return getStaticField<jint>(
			"android.telephony.SubscriptionPlan",
	...
	inline jint SubscriptionPlan::SUBSCRIPTION_STATUS_TRIAL()
	{
		return getStaticField<jint>(
			"android.telephony.SubscriptionPlan",
	...
	inline jint SubscriptionPlan::SUBSCRIPTION_STATUS_UNKNOWN()
	{
		return getStaticField<jint>(
			"android.telephony.SubscriptionPlan",
	...
	inline java::time::ZonedDateTime SubscriptionPlan::getPlanEndDate() const
	{
		return callObjectMethod(
			"getPlanEndDate",
	...
	inline jint SubscriptionPlan::getSubscriptionStatus() const
	{
		return callMethod<jint>(
