...
namespace android::telephony
{
	...
	public:
		...
		static jint MMS_ERROR_DATA_DISABLED();
		static jint MMS_ERROR_HTTP_FAILURE();
		static jint MMS_ERROR_INACTIVE_SUBSCRIPTION();
		static jint MMS_ERROR_INVALID_APN();
		static jint MMS_ERROR_INVALID_SUBSCRIPTION_ID();
		static jint MMS_ERROR_IO_ERROR();
		static jint MMS_ERROR_MMS_DISABLED_BY_CARRIER();
		...
		static jint RESULT_RIL_NO_NETWORK_FOUND();
		static jint RESULT_RIL_NO_RESOURCES();
		static jint RESULT_RIL_NO_SMS_TO_ACK();
		static jint RESULT_RIL_NO_SUBSCRIPTION();
		...
		static jint RESULT_RIL_SIM_BUSY();
		static jint RESULT_RIL_SIM_ERROR();
		static jint RESULT_RIL_SIM_FULL();
		static jint RESULT_RIL_SIM_PIN2();
		static jint RESULT_RIL_SIM_PUK2();
		static jint RESULT_RIL_SMS_SEND_FAIL_RETRY();
		static jint RESULT_RIL_SUBSCRIPTION_NOT_AVAILABLE();
		...
		static jint RESULT_USER_NOT_ALLOWED();
		static jint SMS_RP_CAUSE_CALL_BARRING();
		static jint SMS_RP_CAUSE_CONGESTION();
		static jint SMS_RP_CAUSE_DESTINATION_OUT_OF_ORDER();
		static jint SMS_RP_CAUSE_FACILITY_NOT_IMPLEMENTED();
		static jint SMS_RP_CAUSE_FACILITY_NOT_SUBSCRIBED();
		static jint SMS_RP_CAUSE_FACILITY_REJECTED();
		static jint SMS_RP_CAUSE_INFORMATION_ELEMENT_NON_EXISTENT();
		static jint SMS_RP_CAUSE_INTERWORKING_UNSPECIFIED();
		static jint SMS_RP_CAUSE_INVALID_MANDATORY_INFORMATION();
		static jint SMS_RP_CAUSE_INVALID_MESSAGE_REFERENCE_VALUE();
		static jint SMS_RP_CAUSE_MESSAGE_INCOMPATIBLE_WITH_PROTOCOL_STATE();
		static jint SMS_RP_CAUSE_MESSAGE_TYPE_NON_EXISTENT();
		static jint SMS_RP_CAUSE_NETWORK_OUT_OF_ORDER();
		static jint SMS_RP_CAUSE_OPERATOR_DETERMINED_BARRING();
		static jint SMS_RP_CAUSE_PROTOCOL_ERROR();
		static jint SMS_RP_CAUSE_RESERVED();
		static jint SMS_RP_CAUSE_RESOURCES_UNAVAILABLE();
		static jint SMS_RP_CAUSE_SEMANTICALLY_INCORRECT_MESSAGE();
		static jint SMS_RP_CAUSE_SHORT_MESSAGE_TRANSFER_REJECTED();
		static jint SMS_RP_CAUSE_TEMPORARY_FAILURE();
		static jint SMS_RP_CAUSE_UNALLOCATED_NUMBER();
		static jint SMS_RP_CAUSE_UNIDENTIFIED_SUBSCRIBER();
		static jint SMS_RP_CAUSE_UNKNOWN_SUBSCRIBER();
		...
		android::telephony::SmsManager createForSubscriptionId(jint arg0) const;
		...
		void downloadMultimediaMessage(android::content::Context arg0, JString arg1, android::net::Uri arg2, android::os::Bundle arg3, android::app::PendingIntent arg4, jlong arg5) const;
		android::os::Bundle getCarrierConfigValues() const;
		jint getSmsCapacityOnIcc() const;
		...
		void sendMultimediaMessage(android::content::Context arg0, android::net::Uri arg1, JString arg2, android::os::Bundle arg3, android::app::PendingIntent arg4, jlong arg5) const;
