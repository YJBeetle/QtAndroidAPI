...
namespace android::telephony
{
	...
	public:
		...
		NetworkRegistrationInfo(QJniObject obj) : JObject(obj) {}
		...
		jint getRejectCause() const;
		jint getTransportType() const;
		jint hashCode() const;
		jboolean isNetworkRegistered() const;
		jboolean isNetworkRoaming() const;
		jboolean isNetworkSearching() const;
		jboolean isNonTerrestrialNetwork() const;
