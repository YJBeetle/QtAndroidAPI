...
namespace android::widget
{
	...
	inline jboolean AbsListView::isSelectedChildViewEnabled() const
	{
		return callMethod<jboolean>(
	...
	inline void AbsListView::onProvideContentCaptureStructure(android::view::ViewStructure arg0, jint arg1) const
	{
		callMethod<void>(
	...
	inline void AbsListView::setSelectedChildViewEnabled(jboolean arg0) const
	{
		callMethod<void>(
