...
namespace android::widget
{
	...
	inline RemoteViews::RemoteViews(android::widget::RemoteViews_DrawInstructions arg0)
		: JObject(
			"android.widget.RemoteViews",
			"(Landroid/widget/RemoteViews$DrawInstructions;)V",
			arg0.object()
		) {}
	...
	inline void RemoteViews::setOnStylusHandwritingPendingIntent(jint arg0, android::app::PendingIntent arg1) const
	{
		callMethod<void>(
