...
namespace android::widget
{
	...
	public:
		...
		static jint FOCUSED_SEARCH_RESULT_INDEX_NONE();
		...
		TextView(QJniObject obj) : android::view::View(obj) {}
		...
		jboolean bringPointIntoView(jint arg0, jboolean arg1) const;
		...
		jint getFocusedSearchResultHighlightColor() const;
		jint getFocusedSearchResultIndex() const;
		...
		android::text::Highlights getHighlights() const;
		...
		android::graphics::Paint_FontMetrics getMinimumFontMetrics() const;
		...
		jint getSearchResultHighlightColor() const;
		JIntArray getSearchResultHighlights() const;
		...
		jboolean getShiftDrawingOffsetForStartOverhang() const;
		...
		jboolean getUseBoundsForWidth() const;
		...
		jboolean isLocalePreferredLineHeightForMinimumUsed() const;
		...
		void setFocusedSearchResultHighlightColor(jint arg0) const;
		void setFocusedSearchResultIndex(jint arg0) const;
		...
		void setHighlights(android::text::Highlights arg0) const;
		...
		void setLineBreakStyle(jint arg0) const;
		void setLineBreakWordStyle(jint arg0) const;
		void setLineHeight(jint arg0) const;
		void setLineHeight(jint arg0, jfloat arg1) const;
		...
		void setLocalePreferredLineHeightForMinimumUsed(jboolean arg0) const;
		...
		void setMinimumFontMetrics(android::graphics::Paint_FontMetrics arg0) const;
		...
		void setSearchResultHighlightColor(jint arg0) const;
		void setSearchResultHighlights(JIntArray arg0) const;
		...
		void setShiftDrawingOffsetForStartOverhang(jboolean arg0) const;
		...
		void setUseBoundsForWidth(jboolean arg0) const;
