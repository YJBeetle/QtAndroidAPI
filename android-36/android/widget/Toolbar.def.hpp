...
namespace android::widget
{
	...
	public:
		...
		Toolbar(QJniObject obj) : android::view::ViewGroup(obj) {}
		...
		JString getCollapseContentDescription() const;
		...
		void setCollapseContentDescription(jint arg0) const;
		void setCollapseContentDescription(JString arg0) const;
		void setCollapseIcon(android::graphics::drawable::Drawable arg0) const;
		void setCollapseIcon(jint arg0) const;
