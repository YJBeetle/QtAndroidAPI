...
namespace android::accessibilityservice
{
	...
	inline jint AccessibilityService::ERROR_TAKE_SCREENSHOT_INVALID_WINDOW()
	{
		return getStaticField<jint>(
			"android.accessibilityservice.AccessibilityService",
	...
	inline jint AccessibilityService::ERROR_TAKE_SCREENSHOT_SECURE_WINDOW()
	{
		return getStaticField<jint>(
			"android.accessibilityservice.AccessibilityService",
	...
	inline jint AccessibilityService::GLOBAL_ACTION_MEDIA_PLAY_PAUSE()
	{
		return getStaticField<jint>(
			"android.accessibilityservice.AccessibilityService",
	...
	inline jint AccessibilityService::GLOBAL_ACTION_MENU()
	{
		return getStaticField<jint>(
			"android.accessibilityservice.AccessibilityService",
			"GLOBAL_ACTION_MENU"
	...
	// Methods
	inline void AccessibilityService::attachAccessibilityOverlayToDisplay(jint arg0, android::view::SurfaceControl arg1) const
	{
		callMethod<void>(
	...
	inline void AccessibilityService::attachAccessibilityOverlayToWindow(jint arg0, android::view::SurfaceControl arg1) const
	{
		callMethod<void>(
	...
	inline JObject AccessibilityService::getBrailleDisplayController() const
	{
		return callObjectMethod(
			"getBrailleDisplayController",
			"()Landroid/accessibilityservice/BrailleDisplayController;"
		);
	}
	...
	inline void AccessibilityService::onMotionEvent(android::view::MotionEvent arg0) const
	{
		callMethod<void>(
			"onMotionEvent",
	...
	inline void AccessibilityService::takeScreenshotOfWindow(jint arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
