...
namespace android::accessibilityservice
{
	...
	public:
		...
		static jint ERROR_TAKE_SCREENSHOT_INVALID_WINDOW();
		static jint ERROR_TAKE_SCREENSHOT_NO_ACCESSIBILITY_ACCESS();
		static jint ERROR_TAKE_SCREENSHOT_SECURE_WINDOW();
		...
		static jint GLOBAL_ACTION_DPAD_CENTER();
		static jint GLOBAL_ACTION_DPAD_DOWN();
		static jint GLOBAL_ACTION_DPAD_LEFT();
		static jint GLOBAL_ACTION_DPAD_RIGHT();
		static jint GLOBAL_ACTION_DPAD_UP();
		static jint GLOBAL_ACTION_HOME();
		static jint GLOBAL_ACTION_KEYCODE_HEADSETHOOK();
		static jint GLOBAL_ACTION_LOCK_SCREEN();
		static jint GLOBAL_ACTION_MEDIA_PLAY_PAUSE();
		static jint GLOBAL_ACTION_MENU();
		...
		AccessibilityService(QJniObject obj) : android::app::Service(obj) {}
		
		// Constructors
		AccessibilityService();
		
		// Methods
		void attachAccessibilityOverlayToDisplay(jint arg0, android::view::SurfaceControl arg1) const;
		void attachAccessibilityOverlayToWindow(jint arg0, android::view::SurfaceControl arg1) const;
		jboolean clearCache() const;
		jboolean clearCachedSubtree(android::view::accessibility::AccessibilityNodeInfo arg0) const;
		...
		JObject getBrailleDisplayController() const;
		android::accessibilityservice::FingerprintGestureController getFingerprintGestureController() const;
		android::accessibilityservice::InputMethod getInputMethod() const;
		...
		android::view::accessibility::AccessibilityNodeInfo getRootInActiveWindow(jint arg0) const;
		...
		android::accessibilityservice::TouchInteractionController getTouchInteractionController(jint arg0) const;
		JObject getWindows() const;
		android::util::SparseArray getWindowsOnAllDisplays() const;
		jboolean isCacheEnabled() const;
		jboolean isNodeInCache(android::view::accessibility::AccessibilityNodeInfo arg0) const;
		void onAccessibilityEvent(android::view::accessibility::AccessibilityEvent arg0) const;
		JObject onBind(android::content::Intent arg0) const;
		android::accessibilityservice::InputMethod onCreateInputMethod() const;
		jboolean onGesture(android::accessibilityservice::AccessibilityGestureEvent arg0) const;
		void onInterrupt() const;
		void onMotionEvent(android::view::MotionEvent arg0) const;
		...
		void setAnimationScale(jfloat arg0) const;
		jboolean setCacheEnabled(jboolean arg0) const;
		...
		void takeScreenshotOfWindow(jint arg0, JObject arg1, JObject arg2) const;
	};
} // namespace android::accessibilityservice
