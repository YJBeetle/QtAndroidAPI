...
namespace android::text
{
	...
	public:
		...
		DynamicLayout_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::text::DynamicLayout_Builder setLineBreakConfig(android::graphics::text::LineBreakConfig arg0) const;
		android::text::DynamicLayout_Builder setLineSpacing(jfloat arg0, jfloat arg1) const;
		android::text::DynamicLayout_Builder setMinimumFontMetrics(android::graphics::Paint_FontMetrics arg0) const;
		android::text::DynamicLayout_Builder setShiftDrawingOffsetForStartOverhang(jboolean arg0) const;
		android::text::DynamicLayout_Builder setTextDirection(JObject arg0) const;
		android::text::DynamicLayout_Builder setUseBoundsForWidth(jboolean arg0) const;
