...
namespace android::text
{
	...
	public:
		...
		static JObject INCLUSION_STRATEGY_ANY_OVERLAP();
		static JObject INCLUSION_STRATEGY_CONTAINS_ALL();
		static JObject INCLUSION_STRATEGY_CONTAINS_CENTER();
		static jint JUSTIFICATION_MODE_INTER_CHARACTER();
		...
		Layout(QJniObject obj) : JObject(obj) {}
		...
		android::graphics::RectF computeDrawingBoundingBox() const;
		...
		void draw(android::graphics::Canvas arg0, JObject arg1, JObject arg2, android::graphics::Path arg3, android::graphics::Paint arg4, jint arg5) const;
		void drawBackground(android::graphics::Canvas arg0) const;
		void drawText(android::graphics::Canvas arg0) const;
		void fillCharacterBounds(jint arg0, jint arg1, JFloatArray arg2, jint arg3) const;
		...
		jint getLineLetterSpacingUnitCount(jint arg0, jboolean arg1) const;
		jfloat getLineMax(jint arg0) const;
		jfloat getLineRight(jint arg0) const;
		jfloat getLineSpacingAmount() const;
		...
		JIntArray getRightIndents() const;
		...
		jboolean isFontPaddingIncluded() const;
