...
namespace android::text
{
	...
	public:
		...
		PrecomputedText_Params_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::text::PrecomputedText_Params_Builder setLineBreakConfig(android::graphics::text::LineBreakConfig arg0) const;
