...
namespace android::text::method
{
	...
	public:
		...
		ArrowKeyMovementMethod(QJniObject obj) : android::text::method::BaseMovementMethod(obj) {}
		...
		jboolean nextParagraph(android::widget::TextView arg0, JObject arg1) const;
		...
		jboolean previousParagraph(android::widget::TextView arg0, JObject arg1) const;
	};
} // namespace android::text::method
