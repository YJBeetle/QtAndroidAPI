...
namespace android::text::style
{
	...
	public:
		...
		TtsSpan_TimeBuilder(QJniObject obj) : android::text::style::TtsSpan_SemioticClassBuilder(obj) {}
		...
		android::text::style::TtsSpan_TimeBuilder setSeconds(jint arg0) const;
	};
} // namespace android::text::style
