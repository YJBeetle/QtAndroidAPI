...
namespace android::text
{
	...
	inline android::text::DynamicLayout_Builder DynamicLayout_Builder::setLineBreakConfig(android::graphics::text::LineBreakConfig arg0) const
	{
		return callObjectMethod(
			"setLineBreakConfig",
			"(Landroid/graphics/text/LineBreakConfig;)Landroid/text/DynamicLayout$Builder;",
			arg0.object()
		);
	}
	...
	inline android::text::DynamicLayout_Builder DynamicLayout_Builder::setMinimumFontMetrics(android::graphics::Paint_FontMetrics arg0) const
	{
		return callObjectMethod(
			"setMinimumFontMetrics",
			"(Landroid/graphics/Paint$FontMetrics;)Landroid/text/DynamicLayout$Builder;",
			arg0.object()
		);
	}
	inline android::text::DynamicLayout_Builder DynamicLayout_Builder::setShiftDrawingOffsetForStartOverhang(jboolean arg0) const
	{
		return callObjectMethod(
	...
	inline android::text::DynamicLayout_Builder DynamicLayout_Builder::setUseBoundsForWidth(jboolean arg0) const
	{
		return callObjectMethod(
