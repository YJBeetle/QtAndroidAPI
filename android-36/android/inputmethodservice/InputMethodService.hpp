...
namespace android::inputmethodservice
{
	...
	// Methods
	inline java::time::Duration InputMethodService::getStylusHandwritingIdleTimeoutMax()
	{
	...
	inline void InputMethodService::finishConnectionlessStylusHandwriting(JString arg0) const
	{
		callMethod<void>(
	...
	inline void InputMethodService::finishStylusHandwriting() const
	{
		callMethod<void>(
	...
	inline java::time::Duration InputMethodService::getStylusHandwritingSessionTimeout() const
	{
		return callObjectMethod(
	...
	inline android::view::Window InputMethodService::getStylusHandwritingWindow() const
	{
		return callObjectMethod(
	...
	inline JObject InputMethodService::getSystemService(JString arg0) const
	{
		return callObjectMethod(
			"getSystemService",
	...
	inline void InputMethodService::onCustomImeSwitcherButtonRequestedVisible(jboolean arg0) const
	{
		callMethod<void>(
	...
	inline void InputMethodService::onFinishStylusHandwriting() const
	{
		callMethod<void>(
	...
	inline void InputMethodService::onPrepareStylusHandwriting() const
	{
		callMethod<void>(
	...
	inline jboolean InputMethodService::onShouldVerifyKeyEvent(android::view::KeyEvent arg0) const
	{
		return callMethod<jboolean>(
	...
	inline jboolean InputMethodService::onStartConnectionlessStylusHandwriting(jint arg0, android::view::inputmethod::CursorAnchorInfo arg1) const
	{
		return callMethod<jboolean>(
			"onStartConnectionlessStylusHandwriting",
			"(ILandroid/view/inputmethod/CursorAnchorInfo;)Z",
			arg0,
			arg1.object()
		);
	}
	...
	inline jboolean InputMethodService::onStartStylusHandwriting() const
	{
		return callMethod<jboolean>(
	...
	inline void InputMethodService::onStylusHandwritingMotionEvent(android::view::MotionEvent arg0) const
	{
		callMethod<void>(
	...
	inline void InputMethodService::onUpdateEditorToolType(jint arg0) const
	{
		callMethod<void>(
	...
	inline void InputMethodService::setStylusHandwritingRegion(android::graphics::Region arg0) const
	{
		callMethod<void>(
	...
	inline void InputMethodService::setStylusHandwritingSessionTimeout(java::time::Duration arg0) const
	{
		callMethod<void>(
