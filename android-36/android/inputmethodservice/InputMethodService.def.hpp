...
namespace android::inputmethodservice
{
	...
	public:
		...
		InputMethodService(QJniObject obj) : android::inputmethodservice::AbstractInputMethodService(obj) {}
		
		// Constructors
		InputMethodService();
		
		// Methods
		static java::time::Duration getStylusHandwritingIdleTimeoutMax();
		jboolean enableHardwareAcceleration() const;
		void finishConnectionlessStylusHandwriting(JString arg0) const;
		void finishStylusHandwriting() const;
		...
		java::time::Duration getStylusHandwritingSessionTimeout() const;
		android::view::Window getStylusHandwritingWindow() const;
		...
		void onCustomImeSwitcherButtonRequestedVisible(jboolean arg0) const;
		...
		void onFinishStylusHandwriting() const;
		...
		void onPrepareStylusHandwriting() const;
		jboolean onShouldVerifyKeyEvent(android::view::KeyEvent arg0) const;
		...
		jboolean onStartConnectionlessStylusHandwriting(jint arg0, android::view::inputmethod::CursorAnchorInfo arg1) const;
		...
		jboolean onStartStylusHandwriting() const;
		void onStylusHandwritingMotionEvent(android::view::MotionEvent arg0) const;
		...
		void onUpdateEditorToolType(jint arg0) const;
		...
		void setStylusHandwritingRegion(android::graphics::Region arg0) const;
		void setStylusHandwritingSessionTimeout(java::time::Duration arg0) const;
