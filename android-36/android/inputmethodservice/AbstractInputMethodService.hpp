...
namespace android::inputmethodservice
{
	...
	inline JObject AbstractInputMethodService::getSystemService(JString arg0) const
	{
		return callObjectMethod(
			"getSystemService",
	...
	inline void AbstractInputMethodService::onConfigurationChanged(android::content::res::Configuration arg0) const
	{
		callMethod<void>(
	...
	inline void AbstractInputMethodService::onDestroy() const
	{
		callMethod<void>(
			"onDestroy",
			"()V"
	...
	inline void AbstractInputMethodService::onLowMemory() const
	{
		callMethod<void>(
			"onLowMemory",
			"()V"
	...
	inline jboolean AbstractInputMethodService::onShouldVerifyKeyEvent(android::view::KeyEvent arg0) const
	{
		return callMethod<jboolean>(
	...
	inline void AbstractInputMethodService::onTrimMemory(jint arg0) const
	{
		callMethod<void>(
			"onTrimMemory",
			"(I)V",
	...
	inline void AbstractInputMethodService::registerComponentCallbacks(JObject arg0) const
	{
		callMethod<void>(
	...
	inline void AbstractInputMethodService::unregisterComponentCallbacks(JObject arg0) const
	{
		callMethod<void>(
