...
namespace android
{
	...
	public:
		...
		static jint accessibilityDataSensitive();
		...
		static jint allowCrossUidActivitySwitchFromBelow();
		static jint allowEmbedded();
		static jint allowGameAngleDriver();
		static jint allowGameDownscaling();
		static jint allowGameFpsOverride();
		static jint allowNativeHeapPointerTagging();
		static jint allowParallelSyncs();
		static jint allowSharedIsolatedProcess();
		static jint allowSingleTap();
		static jint allowTaskReparenting();
		static jint allowUndo();
		static jint allowUntrustedActivityEmbedding();
		static jint allowUpdateOwnership();
		static jint alpha();
		...
		static jint autoHandwritingEnabled();
		...
		static jint canDisplayOnRemoteDevices();
		...
		static jint contentSensitivity();
		...
		static jint ems();
		static jint enableOnBackInvokedCallback();
		static jint enableTextStylingShortcuts();
		...
		static jint focusedSearchResultHighlightColor();
		static jint font();
		...
		static jint fragmentAdvancedPattern();
		...
		static jint fragmentPattern();
		static jint fragmentPrefix();
		...
		static jint fragmentSuffix();
		static jint freezesText();
		static jint fromAlpha();
		static jint fromDegrees();
		static jint fromExtendBottom();
		static jint fromExtendLeft();
		static jint fromExtendRight();
		static jint fromExtendTop();
		static jint fromId();
		...
		static jint handwritingBoundsOffsetBottom();
		static jint handwritingBoundsOffsetLeft();
		static jint handwritingBoundsOffsetRight();
		static jint handwritingBoundsOffsetTop();
		...
		static jint intentMatchingFlags();
		...
		static jint level();
		static jint lineBreakStyle();
		static jint lineBreakWordStyle();
		...
		static jint physicalKeyboardHintLanguageTag();
		static jint physicalKeyboardHintLayoutType();
		static jint pivotX();
		static jint pivotY();
		...
		static jint queryAdvancedPattern();
		static jint queryAfterZeroResults();
		static jint queryBackground();
		static jint queryHint();
		static jint queryPattern();
		static jint queryPrefix();
		static jint querySuffix();
		...
		static jint searchResultHighlightColor();
		...
		static jint sharedUserMaxSdkVersion();
		static jint shell();
		static jint shiftDrawingOffsetForStartOverhang();
		static jint shortcutDisabledMessage();
		static jint shortcutId();
		static jint shortcutLongLabel();
		static jint shortcutShortLabel();
		static jint shouldDefaultToObserveMode();
		static jint shouldDisableView();
		static jint shouldUseDefaultUnfoldTransition();
		static jint showAsAction();
		static jint showBackdrop();
		static jint showClockAndComplications();
		...
		static jint stylusHandwritingSettingsActivity();
		...
		static jint supplementalDescription();
		static jint supportedTypes();
		static jint supportsAssist();
		static jint supportsBatteryGameMode();
		static jint supportsConnectionlessStylusHandwriting();
		static jint supportsInlineSuggestions();
		static jint supportsInlineSuggestionsWithTouchExploration();
		...
		static jint supportsPerformanceGameMode();
		static jint supportsPictureInPicture();
		static jint supportsRtl();
		static jint supportsStylusHandwriting();
		...
		static jint toExtendBottom();
		static jint toExtendLeft();
		static jint toExtendRight();
		static jint toExtendTop();
		static jint toId();
		static jint toScene();
		...
		static jint wantsRoleHolderPriority();
		...
		static jint windowIsFrameRatePowerSavingsBalanced();
		...
		static jint windowNoMoveAnimation();
		static jint windowNoTitle();
		static jint windowOptOutEdgeToEdgeEnforcement();
		...
		static jint windowSplashScreenBehavior();
		...
		R_attr(QJniObject obj) : JObject(obj) {}
