...
namespace android::service::voice
{
	...
	inline void VoiceInteractionService::onPrepareToShowSession(android::os::Bundle arg0, jint arg1) const
	{
		callMethod<void>(
	...
	inline void VoiceInteractionService::onShowSessionFailed(android::os::Bundle arg0) const
	{
		callMethod<void>(
			"onShowSessionFailed",
