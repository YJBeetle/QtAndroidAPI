...
{
	// Fields
	inline JString NotificationListenerService::ACTION_SETTINGS_HOME()
	{
	...
	inline jint NotificationListenerService::FLAG_FILTER_TYPE_ALERTING()
	{
	...
	inline jint NotificationListenerService::FLAG_FILTER_TYPE_CONVERSATIONS()
	{
		return getStaticField<jint>(
			"android.service.notification.NotificationListenerService",
	...
	inline jint NotificationListenerService::FLAG_FILTER_TYPE_ONGOING()
	{
		return getStaticField<jint>(
			"android.service.notification.NotificationListenerService",
	...
	inline jint NotificationListenerService::FLAG_FILTER_TYPE_SILENT()
	{
		return getStaticField<jint>(
			"android.service.notification.NotificationListenerService",
	...
	inline JString NotificationListenerService::META_DATA_DEFAULT_AUTOBIND()
	{
		return getStaticObjectField(
			"android.service.notification.NotificationListenerService",
	...
	inline JString NotificationListenerService::META_DATA_DEFAULT_FILTER_TYPES()
	{
		return getStaticObjectField(
			"android.service.notification.NotificationListenerService",
	...
	inline JString NotificationListenerService::META_DATA_DISABLED_FILTER_TYPES()
	{
		return getStaticObjectField(
			"android.service.notification.NotificationListenerService",
	...
	inline jint NotificationListenerService::REASON_ASSISTANT_CANCEL()
	{
		return getStaticField<jint>(
			"android.service.notification.NotificationListenerService",
	...
	inline jint NotificationListenerService::REASON_CHANNEL_REMOVED()
	{
		return getStaticField<jint>(
			"android.service.notification.NotificationListenerService",
	...
	inline jint NotificationListenerService::REASON_CLEAR_DATA()
	{
		return getStaticField<jint>(
			"android.service.notification.NotificationListenerService",
			"REASON_CLEAR_DATA"
	...
	inline jint NotificationListenerService::REASON_LOCKDOWN()
	{
		return getStaticField<jint>(
			"android.service.notification.NotificationListenerService",
			"REASON_LOCKDOWN"
	...
	inline void NotificationListenerService::requestUnbind(android::content::ComponentName arg0)
	{
		callStaticMethod<void>(
			"android.service.notification.NotificationListenerService",
			"requestUnbind",
	...
	inline void NotificationListenerService::clearRequestedListenerHints() const
	{
		callMethod<void>(
	...
	inline android::app::NotificationChannel NotificationListenerService::createConversationNotificationChannelForPackage(JString arg0, android::os::UserHandle arg1, JString arg2, JString arg3) const
	{
		return callObjectMethod(
			"createConversationNotificationChannelForPackage",
			"(Ljava/lang/String;Landroid/os/UserHandle;Ljava/lang/String;Ljava/lang/String;)Landroid/app/NotificationChannel;",
			arg0.object<jstring>(),
			arg1.object(),
			arg2.object<jstring>(),
			arg3.object<jstring>()
	...
	inline void NotificationListenerService::migrateNotificationFilter(jint arg0, JObject arg1) const
	{
		callMethod<void>(
	...
	inline void NotificationListenerService::onSilentStatusBarIconsVisibilityChanged(jboolean arg0) const
	{
		callMethod<void>(
