...
namespace android::service::notification
{
	...
	public:
		// Fields
		static JString ACTION_SETTINGS_HOME();
		static jint FLAG_FILTER_TYPE_ALERTING();
		static jint FLAG_FILTER_TYPE_CONVERSATIONS();
		static jint FLAG_FILTER_TYPE_ONGOING();
		static jint FLAG_FILTER_TYPE_SILENT();
		...
		static JString META_DATA_DEFAULT_AUTOBIND();
		...
		static jint REASON_ASSISTANT_CANCEL();
		static jint REASON_CANCEL();
		static jint REASON_CANCEL_ALL();
		static jint REASON_CHANNEL_BANNED();
		static jint REASON_CHANNEL_REMOVED();
		static jint REASON_CLEAR_DATA();
		...
		NotificationListenerService(QJniObject obj) : android::app::Service(obj) {}
		...
		static void requestUnbind(android::content::ComponentName arg0);
		...
		android::app::NotificationChannel createConversationNotificationChannelForPackage(JString arg0, android::os::UserHandle arg1, JString arg2, JString arg3) const;
		...
		void migrateNotificationFilter(jint arg0, JObject arg1) const;
