...
namespace android::service::notification
{
	...
	inline jint Condition::SOURCE_CONTEXT()
	{
		return getStaticField<jint>(
			"android.service.notification.Condition",
			"SOURCE_CONTEXT"
	...
	inline jint Condition::SOURCE_SCHEDULE()
	{
		return getStaticField<jint>(
			"android.service.notification.Condition",
			"SOURCE_SCHEDULE"
	...
	inline jint Condition::SOURCE_UNKNOWN()
	{
		return getStaticField<jint>(
			"android.service.notification.Condition",
			"SOURCE_UNKNOWN"
	...
	inline jint Condition::SOURCE_USER_ACTION()
	{
		return getStaticField<jint>(
			"android.service.notification.Condition",
			"SOURCE_USER_ACTION"
	...
	inline Condition::Condition(android::net::Uri arg0, JString arg1, jint arg2, jint arg3)
		: JObject(
			"android.service.notification.Condition",
			"(Landroid/net/Uri;Ljava/lang/String;II)V",
			arg0.object(),
			arg1.object<jstring>(),
			arg2,
			arg3
	...
	inline Condition::Condition(android::net::Uri arg0, JString arg1, JString arg2, JString arg3, jint arg4, jint arg5, jint arg6, jint arg7)
		: JObject(
			"android.service.notification.Condition",
			"(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IIII)V",
			arg0.object(),
			arg1.object<jstring>(),
			arg2.object<jstring>(),
			arg3.object<jstring>(),
