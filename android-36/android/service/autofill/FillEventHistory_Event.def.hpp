...
namespace android::service::autofill
{
	...
	public:
		...
		static jint NO_SAVE_UI_REASON_USING_CREDMAN();
		...
		static jint TYPE_VIEW_REQUESTED_AUTOFILL();
		static jint UI_TYPE_CREDENTIAL_MANAGER();
		...
		JObject getShownDatasetIds() const;
		jint getType() const;
