...
namespace android::service::autofill
{
	...
	inline jint FillEventHistory_Event::NO_SAVE_UI_REASON_USING_CREDMAN()
	{
		return getStaticField<jint>(
			"android.service.autofill.FillEventHistory$Event",
	...
	inline jint FillEventHistory_Event::TYPE_VIEW_REQUESTED_AUTOFILL()
	{
		return getStaticField<jint>(
			"android.service.autofill.FillEventHistory$Event",
	...
	inline jint FillEventHistory_Event::UI_TYPE_CREDENTIAL_MANAGER()
	{
		return getStaticField<jint>(
			"android.service.autofill.FillEventHistory$Event",
	...
	inline jint FillEventHistory_Event::UI_TYPE_DIALOG()
	{
		return getStaticField<jint>(
			"android.service.autofill.FillEventHistory$Event",
			"UI_TYPE_DIALOG"
	...
	inline jint FillEventHistory_Event::UI_TYPE_INLINE()
	{
		return getStaticField<jint>(
			"android.service.autofill.FillEventHistory$Event",
			"UI_TYPE_INLINE"
	...
	inline jint FillEventHistory_Event::UI_TYPE_MENU()
	{
		return getStaticField<jint>(
			"android.service.autofill.FillEventHistory$Event",
			"UI_TYPE_MENU"
	...
	inline jint FillEventHistory_Event::UI_TYPE_UNKNOWN()
	{
		return getStaticField<jint>(
			"android.service.autofill.FillEventHistory$Event",
			"UI_TYPE_UNKNOWN"
	...
	inline android::view::autofill::AutofillId FillEventHistory_Event::getFocusedId() const
	{
		return callObjectMethod(
			"getFocusedId",
	...
	inline JObject FillEventHistory_Event::getShownDatasetIds() const
	{
		return callObjectMethod(
			"getShownDatasetIds",
			"()Ljava/util/Set;"
	...
	inline jint FillEventHistory_Event::getUiType() const
	{
		return callMethod<jint>(
			"getUiType",
			"()I"
