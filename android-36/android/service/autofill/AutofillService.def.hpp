...
namespace android::service::autofill
{
	...
	public:
		// Fields
		static JString EXTRA_FILL_RESPONSE();
		...
		AutofillService(QJniObject obj) : android::app::Service(obj) {}
		...
		void onSessionDestroyed(android::service::autofill::FillEventHistory arg0) const;
	};
} // namespace android::service::autofill
