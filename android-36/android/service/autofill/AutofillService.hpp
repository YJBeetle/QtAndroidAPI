...
{
	// Fields
	inline JString AutofillService::EXTRA_FILL_RESPONSE()
	{
	...
	inline void AutofillService::onSessionDestroyed(android::service::autofill::FillEventHistory arg0) const
	{
		callMethod<void>(
			"onSessionDestroyed",
			"(Landroid/service/autofill/FillEventHistory;)V",
			arg0.object()
		);
	}
} // namespace android::service::autofill
