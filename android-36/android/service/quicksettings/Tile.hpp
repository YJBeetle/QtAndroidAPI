...
namespace android::service::quicksettings
{
	...
	inline android::app::PendingIntent Tile::getActivityLaunchForClick() const
	{
	...
	inline JString Tile::getStateDescription() const
	{
		return callObjectMethod(
			"getStateDescription",
			"()Ljava/lang/CharSequence;"
	...
	inline void Tile::setActivityLaunchForClick(android::app::PendingIntent arg0) const
	{
		callMethod<void>(
	...
	inline void Tile::setStateDescription(JString arg0) const
	{
		callMethod<void>(
			"setStateDescription",
			"(Ljava/lang/CharSequence;)V",
