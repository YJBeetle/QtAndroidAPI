...
namespace android::service::wallpaper
{
	...
	public:
		...
		WallpaperService(QJniObject obj) : android::app::Service(obj) {}
		...
		android::service::wallpaper::WallpaperService_Engine onCreateEngine(android::app::wallpaper::WallpaperDescription arg0) const;
