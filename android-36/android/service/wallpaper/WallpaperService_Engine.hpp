...
#include "../../app/wallpaper/WallpaperDescription.def.hpp"
...
namespace android::service::wallpaper
{
	...
	inline jint WallpaperService_Engine::getWallpaperFlags() const
	{
		return callMethod<jint>(
			"getWallpaperFlags",
			"()I"
	...
	inline android::app::wallpaper::WallpaperDescription WallpaperService_Engine::onApplyWallpaper(jint arg0) const
	{
		return callObjectMethod(
			"onApplyWallpaper",
			"(I)Landroid/app/wallpaper/WallpaperDescription;",
			arg0
		);
	}
	...
	inline void WallpaperService_Engine::onWallpaperFlagsChanged(jint arg0) const
	{
		callMethod<void>(
	...
	inline void WallpaperService_Engine::onZoomChanged(jfloat arg0) const
	{
		callMethod<void>(
			"onZoomChanged",
			"(F)V",
...
using namespace android::service::wallpaper;
#endif
