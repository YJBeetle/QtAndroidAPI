...
namespace android::service::wallpaper
{
	...
	inline android::service::wallpaper::WallpaperService_Engine WallpaperService::onCreateEngine(android::app::wallpaper::WallpaperDescription arg0) const
	{
		return callObjectMethod(
			"onCreateEngine",
			"(Landroid/app/wallpaper/WallpaperDescription;)Landroid/service/wallpaper/WallpaperService$Engine;",
			arg0.object()
		);
	}
