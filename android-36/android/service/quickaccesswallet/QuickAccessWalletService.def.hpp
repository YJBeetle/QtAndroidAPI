...
namespace android::service::quickaccesswallet
{
	...
	public:
		...
		QuickAccessWalletService(QJniObject obj) : android::app::Service(obj) {}
		
		// Constructors
		QuickAccessWalletService();
		
		// Methods
		android::app::PendingIntent getGestureTargetActivityPendingIntent() const;
		android::app::PendingIntent getTargetActivityPendingIntent() const;
