...
namespace android::service::quickaccesswallet
{
	...
	// Methods
	inline android::app::PendingIntent QuickAccessWalletService::getGestureTargetActivityPendingIntent() const
	{
	...
	inline android::app::PendingIntent QuickAccessWalletService::getTargetActivityPendingIntent() const
	{
		return callObjectMethod(
