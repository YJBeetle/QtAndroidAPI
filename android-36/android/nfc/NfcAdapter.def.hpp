...
namespace android::nfc
{
	...
	public:
		...
		static JString ACTION_CHANGE_TAG_INTENT_PREFERENCE();
		static JString ACTION_NDEF_DISCOVERED();
		static JString ACTION_PREFERRED_PAYMENT_CHANGED();
		...
		static JString EXTRA_PREFERRED_PAYMENT_CHANGED_REASON();
		static JString EXTRA_READER_PRESENCE_CHECK_DELAY();
		static JString EXTRA_SECURE_ELEMENT_NAME();
		static JString EXTRA_TAG();
		static jint FLAG_LISTEN_DISABLE();
		static jint FLAG_LISTEN_KEEP();
		static jint FLAG_LISTEN_NFC_PASSIVE_A();
		static jint FLAG_LISTEN_NFC_PASSIVE_B();
		static jint FLAG_LISTEN_NFC_PASSIVE_F();
		static jint FLAG_READER_DISABLE();
		static jint FLAG_READER_KEEP();
		...
		static jint PREFERRED_PAYMENT_CHANGED();
		static jint PREFERRED_PAYMENT_LOADED();
		static jint PREFERRED_PAYMENT_UPDATED();
		...
		NfcAdapter(QJniObject obj) : JObject(obj) {}
		...
		android::nfc::NfcAntennaInfo getNfcAntennaInfo() const;
		jboolean ignore(android::nfc::Tag arg0, jint arg1, JObject arg2, android::os::Handler arg3) const;
		jboolean isEnabled() const;
		jboolean isObserveModeEnabled() const;
		jboolean isObserveModeSupported() const;
		jboolean isReaderOptionEnabled() const;
		jboolean isReaderOptionSupported() const;
		jboolean isSecureNfcEnabled() const;
		jboolean isSecureNfcSupported() const;
		jboolean isTagIntentAllowed() const;
		jboolean isTagIntentAppPreferenceSupported() const;
		void resetDiscoveryTechnology(android::app::Activity arg0) const;
		void setDiscoveryTechnology(android::app::Activity arg0, jint arg1, jint arg2) const;
		jboolean setObserveModeEnabled(jboolean arg0) const;
	};
} // namespace android::nfc
