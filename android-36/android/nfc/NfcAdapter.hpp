...
namespace android::nfc
{
	...
	inline JString NfcAdapter::ACTION_CHANGE_TAG_INTENT_PREFERENCE()
	{
		return getStaticObjectField(
			"android.nfc.NfcAdapter",
	...
	inline JString NfcAdapter::ACTION_PREFERRED_PAYMENT_CHANGED()
	{
		return getStaticObjectField(
			"android.nfc.NfcAdapter",
	...
	inline JString NfcAdapter::EXTRA_PREFERRED_PAYMENT_CHANGED_REASON()
	{
		return getStaticObjectField(
			"android.nfc.NfcAdapter",
	...
	inline jint NfcAdapter::FLAG_LISTEN_DISABLE()
	{
	...
	inline jint NfcAdapter::FLAG_LISTEN_KEEP()
	{
		return getStaticField<jint>(
			"android.nfc.NfcAdapter",
			"FLAG_LISTEN_KEEP"
	...
	inline jint NfcAdapter::FLAG_LISTEN_NFC_PASSIVE_A()
	{
		return getStaticField<jint>(
			"android.nfc.NfcAdapter",
	...
	inline jint NfcAdapter::FLAG_LISTEN_NFC_PASSIVE_B()
	{
		return getStaticField<jint>(
			"android.nfc.NfcAdapter",
	...
	inline jint NfcAdapter::FLAG_LISTEN_NFC_PASSIVE_F()
	{
		return getStaticField<jint>(
			"android.nfc.NfcAdapter",
	...
	inline jint NfcAdapter::FLAG_READER_DISABLE()
	{
		return getStaticField<jint>(
			"android.nfc.NfcAdapter",
			"FLAG_READER_DISABLE"
	...
	inline jint NfcAdapter::FLAG_READER_KEEP()
	{
		return getStaticField<jint>(
			"android.nfc.NfcAdapter",
			"FLAG_READER_KEEP"
	...
	inline jint NfcAdapter::PREFERRED_PAYMENT_CHANGED()
	{
		return getStaticField<jint>(
			"android.nfc.NfcAdapter",
	...
	inline jint NfcAdapter::PREFERRED_PAYMENT_LOADED()
	{
		return getStaticField<jint>(
			"android.nfc.NfcAdapter",
	...
	inline jint NfcAdapter::PREFERRED_PAYMENT_UPDATED()
	{
		return getStaticField<jint>(
			"android.nfc.NfcAdapter",
	...
	inline jboolean NfcAdapter::disable() const
	{
	...
	inline jboolean NfcAdapter::enable() const
	{
		return callMethod<jboolean>(
			"enable",
			"()Z"
	...
	inline android::nfc::NfcAntennaInfo NfcAdapter::getNfcAntennaInfo() const
	{
	...
	inline jboolean NfcAdapter::isObserveModeEnabled() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean NfcAdapter::isObserveModeSupported() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean NfcAdapter::isReaderOptionEnabled() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean NfcAdapter::isReaderOptionSupported() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean NfcAdapter::isSecureNfcEnabled() const
	{
		return callMethod<jboolean>(
			"isSecureNfcEnabled",
			"()Z"
	...
	inline jboolean NfcAdapter::isSecureNfcSupported() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean NfcAdapter::isTagIntentAllowed() const
	{
		return callMethod<jboolean>(
			"isTagIntentAllowed",
			"()Z"
	...
	inline jboolean NfcAdapter::isTagIntentAppPreferenceSupported() const
	{
		return callMethod<jboolean>(
	...
	inline void NfcAdapter::resetDiscoveryTechnology(android::app::Activity arg0) const
	{
		callMethod<void>(
	...
	inline void NfcAdapter::setDiscoveryTechnology(android::app::Activity arg0, jint arg1, jint arg2) const
	{
		callMethod<void>(
	...
	inline jboolean NfcAdapter::setObserveModeEnabled(jboolean arg0) const
	{
		return callMethod<jboolean>(
