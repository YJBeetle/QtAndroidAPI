...
namespace android::os
{
	...
	inline jint Process::INVALID_PID()
	{
		return getStaticField<jint>(
			"android.os.Process",
			"INVALID_PID"
	...
	// Methods
	inline jint Process::getAppUidForSdkSandboxUid(jint arg0)
	{
	...
	inline jint Process::getSdkSandboxUidForAppUid(jint arg0)
	{
		return callStaticMethod<jint>(
			"android.os.Process",
	...
	inline jlong Process::getStartRequestedElapsedRealtime()
	{
		return callStaticMethod<jlong>(
			"android.os.Process",
	...
	inline jlong Process::getStartRequestedUptimeMillis()
	{
		return callStaticMethod<jlong>(
			"android.os.Process",
	...
	inline jboolean Process::isIsolatedUid(jint arg0)
	{
		return callStaticMethod<jboolean>(
			"android.os.Process",
			"isIsolatedUid",
	...
	inline jboolean Process::isSdkSandbox()
	{
		return callStaticMethod<jboolean>(
			"android.os.Process",
			"isSdkSandbox",
	...
	inline jboolean Process::isSdkSandboxUid(jint arg0)
	{
		return callStaticMethod<jboolean>(
			"android.os.Process",
			"isSdkSandboxUid",
	...
	inline JString Process::myProcessName()
	{
		return callStaticObjectMethod(
			"android.os.Process",
			"myProcessName",
