...
namespace android::os
{
	...
	inline jboolean TestLooperManager::isBlockedOnSyncBarrier() const
	{
		return callMethod<jboolean>(
	...
	inline java::lang::Long TestLooperManager::peekWhen() const
	{
		return callObjectMethod(
			"peekWhen",
			"()Ljava/lang/Long;"
	...
	inline android::os::Message TestLooperManager::poll() const
	{
		return callObjectMethod(
			"poll",
			"()Landroid/os/Message;"
