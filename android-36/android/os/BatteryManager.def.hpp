...
namespace android::os
{
	...
	public:
		...
		static jint BATTERY_CAPACITY_LEVEL_CRITICAL();
		static jint BATTERY_CAPACITY_LEVEL_FULL();
		static jint BATTERY_CAPACITY_LEVEL_HIGH();
		static jint BATTERY_CAPACITY_LEVEL_LOW();
		static jint BATTERY_CAPACITY_LEVEL_NORMAL();
		static jint BATTERY_CAPACITY_LEVEL_UNKNOWN();
		static jint BATTERY_CAPACITY_LEVEL_UNSUPPORTED();
		...
		static JString EXTRA_CAPACITY_LEVEL();
		...
		JString getStringProperty(jint arg0) const;
