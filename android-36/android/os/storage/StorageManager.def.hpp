...
namespace android::os::storage
{
	...
	public:
		...
		StorageManager(QJniObject obj) : JObject(obj) {}
		...
		android::app::PendingIntent getManageSpaceActivityIntent(JString arg0, jint arg1) const;
		...
		JObject getStorageVolumesIncludingSharedProfiles() const;
