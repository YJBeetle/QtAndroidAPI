...
namespace android::os
{
	...
	public:
		// Fields
		static jint DELAY_TYPE_PAUSE();
		static jint DELAY_TYPE_RELATIVE_START_OFFSET();
		...
		VibrationEffect_Composition(QJniObject obj) : JObject(obj) {}
		...
		android::os::VibrationEffect_Composition addPrimitive(jint arg0, jfloat arg1, jint arg2, jint arg3) const;
