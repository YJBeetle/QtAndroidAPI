...
namespace android::os
{
	...
	inline JString UserManager::DISALLOW_ADD_PRIVATE_PROFILE()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_ADD_WIFI_CONFIG()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_ASSIST_CONTENT()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_CAMERA_TOGGLE()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_CELLULAR_2G()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_CHANGE_NEAR_FIELD_COMMUNICATION_RADIO()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_CHANGE_WIFI_STATE()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_CONFIG_DEFAULT_APPS()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_CONFIG_PRIVATE_DNS()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_CONTENT_CAPTURE()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_CONTENT_SUGGESTIONS()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_GRANT_ADMIN()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_INSTALL_UNKNOWN_SOURCES_GLOBALLY()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_MICROPHONE_TOGGLE()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_NEAR_FIELD_COMMUNICATION_RADIO()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_SHARING_ADMIN_CONFIGURED_WIFI()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_SIM_GLOBALLY()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_THREAD_NETWORK()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_ULTRA_WIDEBAND_RADIO()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_WIFI_DIRECT()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::DISALLOW_WIFI_TETHERING()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline jint UserManager::QUIET_MODE_DISABLE_ONLY_IF_CREDENTIAL_NOT_REQUIRED()
	{
	...
	inline JString UserManager::USER_TYPE_PROFILE_CLONE()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::USER_TYPE_PROFILE_MANAGED()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline JString UserManager::USER_TYPE_PROFILE_PRIVATE()
	{
		return getStaticObjectField(
			"android.os.UserManager",
	...
	inline jboolean UserManager::isHeadlessSystemUserMode()
	{
	...
	inline jboolean UserManager::isAdminUser() const
	{
		return callMethod<jboolean>(
			"isAdminUser",
			"()Z"
	...
	inline jboolean UserManager::isManagedProfile() const
	{
		return callMethod<jboolean>(
			"isManagedProfile",
			"()Z"
	...
	inline jboolean UserManager::isProfile() const
	{
		return callMethod<jboolean>(
			"isProfile",
			"()Z"
	...
	inline jboolean UserManager::isUserForeground() const
	{
		return callMethod<jboolean>(
			"isUserForeground",
			"()Z"
	...
	inline jboolean UserManager::requestQuietModeEnabled(jboolean arg0, android::os::UserHandle arg1, jint arg2) const
	{
		return callMethod<jboolean>(
			"requestQuietModeEnabled",
			"(ZLandroid/os/UserHandle;I)Z",
			arg0,
			arg1.object(),
			arg2
		);
