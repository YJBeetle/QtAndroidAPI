...
namespace android::os
{
	...
	public:
		...
		static JString DISALLOW_ADD_PRIVATE_PROFILE();
		static JString DISALLOW_ADD_USER();
		static JString DISALLOW_ADD_WIFI_CONFIG();
		...
		static JString DISALLOW_ASSIST_CONTENT();
		...
		static JString DISALLOW_CELLULAR_2G();
		static JString DISALLOW_CHANGE_NEAR_FIELD_COMMUNICATION_RADIO();
		static JString DISALLOW_CHANGE_WIFI_STATE();
		...
		static JString DISALLOW_CONFIG_DEFAULT_APPS();
		...
		static JString DISALLOW_GRANT_ADMIN();
		...
		static JString DISALLOW_NEAR_FIELD_COMMUNICATION_RADIO();
		...
		static JString DISALLOW_SHARING_ADMIN_CONFIGURED_WIFI();
		static JString DISALLOW_SIM_GLOBALLY();
		static JString DISALLOW_SMS();
		static JString DISALLOW_SYSTEM_ERROR_DIALOGS();
		static JString DISALLOW_THREAD_NETWORK();
		static JString DISALLOW_ULTRA_WIDEBAND_RADIO();
		...
		static JString DISALLOW_WIFI_DIRECT();
		static JString DISALLOW_WIFI_TETHERING();
		...
		static JString USER_TYPE_PROFILE_CLONE();
		static JString USER_TYPE_PROFILE_MANAGED();
		static JString USER_TYPE_PROFILE_PRIVATE();
		...
		UserManager(QJniObject obj) : JObject(obj) {}
