...
namespace android::os
{
	...
	inline JString Build::SOC_MANUFACTURER()
	{
		return getStaticObjectField(
			"android.os.Build",
			"SOC_MANUFACTURER",
	...
	inline JString Build::SOC_MODEL()
	{
		return getStaticObjectField(
			"android.os.Build",
			"SOC_MODEL",
	...
	inline jint Build::getMajorSdkVersion(jint arg0)
	{
	...
	inline jint Build::getMinorSdkVersion(jint arg0)
	{
		return callStaticMethod<jint>(
			"android.os.Build",
			"getMinorSdkVersion",
