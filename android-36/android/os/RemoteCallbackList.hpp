...
{
	// Fields
	inline jint RemoteCallbackList::FROZEN_CALLEE_POLICY_DROP()
	{
	...
	inline jint RemoteCallbackList::FROZEN_CALLEE_POLICY_ENQUEUE_ALL()
	{
		return getStaticField<jint>(
			"android.os.RemoteCallbackList",
	...
	inline jint RemoteCallbackList::FROZEN_CALLEE_POLICY_ENQUEUE_MOST_RECENT()
	{
		return getStaticField<jint>(
			"android.os.RemoteCallbackList",
	...
	inline jint RemoteCallbackList::FROZEN_CALLEE_POLICY_UNSET()
	{
		return getStaticField<jint>(
			"android.os.RemoteCallbackList",
	...
	inline void RemoteCallbackList::broadcast(JObject arg0) const
	{
		callMethod<void>(
			"broadcast",
	...
	inline JObject RemoteCallbackList::getExecutor() const
	{
		return callObjectMethod(
			"getExecutor",
	...
	inline jint RemoteCallbackList::getFrozenCalleePolicy() const
	{
		return callMethod<jint>(
	...
	inline jint RemoteCallbackList::getMaxQueueSize() const
	{
		return callMethod<jint>(
			"getMaxQueueSize",
			"()I"
