...
namespace android::os
{
	...
	inline JObject Bundle::getParcelable(JString arg0, JClass arg1) const
	{
		return callObjectMethod(
			"getParcelable",
	...
	inline JObjectArray Bundle::getParcelableArray(JString arg0, JClass arg1) const
	{
		return callObjectMethod(
			"getParcelableArray",
			"(Ljava/lang/String;Ljava/lang/Class;)[Ljava/lang/Object;",
	...
	inline java::util::ArrayList Bundle::getParcelableArrayList(JString arg0, JClass arg1) const
	{
		return callObjectMethod(
			"getParcelableArrayList",
	...
	inline JObject Bundle::getSerializable(JString arg0, JClass arg1) const
	{
		return callObjectMethod(
			"getSerializable",
	...
	inline android::util::SparseArray Bundle::getSparseParcelableArray(JString arg0, JClass arg1) const
	{
		return callObjectMethod(
			"getSparseParcelableArray",
			"(Ljava/lang/String;Ljava/lang/Class;)Landroid/util/SparseArray;",
			arg0.object<jstring>(),
			arg1.object<jclass>()
		);
	}
