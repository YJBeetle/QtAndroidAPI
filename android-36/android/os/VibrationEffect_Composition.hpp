...
{
	// Fields
	inline jint VibrationEffect_Composition::DELAY_TYPE_PAUSE()
	{
	...
	inline jint VibrationEffect_Composition::DELAY_TYPE_RELATIVE_START_OFFSET()
	{
		return getStaticField<jint>(
			"android.os.VibrationEffect$Composition",
	...
	inline android::os::VibrationEffect_Composition VibrationEffect_Composition::addPrimitive(jint arg0, jfloat arg1, jint arg2, jint arg3) const
	{
		return callObjectMethod(
			"addPrimitive",
			"(IFII)Landroid/os/VibrationEffect$Composition;",
			arg0,
			arg1,
			arg2,
			arg3
