...
namespace android::os
{
	...
	public:
		...
		static JString ACTION_LOW_POWER_STANDBY_ENABLED_CHANGED();
		static JString ACTION_LOW_POWER_STANDBY_POLICY_CHANGED();
		static JString ACTION_POWER_SAVE_MODE_CHANGED();
		static JString FEATURE_WAKE_ON_LAN_IN_LOW_POWER_STANDBY();
		...
		static jint LOW_POWER_STANDBY_ALLOWED_REASON_ONGOING_CALL();
		static jint LOW_POWER_STANDBY_ALLOWED_REASON_TEMP_POWER_SAVE_ALLOWLIST();
		static jint LOW_POWER_STANDBY_ALLOWED_REASON_VOICE_INTERACTION();
		...
		// Methods
		void addThermalHeadroomListener(JObject arg0) const;
		void addThermalHeadroomListener(JObject arg0, JObject arg1) const;
		void addThermalStatusListener(JObject arg0) const;
		void addThermalStatusListener(JObject arg0, JObject arg1) const;
		java::time::Duration getBatteryDischargePrediction() const;
		jint getCurrentThermalStatus() const;
		jint getLocationPowerSaveMode() const;
		jfloat getThermalHeadroom(jint arg0) const;
		JObject getThermalHeadroomThresholds() const;
		jboolean isAllowedInLowPowerStandby(jint arg0) const;
		jboolean isAllowedInLowPowerStandby(JString arg0) const;
		jboolean isBatteryDischargePredictionPersonalized() const;
		jboolean isDeviceIdleMode() const;
		jboolean isDeviceLightIdleMode() const;
		jboolean isExemptFromLowPowerStandby() const;
		jboolean isIgnoringBatteryOptimizations(JString arg0) const;
		jboolean isInteractive() const;
		jboolean isLowPowerStandbyEnabled() const;
		...
		void removeThermalHeadroomListener(JObject arg0) const;
