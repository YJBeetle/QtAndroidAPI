...
namespace android::os
{
	...
	public:
		...
		VibrationEffect(QJniObject obj) : JObject(obj) {}
		...
		static android::os::VibrationEffect createRepeatingEffect(android::os::VibrationEffect arg0);
		static android::os::VibrationEffect createRepeatingEffect(android::os::VibrationEffect arg0, android::os::VibrationEffect arg1);
