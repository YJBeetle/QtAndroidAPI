...
namespace android::os
{
	...
	inline android::os::VibrationEffect VibrationEffect::createRepeatingEffect(android::os::VibrationEffect arg0)
	{
		return callStaticObjectMethod(
			"android.os.VibrationEffect",
			"createRepeatingEffect",
			"(Landroid/os/VibrationEffect;)Landroid/os/VibrationEffect;",
			arg0.object()
		);
	}
	inline android::os::VibrationEffect VibrationEffect::createRepeatingEffect(android::os::VibrationEffect arg0, android::os::VibrationEffect arg1)
	{
		return callStaticObjectMethod(
			"android.os.VibrationEffect",
			"createRepeatingEffect",
			"(Landroid/os/VibrationEffect;Landroid/os/VibrationEffect;)Landroid/os/VibrationEffect;",
			arg0.object(),
			arg1.object()
		);
	}
	...
	inline android::os::VibrationEffect_Composition VibrationEffect::startComposition()
	{
		return callStaticObjectMethod(
			"android.os.VibrationEffect",
			"startComposition",
