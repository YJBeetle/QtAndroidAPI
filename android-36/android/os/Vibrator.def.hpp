...
namespace android::os
{
	...
	public:
		...
		Vibrator(QJniObject obj) : JObject(obj) {}
		...
		jboolean areEnvelopeEffectsSupported() const;
		JBooleanArray arePrimitivesSupported(JIntArray arg0) const;
		void cancel() const;
		android::os::vibrator::VibratorEnvelopeEffectInfo getEnvelopeEffectInfo() const;
		android::os::vibrator::VibratorFrequencyProfile getFrequencyProfile() const;
		jint getId() const;
		JIntArray getPrimitiveDurations(JIntArray arg0) const;
		jfloat getQFactor() const;
		jfloat getResonantFrequency() const;
		...
		void vibrate(android::os::VibrationEffect arg0, android::os::VibrationAttributes arg1) const;
