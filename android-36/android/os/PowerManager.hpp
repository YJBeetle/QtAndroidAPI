...
namespace android::os
{
	...
	// Methods
	inline void PowerManager::addThermalHeadroomListener(JObject arg0) const
	{
		callMethod<void>(
			"addThermalHeadroomListener",
			"(Landroid/os/PowerManager$OnThermalHeadroomChangedListener;)V",
			arg0.object()
		);
	}
	inline void PowerManager::addThermalHeadroomListener(JObject arg0, JObject arg1) const
	{
		callMethod<void>(
			"addThermalHeadroomListener",
			"(Ljava/util/concurrent/Executor;Landroid/os/PowerManager$OnThermalHeadroomChangedListener;)V",
			arg0.object(),
			arg1.object()
		);
	}
	...
	inline JObject PowerManager::getThermalHeadroomThresholds() const
	{
		return callObjectMethod(
	...
	inline void PowerManager::removeThermalHeadroomListener(JObject arg0) const
	{
		callMethod<void>(
