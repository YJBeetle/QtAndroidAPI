...
namespace android::os
{
	...
	public:
		...
		StrictMode_VmPolicy_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::os::StrictMode_VmPolicy_Builder detectBlockedBackgroundActivityLaunch() const;
		...
		android::os::StrictMode_VmPolicy_Builder ignoreBlockedBackgroundActivityLaunch() const;
