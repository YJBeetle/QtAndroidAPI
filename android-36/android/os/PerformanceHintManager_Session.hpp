...
namespace android::os
{
	...
	inline void PerformanceHintManager_Session::reportActualWorkDuration(android::os::WorkDuration arg0) const
	{
		callMethod<void>(
			"reportActualWorkDuration",
			"(Landroid/os/WorkDuration;)V",
			arg0.object()
		);
	}
	...
	inline void PerformanceHintManager_Session::setPreferPowerEfficiency(jboolean arg0) const
	{
		callMethod<void>(
