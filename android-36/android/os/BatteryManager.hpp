...
namespace android::os
{
	...
	inline jint BatteryManager::BATTERY_CAPACITY_LEVEL_CRITICAL()
	{
	...
	inline jint BatteryManager::BATTERY_CAPACITY_LEVEL_FULL()
	{
		return getStaticField<jint>(
			"android.os.BatteryManager",
	...
	inline jint BatteryManager::BATTERY_CAPACITY_LEVEL_HIGH()
	{
		return getStaticField<jint>(
			"android.os.BatteryManager",
	...
	inline jint BatteryManager::BATTERY_CAPACITY_LEVEL_LOW()
	{
		return getStaticField<jint>(
			"android.os.BatteryManager",
	...
	inline jint BatteryManager::BATTERY_CAPACITY_LEVEL_NORMAL()
	{
		return getStaticField<jint>(
			"android.os.BatteryManager",
	...
	inline jint BatteryManager::BATTERY_CAPACITY_LEVEL_UNKNOWN()
	{
		return getStaticField<jint>(
			"android.os.BatteryManager",
	...
	inline jint BatteryManager::BATTERY_CAPACITY_LEVEL_UNSUPPORTED()
	{
		return getStaticField<jint>(
			"android.os.BatteryManager",
	...
	inline JString BatteryManager::EXTRA_CAPACITY_LEVEL()
	{
		return getStaticObjectField(
			"android.os.BatteryManager",
	...
	inline JString BatteryManager::getStringProperty(jint arg0) const
	{
