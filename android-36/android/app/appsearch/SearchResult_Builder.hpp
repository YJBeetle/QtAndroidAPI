...
namespace android::app::appsearch
{
	...
	// Methods
	inline android::app::appsearch::SearchResult_Builder SearchResult_Builder::addInformationalRankingSignal(jdouble arg0) const
	{
	...
	inline android::app::appsearch::SearchResult_Builder SearchResult_Builder::addJoinedResult(android::app::appsearch::SearchResult arg0) const
	{
		return callObjectMethod(
			"addJoinedResult",
			"(Landroid/app/appsearch/SearchResult;)Landroid/app/appsearch/SearchResult$Builder;",
			arg0.object()
		);
	}
	...
	inline android::app::appsearch::SearchResult_Builder SearchResult_Builder::setParentTypeMap(JObject arg0) const
	{
		return callObjectMethod(
			"setParentTypeMap",
			"(Ljava/util/Map;)Landroid/app/appsearch/SearchResult$Builder;",
			arg0.object()
		);
	}
