...
namespace android::app::appsearch
{
	...
	inline android::app::appsearch::AppSearchBlobHandle GenericDocument::getPropertyBlobHandle(JString arg0) const
	{
		return callObjectMethod(
			"getPropertyBlobHandle",
			"(Ljava/lang/String;)Landroid/app/appsearch/AppSearchBlobHandle;",
			arg0.object<jstring>()
		);
	}
	inline JArray GenericDocument::getPropertyBlobHandleArray(JString arg0) const
	{
		return callObjectMethod(
	...
	inline android::app::appsearch::EmbeddingVector GenericDocument::getPropertyEmbedding(JString arg0) const
	{
		return callObjectMethod(
			"getPropertyEmbedding",
			"(Ljava/lang/String;)Landroid/app/appsearch/EmbeddingVector;",
			arg0.object<jstring>()
		);
	}
	inline JArray GenericDocument::getPropertyEmbeddingArray(JString arg0) const
	{
		return callObjectMethod(
