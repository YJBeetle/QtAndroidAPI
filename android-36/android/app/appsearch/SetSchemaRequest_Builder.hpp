...
namespace android::app::appsearch
{
	...
	inline SetSchemaRequest_Builder::SetSchemaRequest_Builder(android::app::appsearch::SetSchemaRequest arg0)
		: JObject(
			"android.app.appsearch.SetSchemaRequest$Builder",
			"(Landroid/app/appsearch/SetSchemaRequest;)V",
			arg0.object()
		) {}
	
	// Methods
	inline android::app::appsearch::SetSchemaRequest_Builder SetSchemaRequest_Builder::addRequiredPermissionsForSchemaTypeVisibility(JString arg0, JObject arg1) const
	{
		return callObjectMethod(
			"addRequiredPermissionsForSchemaTypeVisibility",
			"(Ljava/lang/String;Ljava/util/Set;)Landroid/app/appsearch/SetSchemaRequest$Builder;",
			arg0.object<jstring>(),
			arg1.object()
		);
	}
	inline android::app::appsearch::SetSchemaRequest_Builder SetSchemaRequest_Builder::addSchemaTypeVisibleToConfig(JString arg0, android::app::appsearch::SchemaVisibilityConfig arg1) const
	{
		return callObjectMethod(
			"addSchemaTypeVisibleToConfig",
			"(Ljava/lang/String;Landroid/app/appsearch/SchemaVisibilityConfig;)Landroid/app/appsearch/SetSchemaRequest$Builder;",
			arg0.object<jstring>(),
			arg1.object()
		);
	}
	...
	inline android::app::appsearch::SetSchemaRequest_Builder SetSchemaRequest_Builder::clearMigrators() const
	{
		return callObjectMethod(
			"clearMigrators",
	...
	inline android::app::appsearch::SetSchemaRequest_Builder SetSchemaRequest_Builder::clearRequiredPermissionsForSchemaTypeVisibility(JString arg0) const
	{
		return callObjectMethod(
			"clearRequiredPermissionsForSchemaTypeVisibility",
			"(Ljava/lang/String;)Landroid/app/appsearch/SetSchemaRequest$Builder;",
			arg0.object<jstring>()
		);
	}
	inline android::app::appsearch::SetSchemaRequest_Builder SetSchemaRequest_Builder::clearSchemaTypeVisibleToConfigs(JString arg0) const
	{
		return callObjectMethod(
	...
	inline android::app::appsearch::SetSchemaRequest_Builder SetSchemaRequest_Builder::clearSchemas() const
	{
		return callObjectMethod(
			"clearSchemas",
			"()Landroid/app/appsearch/SetSchemaRequest$Builder;"
	...
	inline android::app::appsearch::SetSchemaRequest_Builder SetSchemaRequest_Builder::setPubliclyVisibleSchema(JString arg0, android::app::appsearch::PackageIdentifier arg1) const
	{
		return callObjectMethod(
			"setPubliclyVisibleSchema",
			"(Ljava/lang/String;Landroid/app/appsearch/PackageIdentifier;)Landroid/app/appsearch/SetSchemaRequest$Builder;",
			arg0.object<jstring>(),
			arg1.object()
		);
	}
