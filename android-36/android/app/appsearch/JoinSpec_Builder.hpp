...
namespace android::app::appsearch
{
	...
	// Constructors
	inline JoinSpec_Builder::JoinSpec_Builder(android::app::appsearch::JoinSpec arg0)
		: JObject(
			"android.app.appsearch.JoinSpec$Builder",
			"(Landroid/app/appsearch/JoinSpec;)V",
			arg0.object()
		) {}
	...
	inline android::app::appsearch::JoinSpec_Builder JoinSpec_Builder::setChildPropertyExpression(JString arg0) const
	{
		return callObjectMethod(
			"setChildPropertyExpression",
			"(Ljava/lang/String;)Landroid/app/appsearch/JoinSpec$Builder;",
			arg0.object<jstring>()
		);
	}
