...
namespace android::app::appsearch
{
	...
	public:
		...
		GenericDocument(QJniObject obj) : JObject(obj) {}
		...
		android::app::appsearch::AppSearchBlobHandle getPropertyBlobHandle(JString arg0) const;
		JArray getPropertyBlobHandleArray(JString arg0) const;
		...
		android::app::appsearch::EmbeddingVector getPropertyEmbedding(JString arg0) const;
		JArray getPropertyEmbeddingArray(JString arg0) const;
