...
namespace android::app::appsearch
{
	...
	inline void AppSearchSession::commitBlob(JObject arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"commitBlob",
			"(Ljava/util/Set;Ljava/util/concurrent/Executor;Ljava/util/function/Consumer;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
	...
	inline void AppSearchSession::openBlobForRead(JObject arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"openBlobForRead",
			"(Ljava/util/Set;Ljava/util/concurrent/Executor;Ljava/util/function/Consumer;)V",
	...
	inline void AppSearchSession::openBlobForWrite(JObject arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"openBlobForWrite",
			"(Ljava/util/Set;Ljava/util/concurrent/Executor;Ljava/util/function/Consumer;)V",
	...
	inline void AppSearchSession::removeBlob(JObject arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"removeBlob",
			"(Ljava/util/Set;Ljava/util/concurrent/Executor;Ljava/util/function/Consumer;)V",
	...
	inline void AppSearchSession::searchSuggestion(JString arg0, android::app::appsearch::SearchSuggestionSpec arg1, JObject arg2, JObject arg3) const
	{
		callMethod<void>(
			"searchSuggestion",
			"(Ljava/lang/String;Landroid/app/appsearch/SearchSuggestionSpec;Ljava/util/concurrent/Executor;Ljava/util/function/Consumer;)V",
			arg0.object<jstring>(),
			arg1.object(),
			arg2.object(),
			arg3.object()
	...
	inline void AppSearchSession::setBlobVisibility(android::app::appsearch::SetBlobVisibilityRequest arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"setBlobVisibility",
			"(Landroid/app/appsearch/SetBlobVisibilityRequest;Ljava/util/concurrent/Executor;Ljava/util/function/Consumer;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
