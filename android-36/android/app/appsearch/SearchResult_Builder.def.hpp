...
namespace android::app::appsearch
{
	...
	public:
		...
		// Methods
		android::app::appsearch::SearchResult_Builder addInformationalRankingSignal(jdouble arg0) const;
		...
		android::app::appsearch::SearchResult_Builder setParentTypeMap(JObject arg0) const;
