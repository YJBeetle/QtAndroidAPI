...
namespace android::app::appsearch
{
	...
	inline android::app::appsearch::StorageInfo_Builder StorageInfo_Builder::setBlobsCount(jint arg0) const
	{
		return callObjectMethod(
			"setBlobsCount",
			"(I)Landroid/app/appsearch/StorageInfo$Builder;",
	...
	inline android::app::appsearch::StorageInfo_Builder StorageInfo_Builder::setBlobsSizeBytes(jlong arg0) const
	{
		return callObjectMethod(
			"setBlobsSizeBytes",
