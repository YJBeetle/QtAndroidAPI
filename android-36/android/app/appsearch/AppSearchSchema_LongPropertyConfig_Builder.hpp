...
namespace android::app::appsearch
{
	...
	inline android::app::appsearch::AppSearchSchema_LongPropertyConfig_Builder AppSearchSchema_LongPropertyConfig_Builder::setIndexingType(jint arg0) const
	{
		return callObjectMethod(
			"setIndexingType",
			"(I)Landroid/app/appsearch/AppSearchSchema$LongPropertyConfig$Builder;",
	...
	inline android::app::appsearch::AppSearchSchema_LongPropertyConfig_Builder AppSearchSchema_LongPropertyConfig_Builder::setScoringEnabled(jboolean arg0) const
	{
		return callObjectMethod(
			"setScoringEnabled",
			"(Z)Landroid/app/appsearch/AppSearchSchema$LongPropertyConfig$Builder;",
			arg0
		);
	}
} // namespace android::app::appsearch
