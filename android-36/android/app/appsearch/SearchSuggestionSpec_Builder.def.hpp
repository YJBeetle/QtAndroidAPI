...
namespace android::app::appsearch
{
	...
	public:
		...
		android::app::appsearch::SearchSuggestionSpec_Builder addFilterProperties(JString arg0, JObject arg1) const;
		android::app::appsearch::SearchSuggestionSpec_Builder addFilterPropertyPaths(JString arg0, JObject arg1) const;
		...
		android::app::appsearch::SearchSuggestionSpec_Builder addSearchStringParameters(JArray arg0) const;
		android::app::appsearch::SearchSuggestionSpec_Builder addSearchStringParameters(JObject arg0) const;
