...
namespace android::app::appsearch
{
	...
	inline android::app::appsearch::AppSearchSchema_DoublePropertyConfig_Builder AppSearchSchema_DoublePropertyConfig_Builder::setScoringEnabled(jboolean arg0) const
	{
		return callObjectMethod(
			"setScoringEnabled",
			"(Z)Landroid/app/appsearch/AppSearchSchema$DoublePropertyConfig$Builder;",
			arg0
		);
	}
} // namespace android::app::appsearch
