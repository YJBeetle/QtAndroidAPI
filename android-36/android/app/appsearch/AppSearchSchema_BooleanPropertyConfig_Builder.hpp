...
namespace android::app::appsearch
{
	...
	inline android::app::appsearch::AppSearchSchema_BooleanPropertyConfig_Builder AppSearchSchema_BooleanPropertyConfig_Builder::setScoringEnabled(jboolean arg0) const
	{
		return callObjectMethod(
			"setScoringEnabled",
			"(Z)Landroid/app/appsearch/AppSearchSchema$BooleanPropertyConfig$Builder;",
			arg0
		);
	}
} // namespace android::app::appsearch
