...
namespace android::app::appsearch
{
	...
	// Methods
	inline jboolean SetSchemaRequest::equals(JObject arg0) const
	{
	...
	inline JObject SetSchemaRequest::getPubliclyVisibleSchemas() const
	{
		return callObjectMethod(
	...
	inline JObject SetSchemaRequest::getSchemasVisibleToConfigs() const
	{
		return callObjectMethod(
	...
	inline jint SetSchemaRequest::hashCode() const
	{
		return callMethod<jint>(
			"hashCode",
			"()I"
