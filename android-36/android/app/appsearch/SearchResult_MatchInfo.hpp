...
{
	// Fields
	inline JObject SearchResult_MatchInfo::CREATOR()
	{
	...
	// Methods
	inline jint SearchResult_MatchInfo::describeContents() const
	{
	...
	inline void SearchResult_MatchInfo::writeToParcel(android::os::Parcel arg0, jint arg1) const
	{
		callMethod<void>(
			"writeToParcel",
