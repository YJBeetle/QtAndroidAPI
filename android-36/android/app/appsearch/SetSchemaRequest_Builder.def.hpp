...
namespace android::app::appsearch
{
	...
	public:
		...
		SetSchemaRequest_Builder(QJniObject obj) : JObject(obj) {}
		
		// Constructors
		SetSchemaRequest_Builder();
		SetSchemaRequest_Builder(android::app::appsearch::SetSchemaRequest arg0);
		...
		android::app::appsearch::SetSchemaRequest_Builder addSchemaTypeVisibleToConfig(JString arg0, android::app::appsearch::SchemaVisibilityConfig arg1) const;
		...
		android::app::appsearch::SetSchemaRequest_Builder clearMigrators() const;
		android::app::appsearch::SetSchemaRequest_Builder clearRequiredPermissionsForSchemaTypeVisibility(JString arg0) const;
		android::app::appsearch::SetSchemaRequest_Builder clearSchemaTypeVisibleToConfigs(JString arg0) const;
		android::app::appsearch::SetSchemaRequest_Builder clearSchemas() const;
		...
		android::app::appsearch::SetSchemaRequest_Builder setPubliclyVisibleSchema(JString arg0, android::app::appsearch::PackageIdentifier arg1) const;
