...
namespace android::app::appsearch
{
	...
	// Constructors
	inline GenericDocument_Builder::GenericDocument_Builder(android::app::appsearch::GenericDocument arg0)
		: JObject(
	...
	inline android::app::appsearch::GenericDocument_Builder GenericDocument_Builder::clearProperty(JString arg0) const
	{
		return callObjectMethod(
			"clearProperty",
			"(Ljava/lang/String;)Landroid/app/appsearch/GenericDocument$Builder;",
			arg0.object<jstring>()
		);
	}
	...
	inline android::app::appsearch::GenericDocument_Builder GenericDocument_Builder::setId(JString arg0) const
	{
		return callObjectMethod(
			"setId",
			"(Ljava/lang/String;)Landroid/app/appsearch/GenericDocument$Builder;",
	...
	inline android::app::appsearch::GenericDocument_Builder GenericDocument_Builder::setNamespace(JString arg0) const
	{
		return callObjectMethod(
			"setNamespace",
			"(Ljava/lang/String;)Landroid/app/appsearch/GenericDocument$Builder;",
	...
	inline android::app::appsearch::GenericDocument_Builder GenericDocument_Builder::setPropertyBlobHandle(JString arg0, JArray arg1) const
	{
		return callObjectMethod(
			"setPropertyBlobHandle",
			"(Ljava/lang/String;[Landroid/app/appsearch/AppSearchBlobHandle;)Landroid/app/appsearch/GenericDocument$Builder;",
			arg0.object<jstring>(),
			arg1.object<jarray>()
		);
	}
	...
	inline android::app::appsearch::GenericDocument_Builder GenericDocument_Builder::setPropertyEmbedding(JString arg0, JArray arg1) const
	{
		return callObjectMethod(
			"setPropertyEmbedding",
			"(Ljava/lang/String;[Landroid/app/appsearch/EmbeddingVector;)Landroid/app/appsearch/GenericDocument$Builder;",
			arg0.object<jstring>(),
			arg1.object<jarray>()
		);
	}
	...
	inline android::app::appsearch::GenericDocument_Builder GenericDocument_Builder::setSchemaType(JString arg0) const
	{
		return callObjectMethod(
			"setSchemaType",
			"(Ljava/lang/String;)Landroid/app/appsearch/GenericDocument$Builder;",
