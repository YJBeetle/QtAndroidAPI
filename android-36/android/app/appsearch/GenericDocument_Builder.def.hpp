...
namespace android::app::appsearch
{
	...
	public:
		...
		GenericDocument_Builder(QJniObject obj) : JObject(obj) {}
		
		// Constructors
		GenericDocument_Builder(android::app::appsearch::GenericDocument arg0);
		GenericDocument_Builder(JString arg0, JString arg1, JString arg2);
		
		// Methods
		android::app::appsearch::GenericDocument build() const;
		android::app::appsearch::GenericDocument_Builder clearProperty(JString arg0) const;
		android::app::appsearch::GenericDocument_Builder setCreationTimestampMillis(jlong arg0) const;
		android::app::appsearch::GenericDocument_Builder setId(JString arg0) const;
		android::app::appsearch::GenericDocument_Builder setNamespace(JString arg0) const;
		android::app::appsearch::GenericDocument_Builder setPropertyBlobHandle(JString arg0, JArray arg1) const;
		...
		android::app::appsearch::GenericDocument_Builder setPropertyEmbedding(JString arg0, JArray arg1) const;
		...
		android::app::appsearch::GenericDocument_Builder setSchemaType(JString arg0) const;
