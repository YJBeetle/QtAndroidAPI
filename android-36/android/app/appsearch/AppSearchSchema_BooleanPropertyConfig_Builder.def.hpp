...
namespace android::app::appsearch
{
	...
	public:
		...
		AppSearchSchema_BooleanPropertyConfig_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::app::appsearch::AppSearchSchema_BooleanPropertyConfig_Builder setScoringEnabled(jboolean arg0) const;
	};
} // namespace android::app::appsearch
