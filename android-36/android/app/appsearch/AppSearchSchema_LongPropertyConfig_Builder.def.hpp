...
namespace android::app::appsearch
{
	...
	public:
		...
		AppSearchSchema_LongPropertyConfig_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::app::appsearch::AppSearchSchema_LongPropertyConfig_Builder setIndexingType(jint arg0) const;
		android::app::appsearch::AppSearchSchema_LongPropertyConfig_Builder setScoringEnabled(jboolean arg0) const;
	};
} // namespace android::app::appsearch
