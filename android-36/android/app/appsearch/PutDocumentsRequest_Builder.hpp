...
namespace android::app::appsearch
{
	...
	inline android::app::appsearch::PutDocumentsRequest_Builder PutDocumentsRequest_Builder::addTakenActionGenericDocuments(JArray arg0) const
	{
		return callObjectMethod(
	...
	inline android::app::appsearch::PutDocumentsRequest_Builder PutDocumentsRequest_Builder::addTakenActionGenericDocuments(JObject arg0) const
	{
		return callObjectMethod(
			"addTakenActionGenericDocuments",
			"(Ljava/util/Collection;)Landroid/app/appsearch/PutDocumentsRequest$Builder;",
