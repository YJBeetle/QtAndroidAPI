...
namespace android::app::appsearch
{
	...
	inline android::app::appsearch::SearchSuggestionSpec_Builder SearchSuggestionSpec_Builder::addFilterProperties(JString arg0, JObject arg1) const
	{
		return callObjectMethod(
			"addFilterProperties",
			"(Ljava/lang/String;Ljava/util/Collection;)Landroid/app/appsearch/SearchSuggestionSpec$Builder;",
	...
	inline android::app::appsearch::SearchSuggestionSpec_Builder SearchSuggestionSpec_Builder::addFilterPropertyPaths(JString arg0, JObject arg1) const
	{
		return callObjectMethod(
	...
	inline android::app::appsearch::SearchSuggestionSpec_Builder SearchSuggestionSpec_Builder::addSearchStringParameters(JArray arg0) const
	{
		return callObjectMethod(
	...
	inline android::app::appsearch::SearchSuggestionSpec_Builder SearchSuggestionSpec_Builder::addSearchStringParameters(JObject arg0) const
	{
		return callObjectMethod(
			"addSearchStringParameters",
			"(Ljava/util/List;)Landroid/app/appsearch/SearchSuggestionSpec$Builder;",
			arg0.object()
		);
	}
