...
namespace android::app
{
	...
	public:
		...
		static JString ACTION_CONSOLIDATED_NOTIFICATION_POLICY_CHANGED();
		...
		static jint AUTOMATIC_RULE_STATUS_ACTIVATED();
		static jint AUTOMATIC_RULE_STATUS_DEACTIVATED();
		...
		static JString EXTRA_NOTIFICATION_POLICY();
		...
		jboolean areAutomaticZenRulesUserManaged() const;
		...
		jboolean canPostPromotedNotifications() const;
		jboolean canUseFullScreenIntent() const;
		...
		jint getAutomaticZenRuleState(JString arg0) const;
		...
		jboolean matchesCallFilter(android::net::Uri arg0) const;
