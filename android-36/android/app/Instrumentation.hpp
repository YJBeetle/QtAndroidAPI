...
namespace android::app
{
	...
	inline void Instrumentation::callActivityOnNewIntent(android::app::Activity arg0, android::content::Intent arg1, android::app::ComponentCaller arg2) const
	{
		callMethod<void>(
			"callActivityOnNewIntent",
			"(Landroid/app/Activity;Landroid/content/Intent;Landroid/app/ComponentCaller;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
	...
	inline void Instrumentation::resetInTouchMode() const
	{
		callMethod<void>(
			"resetInTouchMode",
			"()V"
