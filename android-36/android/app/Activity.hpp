...
namespace android::app
{
	...
	inline jint Activity::FULLSCREEN_MODE_REQUEST_ENTER()
	{
		return getStaticField<jint>(
			"android.app.Activity",
	...
	inline jint Activity::FULLSCREEN_MODE_REQUEST_EXIT()
	{
		return getStaticField<jint>(
			"android.app.Activity",
	...
	inline jint Activity::OVERRIDE_TRANSITION_CLOSE()
	{
		return getStaticField<jint>(
			"android.app.Activity",
	...
	inline jint Activity::OVERRIDE_TRANSITION_OPEN()
	{
		return getStaticField<jint>(
			"android.app.Activity",
	...
	inline void Activity::clearOverrideActivityTransition(jint arg0) const
	{
		callMethod<void>(
	...
	inline android::app::ComponentCaller Activity::getCaller() const
	{
		return callObjectMethod(
			"getCaller",
	...
	inline android::app::ComponentCaller Activity::getCurrentCaller() const
	{
		return callObjectMethod(
			"getCurrentCaller",
			"()Landroid/app/ComponentCaller;"
	...
	inline android::app::ComponentCaller Activity::getInitialCaller() const
	{
		return callObjectMethod(
			"getInitialCaller",
			"()Landroid/app/ComponentCaller;"
	...
	inline JString Activity::getLaunchedFromPackage() const
	{
		return callObjectMethod(
	...
	inline jint Activity::getLaunchedFromUid() const
	{
		return callMethod<jint>(
			"getLaunchedFromUid",
			"()I"
	...
	inline void Activity::onActivityResult(jint arg0, jint arg1, android::content::Intent arg2, android::app::ComponentCaller arg3) const
	{
		callMethod<void>(
			"onActivityResult",
	...
	inline void Activity::onNewIntent(android::content::Intent arg0, android::app::ComponentCaller arg1) const
	{
		callMethod<void>(
			"onNewIntent",
			"(Landroid/content/Intent;Landroid/app/ComponentCaller;)V",
			arg0.object(),
			arg1.object()
		);
	}
	...
	inline void Activity::onRequestPermissionsResult(jint arg0, JArray arg1, JIntArray arg2, jint arg3) const
	{
		callMethod<void>(
			"onRequestPermissionsResult",
	...
	inline void Activity::overrideActivityTransition(jint arg0, jint arg1, jint arg2) const
	{
		callMethod<void>(
	...
	inline void Activity::overrideActivityTransition(jint arg0, jint arg1, jint arg2, jint arg3) const
	{
		callMethod<void>(
			"overrideActivityTransition",
			"(IIII)V",
	...
	inline void Activity::registerScreenCaptureCallback(JObject arg0, JObject arg1) const
	{
		callMethod<void>(
	...
	inline void Activity::requestFullscreenMode(jint arg0, JObject arg1) const
	{
		callMethod<void>(
			"requestFullscreenMode",
			"(ILandroid/os/OutcomeReceiver;)V",
			arg0,
			arg1.object()
		);
	}
	inline void Activity::requestOpenInBrowserEducation() const
	{
		callMethod<void>(
	...
	inline void Activity::requestPermissions(JArray arg0, jint arg1, jint arg2) const
	{
		callMethod<void>(
			"requestPermissions",
	...
	inline void Activity::setAllowCrossUidActivitySwitchFromBelow(jboolean arg0) const
	{
		callMethod<void>(
	...
	inline void Activity::setIntent(android::content::Intent arg0, android::app::ComponentCaller arg1) const
	{
		callMethod<void>(
			"setIntent",
			"(Landroid/content/Intent;Landroid/app/ComponentCaller;)V",
	...
	inline jboolean Activity::shouldShowRequestPermissionRationale(JString arg0, jint arg1) const
	{
		return callMethod<jboolean>(
			"shouldShowRequestPermissionRationale",
	...
	inline void Activity::unregisterScreenCaptureCallback(JObject arg0) const
	{
		callMethod<void>(
			"unregisterScreenCaptureCallback",
			"(Landroid/app/Activity$ScreenCaptureCallback;)V",
			arg0.object()
		);
	}
} // namespace android::app
