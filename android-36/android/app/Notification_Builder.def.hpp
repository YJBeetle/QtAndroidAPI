...
namespace android::app
{
	...
	public:
		...
		Notification_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::app::Notification_Builder setFlag(jint arg0, jboolean arg1) const;
		android::app::Notification_Builder setForegroundServiceBehavior(jint arg0) const;
		...
		android::app::Notification_Builder setShortCriticalText(JString arg0) const;
