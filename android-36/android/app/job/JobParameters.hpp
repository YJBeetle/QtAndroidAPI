...
namespace android::app::job
{
	...
	inline jint JobParameters::STOP_REASON_TIMEOUT_ABANDONED()
	{
		return getStaticField<jint>(
			"android.app.job.JobParameters",
	...
	inline JString JobParameters::getJobNamespace() const
	{
		return callObjectMethod(
			"getJobNamespace",
			"()Ljava/lang/String;"
	...
	inline jboolean JobParameters::isUserInitiatedJob() const
	{
		return callMethod<jboolean>(
			"isUserInitiatedJob",
			"()Z"
