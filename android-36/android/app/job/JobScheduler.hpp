...
namespace android::app::job
{
	...
	inline jint JobScheduler::PENDING_JOB_REASON_CONSTRAINT_DEADLINE()
	{
		return getStaticField<jint>(
			"android.app.job.JobScheduler",
	...
	inline JIntArray JobScheduler::getPendingJobReasons(jint arg0) const
	{
		return callObjectMethod(
	...
	inline JObject JobScheduler::getPendingJobReasonsHistory(jint arg0) const
	{
		return callObjectMethod(
