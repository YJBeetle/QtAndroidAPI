...
namespace android::app::job
{
	...
	public:
		...
		static jint STOP_REASON_ESTIMATED_APP_LAUNCH_TIME_CHANGED();
		...
		static jint STOP_REASON_TIMEOUT_ABANDONED();
		...
		jboolean isUserInitiatedJob() const;
