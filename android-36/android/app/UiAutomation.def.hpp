...
namespace android::app
{
	...
	public:
		...
		UiAutomation(QJniObject obj) : JObject(obj) {}
		...
		JArray executeShellCommandRwe(JString arg0) const;
		...
		android::graphics::Bitmap takeScreenshot(android::view::Window arg0) const;
