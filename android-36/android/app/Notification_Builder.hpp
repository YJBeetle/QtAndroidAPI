...
namespace android::app
{
	...
	inline android::app::Notification_Builder Notification_Builder::setAllowSystemGeneratedContextualActions(jboolean arg0) const
	{
		return callObjectMethod(
	...
	inline android::app::Notification_Builder Notification_Builder::setBubbleMetadata(android::app::Notification_BubbleMetadata arg0) const
	{
		return callObjectMethod(
			"setBubbleMetadata",
	...
	inline android::app::Notification_Builder Notification_Builder::setFlag(jint arg0, jboolean arg1) const
	{
		return callObjectMethod(
			"setFlag",
			"(IZ)Landroid/app/Notification$Builder;",
			arg0,
			arg1
		);
	}
	inline android::app::Notification_Builder Notification_Builder::setForegroundServiceBehavior(jint arg0) const
	{
		return callObjectMethod(
	...
	inline android::app::Notification_Builder Notification_Builder::setLocusId(android::content::LocusId arg0) const
	{
		return callObjectMethod(
			"setLocusId",
	...
	inline android::app::Notification_Builder Notification_Builder::setShortCriticalText(JString arg0) const
	{
		return callObjectMethod(
