...
namespace android::app::admin
{
	...
	public:
		...
		static JString APP_FUNCTIONS_POLICY();
		...
		static JString CONTENT_PROTECTION_POLICY();
		...
		static JString PASSWORD_COMPLEXITY_POLICY();
		...
		static JString SECURITY_LOGGING_POLICY();
		static JString STATUS_BAR_DISABLED_POLICY();
		static JString USB_DATA_SIGNALING_POLICY();
