...
namespace android::app::admin
{
	...
	inline jint SecurityLog::TAG_BACKUP_SERVICE_TOGGLED()
	{
		return getStaticField<jint>(
			"android.app.admin.SecurityLog",
	...
	inline jint SecurityLog::TAG_BLUETOOTH_CONNECTION()
	{
		return getStaticField<jint>(
			"android.app.admin.SecurityLog",
	...
	inline jint SecurityLog::TAG_BLUETOOTH_DISCONNECTION()
	{
		return getStaticField<jint>(
			"android.app.admin.SecurityLog",
	...
	inline jint SecurityLog::TAG_NFC_DISABLED()
	{
		return getStaticField<jint>(
			"android.app.admin.SecurityLog",
			"TAG_NFC_DISABLED"
	...
	inline jint SecurityLog::TAG_NFC_ENABLED()
	{
		return getStaticField<jint>(
			"android.app.admin.SecurityLog",
			"TAG_NFC_ENABLED"
	...
	inline jint SecurityLog::TAG_PACKAGE_INSTALLED()
	{
		return getStaticField<jint>(
			"android.app.admin.SecurityLog",
	...
	inline jint SecurityLog::TAG_PACKAGE_UNINSTALLED()
	{
		return getStaticField<jint>(
			"android.app.admin.SecurityLog",
	...
	inline jint SecurityLog::TAG_PACKAGE_UPDATED()
	{
		return getStaticField<jint>(
			"android.app.admin.SecurityLog",
			"TAG_PACKAGE_UPDATED"
	...
	inline jint SecurityLog::TAG_PASSWORD_CHANGED()
	{
		return getStaticField<jint>(
			"android.app.admin.SecurityLog",
	...
	inline jint SecurityLog::TAG_PASSWORD_COMPLEXITY_REQUIRED()
	{
		return getStaticField<jint>(
			"android.app.admin.SecurityLog",
	...
	inline jint SecurityLog::TAG_WIFI_CONNECTION()
	{
		return getStaticField<jint>(
			"android.app.admin.SecurityLog",
			"TAG_WIFI_CONNECTION"
	...
	inline jint SecurityLog::TAG_WIFI_DISCONNECTION()
	{
		return getStaticField<jint>(
			"android.app.admin.SecurityLog",
