...
namespace android::app::admin
{
	...
	public:
		...
		static jint TAG_BACKUP_SERVICE_TOGGLED();
		static jint TAG_BLUETOOTH_CONNECTION();
		static jint TAG_BLUETOOTH_DISCONNECTION();
		static jint TAG_CAMERA_POLICY_SET();
		...
		static jint TAG_NFC_DISABLED();
		static jint TAG_NFC_ENABLED();
		static jint TAG_OS_SHUTDOWN();
		static jint TAG_OS_STARTUP();
		static jint TAG_PACKAGE_INSTALLED();
		static jint TAG_PACKAGE_UNINSTALLED();
		static jint TAG_PACKAGE_UPDATED();
		static jint TAG_PASSWORD_CHANGED();
		static jint TAG_PASSWORD_COMPLEXITY_REQUIRED();
		...
		static jint TAG_WIFI_CONNECTION();
		static jint TAG_WIFI_DISCONNECTION();
		...
		SecurityLog(QJniObject obj) : JObject(obj) {}
