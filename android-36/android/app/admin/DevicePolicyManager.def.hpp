...
namespace android::app::admin
{
	...
	public:
		...
		static jint APP_FUNCTIONS_DISABLED();
		static jint APP_FUNCTIONS_DISABLED_CROSS_PROFILE();
		static jint APP_FUNCTIONS_NOT_CONTROLLED_BY_POLICY();
		static jint AUTO_TIME_DISABLED();
		static jint AUTO_TIME_ENABLED();
		static jint AUTO_TIME_NOT_CONTROLLED_BY_POLICY();
		static jint AUTO_TIME_ZONE_DISABLED();
		static jint AUTO_TIME_ZONE_ENABLED();
		static jint AUTO_TIME_ZONE_NOT_CONTROLLED_BY_POLICY();
		static jint CONTENT_PROTECTION_DISABLED();
		static jint CONTENT_PROTECTION_ENABLED();
		static jint CONTENT_PROTECTION_NOT_CONTROLLED_BY_POLICY();
		...
		// Methods
		static jboolean isMtePolicyEnforced();
		...
		jint getAppFunctionsPolicy() const;
		...
		jint getContentProtectionPolicy(android::content::ComponentName arg0) const;
		...
		JObject getSubscriptionIds() const;
		...
		void setAppFunctionsPolicy(jint arg0) const;
		...
		void setAutoTimePolicy(jint arg0) const;
		...
		void setAutoTimeZonePolicy(jint arg0) const;
		...
		void setContentProtectionPolicy(android::content::ComponentName arg0, jint arg1) const;
