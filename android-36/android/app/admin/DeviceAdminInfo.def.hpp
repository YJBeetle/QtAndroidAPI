...
namespace android::app::admin
{
	...
	public:
		...
		static jint HEADLESS_DEVICE_OWNER_MODE_AFFILIATED();
		static jint HEADLESS_DEVICE_OWNER_MODE_SINGLE_USER();
		static jint HEADLESS_DEVICE_OWNER_MODE_UNSUPPORTED();
		...
		DeviceAdminInfo(QJniObject obj) : JObject(obj) {}
		...
		jint getHeadlessDeviceOwnerMode() const;
