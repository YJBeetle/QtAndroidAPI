...
namespace android::app::admin
{
	...
	inline JString DevicePolicyIdentifiers::APP_FUNCTIONS_POLICY()
	{
		return getStaticObjectField(
			"android.app.admin.DevicePolicyIdentifiers",
	...
	inline JString DevicePolicyIdentifiers::CONTENT_PROTECTION_POLICY()
	{
		return getStaticObjectField(
			"android.app.admin.DevicePolicyIdentifiers",
	...
	inline JString DevicePolicyIdentifiers::PASSWORD_COMPLEXITY_POLICY()
	{
		return getStaticObjectField(
			"android.app.admin.DevicePolicyIdentifiers",
	...
	inline JString DevicePolicyIdentifiers::SECURITY_LOGGING_POLICY()
	{
		return getStaticObjectField(
			"android.app.admin.DevicePolicyIdentifiers",
	...
	inline JString DevicePolicyIdentifiers::USB_DATA_SIGNALING_POLICY()
	{
		return getStaticObjectField(
			"android.app.admin.DevicePolicyIdentifiers",
