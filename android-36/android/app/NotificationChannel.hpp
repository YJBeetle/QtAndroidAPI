...
#include "../os/VibrationEffect.def.hpp"
#include "../../JString.hpp"
#include "../../JObject.hpp"
#include "../../JString.hpp"
...
namespace android::app
{
	...
	inline JString NotificationChannel::EDIT_CONVERSATION()
	{
		return getStaticObjectField(
			"android.app.NotificationChannel",
			"EDIT_CONVERSATION",
	...
	inline JString NotificationChannel::EDIT_IMPORTANCE()
	{
		return getStaticObjectField(
			"android.app.NotificationChannel",
			"EDIT_IMPORTANCE",
	...
	inline JString NotificationChannel::EDIT_LAUNCHER()
	{
		return getStaticObjectField(
			"android.app.NotificationChannel",
			"EDIT_LAUNCHER",
	...
	inline JString NotificationChannel::EDIT_LOCKED_DEVICE()
	{
		return getStaticObjectField(
			"android.app.NotificationChannel",
			"EDIT_LOCKED_DEVICE",
	...
	inline JString NotificationChannel::EDIT_SOUND()
	{
		return getStaticObjectField(
			"android.app.NotificationChannel",
			"EDIT_SOUND",
	...
	inline JString NotificationChannel::EDIT_VIBRATION()
	{
		return getStaticObjectField(
			"android.app.NotificationChannel",
			"EDIT_VIBRATION",
	...
	inline JString NotificationChannel::EDIT_ZEN()
	{
		return getStaticObjectField(
			"android.app.NotificationChannel",
			"EDIT_ZEN",
	...
	// Methods
	inline jboolean NotificationChannel::canBubble() const
	{
	...
	inline JString NotificationChannel::getConversationId() const
	{
		return callObjectMethod(
			"getConversationId",
			"()Ljava/lang/String;"
	...
	inline JString NotificationChannel::getParentChannelId() const
	{
		return callObjectMethod(
			"getParentChannelId",
			"()Ljava/lang/String;"
	...
	inline android::os::VibrationEffect NotificationChannel::getVibrationEffect() const
	{
		return callObjectMethod(
			"getVibrationEffect",
	...
	inline jboolean NotificationChannel::hasUserSetImportance() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean NotificationChannel::hasUserSetSound() const
	{
		return callMethod<jboolean>(
			"hasUserSetSound",
			"()Z"
	...
	inline jboolean NotificationChannel::isBlockable() const
	{
		return callMethod<jboolean>(
			"isBlockable",
			"()Z"
	...
	inline jboolean NotificationChannel::isConversation() const
	{
		return callMethod<jboolean>(
			"isConversation",
			"()Z"
	...
	inline jboolean NotificationChannel::isDemoted() const
	{
		return callMethod<jboolean>(
			"isDemoted",
			"()Z"
	...
	inline jboolean NotificationChannel::isImportantConversation() const
	{
		return callMethod<jboolean>(
	...
	inline void NotificationChannel::setAllowBubbles(jboolean arg0) const
	{
		callMethod<void>(
			"setAllowBubbles",
			"(Z)V",
	...
	inline void NotificationChannel::setBlockable(jboolean arg0) const
	{
		callMethod<void>(
			"setBlockable",
			"(Z)V",
	...
	inline void NotificationChannel::setConversationId(JString arg0, JString arg1) const
	{
		callMethod<void>(
			"setConversationId",
	...
	inline void NotificationChannel::setVibrationEffect(android::os::VibrationEffect arg0) const
	{
		callMethod<void>(
			"setVibrationEffect",
