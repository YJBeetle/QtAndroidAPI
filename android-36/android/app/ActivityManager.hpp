...
namespace android::app
{
	...
	inline jboolean ActivityManager::isLowMemoryKillReportSupported()
	{
	...
	inline void ActivityManager::addApplicationStartInfoCompletionListener(JObject arg0, JObject arg1) const
	{
		callMethod<void>(
	...
	inline void ActivityManager::addStartInfoTimestamp(jint arg0, jlong arg1) const
	{
		callMethod<void>(
	...
	inline void ActivityManager::appNotResponding(JString arg0) const
	{
		callMethod<void>(
			"appNotResponding",
			"(Ljava/lang/String;)V",
	...
	inline JObject ActivityManager::getHistoricalProcessExitReasons(JString arg0, jint arg1, jint arg2) const
	{
		return callObjectMethod(
	...
	inline JObject ActivityManager::getHistoricalProcessStartReasons(jint arg0) const
	{
		return callObjectMethod(
	...
	inline void ActivityManager::removeApplicationStartInfoCompletionListener(JObject arg0) const
	{
		callMethod<void>(
	...
	inline void ActivityManager::setProcessStateSummary(JByteArray arg0) const
	{
		callMethod<void>(
