...
namespace android::app::assist
{
	...
	inline JString AssistContent::EXTRA_APP_FUNCTION_DATA()
	{
		return getStaticObjectField(
			"android.app.assist.AssistContent",
	...
	inline android::net::Uri AssistContent::getSessionTransferUri() const
	{
		return callObjectMethod(
	...
	inline void AssistContent::setSessionTransferUri(android::net::Uri arg0) const
	{
		callMethod<void>(
