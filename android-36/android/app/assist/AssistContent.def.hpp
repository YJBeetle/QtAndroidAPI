...
namespace android::app::assist
{
	...
	public:
		...
		static JString EXTRA_APP_FUNCTION_DATA();
		...
		AssistContent(QJniObject obj) : JObject(obj) {}
		...
		android::net::Uri getSessionTransferUri() const;
		...
		void setSessionTransferUri(android::net::Uri arg0) const;
