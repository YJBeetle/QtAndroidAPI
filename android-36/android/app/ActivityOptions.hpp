...
namespace android::app
{
	...
	inline jint ActivityOptions::MODE_BACKGROUND_ACTIVITY_START_ALLOWED()
	{
	...
	inline jint ActivityOptions::MODE_BACKGROUND_ACTIVITY_START_ALLOW_ALWAYS()
	{
		return getStaticField<jint>(
			"android.app.ActivityOptions",
	...
	inline jint ActivityOptions::MODE_BACKGROUND_ACTIVITY_START_ALLOW_IF_VISIBLE()
	{
		return getStaticField<jint>(
			"android.app.ActivityOptions",
	...
	inline jint ActivityOptions::MODE_BACKGROUND_ACTIVITY_START_DENIED()
	{
		return getStaticField<jint>(
			"android.app.ActivityOptions",
	...
	inline jint ActivityOptions::MODE_BACKGROUND_ACTIVITY_START_SYSTEM_DEFINED()
	{
		return getStaticField<jint>(
			"android.app.ActivityOptions",
	...
	inline jint ActivityOptions::getPendingIntentBackgroundActivityStartMode() const
	{
		return callMethod<jint>(
	...
	inline jint ActivityOptions::getPendingIntentCreatorBackgroundActivityStartMode() const
	{
		return callMethod<jint>(
	...
	inline jboolean ActivityOptions::isAllowPassThroughOnTouchOutside() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean ActivityOptions::isShareIdentityEnabled() const
	{
		return callMethod<jboolean>(
	...
	inline void ActivityOptions::setAllowPassThroughOnTouchOutside(jboolean arg0) const
	{
		callMethod<void>(
	...
	inline android::app::ActivityOptions ActivityOptions::setPendingIntentBackgroundActivityStartMode(jint arg0) const
	{
		return callObjectMethod(
	...
	inline android::app::ActivityOptions ActivityOptions::setPendingIntentCreatorBackgroundActivityStartMode(jint arg0) const
	{
		return callObjectMethod(
	...
	inline android::app::ActivityOptions ActivityOptions::setShareIdentityEnabled(jboolean arg0) const
	{
		return callObjectMethod(
