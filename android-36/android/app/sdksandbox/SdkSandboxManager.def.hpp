...
namespace android::app::sdksandbox
{
	...
	public:
		...
		void registerAppOwnedSdkSandboxInterface(android::app::sdksandbox::AppOwnedSdkSandboxInterface arg0) const;
		...
		void unregisterAppOwnedSdkSandboxInterface(JString arg0) const;
	};
} // namespace android::app::sdksandbox
