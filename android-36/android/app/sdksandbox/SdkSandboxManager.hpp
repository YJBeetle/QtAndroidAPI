...
namespace android::app::sdksandbox
{
	...
	inline JObject SdkSandboxManager::getAppOwnedSdkSandboxInterfaces() const
	{
	...
	inline void SdkSandboxManager::registerAppOwnedSdkSandboxInterface(android::app::sdksandbox::AppOwnedSdkSandboxInterface arg0) const
	{
		callMethod<void>(
			"registerAppOwnedSdkSandboxInterface",
			"(Landroid/app/sdksandbox/AppOwnedSdkSandboxInterface;)V",
			arg0.object()
		);
	}
	...
	inline void SdkSandboxManager::unregisterAppOwnedSdkSandboxInterface(JString arg0) const
	{
		callMethod<void>(
