...
namespace android::app
{
	...
	public:
		...
		static jint START_COMPONENT_ACTIVITY();
		static jint START_COMPONENT_BROADCAST();
		static jint START_COMPONENT_CONTENT_PROVIDER();
		static jint START_COMPONENT_OTHER();
		static jint START_COMPONENT_SERVICE();
