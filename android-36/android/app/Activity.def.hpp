...
#include "../view/ContextThemeWrapper.def.hpp"
...
namespace android::app
{
	...
	public:
		...
		static jint FULLSCREEN_MODE_REQUEST_ENTER();
		static jint FULLSCREEN_MODE_REQUEST_EXIT();
		static jint OVERRIDE_TRANSITION_CLOSE();
		static jint OVERRIDE_TRANSITION_OPEN();
		...
		Activity(QJniObject obj) : android::view::ContextThemeWrapper(obj) {}
		...
		void clearOverrideActivityTransition(jint arg0) const;
		...
		android::app::ComponentCaller getCaller() const;
		...
		JObject getOnBackInvokedDispatcher() const;
		...
		void onActivityResult(jint arg0, jint arg1, android::content::Intent arg2, android::app::ComponentCaller arg3) const;
		...
		void onNewIntent(android::content::Intent arg0, android::app::ComponentCaller arg1) const;
		...
		void onPictureInPictureUiStateChanged(android::app::PictureInPictureUiState arg0) const;
		...
		void onRequestPermissionsResult(jint arg0, JArray arg1, JIntArray arg2, jint arg3) const;
		...
		void overrideActivityTransition(jint arg0, jint arg1, jint arg2) const;
		void overrideActivityTransition(jint arg0, jint arg1, jint arg2, jint arg3) const;
		void overridePendingTransition(jint arg0, jint arg1) const;
		void overridePendingTransition(jint arg0, jint arg1, jint arg2) const;
		...
		void registerScreenCaptureCallback(JObject arg0, JObject arg1) const;
		...
		void requestFullscreenMode(jint arg0, JObject arg1) const;
		void requestOpenInBrowserEducation() const;
		void requestPermissions(JArray arg0, jint arg1) const;
		void requestPermissions(JArray arg0, jint arg1, jint arg2) const;
		...
		void setAllowCrossUidActivitySwitchFromBelow(jboolean arg0) const;
		...
		void setIntent(android::content::Intent arg0, android::app::ComponentCaller arg1) const;
		void setLocusContext(android::content::LocusId arg0, android::os::Bundle arg1) const;
		...
		void setRecentsScreenshotEnabled(jboolean arg0) const;
		...
		void setShouldDockBigOverlays(jboolean arg0) const;
		...
		jboolean setTranslucent(jboolean arg0) const;
		...
		jboolean shouldDockBigOverlays() const;
		jboolean shouldShowRequestPermissionRationale(JString arg0) const;
		jboolean shouldShowRequestPermissionRationale(JString arg0, jint arg1) const;
		...
		void unregisterScreenCaptureCallback(JObject arg0) const;
	};
} // namespace android::app
