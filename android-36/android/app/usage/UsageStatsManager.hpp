...
{
	// Fields
	inline JString UsageStatsManager::EXTRA_EVENT_ACTION()
	{
	...
	inline JString UsageStatsManager::EXTRA_EVENT_CATEGORY()
	{
		return getStaticObjectField(
			"android.app.usage.UsageStatsManager",
	...
	inline android::app::usage::UsageEvents UsageStatsManager::queryEvents(android::app::usage::UsageEventsQuery arg0) const
	{
		return callObjectMethod(
			"queryEvents",
			"(Landroid/app/usage/UsageEventsQuery;)Landroid/app/usage/UsageEvents;",
			arg0.object()
		);
	}
