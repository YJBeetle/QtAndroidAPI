...
namespace android::app::usage
{
	...
	public:
		// Fields
		static JString EXTRA_EVENT_ACTION();
		static JString EXTRA_EVENT_CATEGORY();
		...
		UsageStatsManager(QJniObject obj) : JObject(obj) {}
		...
		android::app::usage::UsageEvents queryEvents(android::app::usage::UsageEventsQuery arg0) const;
