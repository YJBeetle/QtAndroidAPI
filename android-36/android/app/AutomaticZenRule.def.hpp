...
namespace android::app
{
	...
	public:
		...
		static jint TYPE_BEDTIME();
		static jint TYPE_DRIVING();
		static jint TYPE_IMMERSIVE();
		static jint TYPE_MANAGED();
		static jint TYPE_OTHER();
		static jint TYPE_SCHEDULE_CALENDAR();
		static jint TYPE_SCHEDULE_TIME();
		static jint TYPE_THEATER();
		...
		AutomaticZenRule(QJniObject obj) : JObject(obj) {}
