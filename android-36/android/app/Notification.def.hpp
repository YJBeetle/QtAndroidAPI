...
namespace android::app
{
	...
	public:
		...
		static JString CATEGORY_VOICEMAIL();
		...
		static JString EXTRA_CALL_TYPE();
		...
		static jint FLAG_PROMOTED_ONGOING();
		...
		Notification(QJniObject obj) : JObject(obj) {}
		...
		JString getShortCriticalText() const;
		...
		jboolean hasPromotableCharacteristics() const;
