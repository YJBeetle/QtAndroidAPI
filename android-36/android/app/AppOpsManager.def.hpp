...
namespace android::app
{
	...
	public:
		...
		static jint OP_NOTED_CALLBACK_FLAG_IGNORE_ASYNC();
		...
		AppOpsManager(QJniObject obj) : JObject(obj) {}
		...
		jint checkOp(JString arg0, jint arg1, JString arg2, JString arg3) const;
		jint checkOpNoThrow(JString arg0, jint arg1, JString arg2) const;
		jint checkOpNoThrow(JString arg0, jint arg1, JString arg2, JString arg3) const;
		jint checkOpRawNoThrow(JString arg0, jint arg1, JString arg2, JString arg3) const;
		...
		void setOnOpNotedCallback(JObject arg0, android::app::AppOpsManager_OnOpNotedCallback arg1, jint arg2) const;
