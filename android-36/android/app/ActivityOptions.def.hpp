...
namespace android::app
{
	...
	public:
		...
		static jint MODE_BACKGROUND_ACTIVITY_START_ALLOWED();
		static jint MODE_BACKGROUND_ACTIVITY_START_ALLOW_ALWAYS();
		static jint MODE_BACKGROUND_ACTIVITY_START_ALLOW_IF_VISIBLE();
		static jint MODE_BACKGROUND_ACTIVITY_START_DENIED();
		static jint MODE_BACKGROUND_ACTIVITY_START_SYSTEM_DEFINED();
		...
		static android::app::ActivityOptions makeCustomAnimation(android::content::Context arg0, jint arg1, jint arg2, jint arg3);
		static android::app::ActivityOptions makeLaunchIntoPip(android::app::PictureInPictureParams arg0);
		...
		jint getPendingIntentBackgroundActivityStartMode() const;
		jint getPendingIntentCreatorBackgroundActivityStartMode() const;
		jint getSplashScreenStyle() const;
		jboolean isAllowPassThroughOnTouchOutside() const;
		jboolean isPendingIntentBackgroundActivityLaunchAllowed() const;
		jboolean isShareIdentityEnabled() const;
		void requestUsageTimeReport(android::app::PendingIntent arg0) const;
		void setAllowPassThroughOnTouchOutside(jboolean arg0) const;
		...
		void setPendingIntentBackgroundActivityLaunchAllowed(jboolean arg0) const;
		android::app::ActivityOptions setPendingIntentBackgroundActivityStartMode(jint arg0) const;
		android::app::ActivityOptions setPendingIntentCreatorBackgroundActivityStartMode(jint arg0) const;
		android::app::ActivityOptions setShareIdentityEnabled(jboolean arg0) const;
		android::app::ActivityOptions setSplashScreenStyle(jint arg0) const;
