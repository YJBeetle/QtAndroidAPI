...
namespace android::app
{
	...
	inline JString NotificationManager::ACTION_CONSOLIDATED_NOTIFICATION_POLICY_CHANGED()
	{
		return getStaticObjectField(
			"android.app.NotificationManager",
	...
	inline jint NotificationManager::AUTOMATIC_RULE_STATUS_ACTIVATED()
	{
	...
	inline jint NotificationManager::AUTOMATIC_RULE_STATUS_DEACTIVATED()
	{
		return getStaticField<jint>(
			"android.app.NotificationManager",
	...
	inline JString NotificationManager::EXTRA_NOTIFICATION_POLICY()
	{
		return getStaticObjectField(
			"android.app.NotificationManager",
	...
	inline jboolean NotificationManager::areAutomaticZenRulesUserManaged() const
	{
	...
	inline jboolean NotificationManager::canPostPromotedNotifications() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean NotificationManager::canUseFullScreenIntent() const
	{
		return callMethod<jboolean>(
	...
	inline jint NotificationManager::getAutomaticZenRuleState(JString arg0) const
	{
	...
	inline jboolean NotificationManager::matchesCallFilter(android::net::Uri arg0) const
	{
		return callMethod<jboolean>(
			"matchesCallFilter",
			"(Landroid/net/Uri;)Z",
