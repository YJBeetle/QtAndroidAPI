...
namespace android::app
{
	...
	// Methods
	inline void KeyguardManager::addKeyguardLockedStateListener(JObject arg0, JObject arg1) const
	{
		callMethod<void>(
			"addKeyguardLockedStateListener",
			"(Ljava/util/concurrent/Executor;Landroid/app/KeyguardManager$KeyguardLockedStateListener;)V",
			arg0.object(),
			arg1.object()
		);
	}
	...
	inline void KeyguardManager::removeKeyguardLockedStateListener(JObject arg0) const
	{
		callMethod<void>(
			"removeKeyguardLockedStateListener",
			"(Landroid/app/KeyguardManager$KeyguardLockedStateListener;)V",
			arg0.object()
		);
	}
