...
namespace android::app
{
	...
	public:
		...
		static jint STOP_FOREGROUND_LEGACY();
		...
		Service(QJniObject obj) : android::content::ContextWrapper(obj) {}
		...
		void onTimeout(jint arg0) const;
		void onTimeout(jint arg0, jint arg1) const;
