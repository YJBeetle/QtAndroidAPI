...
namespace android::adservices::customaudience
{
	...
	inline jint CustomAudience::FLAG_AUCTION_SERVER_REQUEST_OMIT_ADS()
	{
	...
	inline jint CustomAudience::getAuctionServerRequestFlags() const
	{
		return callMethod<jint>(
	...
	inline JObject CustomAudience::getComponentAds() const
	{
		return callObjectMethod(
			"getComponentAds",
			"()Ljava/util/List;"
	...
	inline jdouble CustomAudience::getPriority() const
	{
	...
	inline JString CustomAudience::toString() const
	{
		return callObjectMethod(
			"toString",
			"()Ljava/lang/String;"
