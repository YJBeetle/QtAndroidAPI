...
namespace android::adservices::customaudience
{
	...
	inline android::adservices::customaudience::CustomAudience_Builder CustomAudience_Builder::setAuctionServerRequestFlags(jint arg0) const
	{
		return callObjectMethod(
			"setAuctionServerRequestFlags",
			"(I)Landroid/adservices/customaudience/CustomAudience$Builder;",
			arg0
		);
	}
	...
	inline android::adservices::customaudience::CustomAudience_Builder CustomAudience_Builder::setComponentAds(JObject arg0) const
	{
		return callObjectMethod(
			"setComponentAds",
			"(Ljava/util/List;)Landroid/adservices/customaudience/CustomAudience$Builder;",
	...
	inline android::adservices::customaudience::CustomAudience_Builder CustomAudience_Builder::setPriority(jdouble arg0) const
	{
		return callObjectMethod(
			"setPriority",
			"(D)Landroid/adservices/customaudience/CustomAudience$Builder;",
			arg0
		);
	}
