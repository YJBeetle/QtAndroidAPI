...
namespace android::adservices::adselection
{
	...
	inline android::adservices::adselection::AdSelectionOutcome_Builder AdSelectionOutcome_Builder::setComponentAdUris(JObject arg0) const
	{
		return callObjectMethod(
			"setComponentAdUris",
			"(Ljava/util/List;)Landroid/adservices/adselection/AdSelectionOutcome$Builder;",
			arg0.object()
		);
	}
