...
namespace android::adservices::adselection
{
	...
	public:
		...
		void overrideAdSelectionFromOutcomesConfigRemoteInfo(android::adservices::adselection::AddAdSelectionFromOutcomesOverrideRequest arg0, JObject arg1, JObject arg2) const;
		...
		void removeAdSelectionFromOutcomesConfigRemoteInfoOverride(android::adservices::adselection::RemoveAdSelectionFromOutcomesOverrideRequest arg0, JObject arg1, JObject arg2) const;
		void resetAllAdSelectionConfigRemoteOverrides(JObject arg0, JObject arg1) const;
		void resetAllAdSelectionFromOutcomesConfigRemoteOverrides(JObject arg0, JObject arg1) const;
	};
} // namespace android::adservices::adselection
