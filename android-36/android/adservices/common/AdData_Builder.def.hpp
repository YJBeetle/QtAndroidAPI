...
namespace android::adservices::common
{
	...
	public:
		...
		android::adservices::common::AdData_Builder setAdCounterKeys(JObject arg0) const;
		android::adservices::common::AdData_Builder setAdFilters(android::adservices::common::AdFilters arg0) const;
		android::adservices::common::AdData_Builder setAdRenderId(JString arg0) const;
