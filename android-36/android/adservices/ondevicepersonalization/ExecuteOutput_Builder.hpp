...
namespace android::adservices::ondevicepersonalization
{
	...
	inline android::adservices::ondevicepersonalization::ExecuteOutput_Builder ExecuteOutput_Builder::setBestValue(jint arg0) const
	{
		return callObjectMethod(
			"setBestValue",
			"(I)Landroid/adservices/ondevicepersonalization/ExecuteOutput$Builder;",
			arg0
		);
	}
