...
namespace android::adservices::ondevicepersonalization
{
	...
	inline void OnDevicePersonalizationManager::executeInIsolatedService(android::adservices::ondevicepersonalization::ExecuteInIsolatedServiceRequest arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"executeInIsolatedService",
			"(Landroid/adservices/ondevicepersonalization/ExecuteInIsolatedServiceRequest;Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
