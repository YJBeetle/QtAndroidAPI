...
namespace android::adservices::measurement
{
	...
	inline void MeasurementManager::deleteRegistrations(android::adservices::measurement::DeletionRequest arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"deleteRegistrations",
			"(Landroid/adservices/measurement/DeletionRequest;Ljava/util/concurrent/Executor;Landroid/adservices/common/AdServicesOutcomeReceiver;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
	...
	inline void MeasurementManager::getMeasurementApiStatus(JObject arg0, JObject arg1) const
	{
		callMethod<void>(
			...
			"(Ljava/util/concurrent/Executor;Landroid/adservices/common/AdServicesOutcomeReceiver;)V",
			arg0.object(),
			arg1.object()
		);
	}
	inline void MeasurementManager::registerSource(android::adservices::measurement::SourceRegistrationRequest arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"registerSource",
			"(Landroid/adservices/measurement/SourceRegistrationRequest;Ljava/util/concurrent/Executor;Landroid/adservices/common/AdServicesOutcomeReceiver;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
	...
	inline void MeasurementManager::registerSource(android::net::Uri arg0, android::view::InputEvent arg1, JObject arg2, JObject arg3) const
	{
		callMethod<void>(
			"registerSource",
			"(Landroid/net/Uri;Landroid/view/InputEvent;Ljava/util/concurrent/Executor;Landroid/adservices/common/AdServicesOutcomeReceiver;)V",
			arg0.object(),
			arg1.object(),
			arg2.object(),
			arg3.object()
	...
	inline void MeasurementManager::registerTrigger(android::net::Uri arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"registerTrigger",
			"(Landroid/net/Uri;Ljava/util/concurrent/Executor;Landroid/adservices/common/AdServicesOutcomeReceiver;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
	...
	inline void MeasurementManager::registerWebSource(android::adservices::measurement::WebSourceRegistrationRequest arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"registerWebSource",
			"(Landroid/adservices/measurement/WebSourceRegistrationRequest;Ljava/util/concurrent/Executor;Landroid/adservices/common/AdServicesOutcomeReceiver;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
	...
	inline void MeasurementManager::registerWebTrigger(android::adservices::measurement::WebTriggerRegistrationRequest arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"registerWebTrigger",
			"(Landroid/adservices/measurement/WebTriggerRegistrationRequest;Ljava/util/concurrent/Executor;Landroid/adservices/common/AdServicesOutcomeReceiver;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
