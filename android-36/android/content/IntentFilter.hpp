...
namespace android::content
{
	...
	inline void IntentFilter::addUriRelativeFilterGroup(android::content::UriRelativeFilterGroup arg0) const
	{
		callMethod<void>(
			"addUriRelativeFilterGroup",
			"(Landroid/content/UriRelativeFilterGroup;)V",
			arg0.object()
		);
	}
	inline JObject IntentFilter::asPredicate() const
	{
		return callObjectMethod(
			"asPredicate",
	...
	inline JObject IntentFilter::asPredicateWithTypeResolution(android::content::ContentResolver arg0) const
	{
		return callObjectMethod(
	...
	inline void IntentFilter::clearUriRelativeFilterGroups() const
	{
		callMethod<void>(
	...
	inline jint IntentFilter::countUriRelativeFilterGroups() const
	{
		return callMethod<jint>(
	...
	inline android::content::UriRelativeFilterGroup IntentFilter::getUriRelativeFilterGroup(jint arg0) const
	{
		return callObjectMethod(
			"getUriRelativeFilterGroup",
			"(I)Landroid/content/UriRelativeFilterGroup;",
			arg0
		);
	}
