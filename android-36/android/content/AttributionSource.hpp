...
namespace android::content
{
	...
	// Methods
	inline android::content::AttributionSource AttributionSource::myAttributionSource()
	{
	...
	inline jint AttributionSource::getDeviceId() const
	{
		return callMethod<jint>(
			"getDeviceId",
			"()I"
	...
	inline jint AttributionSource::getPid() const
	{
		return callMethod<jint>(
			"getPid",
			"()I"
