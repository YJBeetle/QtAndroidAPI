...
namespace android::content::om
{
	...
	inline void FabricatedOverlay::setNinePatchResourceValue(JString arg0, android::os::ParcelFileDescriptor arg1, JString arg2) const
	{
		callMethod<void>(
			"setNinePatchResourceValue",
	...
	inline void FabricatedOverlay::setResourceValue(JString arg0, android::content::res::AssetFileDescriptor arg1, JString arg2) const
	{
		callMethod<void>(
			"setResourceValue",
			"(Ljava/lang/String;Landroid/content/res/AssetFileDescriptor;Ljava/lang/String;)V",
			arg0.object<jstring>(),
			arg1.object(),
			arg2.object<jstring>()
		);
