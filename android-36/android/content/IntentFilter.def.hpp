...
namespace android::content
{
	...
	public:
		...
		void addUriRelativeFilterGroup(android::content::UriRelativeFilterGroup arg0) const;
		...
		void clearUriRelativeFilterGroups() const;
		...
		jint countUriRelativeFilterGroups() const;
		...
		android::content::UriRelativeFilterGroup getUriRelativeFilterGroup(jint arg0) const;
