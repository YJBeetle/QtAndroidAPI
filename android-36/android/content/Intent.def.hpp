...
namespace android::content
{
	...
	public:
		...
		static JString ACTION_APPLICATION_LOCALE_CHANGED();
		...
		static JString ACTION_CREATE_NOTE();
		...
		static JString ACTION_LAUNCH_CAPTURE_CONTENT_ACTIVITY_FOR_NOTE();
		...
		static JString ACTION_PACKAGE_UNSTOPPED();
		...
		static JString ACTION_PROFILE_ADDED();
		static JString ACTION_PROFILE_AVAILABLE();
		static JString ACTION_PROFILE_INACCESSIBLE();
		static JString ACTION_PROFILE_REMOVED();
		static JString ACTION_PROFILE_UNAVAILABLE();
		...
		static JString ACTION_SAFETY_CENTER();
		...
		static JString ACTION_SHOW_WORK_APPS();
		...
		static JString ACTION_UNARCHIVE_PACKAGE();
		...
		static jint CAPTURE_CONTENT_FOR_NOTE_BLOCKED_BY_ADMIN();
		static jint CAPTURE_CONTENT_FOR_NOTE_FAILED();
		static jint CAPTURE_CONTENT_FOR_NOTE_SUCCESS();
		static jint CAPTURE_CONTENT_FOR_NOTE_USER_CANCELED();
		static jint CAPTURE_CONTENT_FOR_NOTE_WINDOW_MODE_UNSUPPORTED();
		...
		static JString CATEGORY_APP_FITNESS();
		...
		static JString CATEGORY_APP_WEATHER();
		...
		static jint CHOOSER_CONTENT_TYPE_ALBUM();
		...
		static JString EXTRA_CAPTURE_CONTENT_FOR_NOTE_STATUS_CODE();
		...
		static JString EXTRA_CHOOSER_ADDITIONAL_CONTENT_URI();
		static JString EXTRA_CHOOSER_CONTENT_TYPE_HINT();
		static JString EXTRA_CHOOSER_CUSTOM_ACTIONS();
		static JString EXTRA_CHOOSER_FOCUSED_ITEM_POSITION();
		static JString EXTRA_CHOOSER_MODIFY_SHARE_ACTION();
		static JString EXTRA_CHOOSER_REFINEMENT_INTENT_SENDER();
		static JString EXTRA_CHOOSER_RESULT();
		static JString EXTRA_CHOOSER_RESULT_INTENT_SENDER();
		...
		static JString EXTRA_USE_STYLUS_MODE();
		...
		Intent(QJniObject obj) : JObject(obj) {}
		...
		JObjectArray getParcelableArrayExtra(JString arg0, JClass arg1) const;
		java::util::ArrayList getParcelableArrayListExtra(JString arg0) const;
		java::util::ArrayList getParcelableArrayListExtra(JString arg0, JClass arg1) const;
		JObject getParcelableExtra(JString arg0) const;
		JObject getParcelableExtra(JString arg0, JClass arg1) const;
		JString getScheme() const;
		android::content::Intent getSelector() const;
		JObject getSerializableExtra(JString arg0) const;
		JObject getSerializableExtra(JString arg0, JClass arg1) const;
		...
		jboolean isMismatchingFilter() const;
		...
		void removeLaunchSecurityProtection() const;
