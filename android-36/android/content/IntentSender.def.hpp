...
namespace android::content
{
	...
	public:
		...
		IntentSender(QJniObject obj) : JObject(obj) {}
		...
		void sendIntent(android::content::Context arg0, jint arg1, android::content::Intent arg2, JString arg3, android::os::Bundle arg4, JObject arg5, JObject arg6) const;
