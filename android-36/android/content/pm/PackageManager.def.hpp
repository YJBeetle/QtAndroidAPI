...
namespace android::content::pm
{
	class PackageManager_ComponentInfoFlags;
}
namespace android::content::pm
{
	class PackageManager_PackageInfoFlags;
}
namespace android::content::pm
{
	class PackageManager_Property;
}
namespace android::content::pm
{
	class PackageManager_ResolveInfoFlags;
}
namespace android::content::pm
{
...
namespace android::content::pm
{
	...
	public:
		...
		static JString FEATURE_AUDIO_SPATIAL_HEADTRACKING_LOW_LATENCY();
		...
		static JString FEATURE_BLUETOOTH_LE_CHANNEL_SOUNDING();
		...
		static JString FEATURE_CAMERA_CONCURRENT();
		...
		static JString FEATURE_CONTROLS();
		static JString FEATURE_CREDENTIALS();
		static JString FEATURE_DEVICE_ADMIN();
		static JString FEATURE_DEVICE_LOCK();
		static JString FEATURE_EMBEDDED();
		static JString FEATURE_ETHERNET();
		static JString FEATURE_EXPANDED_PICTURE_IN_PICTURE();
		...
		static JString FEATURE_HARDWARE_KEYSTORE();
		static JString FEATURE_HIFI_SENSORS();
		static JString FEATURE_HOME_SCREEN();
		static JString FEATURE_IDENTITY_CREDENTIAL_HARDWARE();
		static JString FEATURE_IDENTITY_CREDENTIAL_HARDWARE_DIRECT_ACCESS();
		static JString FEATURE_INPUT_METHODS();
		static JString FEATURE_IPSEC_TUNNELS();
		static JString FEATURE_IPSEC_TUNNEL_MIGRATION();
		static JString FEATURE_IRIS();
		static JString FEATURE_KEYSTORE_APP_ATTEST_KEY();
		static JString FEATURE_KEYSTORE_LIMITED_USE_KEY();
		static JString FEATURE_KEYSTORE_SINGLE_USE_KEY();
		...
		static JString FEATURE_OPENGLES_DEQP_LEVEL();
		...
		static JString FEATURE_SECURITY_MODEL_COMPATIBLE();
		static JString FEATURE_SENSOR_ACCELEROMETER();
		static JString FEATURE_SENSOR_ACCELEROMETER_LIMITED_AXES();
		static JString FEATURE_SENSOR_ACCELEROMETER_LIMITED_AXES_UNCALIBRATED();
		...
		static JString FEATURE_SENSOR_DYNAMIC_HEAD_TRACKER();
		static JString FEATURE_SENSOR_GYROSCOPE();
		static JString FEATURE_SENSOR_GYROSCOPE_LIMITED_AXES();
		static JString FEATURE_SENSOR_GYROSCOPE_LIMITED_AXES_UNCALIBRATED();
		static JString FEATURE_SENSOR_HEADING();
		static JString FEATURE_SENSOR_HEART_RATE();
		static JString FEATURE_SENSOR_HEART_RATE_ECG();
		static JString FEATURE_SENSOR_HINGE_ANGLE();
		...
		static JString FEATURE_SE_OMAPI_ESE();
		static JString FEATURE_SE_OMAPI_SD();
		static JString FEATURE_SE_OMAPI_UICC();
		static JString FEATURE_SIP();
		static JString FEATURE_SIP_VOIP();
		static JString FEATURE_STRONGBOX_KEYSTORE();
		static JString FEATURE_TELECOM();
		static JString FEATURE_TELEPHONY();
		static JString FEATURE_TELEPHONY_CALLING();
		static JString FEATURE_TELEPHONY_CDMA();
		static JString FEATURE_TELEPHONY_DATA();
		static JString FEATURE_TELEPHONY_EUICC();
		static JString FEATURE_TELEPHONY_EUICC_MEP();
		static JString FEATURE_TELEPHONY_GSM();
		static JString FEATURE_TELEPHONY_IMS();
		static JString FEATURE_TELEPHONY_MBMS();
		static JString FEATURE_TELEPHONY_MESSAGING();
		static JString FEATURE_TELEPHONY_RADIO_ACCESS();
		static JString FEATURE_TELEPHONY_SUBSCRIPTION();
		static JString FEATURE_TELEVISION();
		static JString FEATURE_THREAD_NETWORK();
		...
		static JString FEATURE_VULKAN_DEQP_LEVEL();
		...
		static JString FEATURE_WALLET_LOCATION_BASED_SUGGESTIONS();
		...
		static JString FEATURE_WINDOW_MAGNIFICATION();
		...
		static jint GET_ATTRIBUTIONS();
		static jlong GET_ATTRIBUTIONS_LONG();
		...
		static jint INSTALL_SCENARIO_BULK();
		static jint INSTALL_SCENARIO_BULK_SECONDARY();
		static jint INSTALL_SCENARIO_DEFAULT();
		static jint INSTALL_SCENARIO_FAST();
		static jint MATCH_ALL();
		static jint MATCH_APEX();
		static jlong MATCH_ARCHIVED_PACKAGES();
		...
		static JString PROPERTY_COMPAT_OVERRIDE_LANDSCAPE_TO_PORTRAIT();
		static JString PROPERTY_MEDIA_CAPABILITIES();
		static JString PROPERTY_SELF_CERTIFIED_NETWORK_CAPABILITIES();
		static JString PROPERTY_SPECIAL_USE_FGS_SUBTYPE();
		static JString PROPERTY_USE_RESTRICTED_BACKUP_MODE();
		...
		// Methods
		static android::content::pm::SigningInfo getVerifiedSigningInfo(JString arg0, jint arg1);
		...
		JBooleanArray canPackageQuery(JString arg0, JArray arg1) const;
		jboolean canPackageQuery(JString arg0, JString arg1) const;
		...
		android::content::pm::ActivityInfo getActivityInfo(android::content::ComponentName arg0, android::content::pm::PackageManager_ComponentInfoFlags arg1) const;
		...
		android::content::pm::ApplicationInfo getApplicationInfo(JString arg0, android::content::pm::PackageManager_ApplicationInfoFlags arg1) const;
		...
		android::content::pm::ArchivedPackageInfo getArchivedPackage(JString arg0) const;
		JString getBackgroundPermissionOptionLabel() const;
		...
		void getGroupOfPlatformPermission(JString arg0, JObject arg1, JObject arg2) const;
		android::content::pm::InstallSourceInfo getInstallSourceInfo(JString arg0) const;
		JObject getInstalledApplications(android::content::pm::PackageManager_ApplicationInfoFlags arg0) const;
		JObject getInstalledApplications(jint arg0) const;
		JObject getInstalledModules(jint arg0) const;
		JObject getInstalledPackages(android::content::pm::PackageManager_PackageInfoFlags arg0) const;
		...
		android::content::IntentSender getLaunchIntentSenderForPackage(JString arg0) const;
		android::content::Intent getLeanbackLaunchIntentForPackage(JString arg0) const;
		JObject getMimeGroup(JString arg0) const;
		android::content::pm::ModuleInfo getModuleInfo(JString arg0, jint arg1) const;
		JString getNameForUid(jint arg0) const;
		android::content::pm::PackageInfo getPackageArchiveInfo(JString arg0, android::content::pm::PackageManager_PackageInfoFlags arg1) const;
		...
		JIntArray getPackageGids(JString arg0, android::content::pm::PackageManager_PackageInfoFlags arg1) const;
		JIntArray getPackageGids(JString arg0, jint arg1) const;
		android::content::pm::PackageInfo getPackageInfo(android::content::pm::VersionedPackage arg0, android::content::pm::PackageManager_PackageInfoFlags arg1) const;
		android::content::pm::PackageInfo getPackageInfo(android::content::pm::VersionedPackage arg0, jint arg1) const;
		android::content::pm::PackageInfo getPackageInfo(JString arg0, android::content::pm::PackageManager_PackageInfoFlags arg1) const;
		...
		jint getPackageUid(JString arg0, android::content::pm::PackageManager_PackageInfoFlags arg1) const;
		jint getPackageUid(JString arg0, jint arg1) const;
		JArray getPackagesForUid(jint arg0) const;
		JObject getPackagesHoldingPermissions(JArray arg0, android::content::pm::PackageManager_PackageInfoFlags arg1) const;
		...
		void getPlatformPermissionsForGroup(JString arg0, JObject arg1, JObject arg2) const;
		jint getPreferredActivities(JObject arg0, JObject arg1, JString arg2) const;
		JObject getPreferredPackages(jint arg0) const;
		android::content::pm::PackageManager_Property getProperty(JString arg0, android::content::ComponentName arg1) const;
		android::content::pm::PackageManager_Property getProperty(JString arg0, JString arg1) const;
		android::content::pm::ProviderInfo getProviderInfo(android::content::ComponentName arg0, android::content::pm::PackageManager_ComponentInfoFlags arg1) const;
		android::content::pm::ProviderInfo getProviderInfo(android::content::ComponentName arg0, jint arg1) const;
		android::content::pm::ActivityInfo getReceiverInfo(android::content::ComponentName arg0, android::content::pm::PackageManager_ComponentInfoFlags arg1) const;
		...
		android::content::res::Resources getResourcesForApplication(android::content::pm::ApplicationInfo arg0, android::content::res::Configuration arg1) const;
		android::content::pm::ServiceInfo getServiceInfo(android::content::ComponentName arg0, android::content::pm::PackageManager_ComponentInfoFlags arg1) const;
		android::content::pm::ServiceInfo getServiceInfo(android::content::ComponentName arg0, jint arg1) const;
		JObject getSharedLibraries(android::content::pm::PackageManager_PackageInfoFlags arg0) const;
		...
		jint getTargetSdkVersion(JString arg0) const;
		...
		jboolean isAppArchivable(JString arg0) const;
		jboolean isAutoRevokeWhitelisted() const;
		jboolean isAutoRevokeWhitelisted(JString arg0) const;
		jboolean isDefaultApplicationIcon(android::graphics::drawable::Drawable arg0) const;
		jboolean isDeviceUpgrading() const;
		jboolean isInstantApp() const;
		jboolean isInstantApp(JString arg0) const;
		jboolean isPackageStopped(JString arg0) const;
		...
		JObject parseAndroidManifest(android::os::ParcelFileDescriptor arg0, JObject arg1) const;
		JObject parseAndroidManifest(java::io::File arg0, JObject arg1) const;
		JObject queryActivityProperty(JString arg0) const;
		JObject queryApplicationProperty(JString arg0) const;
		JObject queryBroadcastReceivers(android::content::Intent arg0, android::content::pm::PackageManager_ResolveInfoFlags arg1) const;
		JObject queryBroadcastReceivers(android::content::Intent arg0, jint arg1) const;
		JObject queryContentProviders(JString arg0, jint arg1, android::content::pm::PackageManager_ComponentInfoFlags arg2) const;
		...
		JObject queryIntentActivities(android::content::Intent arg0, android::content::pm::PackageManager_ResolveInfoFlags arg1) const;
		...
		JObject queryIntentActivityOptions(android::content::ComponentName arg0, JObject arg1, android::content::Intent arg2, android::content::pm::PackageManager_ResolveInfoFlags arg3) const;
		JObject queryIntentContentProviders(android::content::Intent arg0, android::content::pm::PackageManager_ResolveInfoFlags arg1) const;
		JObject queryIntentContentProviders(android::content::Intent arg0, jint arg1) const;
		JObject queryIntentServices(android::content::Intent arg0, android::content::pm::PackageManager_ResolveInfoFlags arg1) const;
		...
		JObject queryProviderProperty(JString arg0) const;
		JObject queryReceiverProperty(JString arg0) const;
		JObject queryServiceProperty(JString arg0) const;
		void relinquishUpdateOwnership(JString arg0) const;
		...
		void requestChecksums(JString arg0, jboolean arg1, jint arg2, JObject arg3, JObject arg4) const;
		android::content::pm::ResolveInfo resolveActivity(android::content::Intent arg0, android::content::pm::PackageManager_ResolveInfoFlags arg1) const;
		android::content::pm::ResolveInfo resolveActivity(android::content::Intent arg0, jint arg1) const;
		android::content::pm::ProviderInfo resolveContentProvider(JString arg0, android::content::pm::PackageManager_ComponentInfoFlags arg1) const;
		android::content::pm::ProviderInfo resolveContentProvider(JString arg0, jint arg1) const;
		android::content::pm::ResolveInfo resolveService(android::content::Intent arg0, android::content::pm::PackageManager_ResolveInfoFlags arg1) const;
		...
		jboolean setAutoRevokeWhitelisted(JString arg0, jboolean arg1) const;
		void setComponentEnabledSetting(android::content::ComponentName arg0, jint arg1, jint arg2) const;
		void setComponentEnabledSettings(JObject arg0) const;
		void setInstallerPackageName(JString arg0, JString arg1) const;
		void setMimeGroup(JString arg0, JObject arg1) const;
