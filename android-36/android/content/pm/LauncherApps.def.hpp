...
namespace android::content::pm
{
	class LauncherApps_ArchiveCompatibilityParams;
}
namespace android::content::pm
{
...
namespace android::content::pm
{
	...
	public:
		...
		android::content::IntentSender getAppMarketActivityIntent(JString arg0, android::os::UserHandle arg1) const;
		android::content::pm::ApplicationInfo getApplicationInfo(JString arg0, jint arg1, android::os::UserHandle arg2) const;
		android::content::pm::LauncherUserInfo getLauncherUserInfo(android::os::UserHandle arg0) const;
		android::content::pm::LauncherApps_PinItemRequest getPinItemRequest(android::content::Intent arg0) const;
		JObject getPreInstalledSystemPackages(android::os::UserHandle arg0) const;
		android::content::IntentSender getPrivateSpaceSettingsIntent() const;
		...
		android::app::PendingIntent getShortcutIntent(JString arg0, JString arg1, android::os::Bundle arg2, android::os::UserHandle arg3) const;
		...
		void setArchiveCompatibility(android::content::pm::LauncherApps_ArchiveCompatibilityParams arg0) const;
