...
namespace android::content::pm
{
	...
	inline JObject LauncherApps::getAllPackageInstallerSessions() const
	{
		return callObjectMethod(
	...
	inline android::content::IntentSender LauncherApps::getAppMarketActivityIntent(JString arg0, android::os::UserHandle arg1) const
	{
		return callObjectMethod(
			"getAppMarketActivityIntent",
			"(Ljava/lang/String;Landroid/os/UserHandle;)Landroid/content/IntentSender;",
			arg0.object<jstring>(),
			arg1.object()
		);
	}
	...
	inline android::content::pm::LauncherUserInfo LauncherApps::getLauncherUserInfo(android::os::UserHandle arg0) const
	{
		return callObjectMethod(
			"getLauncherUserInfo",
			"(Landroid/os/UserHandle;)Landroid/content/pm/LauncherUserInfo;",
			arg0.object()
		);
	}
	...
	inline JObject LauncherApps::getPreInstalledSystemPackages(android::os::UserHandle arg0) const
	{
		return callObjectMethod(
	...
	inline android::content::IntentSender LauncherApps::getPrivateSpaceSettingsIntent() const
	{
		return callObjectMethod(
	...
	inline android::app::PendingIntent LauncherApps::getShortcutIntent(JString arg0, JString arg1, android::os::Bundle arg2, android::os::UserHandle arg3) const
	{
		return callObjectMethod(
			"getShortcutIntent",
	...
	inline void LauncherApps::registerPackageInstallerSessionCallback(JObject arg0, android::content::pm::PackageInstaller_SessionCallback arg1) const
	{
		callMethod<void>(
	...
	inline void LauncherApps::setArchiveCompatibility(android::content::pm::LauncherApps_ArchiveCompatibilityParams arg0) const
	{
		callMethod<void>(
			"setArchiveCompatibility",
			"(Landroid/content/pm/LauncherApps$ArchiveCompatibilityParams;)V",
			arg0.object()
		);
	}
	inline jboolean LauncherApps::shouldHideFromSuggestions(JString arg0, android::os::UserHandle arg1) const
	{
		return callMethod<jboolean>(
	...
	inline void LauncherApps::startPackageInstallerSessionDetailsActivity(android::content::pm::PackageInstaller_SessionInfo arg0, android::graphics::Rect arg1, android::os::Bundle arg2) const
	{
		callMethod<void>(
	...
	inline void LauncherApps::unregisterPackageInstallerSessionCallback(android::content::pm::PackageInstaller_SessionCallback arg0) const
	{
		callMethod<void>(
