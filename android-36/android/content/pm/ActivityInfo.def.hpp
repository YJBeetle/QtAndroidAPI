...
namespace android::content::pm
{
	...
	public:
		...
		static jint CONFIG_ASSETS_PATHS();
		static jint CONFIG_COLOR_MODE();
		static jint CONFIG_DENSITY();
		static jint CONFIG_FONT_SCALE();
		static jint CONFIG_FONT_WEIGHT_ADJUSTMENT();
		static jint CONFIG_GRAMMATICAL_GENDER();
		...
		static jint CONFIG_RESOURCES_UNUSED();
		...
		static jint FLAG_ALLOW_UNTRUSTED_ACTIVITY_EMBEDDING();
		...
		static jint LAUNCH_SINGLE_INSTANCE_PER_TASK();
		...
		JString requiredDisplayCategory();
		...
		ActivityInfo(QJniObject obj) : android::content::pm::ComponentInfo(obj) {}
		...
		JObject getKnownActivityEmbeddingCerts() const;
