...
namespace android::content::pm
{
	...
	inline jboolean CrossProfileApps::isManagedProfile(android::os::UserHandle arg0) const
	{
		return callMethod<jboolean>(
			"isManagedProfile",
	...
	inline jboolean CrossProfileApps::isProfile(android::os::UserHandle arg0) const
	{
		return callMethod<jboolean>(
			"isProfile",
			"(Landroid/os/UserHandle;)Z",
	...
	inline void CrossProfileApps::startMainActivity(android::content::ComponentName arg0, android::os::UserHandle arg1, android::app::Activity arg2, android::os::Bundle arg3) const
	{
		callMethod<void>(
			"startMainActivity",
			"(Landroid/content/ComponentName;Landroid/os/UserHandle;Landroid/app/Activity;Landroid/os/Bundle;)V",
			arg0.object(),
			arg1.object(),
			arg2.object(),
			arg3.object()
