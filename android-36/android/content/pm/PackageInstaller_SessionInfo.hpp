...
namespace android::content::pm
{
	...
	inline jint PackageInstaller_SessionInfo::SESSION_ACTIVATION_FAILED()
	{
		return getStaticField<jint>(
			"android.content.pm.PackageInstaller$SessionInfo",
	...
	inline jint PackageInstaller_SessionInfo::SESSION_CONFLICT()
	{
		return getStaticField<jint>(
			"android.content.pm.PackageInstaller$SessionInfo",
			"SESSION_CONFLICT"
	...
	inline jint PackageInstaller_SessionInfo::SESSION_NO_ERROR()
	{
		return getStaticField<jint>(
			"android.content.pm.PackageInstaller$SessionInfo",
			"SESSION_NO_ERROR"
	...
	inline jint PackageInstaller_SessionInfo::SESSION_UNKNOWN_ERROR()
	{
		return getStaticField<jint>(
			"android.content.pm.PackageInstaller$SessionInfo",
	...
	inline jint PackageInstaller_SessionInfo::SESSION_VERIFICATION_FAILED()
	{
		return getStaticField<jint>(
			"android.content.pm.PackageInstaller$SessionInfo",
	...
	inline jint PackageInstaller_SessionInfo::STAGED_SESSION_CONFLICT()
	{
		return getStaticField<jint>(
			"android.content.pm.PackageInstaller$SessionInfo",
	...
	inline jboolean PackageInstaller_SessionInfo::getDontKillApp() const
	{
	...
	inline JString PackageInstaller_SessionInfo::getInstallerAttributionTag() const
	{
		return callObjectMethod(
	...
	inline jint PackageInstaller_SessionInfo::getInstallerUid() const
	{
		return callMethod<jint>(
			"getInstallerUid",
			"()I"
	...
	inline jint PackageInstaller_SessionInfo::getPackageSource() const
	{
		return callMethod<jint>(
			"getPackageSource",
			"()I"
	...
	inline jint PackageInstaller_SessionInfo::getRequireUserAction() const
	{
		return callMethod<jint>(
	...
	inline jboolean PackageInstaller_SessionInfo::isApplicationEnabledSettingPersistent() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean PackageInstaller_SessionInfo::isAutoInstallDependenciesEnabled() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean PackageInstaller_SessionInfo::isPreApprovalRequested() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean PackageInstaller_SessionInfo::isRequestUpdateOwnership() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean PackageInstaller_SessionInfo::isUnarchival() const
	{
		return callMethod<jboolean>(
			"isUnarchival",
			"()Z"
