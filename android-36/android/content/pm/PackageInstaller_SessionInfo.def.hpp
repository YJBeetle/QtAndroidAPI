...
namespace android::content::pm
{
	...
	public:
		...
		jboolean isAutoInstallDependenciesEnabled() const;
		jboolean isCommitted() const;
		jboolean isMultiPackage() const;
		jboolean isPreApprovalRequested() const;
