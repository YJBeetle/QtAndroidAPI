...
namespace android::content::pm
{
	...
	inline void PackageInstaller_SessionParams::setAutoInstallDependenciesEnabled(jboolean arg0) const
	{
		callMethod<void>(
	...
	inline void PackageInstaller_SessionParams::setUnarchiveId(jint arg0) const
	{
		callMethod<void>(
			"setUnarchiveId",
			"(I)V",
