...
namespace android::content
{
	...
	public:
		...
		static JString ADVANCED_PROTECTION_SERVICE();
		static JString ALARM_SERVICE();
		static JString APPWIDGET_SERVICE();
		static JString APP_FUNCTION_SERVICE();
		...
		static jint BIND_PACKAGE_ISOLATED_PROCESS();
		...
		static JString CONTACT_KEYS_SERVICE();
		...
		static JString KEYSTORE_SERVICE();
		...
		static JString MEDIA_QUALITY_SERVICE();
		...
		static JString PERSISTENT_DATA_BLOCK_SERVICE();
		static JString POWER_SERVICE();
		static JString PRINT_SERVICE();
		static JString PROFILING_SERVICE();
		...
		static JString SATELLITE_SERVICE();
		static JString SEARCH_SERVICE();
		static JString SECURITY_STATE_SERVICE();
		...
		jint checkContentUriPermissionFull(android::net::Uri arg0, jint arg1, jint arg2, jint arg3) const;
