...
namespace android::bluetooth
{
	...
	inline JString BluetoothDevice::ACTION_ALIAS_CHANGED()
	{
		return getStaticObjectField(
			"android.bluetooth.BluetoothDevice",
	...
	inline JString BluetoothDevice::ACTION_ENCRYPTION_CHANGE()
	{
		return getStaticObjectField(
			"android.bluetooth.BluetoothDevice",
	...
	inline JString BluetoothDevice::ACTION_KEY_MISSING()
	{
		return getStaticObjectField(
			"android.bluetooth.BluetoothDevice",
			"ACTION_KEY_MISSING",
	...
	inline jint BluetoothDevice::ADDRESS_TYPE_ANONYMOUS()
	{
	...
	inline jint BluetoothDevice::ADDRESS_TYPE_PUBLIC()
	{
		return getStaticField<jint>(
			"android.bluetooth.BluetoothDevice",
			"ADDRESS_TYPE_PUBLIC"
	...
	inline jint BluetoothDevice::ADDRESS_TYPE_RANDOM()
	{
		return getStaticField<jint>(
			"android.bluetooth.BluetoothDevice",
			"ADDRESS_TYPE_RANDOM"
	...
	inline jint BluetoothDevice::ADDRESS_TYPE_UNKNOWN()
	{
		return getStaticField<jint>(
			"android.bluetooth.BluetoothDevice",
	...
	inline jint BluetoothDevice::ENCRYPTION_ALGORITHM_AES()
	{
		return getStaticField<jint>(
			"android.bluetooth.BluetoothDevice",
	...
	inline jint BluetoothDevice::ENCRYPTION_ALGORITHM_E0()
	{
		return getStaticField<jint>(
			"android.bluetooth.BluetoothDevice",
	...
	inline jint BluetoothDevice::ENCRYPTION_ALGORITHM_NONE()
	{
		return getStaticField<jint>(
			"android.bluetooth.BluetoothDevice",
	...
	inline JString BluetoothDevice::EXTRA_ENCRYPTION_ALGORITHM()
	{
		return getStaticObjectField(
			"android.bluetooth.BluetoothDevice",
	...
	inline JString BluetoothDevice::EXTRA_ENCRYPTION_ENABLED()
	{
		return getStaticObjectField(
			"android.bluetooth.BluetoothDevice",
	...
	inline JString BluetoothDevice::EXTRA_ENCRYPTION_STATUS()
	{
		return getStaticObjectField(
			"android.bluetooth.BluetoothDevice",
	...
	inline JString BluetoothDevice::EXTRA_IS_COORDINATED_SET_MEMBER()
	{
		return getStaticObjectField(
			"android.bluetooth.BluetoothDevice",
	...
	inline JString BluetoothDevice::EXTRA_KEY_SIZE()
	{
		return getStaticObjectField(
			"android.bluetooth.BluetoothDevice",
			"EXTRA_KEY_SIZE",
	...
	inline JString BluetoothDevice::EXTRA_TRANSPORT()
	{
		return getStaticObjectField(
			"android.bluetooth.BluetoothDevice",
			"EXTRA_TRANSPORT",
	...
	inline android::bluetooth::BluetoothSocket BluetoothDevice::createInsecureL2capChannel(jint arg0) const
	{
		return callObjectMethod(
	...
	inline android::bluetooth::BluetoothSocket BluetoothDevice::createL2capChannel(jint arg0) const
	{
		return callObjectMethod(
			"createL2capChannel",
			"(I)Landroid/bluetooth/BluetoothSocket;",
	...
	inline android::bluetooth::BluetoothSocket BluetoothDevice::createUsingSocketSettings(android::bluetooth::BluetoothSocketSettings arg0) const
	{
		return callObjectMethod(
			"createUsingSocketSettings",
			"(Landroid/bluetooth/BluetoothSocketSettings;)Landroid/bluetooth/BluetoothSocket;",
			arg0.object()
		);
	}
	...
	inline jint BluetoothDevice::getAddressType() const
	{
		return callMethod<jint>(
			"getAddressType",
			"()I"
	...
	inline JString BluetoothDevice::getAlias() const
	{
		return callObjectMethod(
			"getAlias",
			"()Ljava/lang/String;"
	...
	inline android::bluetooth::BluetoothDevice_BluetoothAddress BluetoothDevice::getIdentityAddressWithType() const
	{
		return callObjectMethod(
			"getIdentityAddressWithType",
			"()Landroid/bluetooth/BluetoothDevice$BluetoothAddress;"
		);
	}
	...
	inline jint BluetoothDevice::setAlias(JString arg0) const
	{
		return callMethod<jint>(
			"setAlias",
			"(Ljava/lang/String;)I",
