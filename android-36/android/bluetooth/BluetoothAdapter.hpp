...
namespace android::bluetooth
{
	...
	inline java::time::Duration BluetoothAdapter::getDiscoverableTimeout() const
	{
		return callObjectMethod(
	...
	inline jint BluetoothAdapter::getMaxConnectedAudioDevices() const
	{
		return callMethod<jint>(
	...
	inline android::bluetooth::BluetoothDevice BluetoothAdapter::getRemoteLeDevice(JString arg0, jint arg1) const
	{
		return callObjectMethod(
			"getRemoteLeDevice",
	...
	inline jint BluetoothAdapter::isLeAudioBroadcastAssistantSupported() const
	{
		return callMethod<jint>(
	...
	inline jint BluetoothAdapter::isLeAudioBroadcastSourceSupported() const
	{
		return callMethod<jint>(
	...
	inline jint BluetoothAdapter::isLeAudioSupported() const
	{
		return callMethod<jint>(
			"isLeAudioSupported",
			"()I"
	...
	inline android::bluetooth::BluetoothServerSocket BluetoothAdapter::listenUsingInsecureL2capChannel() const
	{
		return callObjectMethod(
	...
	inline android::bluetooth::BluetoothServerSocket BluetoothAdapter::listenUsingL2capChannel() const
	{
		return callObjectMethod(
	...
	inline android::bluetooth::BluetoothServerSocket BluetoothAdapter::listenUsingSocketSettings(android::bluetooth::BluetoothSocketSettings arg0) const
	{
		return callObjectMethod(
			"listenUsingSocketSettings",
			"(Landroid/bluetooth/BluetoothSocketSettings;)Landroid/bluetooth/BluetoothServerSocket;",
			arg0.object()
		);
	}
