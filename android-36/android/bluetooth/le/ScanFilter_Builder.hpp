...
namespace android::bluetooth::le
{
	...
	inline android::bluetooth::le::ScanFilter_Builder ScanFilter_Builder::setAdvertisingDataType(jint arg0) const
	{
		return callObjectMethod(
			"setAdvertisingDataType",
			"(I)Landroid/bluetooth/le/ScanFilter$Builder;",
			arg0
		);
	}
	inline android::bluetooth::le::ScanFilter_Builder ScanFilter_Builder::setAdvertisingDataTypeWithData(jint arg0, JByteArray arg1, JByteArray arg2) const
	{
		return callObjectMethod(
	...
	inline android::bluetooth::le::ScanFilter_Builder ScanFilter_Builder::setServiceSolicitationUuid(android::os::ParcelUuid arg0) const
	{
		return callObjectMethod(
	...
	inline android::bluetooth::le::ScanFilter_Builder ScanFilter_Builder::setServiceSolicitationUuid(android::os::ParcelUuid arg0, android::os::ParcelUuid arg1) const
	{
		return callObjectMethod(
			"setServiceSolicitationUuid",
