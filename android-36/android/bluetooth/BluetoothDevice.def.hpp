...
namespace android::bluetooth
{
	class BluetoothDevice_BluetoothAddress;
}
namespace android::bluetooth
{
	class BluetoothGatt;
...
namespace android::bluetooth
{
	...
	public:
		...
		static JString ACTION_ENCRYPTION_CHANGE();
		static JString ACTION_FOUND();
		static JString ACTION_KEY_MISSING();
		static JString ACTION_NAME_CHANGED();
		static JString ACTION_PAIRING_REQUEST();
		static JString ACTION_UUID();
		static jint ADDRESS_TYPE_ANONYMOUS();
		static jint ADDRESS_TYPE_PUBLIC();
		static jint ADDRESS_TYPE_RANDOM();
		static jint ADDRESS_TYPE_UNKNOWN();
		...
		static jint ENCRYPTION_ALGORITHM_AES();
		static jint ENCRYPTION_ALGORITHM_E0();
		static jint ENCRYPTION_ALGORITHM_NONE();
		static jint ERROR();
		static JString EXTRA_BOND_STATE();
		static JString EXTRA_CLASS();
		static JString EXTRA_DEVICE();
		static JString EXTRA_ENCRYPTION_ALGORITHM();
		static JString EXTRA_ENCRYPTION_ENABLED();
		static JString EXTRA_ENCRYPTION_STATUS();
		static JString EXTRA_IS_COORDINATED_SET_MEMBER();
		static JString EXTRA_KEY_SIZE();
		...
		static JString EXTRA_TRANSPORT();
		...
		BluetoothDevice(QJniObject obj) : JObject(obj) {}
		...
		android::bluetooth::BluetoothSocket createUsingSocketSettings(android::bluetooth::BluetoothSocketSettings arg0) const;
		...
		android::bluetooth::BluetoothDevice_BluetoothAddress getIdentityAddressWithType() const;
