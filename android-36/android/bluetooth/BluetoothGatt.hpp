...
namespace android::bluetooth
{
	...
	inline jint BluetoothGatt::CONNECTION_PRIORITY_DCK()
	{
		return getStaticField<jint>(
			"android.bluetooth.BluetoothGatt",
	...
	inline jint BluetoothGatt::GATT_CONNECTION_TIMEOUT()
	{
		return getStaticField<jint>(
			"android.bluetooth.BluetoothGatt",
	...
	inline jint BluetoothGatt::GATT_INSUFFICIENT_AUTHORIZATION()
	{
		return getStaticField<jint>(
			"android.bluetooth.BluetoothGatt",
	...
	inline jint BluetoothGatt::writeCharacteristic(android::bluetooth::BluetoothGattCharacteristic arg0, JByteArray arg1, jint arg2) const
	{
		return callMethod<jint>(
			"writeCharacteristic",
	...
	inline jint BluetoothGatt::writeDescriptor(android::bluetooth::BluetoothGattDescriptor arg0, JByteArray arg1) const
	{
		return callMethod<jint>(
			"writeDescriptor",
