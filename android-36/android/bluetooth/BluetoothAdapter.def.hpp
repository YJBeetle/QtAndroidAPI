...
namespace android::bluetooth
{
	...
	public:
		...
		BluetoothAdapter(QJniObject obj) : JObject(obj) {}
		...
		java::time::Duration getDiscoverableTimeout() const;
		jint getLeMaximumAdvertisingDataLength() const;
		jint getMaxConnectedAudioDevices() const;
		...
		android::bluetooth::BluetoothDevice getRemoteLeDevice(JString arg0, jint arg1) const;
		jint getScanMode() const;
		jint getState() const;
		jboolean isDiscovering() const;
		jboolean isEnabled() const;
		jboolean isLe2MPhySupported() const;
		jint isLeAudioBroadcastAssistantSupported() const;
		jint isLeAudioBroadcastSourceSupported() const;
		jint isLeAudioSupported() const;
		...
		android::bluetooth::BluetoothServerSocket listenUsingSocketSettings(android::bluetooth::BluetoothSocketSettings arg0) const;
