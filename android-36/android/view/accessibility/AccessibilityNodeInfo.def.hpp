...
namespace android::view::accessibility
{
	...
	public:
		...
		static JString ACTION_ARGUMENT_DIRECTION_INT();
		...
		static JString ACTION_ARGUMENT_SCROLL_AMOUNT_FLOAT();
		...
		static jint CHECKED_STATE_FALSE();
		static jint CHECKED_STATE_PARTIAL();
		static jint CHECKED_STATE_TRUE();
		static JObject CREATOR();
		static jint EXPANDED_STATE_COLLAPSED();
		static jint EXPANDED_STATE_FULL();
		static jint EXPANDED_STATE_PARTIAL();
		static jint EXPANDED_STATE_UNDEFINED();
		static JString EXTRA_DATA_RENDERING_INFO_KEY();
		static JString EXTRA_DATA_TEXT_CHARACTER_LOCATION_ARG_LENGTH();
		static jint EXTRA_DATA_TEXT_CHARACTER_LOCATION_ARG_MAX_LENGTH();
		static JString EXTRA_DATA_TEXT_CHARACTER_LOCATION_ARG_START_INDEX();
		static JString EXTRA_DATA_TEXT_CHARACTER_LOCATION_IN_WINDOW_KEY();
		static JString EXTRA_DATA_TEXT_CHARACTER_LOCATION_KEY();
		static jint FLAG_PREFETCH_ANCESTORS();
		static jint FLAG_PREFETCH_DESCENDANTS_BREADTH_FIRST();
		static jint FLAG_PREFETCH_DESCENDANTS_DEPTH_FIRST();
		static jint FLAG_PREFETCH_DESCENDANTS_HYBRID();
		static jint FLAG_PREFETCH_SIBLINGS();
		static jint FLAG_PREFETCH_UNINTERRUPTIBLE();
		static jint FOCUS_ACCESSIBILITY();
		static jint FOCUS_INPUT();
		static jint MAX_NUMBER_OF_PREFETCHED_NODES();
		...
		AccessibilityNodeInfo(QJniObject obj) : JObject(obj) {}
		...
		void addLabeledBy(android::view::View arg0) const;
		void addLabeledBy(android::view::View arg0, jint arg1) const;
		...
		void getBoundsInWindow(android::graphics::Rect arg0) const;
		jint getChecked() const;
		android::view::accessibility::AccessibilityNodeInfo getChild(jint arg0) const;
		android::view::accessibility::AccessibilityNodeInfo getChild(jint arg0, jint arg1) const;
		...
		JObject getLabeledByList() const;
		jint getLiveRegion() const;
		jint getMaxTextLength() const;
		java::time::Duration getMinDurationBetweenContentChanges() const;
		...
		android::view::accessibility::AccessibilityNodeInfo getParent(jint arg0) const;
		...
		jboolean hasRequestInitialAccessibilityFocus() const;
		jint hashCode() const;
		...
		jboolean isFieldRequired() const;
		jboolean isFocusable() const;
		jboolean isFocused() const;
		jboolean isGranularScrollingSupported() const;
		...
		jboolean removeLabeledBy(android::view::View arg0) const;
		jboolean removeLabeledBy(android::view::View arg0, jint arg1) const;
		void setAccessibilityDataSensitive(jboolean arg0) const;
		...
		void setContainerTitle(JString arg0) const;
		...
		void setExpandedState(jint arg0) const;
		void setFieldRequired(jboolean arg0) const;
		void setFocusable(jboolean arg0) const;
		void setFocused(jboolean arg0) const;
		void setGranularScrollingSupported(jboolean arg0) const;
		...
		void setMinDurationBetweenContentChanges(java::time::Duration arg0) const;
		...
		void setQueryFromAppProcessEnabled(android::view::View arg0, jboolean arg1) const;
		void setRangeInfo(android::view::accessibility::AccessibilityNodeInfo_RangeInfo arg0) const;
		void setRequestInitialAccessibilityFocus(jboolean arg0) const;
		...
		void setTextSelectable(jboolean arg0) const;
		...
		void setUniqueId(JString arg0) const;
