...
namespace android::view::accessibility
{
	...
	inline jint AccessibilityWindowInfo::TYPE_MAGNIFICATION_OVERLAY()
	{
		return getStaticField<jint>(
			"android.view.accessibility.AccessibilityWindowInfo",
	...
	inline jint AccessibilityWindowInfo::TYPE_WINDOW_CONTROL()
	{
		return getStaticField<jint>(
			"android.view.accessibility.AccessibilityWindowInfo",
			"TYPE_WINDOW_CONTROL"
	...
	inline android::os::LocaleList AccessibilityWindowInfo::getLocales() const
	{
		return callObjectMethod(
			"getLocales",
	...
	inline android::view::accessibility::AccessibilityNodeInfo AccessibilityWindowInfo::getRoot(jint arg0) const
	{
		return callObjectMethod(
			"getRoot",
	...
	inline jlong AccessibilityWindowInfo::getTransitionTimeMillis() const
	{
