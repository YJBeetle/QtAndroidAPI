...
namespace android::view::accessibility
{
	...
	public:
		// Fields
		static jint CONTENT_CHANGE_TYPE_CHECKED();
		static jint CONTENT_CHANGE_TYPE_CONTENT_DESCRIPTION();
		static jint CONTENT_CHANGE_TYPE_CONTENT_INVALID();
		static jint CONTENT_CHANGE_TYPE_DRAG_CANCELLED();
		static jint CONTENT_CHANGE_TYPE_DRAG_DROPPED();
		static jint CONTENT_CHANGE_TYPE_DRAG_STARTED();
		static jint CONTENT_CHANGE_TYPE_ENABLED();
		static jint CONTENT_CHANGE_TYPE_ERROR();
		static jint CONTENT_CHANGE_TYPE_EXPANDED();
		...
		static jint CONTENT_CHANGE_TYPE_SUPPLEMENTAL_DESCRIPTION();
		...
		static jint SPEECH_STATE_LISTENING_END();
		static jint SPEECH_STATE_LISTENING_START();
		static jint SPEECH_STATE_SPEAKING_END();
		static jint SPEECH_STATE_SPEAKING_START();
		...
		static jint TYPE_SPEECH_STATE_CHANGE();
		...
		static jint TYPE_VIEW_TARGETED_BY_SCROLL();
		...
		AccessibilityEvent(QJniObject obj) : android::view::accessibility::AccessibilityRecord(obj) {}
		...
		jint getSpeechStateChangeTypes() const;
		...
		void setSpeechStateChangeTypes(jint arg0) const;
