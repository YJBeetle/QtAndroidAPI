...
namespace android::view::accessibility
{
	...
	public:
		...
		AccessibilityManager(QJniObject obj) : JObject(obj) {}
		...
		void addAccessibilityServicesStateChangeListener(JObject arg0) const;
		void addAccessibilityServicesStateChangeListener(JObject arg0, JObject arg1) const;
		...
		void addAudioDescriptionRequestedChangeListener(JObject arg0, JObject arg1) const;
		void addHighContrastTextStateChangeListener(JObject arg0, JObject arg1) const;
		...
		jint getAccessibilityFocusColor() const;
		jint getAccessibilityFocusStrokeWidth() const;
		...
		jboolean isAudioDescriptionRequested() const;
		jboolean isEnabled() const;
		jboolean isHighContrastTextEnabled() const;
		jboolean isRequestFromAccessibilityTool() const;
		...
		jboolean removeAccessibilityServicesStateChangeListener(JObject arg0) const;
		jboolean removeAccessibilityStateChangeListener(JObject arg0) const;
		jboolean removeAudioDescriptionRequestedChangeListener(JObject arg0) const;
		void removeHighContrastTextStateChangeListener(JObject arg0) const;
