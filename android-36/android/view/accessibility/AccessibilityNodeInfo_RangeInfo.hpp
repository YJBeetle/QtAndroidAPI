...
{
	// Fields
	inline android::view::accessibility::AccessibilityNodeInfo_RangeInfo AccessibilityNodeInfo_RangeInfo::INDETERMINATE()
	{
	...
	inline jint AccessibilityNodeInfo_RangeInfo::RANGE_TYPE_INDETERMINATE()
	{
		return getStaticField<jint>(
			"android.view.accessibility.AccessibilityNodeInfo$RangeInfo",
	...
	// Constructors
	inline AccessibilityNodeInfo_RangeInfo::AccessibilityNodeInfo_RangeInfo(jint arg0, jfloat arg1, jfloat arg2, jfloat arg3)
		: JObject(
			"android.view.accessibility.AccessibilityNodeInfo$RangeInfo",
			"(IFFF)V",
			arg0,
