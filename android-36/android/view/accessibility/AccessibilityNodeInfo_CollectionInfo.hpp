...
namespace android::view::accessibility
{
	...
	inline jint AccessibilityNodeInfo_CollectionInfo::UNDEFINED()
	{
		return getStaticField<jint>(
			"android.view.accessibility.AccessibilityNodeInfo$CollectionInfo",
			"UNDEFINED"
	...
	// Constructors
	inline AccessibilityNodeInfo_CollectionInfo::AccessibilityNodeInfo_CollectionInfo(jint arg0, jint arg1, jboolean arg2)
		: JObject(
			"android.view.accessibility.AccessibilityNodeInfo$CollectionInfo",
			"(IIZ)V",
			arg0,
	...
	inline AccessibilityNodeInfo_CollectionInfo::AccessibilityNodeInfo_CollectionInfo(jint arg0, jint arg1, jboolean arg2, jint arg3)
		: JObject(
			"android.view.accessibility.AccessibilityNodeInfo$CollectionInfo",
			"(IIZI)V",
			arg0,
	...
	inline jint AccessibilityNodeInfo_CollectionInfo::getImportantForAccessibilityItemCount() const
	{
		return callMethod<jint>(
	...
	inline jint AccessibilityNodeInfo_CollectionInfo::getItemCount() const
	{
		return callMethod<jint>(
			"getItemCount",
			"()I"
