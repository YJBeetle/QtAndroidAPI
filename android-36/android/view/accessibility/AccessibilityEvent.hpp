...
{
	// Fields
	inline jint AccessibilityEvent::CONTENT_CHANGE_TYPE_CHECKED()
	{
	...
	inline jint AccessibilityEvent::CONTENT_CHANGE_TYPE_CONTENT_INVALID()
	{
		return getStaticField<jint>(
			"android.view.accessibility.AccessibilityEvent",
	...
	inline jint AccessibilityEvent::CONTENT_CHANGE_TYPE_ENABLED()
	{
		return getStaticField<jint>(
			"android.view.accessibility.AccessibilityEvent",
	...
	inline jint AccessibilityEvent::CONTENT_CHANGE_TYPE_ERROR()
	{
		return getStaticField<jint>(
			"android.view.accessibility.AccessibilityEvent",
	...
	inline jint AccessibilityEvent::CONTENT_CHANGE_TYPE_EXPANDED()
	{
		return getStaticField<jint>(
			"android.view.accessibility.AccessibilityEvent",
	...
	inline jint AccessibilityEvent::CONTENT_CHANGE_TYPE_SUPPLEMENTAL_DESCRIPTION()
	{
		return getStaticField<jint>(
			"android.view.accessibility.AccessibilityEvent",
	...
	inline jint AccessibilityEvent::TYPE_VIEW_TARGETED_BY_SCROLL()
	{
		return getStaticField<jint>(
			"android.view.accessibility.AccessibilityEvent",
	...
	inline jboolean AccessibilityEvent::isAccessibilityDataSensitive() const
	{
	...
	inline void AccessibilityEvent::setAccessibilityDataSensitive(jboolean arg0) const
	{
		callMethod<void>(
