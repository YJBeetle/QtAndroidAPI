...
namespace android::view
{
	...
	public:
		...
		static jint FRAME_RATE_CATEGORY_HIGH();
		static jint FRAME_RATE_CATEGORY_NORMAL();
		...
		Display(QJniObject obj) : JObject(obj) {}
		...
		jfloat getHdrSdrRatio() const;
		jint getHeight() const;
		jfloat getHighestHdrSdrRatio() const;
		...
		android::hardware::OverlayProperties getOverlaySupport() const;
		...
		android::view::DisplayShape getShape() const;
		void getSize(android::graphics::Point arg0) const;
		jint getState() const;
		jfloat getSuggestedFrameRate(jint arg0) const;
		JArray getSupportedModes() const;
		JFloatArray getSupportedRefreshRates() const;
		jint getWidth() const;
		jboolean hasArrSupport() const;
		jboolean isHdr() const;
		jboolean isHdrSdrRatioAvailable() const;
		jboolean isMinimalPostProcessingSupported() const;
		jboolean isValid() const;
		jboolean isWideColorGamut() const;
		void registerHdrSdrRatioChangedListener(JObject arg0, JObject arg1) const;
		JString toString() const;
		void unregisterHdrSdrRatioChangedListener(JObject arg0) const;
	};
} // namespace android::view
