...
namespace android::view
{
	...
	inline void SurfaceView::clearChildSurfacePackage() const
	{
		callMethod<void>(
	...
	inline JString SurfaceView::getAccessibilityClassName() const
	{
	...
	inline android::view::SurfaceControlViewHost_SurfacePackage SurfaceView::getChildSurfacePackage() const
	{
		return callObjectMethod(
	...
	inline jint SurfaceView::getCompositionOrder() const
	{
	...
	inline void SurfaceView::setCompositionOrder(jint arg0) const
	{
		callMethod<void>(
			"setCompositionOrder",
			"(I)V",
	...
	inline void SurfaceView::setDesiredHdrHeadroom(jfloat arg0) const
	{
		callMethod<void>(
