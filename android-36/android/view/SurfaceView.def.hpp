...
namespace android::view
{
	...
	public:
		...
		void clearChildSurfacePackage() const;
		void draw(android::graphics::Canvas arg0) const;
		jboolean gatherTransparentRegion(android::graphics::Region arg0) const;
		JString getAccessibilityClassName() const;
		android::view::SurfaceControlViewHost_SurfacePackage getChildSurfacePackage() const;
		jint getCompositionOrder() const;
		...
		void setCompositionOrder(jint arg0) const;
