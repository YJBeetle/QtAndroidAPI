...
#include "../hardware/DisplayLuts.def.hpp"
...
namespace android::view
{
	...
	inline android::view::SurfaceControl_Transaction SurfaceControl_Transaction::addTransactionCompletedListener(JObject arg0, JObject arg1) const
	{
		return callObjectMethod(
			"addTransactionCompletedListener",
			"(Ljava/util/concurrent/Executor;Ljava/util/function/Consumer;)Landroid/view/SurfaceControl$Transaction;",
			arg0.object(),
			arg1.object()
		);
	}
	...
	inline android::view::SurfaceControl_Transaction SurfaceControl_Transaction::setContentPriority(android::view::SurfaceControl arg0, jint arg1) const
	{
		return callObjectMethod(
			"setContentPriority",
			"(Landroid/view/SurfaceControl;I)Landroid/view/SurfaceControl$Transaction;",
	...
	inline android::view::SurfaceControl_Transaction SurfaceControl_Transaction::setDesiredHdrHeadroom(android::view::SurfaceControl arg0, jfloat arg1) const
	{
		return callObjectMethod(
	...
	inline android::view::SurfaceControl_Transaction SurfaceControl_Transaction::setDesiredPresentTimeNanos(jlong arg0) const
	{
		return callObjectMethod(
			"setDesiredPresentTimeNanos",
			"(J)Landroid/view/SurfaceControl$Transaction;",
			arg0
		);
	}
	...
	inline android::view::SurfaceControl_Transaction SurfaceControl_Transaction::setFrameTimeline(jlong arg0) const
	{
		return callObjectMethod(
			"setFrameTimeline",
			"(J)Landroid/view/SurfaceControl$Transaction;",
	...
	inline android::view::SurfaceControl_Transaction SurfaceControl_Transaction::setLuts(android::view::SurfaceControl arg0, android::hardware::DisplayLuts arg1) const
	{
		return callObjectMethod(
			"setLuts",
			"(Landroid/view/SurfaceControl;Landroid/hardware/DisplayLuts;)Landroid/view/SurfaceControl$Transaction;",
			arg0.object(),
			arg1.object()
		);
	}
