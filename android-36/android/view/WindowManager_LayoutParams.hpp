...
namespace android::view
{
	...
	inline jfloat WindowManager_LayoutParams::getDesiredHdrHeadroom() const
	{
	...
	inline jboolean WindowManager_LayoutParams::getFrameRateBoostOnTouchEnabled() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean WindowManager_LayoutParams::isFrameRatePowerSavingsBalanced() const
	{
		return callMethod<jboolean>(
	...
	inline void WindowManager_LayoutParams::setDesiredHdrHeadroom(jfloat arg0) const
	{
		callMethod<void>(
	...
	inline void WindowManager_LayoutParams::setFrameRateBoostOnTouchEnabled(jboolean arg0) const
	{
		callMethod<void>(
	...
	inline void WindowManager_LayoutParams::setFrameRatePowerSavingsBalanced(jboolean arg0) const
	{
		callMethod<void>(
