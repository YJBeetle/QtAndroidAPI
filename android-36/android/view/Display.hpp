...
#include "../hardware/OverlayProperties.def.hpp"
...
namespace android::view
{
	...
	inline jint Display::FRAME_RATE_CATEGORY_HIGH()
	{
		return getStaticField<jint>(
			"android.view.Display",
	...
	inline jint Display::FRAME_RATE_CATEGORY_NORMAL()
	{
		return getStaticField<jint>(
			"android.view.Display",
	...
	inline jfloat Display::getHdrSdrRatio() const
	{
	...
	inline jfloat Display::getHighestHdrSdrRatio() const
	{
		return callMethod<jfloat>(
	...
	inline android::hardware::OverlayProperties Display::getOverlaySupport() const
	{
		return callObjectMethod(
			"getOverlaySupport",
	...
	inline android::view::DisplayShape Display::getShape() const
	{
		return callObjectMethod(
			"getShape",
	...
	inline jfloat Display::getSuggestedFrameRate(jint arg0) const
	{
		return callMethod<jfloat>(
	...
	inline jboolean Display::hasArrSupport() const
	{
	...
	inline jboolean Display::isHdrSdrRatioAvailable() const
	{
		return callMethod<jboolean>(
	...
	inline void Display::registerHdrSdrRatioChangedListener(JObject arg0, JObject arg1) const
	{
		callMethod<void>(
	...
	inline void Display::unregisterHdrSdrRatioChangedListener(JObject arg0) const
	{
		callMethod<void>(
