...
namespace android::view::animation
{
	...
	inline jint Animation::getBackdropColor() const
	{
	...
	inline jboolean Animation::getShowBackdrop() const
	{
		return callMethod<jboolean>(
			"getShowBackdrop",
			"()Z"
	...
	inline void Animation::setBackdropColor(jint arg0) const
	{
		callMethod<void>(
			"setBackdropColor",
			"(I)V",
	...
	inline void Animation::setShowBackdrop(jboolean arg0) const
	{
		callMethod<void>(
			"setShowBackdrop",
			"(Z)V",
