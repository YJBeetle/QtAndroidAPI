...
namespace android::view
{
	...
	public:
		...
		android::view::SurfaceControl_Transaction addTransactionCompletedListener(JObject arg0, JObject arg1) const;
		void apply() const;
		...
		android::view::SurfaceControl_Transaction setContentPriority(android::view::SurfaceControl arg0, jint arg1) const;
		...
		android::view::SurfaceControl_Transaction setDesiredHdrHeadroom(android::view::SurfaceControl arg0, jfloat arg1) const;
		android::view::SurfaceControl_Transaction setDesiredPresentTimeNanos(jlong arg0) const;
		...
		android::view::SurfaceControl_Transaction setFrameTimeline(jlong arg0) const;
		...
		android::view::SurfaceControl_Transaction setLuts(android::view::SurfaceControl arg0, android::hardware::DisplayLuts arg1) const;
