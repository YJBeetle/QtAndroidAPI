...
namespace android::view
{
	...
	inline android::window::InputTransferToken SurfaceControlViewHost_SurfacePackage::getInputTransferToken() const
	{
	...
	inline JString SurfaceControlViewHost_SurfacePackage::toString() const
	{
		return callObjectMethod(
			"toString",
			"()Ljava/lang/String;"
