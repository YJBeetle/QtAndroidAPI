...
namespace android::view::contentcapture
{
	...
	inline void ContentCaptureSession::flush() const
	{
		callMethod<void>(
			"flush",
			"()V"
	...
	inline void ContentCaptureSession::notifySessionPaused() const
	{
		callMethod<void>(
			"notifySessionPaused",
			"()V"
	...
	inline void ContentCaptureSession::notifySessionResumed() const
	{
		callMethod<void>(
	...
	inline void ContentCaptureSession::notifyViewInsetsChanged(android::graphics::Insets arg0) const
	{
		callMethod<void>(
	...
	inline void ContentCaptureSession::notifyViewsAppeared(JObject arg0) const
	{
		callMethod<void>(
			"notifyViewsAppeared",
			"(Ljava/util/List;)V",
