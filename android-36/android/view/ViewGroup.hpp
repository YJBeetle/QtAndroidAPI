...
namespace android::view
{
	...
	inline void ViewGroup::dispatchCreateViewTranslationRequest(JObject arg0, JIntArray arg1, android::view::translation::TranslationCapability arg2, JObject arg3) const
	{
		callMethod<void>(
	...
	inline void ViewGroup::dispatchScrollCaptureSearch(android::graphics::Rect arg0, android::graphics::Point arg1, JObject arg2) const
	{
		callMethod<void>(
	...
	inline JObject ViewGroup::findOnBackInvokedDispatcherForChild(android::view::View arg0, android::view::View arg1) const
	{
		return callObjectMethod(
	...
	inline void ViewGroup::propagateRequestedFrameRate(jfloat arg0, jboolean arg1) const
	{
		callMethod<void>(
	...
	inline void ViewGroup::setRequestedFrameRate(jfloat arg0) const
	{
		callMethod<void>(
