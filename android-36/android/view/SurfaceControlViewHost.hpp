...
#include "../window/InputTransferToken.def.hpp"
...
namespace android::view
{
	...
	inline SurfaceControlViewHost::SurfaceControlViewHost(android::content::Context arg0, android::view::Display arg1, android::window::InputTransferToken arg2)
		: JObject(
			"android.view.SurfaceControlViewHost",
			"(Landroid/content/Context;Landroid/view/Display;Landroid/window/InputTransferToken;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		) {}
