...
namespace android::view
{
	...
	public:
		...
		JObject findOnBackInvokedDispatcherForChild(android::view::View arg0, android::view::View arg1) const;
		...
		void propagateRequestedFrameRate(jfloat arg0, jboolean arg1) const;
