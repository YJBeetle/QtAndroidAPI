...
namespace android::view::autofill
{
	...
	inline jint AutofillId::getAutofillVirtualId() const
	{
		return callMethod<jint>(
	...
	inline jint AutofillId::getSessionId() const
	{
		return callMethod<jint>(
			"getSessionId",
			"()I"
	...
	inline jint AutofillId::getViewId() const
	{
		return callMethod<jint>(
			"getViewId",
			"()I"
	...
	inline jboolean AutofillId::isInAutofillSession() const
	{
		return callMethod<jboolean>(
			"isInAutofillSession",
			"()Z"
	...
	inline jboolean AutofillId::isVirtual() const
	{
		return callMethod<jboolean>(
			"isVirtual",
			"()Z"
