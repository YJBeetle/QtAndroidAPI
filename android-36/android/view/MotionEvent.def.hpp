...
namespace android::view
{
	...
	public:
		...
		static jint AXIS_GESTURE_PINCH_SCALE_FACTOR();
		static jint AXIS_GESTURE_SCROLL_X_DISTANCE();
		static jint AXIS_GESTURE_SCROLL_Y_DISTANCE();
		static jint AXIS_GESTURE_X_OFFSET();
		static jint AXIS_GESTURE_Y_OFFSET();
		...
		static jint CLASSIFICATION_PINCH();
		static jint CLASSIFICATION_TWO_FINGER_SWIPE();
		...
		MotionEvent(QJniObject obj) : android::view::InputEvent(obj) {}
		...
		static android::view::MotionEvent obtain(jlong arg0, jlong arg1, jint arg2, jint arg3, JArray arg4, JArray arg5, jint arg6, jint arg7, jfloat arg8, jfloat arg9, jint arg10, jint arg11, jint arg12, jint arg13, jint arg14, jint arg15);
		...
		jlong getHistoricalEventTimeNanos(jint arg0) const;
