...
namespace android::view
{
	...
	public:
		// Fields
		static JString EXTRA_VIRTUAL_STRUCTURE_TYPE();
		static JString EXTRA_VIRTUAL_STRUCTURE_VERSION_NUMBER();
		...
		ViewStructure(QJniObject obj) : JObject(obj) {}
		...
		void clearCredentialManagerRequest() const;
		...
		void setReceiveContentMimeTypes(JArray arg0) const;
