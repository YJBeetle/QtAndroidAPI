...
{
	// Fields
	inline JString ViewStructure::EXTRA_VIRTUAL_STRUCTURE_TYPE()
	{
	...
	inline JString ViewStructure::EXTRA_VIRTUAL_STRUCTURE_VERSION_NUMBER()
	{
		return getStaticObjectField(
			"android.view.ViewStructure",
	...
	inline void ViewStructure::clearCredentialManagerRequest() const
	{
		callMethod<void>(
	...
	inline JObject ViewStructure::getPendingCredentialCallback() const
	{
		return callObjectMethod(
	...
	inline android::credentials::GetCredentialRequest ViewStructure::getPendingCredentialRequest() const
	{
		return callObjectMethod(
	...
	inline void ViewStructure::setHintIdEntry(JString arg0) const
	{
		callMethod<void>(
			"setHintIdEntry",
			"(Ljava/lang/String;)V",
	...
	inline void ViewStructure::setPendingCredentialRequest(android::credentials::GetCredentialRequest arg0, JObject arg1) const
	{
		callMethod<void>(
	...
	inline void ViewStructure::setReceiveContentMimeTypes(JArray arg0) const
	{
		callMethod<void>(
