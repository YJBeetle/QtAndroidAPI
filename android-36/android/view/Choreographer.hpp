...
namespace android::view
{
	...
	inline void Choreographer::postVsyncCallback(JObject arg0) const
	{
		callMethod<void>(
			"postVsyncCallback",
			"(Landroid/view/Choreographer$VsyncCallback;)V",
			arg0.object()
		);
	}
	...
	inline void Choreographer::removeVsyncCallback(JObject arg0) const
	{
		callMethod<void>(
			"removeVsyncCallback",
			"(Landroid/view/Choreographer$VsyncCallback;)V",
