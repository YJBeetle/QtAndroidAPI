...
namespace android::view
{
	...
	inline JObject WindowInsets::getBoundingRects(jint arg0) const
	{
		return callObjectMethod(
			"getBoundingRects",
			"(I)Ljava/util/List;",
	...
	inline JObject WindowInsets::getBoundingRectsIgnoringVisibility(jint arg0) const
	{
		return callObjectMethod(
	...
	inline android::view::DisplayShape WindowInsets::getDisplayShape() const
	{
		return callObjectMethod(
			"getDisplayShape",
	...
	inline android::util::Size WindowInsets::getFrame() const
	{
		return callObjectMethod(
			"getFrame",
			"()Landroid/util/Size;"
