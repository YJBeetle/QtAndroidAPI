...
namespace android::view
{
	...
	public:
		...
		static jint DISPLAY_FLAG_DISABLE_HDR_CONVERSION();
		...
		jboolean areWallpaperTouchEventsEnabled() const;
		jboolean canPlayMoveAnimation() const;
		...
		jfloat getDesiredHdrHeadroom() const;
		jint getFitInsetsSides() const;
		jint getFitInsetsTypes() const;
		jboolean getFrameRateBoostOnTouchEnabled() const;
		JString getTitle() const;
		jboolean isFitInsetsIgnoringVisibility() const;
		jboolean isFrameRatePowerSavingsBalanced() const;
		jboolean isHdrConversionEnabled() const;
		void setBlurBehindRadius(jint arg0) const;
		void setCanPlayMoveAnimation(jboolean arg0) const;
		void setColorMode(jint arg0) const;
		void setDesiredHdrHeadroom(jfloat arg0) const;
		...
		void setFrameRateBoostOnTouchEnabled(jboolean arg0) const;
		void setFrameRatePowerSavingsBalanced(jboolean arg0) const;
		void setHdrConversionEnabled(jboolean arg0) const;
		void setTitle(JString arg0) const;
		void setWallpaperTouchEventsEnabled(jboolean arg0) const;
