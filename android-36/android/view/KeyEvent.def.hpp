...
namespace android::view
{
	...
	public:
		...
		static jint KEYCODE_DEMO_APP_1();
		static jint KEYCODE_DEMO_APP_2();
		static jint KEYCODE_DEMO_APP_3();
		static jint KEYCODE_DEMO_APP_4();
		static jint KEYCODE_DICTATE();
		static jint KEYCODE_DO_NOT_DISTURB();
		...
		static jint KEYCODE_EMOJI_PICKER();
		...
		static jint KEYCODE_F13();
		static jint KEYCODE_F14();
		static jint KEYCODE_F15();
		static jint KEYCODE_F16();
		static jint KEYCODE_F17();
		static jint KEYCODE_F18();
		static jint KEYCODE_F19();
		static jint KEYCODE_F2();
		static jint KEYCODE_F20();
		static jint KEYCODE_F21();
		static jint KEYCODE_F22();
		static jint KEYCODE_F23();
		static jint KEYCODE_F24();
		...
		static jint KEYCODE_FEATURED_APP_1();
		static jint KEYCODE_FEATURED_APP_2();
		static jint KEYCODE_FEATURED_APP_3();
		static jint KEYCODE_FEATURED_APP_4();
		static jint KEYCODE_FOCUS();
		static jint KEYCODE_FORWARD();
		static jint KEYCODE_FORWARD_DEL();
		static jint KEYCODE_FULLSCREEN();
		...
		static jint KEYCODE_KEYBOARD_BACKLIGHT_DOWN();
		static jint KEYCODE_KEYBOARD_BACKLIGHT_TOGGLE();
		static jint KEYCODE_KEYBOARD_BACKLIGHT_UP();
		static jint KEYCODE_L();
		static jint KEYCODE_LANGUAGE_SWITCH();
		static jint KEYCODE_LAST_CHANNEL();
		static jint KEYCODE_LEFT_BRACKET();
		static jint KEYCODE_LOCK();
		static jint KEYCODE_M();
		static jint KEYCODE_MACRO_1();
		static jint KEYCODE_MACRO_2();
		static jint KEYCODE_MACRO_3();
		static jint KEYCODE_MACRO_4();
		...
		static jint KEYCODE_STYLUS_BUTTON_PRIMARY();
		static jint KEYCODE_STYLUS_BUTTON_SECONDARY();
		static jint KEYCODE_STYLUS_BUTTON_TAIL();
		static jint KEYCODE_STYLUS_BUTTON_TERTIARY();
		...
		static jint KEYCODE_VIDEO_APP_1();
		static jint KEYCODE_VIDEO_APP_2();
		static jint KEYCODE_VIDEO_APP_3();
		static jint KEYCODE_VIDEO_APP_4();
		static jint KEYCODE_VIDEO_APP_5();
		static jint KEYCODE_VIDEO_APP_6();
		static jint KEYCODE_VIDEO_APP_7();
		static jint KEYCODE_VIDEO_APP_8();
		...
		KeyEvent(QJniObject obj) : android::view::InputEvent(obj) {}
