...
namespace android::view
{
	...
	public:
		// Fields
		static jint ACCESSIBILITY_DATA_SENSITIVE_AUTO();
		static jint ACCESSIBILITY_DATA_SENSITIVE_NO();
		static jint ACCESSIBILITY_DATA_SENSITIVE_YES();
		...
		static jint CONTENT_SENSITIVITY_AUTO();
		static jint CONTENT_SENSITIVITY_NOT_SENSITIVE();
		static jint CONTENT_SENSITIVITY_SENSITIVE();
		static jint DRAG_FLAG_ACCESSIBILITY_ACTION();
		...
		static jint DRAG_FLAG_GLOBAL_SAME_APPLICATION();
		static jint DRAG_FLAG_GLOBAL_URI_READ();
		static jint DRAG_FLAG_GLOBAL_URI_WRITE();
		static jint DRAG_FLAG_HIDE_CALLING_TASK_ON_DRAG_START();
		static jint DRAG_FLAG_OPAQUE();
		static jint DRAG_FLAG_START_INTENT_SENDER_ON_UNHANDLED_DRAG();
		...
		static jfloat REQUESTED_FRAME_RATE_CATEGORY_DEFAULT();
		static jfloat REQUESTED_FRAME_RATE_CATEGORY_HIGH();
		static jfloat REQUESTED_FRAME_RATE_CATEGORY_LOW();
		static jfloat REQUESTED_FRAME_RATE_CATEGORY_NORMAL();
		static jfloat REQUESTED_FRAME_RATE_CATEGORY_NO_PREFERENCE();
		...
		View(QJniObject obj) : JObject(obj) {}
		...
		void clearPendingCredentialRequest() const;
		...
		JObject findOnBackInvokedDispatcher() const;
		...
		JString getAllowedHandwritingDelegatePackageName() const;
		JString getAllowedHandwritingDelegatorPackageName() const;
		...
		jint getContentSensitivity() const;
		...
		jfloat getFrameContentVelocity() const;
		...
		jfloat getHandwritingBoundsOffsetBottom() const;
		jfloat getHandwritingBoundsOffsetLeft() const;
		jfloat getHandwritingBoundsOffsetRight() const;
		jfloat getHandwritingBoundsOffsetTop() const;
		jint getHandwritingDelegateFlags() const;
		JObject getHandwritingDelegatorCallback() const;
		...
		JObject getPendingCredentialCallback() const;
		android::credentials::GetCredentialRequest getPendingCredentialRequest() const;
		jfloat getPivotX() const;
		jfloat getPivotY() const;
		android::view::PointerIcon getPointerIcon() const;
		JObject getPreferKeepClearRects() const;
		JArray getReceiveContentMimeTypes() const;
		jfloat getRequestedFrameRate() const;
		...
		JString getSupplementalDescription() const;
		...
		jboolean isAccessibilityDataSensitive() const;
		...
		jboolean isAutoHandwritingEnabled() const;
		jboolean isClickable() const;
		jboolean isContentSensitive() const;
		jboolean isContextClickable() const;
		jboolean isCredential() const;
		...
		jboolean isHandwritingDelegate() const;
		...
		jboolean isPreferKeepClear() const;
		...
		void reportAppJankStats(android::app::jank::AppJankStats arg0) const;
		...
		void setAccessibilityDataSensitive(jint arg0) const;
		...
		void setAllowedHandwritingDelegatePackage(JString arg0) const;
		void setAllowedHandwritingDelegatorPackage(JString arg0) const;
		...
		void setAutoHandwritingEnabled(jboolean arg0) const;
		...
		void setContentSensitivity(jint arg0) const;
		...
		void setFrameContentVelocity(jfloat arg0) const;
		void setHandwritingBoundsOffsets(jfloat arg0, jfloat arg1, jfloat arg2, jfloat arg3) const;
		void setHandwritingDelegateFlags(jint arg0) const;
		void setHandwritingDelegatorCallback(JObject arg0) const;
		...
		void setIsCredential(jboolean arg0) const;
		void setIsHandwritingDelegate(jboolean arg0) const;
		...
		void setPendingCredentialRequest(android::credentials::GetCredentialRequest arg0, JObject arg1) const;
		void setPivotX(jfloat arg0) const;
		void setPivotY(jfloat arg0) const;
		void setPointerIcon(android::view::PointerIcon arg0) const;
		void setPreferKeepClear(jboolean arg0) const;
		void setPreferKeepClearRects(JObject arg0) const;
		void setPressed(jboolean arg0) const;
		void setRenderEffect(android::graphics::RenderEffect arg0) const;
		void setRequestedFrameRate(jfloat arg0) const;
		...
		void setSupplementalDescription(JString arg0) const;
