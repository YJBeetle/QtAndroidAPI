...
namespace android::view::inputmethod
{
	...
	public:
		...
		android::view::inputmethod::InputMethodSubtype_InputMethodSubtypeBuilder setLayoutLabelNonLocalized(JString arg0) const;
		android::view::inputmethod::InputMethodSubtype_InputMethodSubtypeBuilder setLayoutLabelResource(jint arg0) const;
