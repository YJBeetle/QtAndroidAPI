...
{
	// Fields
	inline JString InputMethodInfo::ACTION_IME_LANGUAGE_SETTINGS()
	{
	...
	inline JString InputMethodInfo::ACTION_STYLUS_HANDWRITING_SETTINGS()
	{
		return getStaticObjectField(
			"android.view.inputmethod.InputMethodInfo",
	...
	// Methods
	inline android::content::Intent InputMethodInfo::createImeLanguageSettingsActivityIntent() const
	{
	...
	inline android::content::Intent InputMethodInfo::createStylusHandwritingSettingsActivityIntent() const
	{
		return callObjectMethod(
	...
	inline jboolean InputMethodInfo::supportsConnectionlessStylusHandwriting() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean InputMethodInfo::supportsStylusHandwriting() const
	{
		return callMethod<jboolean>(
