...
namespace android::view::inputmethod
{
	...
	inline JString InputMethodSubtype::getLayoutDisplayName(android::content::Context arg0, android::content::pm::ApplicationInfo arg1) const
	{
		return callObjectMethod(
			"getLayoutDisplayName",
			"(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;)Ljava/lang/CharSequence;",
			arg0.object(),
			arg1.object()
		);
	}
	inline JString InputMethodSubtype::getLayoutLabelNonLocalized() const
	{
		return callObjectMethod(
	...
	inline jint InputMethodSubtype::getLayoutLabelResource() const
	{
		return callMethod<jint>(
	...
	inline JString InputMethodSubtype::getNameOverride() const
	{
		return callObjectMethod(
			"getNameOverride",
			"()Ljava/lang/CharSequence;"
	...
	inline android::icu::util::ULocale InputMethodSubtype::getPhysicalKeyboardHintLanguageTag() const
	{
		return callObjectMethod(
	...
	inline JString InputMethodSubtype::getPhysicalKeyboardHintLayoutType() const
	{
		return callObjectMethod(
