...
namespace android::view::inputmethod
{
	...
	public:
		// Fields
		static JString ACTION_IME_LANGUAGE_SETTINGS();
		...
		// Methods
		android::content::Intent createImeLanguageSettingsActivityIntent() const;
		...
		jboolean supportsConnectionlessStylusHandwriting() const;
