...
namespace android::view::inputmethod
{
	...
	inline android::view::autofill::AutofillId EditorInfo::getAutofillId() const
	{
	...
	inline jint EditorInfo::getInitialToolType() const
	{
		return callMethod<jint>(
			"getInitialToolType",
			"()I"
	...
	inline JObject EditorInfo::getSupportedHandwritingGesturePreviews() const
	{
		return callObjectMethod(
	...
	inline JObject EditorInfo::getSupportedHandwritingGestures() const
	{
		return callObjectMethod(
	...
	inline jboolean EditorInfo::isStylusHandwritingEnabled() const
	{
	...
	inline jboolean EditorInfo::isWritingToolsEnabled() const
	{
		return callMethod<jboolean>(
	...
	inline void EditorInfo::setAutofillId(android::view::autofill::AutofillId arg0) const
	{
		callMethod<void>(
			"setAutofillId",
	...
	inline void EditorInfo::setInitialToolType(jint arg0) const
	{
		callMethod<void>(
			"setInitialToolType",
			"(I)V",
	...
	inline void EditorInfo::setStylusHandwritingEnabled(jboolean arg0) const
	{
		callMethod<void>(
	...
	inline void EditorInfo::setSupportedHandwritingGesturePreviews(JObject arg0) const
	{
		callMethod<void>(
	...
	inline void EditorInfo::setSupportedHandwritingGestures(JObject arg0) const
	{
		callMethod<void>(
	...
	inline void EditorInfo::setWritingToolsEnabled(jboolean arg0) const
	{
		callMethod<void>(
