...
namespace android::view::inputmethod
{
	...
	public:
		...
		EditorInfo(QJniObject obj) : JObject(obj) {}
		...
		android::view::inputmethod::SurroundingText getInitialSurroundingText(jint arg0, jint arg1, jint arg2) const;
		JString getInitialTextAfterCursor(jint arg0, jint arg1) const;
		JString getInitialTextBeforeCursor(jint arg0, jint arg1) const;
		jint getInitialToolType() const;
		JObject getSupportedHandwritingGesturePreviews() const;
		JObject getSupportedHandwritingGestures() const;
		jboolean isStylusHandwritingEnabled() const;
		jboolean isWritingToolsEnabled() const;
		...
		void setInitialToolType(jint arg0) const;
		void setStylusHandwritingEnabled(jboolean arg0) const;
		void setSupportedHandwritingGesturePreviews(JObject arg0) const;
		void setSupportedHandwritingGestures(JObject arg0) const;
		void setWritingToolsEnabled(jboolean arg0) const;
