...
namespace android::view::inputmethod
{
	...
	public:
		...
		InputMethodSubtype(QJniObject obj) : JObject(obj) {}
		...
		JString getLayoutDisplayName(android::content::Context arg0, android::content::pm::ApplicationInfo arg1) const;
		JString getLayoutLabelNonLocalized() const;
		jint getLayoutLabelResource() const;
		JString getLocale() const;
		JString getMode() const;
		JString getNameOverride() const;
		jint getNameResId() const;
		android::icu::util::ULocale getPhysicalKeyboardHintLanguageTag() const;
		JString getPhysicalKeyboardHintLayoutType() const;
		jint hashCode() const;
