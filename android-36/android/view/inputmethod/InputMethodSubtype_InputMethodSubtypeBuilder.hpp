...
namespace android::view::inputmethod
{
	...
	inline android::view::inputmethod::InputMethodSubtype_InputMethodSubtypeBuilder InputMethodSubtype_InputMethodSubtypeBuilder::setLayoutLabelNonLocalized(JString arg0) const
	{
		return callObjectMethod(
			"setLayoutLabelNonLocalized",
			"(Ljava/lang/CharSequence;)Landroid/view/inputmethod/InputMethodSubtype$InputMethodSubtypeBuilder;",
			arg0.object<jstring>()
		);
	}
	inline android::view::inputmethod::InputMethodSubtype_InputMethodSubtypeBuilder InputMethodSubtype_InputMethodSubtypeBuilder::setLayoutLabelResource(jint arg0) const
	{
		return callObjectMethod(
	...
	inline android::view::inputmethod::InputMethodSubtype_InputMethodSubtypeBuilder InputMethodSubtype_InputMethodSubtypeBuilder::setPhysicalKeyboardHint(android::icu::util::ULocale arg0, JString arg1) const
	{
		return callObjectMethod(
			"setPhysicalKeyboardHint",
			"(Landroid/icu/util/ULocale;Ljava/lang/String;)Landroid/view/inputmethod/InputMethodSubtype$InputMethodSubtypeBuilder;",
			arg0.object(),
			arg1.object<jstring>()
		);
	}
	...
	inline android::view::inputmethod::InputMethodSubtype_InputMethodSubtypeBuilder InputMethodSubtype_InputMethodSubtypeBuilder::setSubtypeNameOverride(JString arg0) const
	{
		return callObjectMethod(
