...
namespace android::view
{
	...
	inline jint Display_HdrCapabilities::HDR_TYPE_HDR10_PLUS()
	{
		return getStaticField<jint>(
			"android.view.Display$HdrCapabilities",
			"HDR_TYPE_HDR10_PLUS"
	...
	inline jint Display_HdrCapabilities::HDR_TYPE_INVALID()
	{
		return getStaticField<jint>(
			"android.view.Display$HdrCapabilities",
			"HDR_TYPE_INVALID"
	...
	inline JString Display_HdrCapabilities::toString() const
	{
		return callObjectMethod(
			"toString",
			"()Ljava/lang/String;"
