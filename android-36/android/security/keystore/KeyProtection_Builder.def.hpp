...
namespace android::security::keystore
{
	...
	public:
		...
		android::security::keystore::KeyProtection_Builder setIsStrongBoxBacked(jboolean arg0) const;
		...
		android::security::keystore::KeyProtection_Builder setMaxUsageCount(jint arg0) const;
		android::security::keystore::KeyProtection_Builder setMgf1Digests(JArray arg0) const;
