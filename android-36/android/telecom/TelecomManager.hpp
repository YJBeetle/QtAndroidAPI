...
namespace android::telecom
{
	...
	inline JString TelecomManager::EXTRA_CALL_LOG_URI()
	{
		return getStaticObjectField(
			"android.telecom.TelecomManager",
			"EXTRA_CALL_LOG_URI",
	...
	inline jint TelecomManager::PRESENTATION_UNAVAILABLE()
	{
		return getStaticField<jint>(
			"android.telecom.TelecomManager",
	...
	inline void TelecomManager::addCall(android::telecom::CallAttributes arg0, JObject arg1, JObject arg2, JObject arg3, JObject arg4) const
	{
		callMethod<void>(
			"addCall",
			"(Landroid/telecom/CallAttributes;Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;Landroid/telecom/CallControlCallback;Landroid/telecom/CallEventCallback;)V",
			arg0.object(),
			arg1.object(),
			arg2.object(),
			arg3.object(),
	...
	inline JObject TelecomManager::getOwnSelfManagedPhoneAccounts() const
	{
		return callObjectMethod(
	...
	inline JObject TelecomManager::getRegisteredPhoneAccounts() const
	{
		return callObjectMethod(
