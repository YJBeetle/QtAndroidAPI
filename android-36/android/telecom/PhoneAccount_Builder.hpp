...
namespace android::telecom
{
	...
	inline android::telecom::PhoneAccount_Builder PhoneAccount_Builder::clearSimultaneousCallingRestriction() const
	{
		return callObjectMethod(
	...
	inline android::telecom::PhoneAccount_Builder PhoneAccount_Builder::setSimultaneousCallingRestriction(JObject arg0) const
	{
		return callObjectMethod(
			"setSimultaneousCallingRestriction",
			"(Ljava/util/Set;)Landroid/telecom/PhoneAccount$Builder;",
			arg0.object()
		);
	}
