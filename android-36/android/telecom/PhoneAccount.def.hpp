...
namespace android::telecom
{
	...
	public:
		...
		static jint CAPABILITY_SUPPORTS_CALL_STREAMING();
		static jint CAPABILITY_SUPPORTS_TRANSACTIONAL_OPERATIONS();
		static jint CAPABILITY_SUPPORTS_VIDEO_CALLING();
		static jint CAPABILITY_SUPPORTS_VOICE_CALLING_INDICATIONS();
		static jint CAPABILITY_VIDEO_CALLING();
		static jint CAPABILITY_VIDEO_CALLING_RELIES_ON_PRESENCE();
		static jint CAPABILITY_VOICE_CALLING_AVAILABLE();
		...
		PhoneAccount(QJniObject obj) : JObject(obj) {}
