...
namespace android::telecom
{
	...
	public:
		...
		PhoneAccount_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::telecom::PhoneAccount_Builder clearSimultaneousCallingRestriction() const;
		...
		android::telecom::PhoneAccount_Builder setSimultaneousCallingRestriction(JObject arg0) const;
