...
namespace android::telecom
{
	...
	public:
		...
		static JString EXTRA_CALL_LOG_URI();
		...
		static jint PRESENTATION_UNAVAILABLE();
		...
		TelecomManager(QJniObject obj) : JObject(obj) {}
		...
		void addCall(android::telecom::CallAttributes arg0, JObject arg1, JObject arg2, JObject arg3, JObject arg4) const;
		void addNewIncomingCall(android::telecom::PhoneAccountHandle arg0, android::os::Bundle arg1) const;
		void addNewIncomingConference(android::telecom::PhoneAccountHandle arg0, android::os::Bundle arg1) const;
		...
		jboolean hasManageOngoingCallsPermission() const;
		...
		void startConference(JObject arg0, android::os::Bundle arg1) const;
