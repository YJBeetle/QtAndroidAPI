...
{
	// Fields
	inline jint Call_Details::CAPABILITY_ADD_PARTICIPANT()
	{
	...
	inline jint Call_Details::CAPABILITY_REMOTE_PARTY_SUPPORTS_RTT()
	{
		return getStaticField<jint>(
			"android.telecom.Call$Details",
	...
	inline jint Call_Details::PROPERTY_ASSISTED_DIALING()
	{
		return getStaticField<jint>(
			"android.telecom.Call$Details",
	...
	inline jint Call_Details::PROPERTY_CROSS_SIM()
	{
		return getStaticField<jint>(
			"android.telecom.Call$Details",
			"PROPERTY_CROSS_SIM"
	...
	inline jint Call_Details::PROPERTY_IS_ADHOC_CONFERENCE()
	{
		return getStaticField<jint>(
			"android.telecom.Call$Details",
	...
	inline jint Call_Details::PROPERTY_IS_TRANSACTIONAL()
	{
		return getStaticField<jint>(
			"android.telecom.Call$Details",
	...
	inline jint Call_Details::getCallerNumberVerificationStatus() const
	{
		return callMethod<jint>(
	...
	inline JString Call_Details::getContactDisplayName() const
	{
		return callObjectMethod(
	...
	inline android::net::Uri Call_Details::getContactPhotoUri() const
	{
		return callObjectMethod(
			"getContactPhotoUri",
			"()Landroid/net/Uri;"
	...
	inline JString Call_Details::getId() const
	{
		return callObjectMethod(
			"getId",
			"()Ljava/lang/String;"
	...
	inline jint Call_Details::getState() const
	{
		return callMethod<jint>(
			"getState",
			"()I"
