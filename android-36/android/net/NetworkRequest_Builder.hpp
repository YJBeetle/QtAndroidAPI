...
namespace android::net
{
	...
	inline NetworkRequest_Builder::NetworkRequest_Builder(android::net::NetworkRequest arg0)
		: JObject(
			"android.net.NetworkRequest$Builder",
	...
	inline android::net::NetworkRequest_Builder NetworkRequest_Builder::setIncludeOtherUidNetworks(jboolean arg0) const
	{
		return callObjectMethod(
	...
	inline android::net::NetworkRequest_Builder NetworkRequest_Builder::setSubscriptionIds(JObject arg0) const
	{
		return callObjectMethod(
			"setSubscriptionIds",
			"(Ljava/util/Set;)Landroid/net/NetworkRequest$Builder;",
			arg0.object()
		);
	}
} // namespace android::net
