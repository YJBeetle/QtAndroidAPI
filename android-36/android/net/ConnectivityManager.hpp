...
namespace android::net
{
	...
	inline android::net::SocketKeepalive ConnectivityManager::createSocketKeepalive(android::net::Network arg0, android::net::IpSecManager_UdpEncapsulationSocket arg1, java::net::InetAddress arg2, java::net::InetAddress arg3, JObject arg4, android::net::SocketKeepalive_Callback arg5) const
	{
	...
	inline jint ConnectivityManager::getConnectionOwnerUid(jint arg0, java::net::InetSocketAddress arg1, java::net::InetSocketAddress arg2) const
	{
	...
	inline void ConnectivityManager::registerBestMatchingNetworkCallback(android::net::NetworkRequest arg0, android::net::ConnectivityManager_NetworkCallback arg1, android::os::Handler arg2) const
	{
		callMethod<void>(
	...
	inline void ConnectivityManager::reserveNetwork(android::net::NetworkRequest arg0, android::os::Handler arg1, android::net::ConnectivityManager_NetworkCallback arg2) const
	{
		callMethod<void>(
			"reserveNetwork",
			"(Landroid/net/NetworkRequest;Landroid/os/Handler;Landroid/net/ConnectivityManager$NetworkCallback;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
