...
namespace android::net::eap
{
	...
	public:
		...
		EapSessionConfig_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::net::eap::EapSessionConfig_Builder setEapAkaConfig(jint arg0, jint arg1, android::net::eap::EapSessionConfig_EapAkaOption arg2) const;
