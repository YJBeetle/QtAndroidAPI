...
namespace android::net
{
	...
	public:
		...
		static jint NET_CAPABILITY_LOCAL_NETWORK();
		static jint NET_CAPABILITY_MCX();
		static jint NET_CAPABILITY_MMS();
		static jint NET_CAPABILITY_MMTEL();
		static jint NET_CAPABILITY_NOT_BANDWIDTH_CONSTRAINED();
		...
		static jint TRANSPORT_SATELLITE();
		static jint TRANSPORT_THREAD();
