...
namespace android::net::http
{
	...
	public:
		...
		X509TrustManagerExtensions(QJniObject obj) : JObject(obj) {}
		...
		JObject checkServerTrusted(JArray arg0, JByteArray arg1, JByteArray arg2, JString arg3, JString arg4) const;
