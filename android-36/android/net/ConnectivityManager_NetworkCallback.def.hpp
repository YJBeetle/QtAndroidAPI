...
namespace android::net
{
	...
	public:
		...
		ConnectivityManager_NetworkCallback(QJniObject obj) : JObject(obj) {}
		
		// Constructors
		ConnectivityManager_NetworkCallback();
		ConnectivityManager_NetworkCallback(jint arg0);
		...
		void onReserved(android::net::NetworkCapabilities arg0) const;
