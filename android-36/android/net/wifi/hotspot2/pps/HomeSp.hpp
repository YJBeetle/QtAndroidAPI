...
namespace android::net::wifi::hotspot2::pps
{
	...
	inline JLongArray HomeSp::getMatchAllOis() const
	{
		return callObjectMethod(
			"getMatchAllOis",
			"()[J"
	...
	inline JLongArray HomeSp::getMatchAnyOis() const
	{
		return callObjectMethod(
			"getMatchAnyOis",
			"()[J"
	...
	inline JObject HomeSp::getOtherHomePartnersList() const
	{
		return callObjectMethod(
	...
	inline void HomeSp::setMatchAllOis(JLongArray arg0) const
	{
		callMethod<void>(
			"setMatchAllOis",
			"([J)V",
	...
	inline void HomeSp::setMatchAnyOis(JLongArray arg0) const
	{
		callMethod<void>(
			"setMatchAnyOis",
			"([J)V",
	...
	inline void HomeSp::setOtherHomePartnersList(JObject arg0) const
	{
		callMethod<void>(
