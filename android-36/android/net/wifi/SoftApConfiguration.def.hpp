...
namespace android::net::wifi
{
	...
	public:
		// Fields
		static jint BAND_2GHZ();
		static jint BAND_5GHZ();
		static jint BAND_60GHZ();
		static jint BAND_6GHZ();
		...
		SoftApConfiguration(QJniObject obj) : JObject(obj) {}
		...
		android::util::SparseIntArray getChannels() const;
