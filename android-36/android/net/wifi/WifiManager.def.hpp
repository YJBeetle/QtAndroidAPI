...
namespace android::net::wifi
{
	...
	public:
		...
		static jint ACTION_REMOVE_SUGGESTION_DISCONNECT();
		static jint ACTION_REMOVE_SUGGESTION_LINGER();
		...
		static JString CHANNEL_DATA_KEY_FREQUENCY_MHZ();
		static JString CHANNEL_DATA_KEY_NUM_AP();
		...
		static jint FLAG_SEND_DHCP_HOSTNAME_RESTRICTION_OPEN();
		static jint FLAG_SEND_DHCP_HOSTNAME_RESTRICTION_SECURE();
		static JString NETWORK_IDS_CHANGED_ACTION();
		static JString NETWORK_STATE_CHANGED_ACTION();
		static jint ROAMING_MODE_AGGRESSIVE();
		static jint ROAMING_MODE_NONE();
		static jint ROAMING_MODE_NORMAL();
		static JString RSSI_CHANGED_ACTION();
		static JString SCAN_RESULTS_AVAILABLE_ACTION();
		static jint STATUS_LOCAL_ONLY_CONNECTION_FAILURE_ASSOCIATION();
		static jint STATUS_LOCAL_ONLY_CONNECTION_FAILURE_AUTHENTICATION();
		static jint STATUS_LOCAL_ONLY_CONNECTION_FAILURE_IP_PROVISIONING();
		static jint STATUS_LOCAL_ONLY_CONNECTION_FAILURE_NOT_FOUND();
		static jint STATUS_LOCAL_ONLY_CONNECTION_FAILURE_NO_RESPONSE();
		static jint STATUS_LOCAL_ONLY_CONNECTION_FAILURE_UNKNOWN();
		static jint STATUS_LOCAL_ONLY_CONNECTION_FAILURE_USER_REJECT();
		...
		static jint STATUS_NETWORK_SUGGESTIONS_ERROR_RESTRICTED_BY_ADMIN();
		...
		static jint WIFI_INTERFACE_TYPE_AP();
		static jint WIFI_INTERFACE_TYPE_AWARE();
		static jint WIFI_INTERFACE_TYPE_DIRECT();
		static jint WIFI_INTERFACE_TYPE_STA();
		...
		static jint WIFI_MULTI_INTERNET_MODE_DBS_AP();
		static jint WIFI_MULTI_INTERNET_MODE_DISABLED();
		static jint WIFI_MULTI_INTERNET_MODE_MULTI_AP();
		...
		void addLocalOnlyConnectionFailureListener(JObject arg0, JObject arg1) const;
		...
		void addWifiStateChangedListener(JObject arg0, JObject arg1) const;
		void allowAutojoinGlobal(jboolean arg0) const;
		...
		void disallowCurrentSuggestedNetwork(android::net::wifi::BlockingOption arg0) const;
		jboolean disconnect() const;
		jboolean enableNetwork(jint arg0, jboolean arg1) const;
		void flushPasspointAnqpCache() const;
		JObject getAllowedChannels(jint arg0, jint arg1) const;
		JObject getCallerConfiguredNetworks() const;
		void getChannelData(JObject arg0, JObject arg1) const;
		...
		jint getMaxNumberOfChannelsPerNetworkSpecifierRequest() const;
		jint getMaxNumberOfNetworkSuggestionsPerApp() const;
		jint getMaxSignalLevel() const;
		void getMaxSupportedConcurrentTdlsSessions(JObject arg0, JObject arg1) const;
		JObject getNetworkSuggestions() const;
		void getNumberOfEnabledTdlsSessions(JObject arg0, JObject arg1) const;
		JObject getPasspointConfigurations() const;
		void getPerSsidRoamingModes(JObject arg0, JObject arg1) const;
		JObject getScanResults() const;
		jint getStaConcurrencyForMultiInternetMode() const;
		JObject getUsableChannels(jint arg0, jint arg1) const;
		...
		jboolean isAggressiveRoamingModeSupported() const;
		...
		jboolean isD2dSupportedWhenInfraStaDisabled() const;
		jboolean isDecoratedIdentitySupported() const;
		jboolean isDeviceToApRttSupported() const;
		jboolean isDualBandSimultaneousSupported() const;
		jboolean isEasyConnectDppAkmSupported() const;
		...
		jboolean isStaConcurrencyForMultiInternetSupported() const;
		void isTdlsOperationCurrentlyAvailable(JObject arg0, JObject arg1) const;
		jboolean isTdlsSupported() const;
		jboolean isTidToLinkMappingNegotiationSupported() const;
		jboolean isTlsMinimumVersionSupported() const;
		jboolean isTlsV13Supported() const;
		jboolean isTrustOnFirstUseSupported() const;
		jboolean isWapiSupported() const;
		jboolean isWepSupported() const;
		jboolean isWifiDisplayR2Supported() const;
		jboolean isWifiEnabled() const;
		jboolean isWifiPasspointEnabled() const;
		...
		jboolean isWpaPersonalSupported() const;
		jboolean pingSupplicant() const;
		void queryAutojoinGlobal(JObject arg0, JObject arg1) const;
		void querySendDhcpHostnameRestriction(JObject arg0, JObject arg1) const;
		...
		void removeLocalOnlyConnectionFailureListener(JObject arg0) const;
		jboolean removeNetwork(jint arg0) const;
		jint removeNetworkSuggestions(JObject arg0) const;
		jint removeNetworkSuggestions(JObject arg0, jint arg1) const;
		jboolean removeNonCallerConfiguredNetworks() const;
		void removePasspointConfiguration(JString arg0) const;
		void removePerSsidRoamingMode(android::net::wifi::WifiSsid arg0) const;
		...
		void removeWifiStateChangedListener(JObject arg0) const;
		void reportCreateInterfaceImpact(jint arg0, jboolean arg1, JObject arg2, JObject arg3) const;
		jboolean saveConfiguration() const;
		void setPerSsidRoamingMode(android::net::wifi::WifiSsid arg0, jint arg1) const;
		void setSendDhcpHostnameRestriction(jint arg0) const;
		void setTdlsEnabled(java::net::InetAddress arg0, jboolean arg1) const;
		void setTdlsEnabled(java::net::InetAddress arg0, jboolean arg1, JObject arg2, JObject arg3) const;
		void setTdlsEnabledWithMacAddress(JString arg0, jboolean arg1) const;
		void setTdlsEnabledWithMacAddress(JString arg0, jboolean arg1, JObject arg2, JObject arg3) const;
		...
		void startLocalOnlyHotspotWithConfiguration(android::net::wifi::SoftApConfiguration arg0, JObject arg1, android::net::wifi::WifiManager_LocalOnlyHotspotCallback arg2) const;
		...
		jboolean validateSoftApConfiguration(android::net::wifi::SoftApConfiguration arg0) const;
	};
} // namespace android::net::wifi
