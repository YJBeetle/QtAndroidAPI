...
namespace android::net::wifi::p2p
{
	...
	inline android::net::wifi::p2p::WifiP2pConfig_Builder WifiP2pConfig_Builder::setAuthorizeConnectionFromPeerEnabled(jboolean arg0) const
	{
		return callObjectMethod(
	...
	inline android::net::wifi::p2p::WifiP2pConfig_Builder WifiP2pConfig_Builder::setGroupClientIpProvisioningMode(jint arg0) const
	{
		return callObjectMethod(
	...
	inline android::net::wifi::p2p::WifiP2pConfig_Builder WifiP2pConfig_Builder::setPairingBootstrappingConfig(android::net::wifi::p2p::WifiP2pPairingBootstrappingConfig arg0) const
	{
		return callObjectMethod(
			"setPairingBootstrappingConfig",
			"(Landroid/net/wifi/p2p/WifiP2pPairingBootstrappingConfig;)Landroid/net/wifi/p2p/WifiP2pConfig$Builder;",
			arg0.object()
		);
	}
	...
	inline android::net::wifi::p2p::WifiP2pConfig_Builder WifiP2pConfig_Builder::setPccModeConnectionType(jint arg0) const
	{
		return callObjectMethod(
