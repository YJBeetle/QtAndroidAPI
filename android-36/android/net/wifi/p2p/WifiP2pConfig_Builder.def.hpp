...
namespace android::net::wifi::p2p
{
	...
	public:
		...
		WifiP2pConfig_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::net::wifi::p2p::WifiP2pConfig_Builder setAuthorizeConnectionFromPeerEnabled(jboolean arg0) const;
		android::net::wifi::p2p::WifiP2pConfig_Builder setDeviceAddress(android::net::MacAddress arg0) const;
		android::net::wifi::p2p::WifiP2pConfig_Builder setGroupClientIpProvisioningMode(jint arg0) const;
		...
		android::net::wifi::p2p::WifiP2pConfig_Builder setPairingBootstrappingConfig(android::net::wifi::p2p::WifiP2pPairingBootstrappingConfig arg0) const;
		android::net::wifi::p2p::WifiP2pConfig_Builder setPassphrase(JString arg0) const;
		android::net::wifi::p2p::WifiP2pConfig_Builder setPccModeConnectionType(jint arg0) const;
	};
} // namespace android::net::wifi::p2p
