...
namespace android::net::wifi::p2p
{
	...
	public:
		...
		static jint GROUP_CREATION_FAILURE_REASON_CONNECTION_CANCELLED();
		static jint GROUP_CREATION_FAILURE_REASON_GROUP_REMOVED();
		static jint GROUP_CREATION_FAILURE_REASON_INVITATION_FAILED();
		static jint GROUP_CREATION_FAILURE_REASON_PROVISION_DISCOVERY_FAILED();
		static jint GROUP_CREATION_FAILURE_REASON_TIMED_OUT();
		static jint GROUP_CREATION_FAILURE_REASON_USER_REJECTED();
		static jint NO_PERMISSION();
		...
		static jint WIFI_P2P_SCAN_FULL();
		static jint WIFI_P2P_SCAN_SINGLE_FREQ();
		static jint WIFI_P2P_SCAN_SOCIAL();
		...
		void discoverUsdBasedServices(android::net::wifi::p2p::WifiP2pManager_Channel arg0, android::net::wifi::p2p::WifiP2pUsdBasedServiceDiscoveryConfig arg1, JObject arg2) const;
		...
		jboolean isPccModeSupported() const;
		jboolean isSetVendorElementsSupported() const;
		jboolean isWiFiDirectR2Supported() const;
		void registerWifiP2pListener(JObject arg0, JObject arg1) const;
		...
		void requestDirInfo(android::net::wifi::p2p::WifiP2pManager_Channel arg0, JObject arg1, JObject arg2) const;
		...
		void startPeerDiscovery(android::net::wifi::p2p::WifiP2pManager_Channel arg0, android::net::wifi::p2p::WifiP2pDiscoveryConfig arg1, JObject arg2) const;
		void startUsdBasedLocalServiceAdvertisement(android::net::wifi::p2p::WifiP2pManager_Channel arg0, android::net::wifi::p2p::nsd::WifiP2pServiceInfo arg1, android::net::wifi::p2p::WifiP2pUsdBasedLocalServiceAdvertisementConfig arg2, JObject arg3) const;
		...
		void unregisterWifiP2pListener(JObject arg0) const;
		void validateDirInfo(android::net::wifi::p2p::WifiP2pManager_Channel arg0, android::net::wifi::p2p::WifiP2pDirInfo arg1, JObject arg2, JObject arg3) const;
	};
} // namespace android::net::wifi::p2p
