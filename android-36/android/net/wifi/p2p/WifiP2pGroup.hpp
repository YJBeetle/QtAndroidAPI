...
namespace android::net::wifi::p2p
{
	...
	inline jint WifiP2pGroup::SECURITY_TYPE_UNKNOWN()
	{
		return getStaticField<jint>(
			"android.net.wifi.p2p.WifiP2pGroup",
	...
	inline jint WifiP2pGroup::SECURITY_TYPE_WPA2_PSK()
	{
		return getStaticField<jint>(
			"android.net.wifi.p2p.WifiP2pGroup",
	...
	inline jint WifiP2pGroup::SECURITY_TYPE_WPA3_COMPATIBILITY()
	{
		return getStaticField<jint>(
			"android.net.wifi.p2p.WifiP2pGroup",
	...
	inline jint WifiP2pGroup::SECURITY_TYPE_WPA3_SAE()
	{
		return getStaticField<jint>(
			"android.net.wifi.p2p.WifiP2pGroup",
	...
	inline android::net::MacAddress WifiP2pGroup::getGroupOwnerBssid() const
	{
		return callObjectMethod(
			"getGroupOwnerBssid",
	...
	inline jint WifiP2pGroup::getSecurityType() const
	{
		return callMethod<jint>(
			"getSecurityType",
			"()I"
