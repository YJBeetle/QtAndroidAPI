...
namespace android::net::wifi::p2p::nsd
{
	...
	// Constructors
	inline WifiP2pServiceRequest::WifiP2pServiceRequest(android::net::wifi::p2p::nsd::WifiP2pUsdBasedServiceConfig arg0)
		: JObject(
	...
	inline android::net::wifi::p2p::nsd::WifiP2pUsdBasedServiceConfig WifiP2pServiceRequest::getWifiP2pUsdBasedServiceConfig() const
	{
