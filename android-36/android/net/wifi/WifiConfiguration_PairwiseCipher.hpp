...
namespace android::net::wifi
{
	...
	inline jint WifiConfiguration_PairwiseCipher::GCMP_128()
	{
		return getStaticField<jint>(
			"android.net.wifi.WifiConfiguration$PairwiseCipher",
			"GCMP_128"
	...
	inline jint WifiConfiguration_PairwiseCipher::GCMP_256()
	{
		return getStaticField<jint>(
			"android.net.wifi.WifiConfiguration$PairwiseCipher",
			"GCMP_256"
	...
	inline jint WifiConfiguration_PairwiseCipher::SMS4()
	{
		return getStaticField<jint>(
			"android.net.wifi.WifiConfiguration$PairwiseCipher",
			"SMS4"
