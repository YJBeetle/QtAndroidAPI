...
namespace android::net::wifi
{
	...
	inline jint EasyConnectStatusCallback::EASY_CONNECT_EVENT_FAILURE_ENROLLEE_FAILED_TO_SCAN_NETWORK_CHANNEL()
	{
		return getStaticField<jint>(
			"android.net.wifi.EasyConnectStatusCallback",
	...
	inline jint EasyConnectStatusCallback::EASY_CONNECT_EVENT_FAILURE_URI_GENERATION()
	{
		return getStaticField<jint>(
			"android.net.wifi.EasyConnectStatusCallback",
