...
namespace android::net::wifi::rtt
{
	...
	inline android::net::wifi::rtt::RangingRequest_Builder RangingRequest_Builder::addResponder(android::net::wifi::rtt::ResponderConfig arg0) const
	{
		return callObjectMethod(
			"addResponder",
			"(Landroid/net/wifi/rtt/ResponderConfig;)Landroid/net/wifi/rtt/RangingRequest$Builder;",
			arg0.object()
		);
	}
	inline android::net::wifi::rtt::RangingRequest_Builder RangingRequest_Builder::addResponders(JObject arg0) const
	{
		return callObjectMethod(
			"addResponders",
			"(Ljava/util/List;)Landroid/net/wifi/rtt/RangingRequest$Builder;",
	...
	inline android::net::wifi::rtt::RangingRequest_Builder RangingRequest_Builder::setSecurityMode(jint arg0) const
	{
		return callObjectMethod(
			"setSecurityMode",
			"(I)Landroid/net/wifi/rtt/RangingRequest$Builder;",
