...
namespace android::net::wifi::rtt
{
	...
	inline jint ResponderConfig::RESPONDER_AP()
	{
	...
	inline jint ResponderConfig::RESPONDER_STA()
	{
		return getStaticField<jint>(
			"android.net.wifi.rtt.ResponderConfig",
			"RESPONDER_STA"
	...
	inline jint ResponderConfig::getResponderType() const
	{
		return callMethod<jint>(
			"getResponderType",
			"()I"
	...
	inline android::net::wifi::rtt::SecureRangingConfig ResponderConfig::getSecureRangingConfig() const
	{
		return callObjectMethod(
	...
	inline jboolean ResponderConfig::is80211azNtbSupported() const
	{
		return callMethod<jboolean>(
