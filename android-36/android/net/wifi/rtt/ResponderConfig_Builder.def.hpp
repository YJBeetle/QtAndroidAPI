...
namespace android::net::wifi::rtt
{
	...
	public:
		...
		android::net::wifi::rtt::ResponderConfig_Builder set80211azNtbSupported(jboolean arg0) const;
		...
		android::net::wifi::rtt::ResponderConfig_Builder setResponderType(jint arg0) const;
		android::net::wifi::rtt::ResponderConfig_Builder setSecureRangingConfig(android::net::wifi::rtt::SecureRangingConfig arg0) const;
	};
} // namespace android::net::wifi::rtt
