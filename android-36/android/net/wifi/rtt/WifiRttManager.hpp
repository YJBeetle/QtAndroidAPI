...
namespace android::net::wifi::rtt
{
	...
	inline JString WifiRttManager::CHARACTERISTICS_KEY_BOOLEAN_NTB_INITIATOR()
	{
		return getStaticObjectField(
			"android.net.wifi.rtt.WifiRttManager",
	...
	inline JString WifiRttManager::CHARACTERISTICS_KEY_BOOLEAN_RANGING_FRAME_PROTECTION_SUPPORTED()
	{
		return getStaticObjectField(
			"android.net.wifi.rtt.WifiRttManager",
	...
	inline JString WifiRttManager::CHARACTERISTICS_KEY_BOOLEAN_SECURE_HE_LTF_SUPPORTED()
	{
		return getStaticObjectField(
			"android.net.wifi.rtt.WifiRttManager",
	...
	inline JString WifiRttManager::CHARACTERISTICS_KEY_INT_MAX_SUPPORTED_SECURE_HE_LTF_PROTO_VERSION()
	{
		return getStaticObjectField(
			"android.net.wifi.rtt.WifiRttManager",
