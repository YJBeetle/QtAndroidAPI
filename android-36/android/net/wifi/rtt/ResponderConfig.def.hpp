...
namespace android::net::wifi::rtt
{
	...
	public:
		...
		static jint RESPONDER_AP();
		static jint RESPONDER_STA();
		...
		ResponderConfig(QJniObject obj) : JObject(obj) {}
		...
		jint getResponderType() const;
		android::net::wifi::rtt::SecureRangingConfig getSecureRangingConfig() const;
		jint hashCode() const;
		jboolean is80211azNtbSupported() const;
