...
namespace android::net::wifi::rtt
{
	...
	inline jint RangingRequest::SECURITY_MODE_OPEN()
	{
	...
	inline jint RangingRequest::SECURITY_MODE_OPPORTUNISTIC()
	{
		return getStaticField<jint>(
			"android.net.wifi.rtt.RangingRequest",
	...
	inline jint RangingRequest::SECURITY_MODE_SECURE_AUTH()
	{
		return getStaticField<jint>(
			"android.net.wifi.rtt.RangingRequest",
	...
	inline jint RangingRequest::getSecurityMode() const
	{
		return callMethod<jint>(
			"getSecurityMode",
			"()I"
