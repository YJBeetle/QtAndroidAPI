...
namespace android::net::wifi::rtt
{
	...
	inline android::net::wifi::rtt::ResponderConfig_Builder ResponderConfig_Builder::set80211azNtbSupported(jboolean arg0) const
	{
		return callObjectMethod(
	...
	inline android::net::wifi::rtt::ResponderConfig_Builder ResponderConfig_Builder::setResponderType(jint arg0) const
	{
		return callObjectMethod(
			"setResponderType",
			"(I)Landroid/net/wifi/rtt/ResponderConfig$Builder;",
	...
	inline android::net::wifi::rtt::ResponderConfig_Builder ResponderConfig_Builder::setSecureRangingConfig(android::net::wifi::rtt::SecureRangingConfig arg0) const
	{
		return callObjectMethod(
			"setSecureRangingConfig",
			"(Landroid/net/wifi/rtt/SecureRangingConfig;)Landroid/net/wifi/rtt/ResponderConfig$Builder;",
			arg0.object()
		);
	}
} // namespace android::net::wifi::rtt
