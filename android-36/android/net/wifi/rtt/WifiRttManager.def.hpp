...
namespace android::net::wifi::rtt
{
	...
	public:
		...
		static JString CHARACTERISTICS_KEY_BOOLEAN_NTB_INITIATOR();
		static JString CHARACTERISTICS_KEY_BOOLEAN_ONE_SIDED_RTT();
		static JString CHARACTERISTICS_KEY_BOOLEAN_RANGING_FRAME_PROTECTION_SUPPORTED();
		static JString CHARACTERISTICS_KEY_BOOLEAN_SECURE_HE_LTF_SUPPORTED();
		static JString CHARACTERISTICS_KEY_BOOLEAN_STA_RESPONDER();
		static JString CHARACTERISTICS_KEY_INT_MAX_SUPPORTED_SECURE_HE_LTF_PROTO_VERSION();
