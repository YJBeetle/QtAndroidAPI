...
namespace android::net::wifi
{
	...
	public:
		...
		android::net::wifi::WifiNetworkSuggestion_Builder setCarrierMerged(jboolean arg0) const;
		...
		android::net::wifi::WifiNetworkSuggestion_Builder setIsWpa3SaeH2eOnlyModeEnabled(jboolean arg0) const;
		android::net::wifi::WifiNetworkSuggestion_Builder setMacRandomizationSetting(jint arg0) const;
		...
		android::net::wifi::WifiNetworkSuggestion_Builder setPriorityGroup(jint arg0) const;
		android::net::wifi::WifiNetworkSuggestion_Builder setRestricted(jboolean arg0) const;
		android::net::wifi::WifiNetworkSuggestion_Builder setSsid(JString arg0) const;
		android::net::wifi::WifiNetworkSuggestion_Builder setSubscriptionGroup(android::os::ParcelUuid arg0) const;
		android::net::wifi::WifiNetworkSuggestion_Builder setSubscriptionId(jint arg0) const;
		...
		android::net::wifi::WifiNetworkSuggestion_Builder setWifi7Enabled(jboolean arg0) const;
		android::net::wifi::WifiNetworkSuggestion_Builder setWifiSsid(android::net::wifi::WifiSsid arg0) const;
		...
		android::net::wifi::WifiNetworkSuggestion_Builder setWpa3Enterprise192BitModeConfig(android::net::wifi::WifiEnterpriseConfig arg0) const;
		android::net::wifi::WifiNetworkSuggestion_Builder setWpa3EnterpriseConfig(android::net::wifi::WifiEnterpriseConfig arg0) const;
		android::net::wifi::WifiNetworkSuggestion_Builder setWpa3EnterpriseStandardModeConfig(android::net::wifi::WifiEnterpriseConfig arg0) const;
