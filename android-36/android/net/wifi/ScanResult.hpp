...
namespace android::net::wifi
{
	...
	inline jint ScanResult::CHANNEL_WIDTH_320MHZ()
	{
		return getStaticField<jint>(
			"android.net.wifi.ScanResult",
	...
	inline jint ScanResult::PREAMBLE_EHT()
	{
		return getStaticField<jint>(
			"android.net.wifi.ScanResult",
			"PREAMBLE_EHT"
	...
	inline jint ScanResult::PREAMBLE_HE()
	{
		return getStaticField<jint>(
			"android.net.wifi.ScanResult",
			"PREAMBLE_HE"
	...
	inline jint ScanResult::PREAMBLE_HT()
	{
		return getStaticField<jint>(
			"android.net.wifi.ScanResult",
			"PREAMBLE_HT"
	...
	inline jint ScanResult::PREAMBLE_LEGACY()
	{
		return getStaticField<jint>(
			"android.net.wifi.ScanResult",
			"PREAMBLE_LEGACY"
	...
	inline jint ScanResult::PREAMBLE_VHT()
	{
		return getStaticField<jint>(
			"android.net.wifi.ScanResult",
			"PREAMBLE_VHT"
	...
	inline jint ScanResult::WIFI_STANDARD_11BE()
	{
		return getStaticField<jint>(
			"android.net.wifi.ScanResult",
			"WIFI_STANDARD_11BE"
	...
	inline JObject ScanResult::getAffiliatedMloLinks() const
	{
	...
	inline android::net::MacAddress ScanResult::getApMldMacAddress() const
	{
		return callObjectMethod(
			"getApMldMacAddress",
	...
	inline jint ScanResult::getApMloLinkId() const
	{
		return callMethod<jint>(
			"getApMloLinkId",
			"()I"
	...
	inline JIntArray ScanResult::getSecurityTypes() const
	{
		return callObjectMethod(
			"getSecurityTypes",
			"()[I"
	...
	inline android::net::wifi::WifiSsid ScanResult::getWifiSsid() const
	{
		return callObjectMethod(
			"getWifiSsid",
	...
	inline jboolean ScanResult::is80211azNtbResponder() const
	{
	...
	inline jboolean ScanResult::isRangingFrameProtectionRequired() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean ScanResult::isSecureHeLtfSupported() const
	{
		return callMethod<jboolean>(
	...
	inline jboolean ScanResult::isTwtResponder() const
	{
		return callMethod<jboolean>(
			"isTwtResponder",
			"()Z"
