...
{
	// Fields
	inline jint SoftApConfiguration::BAND_2GHZ()
	{
	...
	inline jint SoftApConfiguration::BAND_5GHZ()
	{
		return getStaticField<jint>(
			"android.net.wifi.SoftApConfiguration",
			"BAND_5GHZ"
	...
	inline jint SoftApConfiguration::BAND_60GHZ()
	{
		return getStaticField<jint>(
			"android.net.wifi.SoftApConfiguration",
			"BAND_60GHZ"
	...
	inline jint SoftApConfiguration::BAND_6GHZ()
	{
		return getStaticField<jint>(
			"android.net.wifi.SoftApConfiguration",
			"BAND_6GHZ"
	...
	inline jint SoftApConfiguration::SECURITY_TYPE_WPA3_OWE()
	{
		return getStaticField<jint>(
			"android.net.wifi.SoftApConfiguration",
	...
	inline jint SoftApConfiguration::SECURITY_TYPE_WPA3_OWE_TRANSITION()
	{
		return getStaticField<jint>(
			"android.net.wifi.SoftApConfiguration",
	...
	inline android::util::SparseIntArray SoftApConfiguration::getChannels() const
	{
		return callObjectMethod(
			"getChannels",
	...
	inline android::net::wifi::WifiSsid SoftApConfiguration::getWifiSsid() const
	{
		return callObjectMethod(
			"getWifiSsid",
