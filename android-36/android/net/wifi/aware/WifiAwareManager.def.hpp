...
namespace android::net::wifi::aware
{
	...
	public:
		...
		void getPairedDevices(JObject arg0, JObject arg1) const;
		jboolean isAvailable() const;
		jboolean isDeviceAttached() const;
		jboolean isInstantCommunicationModeEnabled() const;
		void isOpportunisticModeEnabled(JObject arg0, JObject arg1) const;
		jboolean isSetChannelOnDataPathSupported() const;
		void removePairedDevice(JString arg0) const;
		void resetPairedDevices() const;
		void setOpportunisticModeEnabled(jboolean arg0) const;
	};
} // namespace android::net::wifi::aware
