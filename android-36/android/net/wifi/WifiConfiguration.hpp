...
namespace android::net::wifi
{
	...
	inline jint WifiConfiguration::RANDOMIZATION_AUTO()
	{
	...
	inline jint WifiConfiguration::RANDOMIZATION_NONE()
	{
		return getStaticField<jint>(
			"android.net.wifi.WifiConfiguration",
			"RANDOMIZATION_NONE"
	...
	inline jint WifiConfiguration::RANDOMIZATION_NON_PERSISTENT()
	{
		return getStaticField<jint>(
			"android.net.wifi.WifiConfiguration",
	...
	inline jint WifiConfiguration::RANDOMIZATION_PERSISTENT()
	{
		return getStaticField<jint>(
			"android.net.wifi.WifiConfiguration",
	...
	inline jint WifiConfiguration::SECURITY_TYPE_DPP()
	{
		return getStaticField<jint>(
			"android.net.wifi.WifiConfiguration",
			"SECURITY_TYPE_DPP"
	...
	inline jint WifiConfiguration::SECURITY_TYPE_EAP_WPA3_ENTERPRISE()
	{
		return getStaticField<jint>(
			"android.net.wifi.WifiConfiguration",
	...
	inline jint WifiConfiguration::SECURITY_TYPE_EAP_WPA3_ENTERPRISE_192_BIT()
	{
		return getStaticField<jint>(
			"android.net.wifi.WifiConfiguration",
	...
	inline jint WifiConfiguration::getMacRandomizationSetting() const
	{
		return callMethod<jint>(
	...
	inline jboolean WifiConfiguration::isDppConfigurator() const
	{
	...
	inline void WifiConfiguration::setIpConfiguration(android::net::IpConfiguration arg0) const
	{
		callMethod<void>(
			"setIpConfiguration",
			"(Landroid/net/IpConfiguration;)V",
			arg0.object()
		);
	}
	inline void WifiConfiguration::setMacRandomizationSetting(jint arg0) const
	{
		callMethod<void>(
