...
namespace android::net::nsd
{
	...
	// Methods
	inline void NsdManager::discoverServices(android::net::nsd::DiscoveryRequest arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"discoverServices",
			"(Landroid/net/nsd/DiscoveryRequest;Ljava/util/concurrent/Executor;Landroid/net/nsd/NsdManager$DiscoveryListener;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
