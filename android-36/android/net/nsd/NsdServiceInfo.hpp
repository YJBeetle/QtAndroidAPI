...
namespace android::net::nsd
{
	...
	inline JObject NsdServiceInfo::getHostAddresses() const
	{
		return callObjectMethod(
			"getHostAddresses",
			"()Ljava/util/List;"
	...
	inline JString NsdServiceInfo::getHostname() const
	{
		return callObjectMethod(
			"getHostname",
			"()Ljava/lang/String;"
	...
	inline JObject NsdServiceInfo::getSubtypes() const
	{
		return callObjectMethod(
			"getSubtypes",
			"()Ljava/util/Set;"
	...
	inline void NsdServiceInfo::setHostAddresses(JObject arg0) const
	{
		callMethod<void>(
			"setHostAddresses",
			"(Ljava/util/List;)V",
	...
	inline void NsdServiceInfo::setSubtypes(JObject arg0) const
	{
		callMethod<void>(
			"setSubtypes",
			"(Ljava/util/Set;)V",
