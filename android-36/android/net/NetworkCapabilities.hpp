...
namespace android::net
{
	...
	inline jint NetworkCapabilities::NET_CAPABILITY_ENTERPRISE()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
	...
	inline jint NetworkCapabilities::NET_CAPABILITY_HEAD_UNIT()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
	...
	inline jint NetworkCapabilities::NET_CAPABILITY_LOCAL_NETWORK()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
	...
	inline jint NetworkCapabilities::NET_CAPABILITY_MCX()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
			"NET_CAPABILITY_MCX"
	...
	inline jint NetworkCapabilities::NET_CAPABILITY_MMTEL()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
	...
	inline jint NetworkCapabilities::NET_CAPABILITY_NOT_BANDWIDTH_CONSTRAINED()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
	...
	inline jint NetworkCapabilities::NET_CAPABILITY_PRIORITIZE_BANDWIDTH()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
	...
	inline jint NetworkCapabilities::NET_CAPABILITY_PRIORITIZE_LATENCY()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
	...
	inline jint NetworkCapabilities::NET_CAPABILITY_TEMPORARILY_NOT_METERED()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
	...
	inline jint NetworkCapabilities::NET_ENTERPRISE_ID_1()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
			"NET_ENTERPRISE_ID_1"
	...
	inline jint NetworkCapabilities::NET_ENTERPRISE_ID_2()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
			"NET_ENTERPRISE_ID_2"
	...
	inline jint NetworkCapabilities::NET_ENTERPRISE_ID_3()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
			"NET_ENTERPRISE_ID_3"
	...
	inline jint NetworkCapabilities::NET_ENTERPRISE_ID_4()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
			"NET_ENTERPRISE_ID_4"
	...
	inline jint NetworkCapabilities::NET_ENTERPRISE_ID_5()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
			"NET_ENTERPRISE_ID_5"
	...
	inline jint NetworkCapabilities::SIGNAL_STRENGTH_UNSPECIFIED()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
	...
	inline jint NetworkCapabilities::TRANSPORT_SATELLITE()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
			"TRANSPORT_SATELLITE"
	...
	inline jint NetworkCapabilities::TRANSPORT_THREAD()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
			"TRANSPORT_THREAD"
	...
	inline jint NetworkCapabilities::TRANSPORT_USB()
	{
		return getStaticField<jint>(
			"android.net.NetworkCapabilities",
			"TRANSPORT_USB"
	...
	// Constructors
	inline NetworkCapabilities::NetworkCapabilities()
		: JObject(
			"android.net.NetworkCapabilities",
			"()V"
		) {}
	...
	inline JIntArray NetworkCapabilities::getCapabilities() const
	{
	...
	inline JIntArray NetworkCapabilities::getEnterpriseIds() const
	{
		return callObjectMethod(
			"getEnterpriseIds",
			"()[I"
	...
	inline android::net::NetworkSpecifier NetworkCapabilities::getNetworkSpecifier() const
	{
		return callObjectMethod(
			"getNetworkSpecifier",
	...
	inline jint NetworkCapabilities::getOwnerUid() const
	{
		return callMethod<jint>(
			"getOwnerUid",
			"()I"
	...
	inline jint NetworkCapabilities::getSignalStrength() const
	{
		return callMethod<jint>(
			"getSignalStrength",
			"()I"
	...
	inline JObject NetworkCapabilities::getSubscriptionIds() const
	{
		return callObjectMethod(
			"getSubscriptionIds",
			"()Ljava/util/Set;"
	...
	inline JObject NetworkCapabilities::getTransportInfo() const
	{
		return callObjectMethod(
			"getTransportInfo",
	...
	inline jboolean NetworkCapabilities::hasEnterpriseId(jint arg0) const
	{
		return callMethod<jboolean>(
			"hasEnterpriseId",
			"(I)Z",
