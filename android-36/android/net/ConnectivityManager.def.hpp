...
namespace android::net
{
	...
	public:
		...
		android::net::SocketKeepalive createSocketKeepalive(android::net::Network arg0, android::net::IpSecManager_UdpEncapsulationSocket arg1, java::net::InetAddress arg2, java::net::InetAddress arg3, JObject arg4, android::net::SocketKeepalive_Callback arg5) const;
		...
		jint getConnectionOwnerUid(jint arg0, java::net::InetSocketAddress arg1, java::net::InetSocketAddress arg2) const;
		...
		void registerBestMatchingNetworkCallback(android::net::NetworkRequest arg0, android::net::ConnectivityManager_NetworkCallback arg1, android::os::Handler arg2) const;
		...
		void reserveNetwork(android::net::NetworkRequest arg0, android::os::Handler arg1, android::net::ConnectivityManager_NetworkCallback arg2) const;
