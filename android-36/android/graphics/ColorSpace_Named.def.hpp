...
namespace android::graphics
{
	...
	public:
		...
		static android::graphics::ColorSpace_Named BT2020_HLG();
		static android::graphics::ColorSpace_Named BT2020_PQ();
		...
		static android::graphics::ColorSpace_Named OK_LAB();
		...
		ColorSpace_Named(QJniObject obj) : java::lang::Enum(obj) {}
