...
namespace android::graphics
{
	...
	inline android::graphics::Bitmap_CompressFormat Bitmap_CompressFormat::WEBP_LOSSLESS()
	{
		return getStaticObjectField(
			"android.graphics.Bitmap$CompressFormat",
			"WEBP_LOSSLESS",
	...
	inline android::graphics::Bitmap_CompressFormat Bitmap_CompressFormat::WEBP_LOSSY()
	{
		return getStaticObjectField(
			"android.graphics.Bitmap$CompressFormat",
			"WEBP_LOSSY",
