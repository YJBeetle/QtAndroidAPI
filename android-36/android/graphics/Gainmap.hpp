...
namespace android::graphics
{
	...
	inline jint Gainmap::GAINMAP_DIRECTION_HDR_TO_SDR()
	{
	...
	inline jint Gainmap::GAINMAP_DIRECTION_SDR_TO_HDR()
	{
		return getStaticField<jint>(
			"android.graphics.Gainmap",
			"GAINMAP_DIRECTION_SDR_TO_HDR"
		);
	}
	...
	inline Gainmap::Gainmap(android::graphics::Gainmap &arg0, android::graphics::Bitmap arg1)
		: JObject(
			"android.graphics.Gainmap",
			"(Landroid/graphics/Gainmap;Landroid/graphics/Bitmap;)V",
			arg0.object(),
			arg1.object()
		) {}
	...
	inline android::graphics::ColorSpace Gainmap::getAlternativeImagePrimaries() const
	{
		return callObjectMethod(
			"getAlternativeImagePrimaries",
	...
	inline jint Gainmap::getGainmapDirection() const
	{
		return callMethod<jint>(
			"getGainmapDirection",
			"()I"
	...
	inline void Gainmap::setAlternativeImagePrimaries(android::graphics::ColorSpace arg0) const
	{
		callMethod<void>(
			"setAlternativeImagePrimaries",
	...
	inline void Gainmap::setGainmapDirection(jint arg0) const
	{
		callMethod<void>(
			"setGainmapDirection",
			"(I)V",
