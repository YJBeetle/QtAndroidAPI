...
namespace android::graphics::text
{
	...
	inline android::graphics::text::LineBreakConfig_Builder LineBreakConfig_Builder::merge(android::graphics::text::LineBreakConfig arg0) const
	{
		return callObjectMethod(
			"merge",
			"(Landroid/graphics/text/LineBreakConfig;)Landroid/graphics/text/LineBreakConfig$Builder;",
			arg0.object()
		);
	}
	inline android::graphics::text::LineBreakConfig_Builder LineBreakConfig_Builder::setHyphenation(jint arg0) const
	{
		return callObjectMethod(
			"setHyphenation",
