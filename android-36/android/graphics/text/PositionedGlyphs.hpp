...
{
	// Fields
	inline jfloat PositionedGlyphs::NO_OVERRIDE()
	{
	...
	inline jboolean PositionedGlyphs::getFakeBold(jint arg0) const
	{
		return callMethod<jboolean>(
			"getFakeBold",
			"(I)Z",
	...
	inline jboolean PositionedGlyphs::getFakeItalic(jint arg0) const
	{
		return callMethod<jboolean>(
			"getFakeItalic",
			"(I)Z",
	...
	inline jfloat PositionedGlyphs::getItalicOverride(jint arg0) const
	{
		return callMethod<jfloat>(
			"getItalicOverride",
			"(I)F",
	...
	inline jfloat PositionedGlyphs::getWeightOverride(jint arg0) const
	{
		return callMethod<jfloat>(
			"getWeightOverride",
			"(I)F",
