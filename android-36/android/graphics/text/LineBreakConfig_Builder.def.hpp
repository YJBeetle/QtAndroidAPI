...
namespace android::graphics::text
{
	...
	public:
		...
		android::graphics::text::LineBreakConfig_Builder merge(android::graphics::text::LineBreakConfig arg0) const;
		android::graphics::text::LineBreakConfig_Builder setHyphenation(jint arg0) const;
