...
namespace android::graphics
{
	...
	inline void Path::computeBounds(android::graphics::RectF arg0) const
	{
		callMethod<void>(
			"computeBounds",
	...
	inline void Path::conicTo(jfloat arg0, jfloat arg1, jfloat arg2, jfloat arg3, jfloat arg4) const
	{
		callMethod<void>(
			"conicTo",
			"(FFFFF)V",
	...
	inline jint Path::getGenerationId() const
	{
	...
	inline android::graphics::PathIterator Path::getPathIterator() const
	{
		return callObjectMethod(
			"getPathIterator",
	...
	inline jboolean Path::interpolate(android::graphics::Path arg0, jfloat arg1, android::graphics::Path arg2) const
	{
		return callMethod<jboolean>(
			"interpolate",
			"(Landroid/graphics/Path;FLandroid/graphics/Path;)Z",
			arg0.object(),
			arg1,
			arg2.object()
		);
	...
	inline jboolean Path::isInterpolatable(android::graphics::Path arg0) const
	{
		return callMethod<jboolean>(
			"isInterpolatable",
	...
	inline void Path::rConicTo(jfloat arg0, jfloat arg1, jfloat arg2, jfloat arg3, jfloat arg4) const
	{
		callMethod<void>(
			"rConicTo",
			"(FFFFF)V",
