...
namespace android::graphics
{
	...
	public:
		...
		Canvas(QJniObject obj) : JObject(obj) {}
		...
		void clipOutShader(android::graphics::Shader arg0) const;
		...
		void clipShader(android::graphics::Shader arg0) const;
		void concat(android::graphics::Matrix arg0) const;
		void concat(android::graphics::Matrix44 arg0) const;
		void disableZ() const;
		...
		void drawColor(jlong arg0) const;
		...
		void drawGlyphs(JIntArray arg0, jint arg1, JFloatArray arg2, jint arg3, jint arg4, android::graphics::fonts::Font arg5, android::graphics::Paint arg6) const;
		...
		void drawMesh(android::graphics::Mesh arg0, android::graphics::BlendMode arg1, android::graphics::Paint arg2) const;
		...
		void drawRegion(android::graphics::Region arg0, android::graphics::Paint arg1) const;
		...
		jboolean quickReject(android::graphics::Path arg0) const;
		jboolean quickReject(android::graphics::RectF arg0) const;
		...
		jboolean quickReject(jfloat arg0, jfloat arg1, jfloat arg2, jfloat arg3) const;
