...
namespace android::graphics
{
	...
	inline jint Paint::TEXT_RUN_FLAG_LEFT_EDGE()
	{
		return getStaticField<jint>(
			"android.graphics.Paint",
	...
	inline jint Paint::TEXT_RUN_FLAG_RIGHT_EDGE()
	{
		return getStaticField<jint>(
			"android.graphics.Paint",
	...
	inline jint Paint::VERTICAL_TEXT_FLAG()
	{
		return getStaticField<jint>(
			"android.graphics.Paint",
			"VERTICAL_TEXT_FLAG"
	...
	inline void Paint::getFontMetricsForLocale(android::graphics::Paint_FontMetrics arg0) const
	{
		callMethod<void>(
	...
	inline void Paint::getFontMetricsIntForLocale(android::graphics::Paint_FontMetricsInt arg0) const
	{
		callMethod<void>(
