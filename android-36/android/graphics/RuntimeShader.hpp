...
namespace android::graphics
{
	...
	inline void RuntimeShader::setInputColorFilter(JString arg0, android::graphics::ColorFilter arg1) const
	{
		callMethod<void>(
			"setInputColorFilter",
	...
	inline void RuntimeShader::setInputXfermode(JString arg0, android::graphics::RuntimeXfermode arg1) const
	{
		callMethod<void>(
			"setInputXfermode",
