...
namespace android::graphics
{
	class RuntimeColorFilter : public android::graphics::ColorFilter
	{
	public:
		// Fields
		
		// QJniObject forward
		template<typename ...Ts> explicit RuntimeColorFilter(const char *className, const char *sig, Ts...agv) : android::graphics::ColorFilter(className, sig, std::forward<Ts>(agv)...) {}
		RuntimeColorFilter(QJniObject obj) : android::graphics::ColorFilter(obj) {}
		
		// Constructors
		RuntimeColorFilter(JString arg0);
