...
namespace android::media::tv
{
	...
	public:
		...
		void notifyAdBufferConsumed(android::media::tv::AdBuffer arg0) const;
		...
		void notifyAudioPresentationChanged(JObject arg0) const;
		void notifyAudioPresentationSelected(jint arg0, jint arg1) const;
		void notifyAvailableSpeeds(JFloatArray arg0) const;
		...
		void notifyCueingMessageAvailability(jboolean arg0) const;
		void notifySignalStrength(jint arg0) const;
		void notifyTimeShiftMode(jint arg0) const;
		...
		void onAdBufferReady(android::media::tv::AdBuffer arg0) const;
		...
		void onResumePlayback() const;
		jboolean onSelectAudioPresentation(jint arg0, jint arg1) const;
		...
		void onSetTvMessageEnabled(jint arg0, jboolean arg1) const;
		void onStopPlayback(jint arg0) const;
		...
		void onTimeShiftSetMode(jint arg0) const;
		...
		void onTvAdSessionData(JString arg0, android::os::Bundle arg1) const;
		void onTvMessage(jint arg0, android::os::Bundle arg1) const;
		void onUnblockContent(android::media::tv::TvContentRating arg0) const;
		void sendTvInputSessionData(JString arg0, android::os::Bundle arg1) const;
