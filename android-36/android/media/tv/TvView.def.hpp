...
namespace android::media::tv
{
	...
	public:
		...
		TvView(QJniObject obj) : android::view::ViewGroup(obj) {}
		...
		JObject getAudioPresentations() const;
		...
		void overrideTvAppAttributionSource(android::content::AttributionSource arg0) const;
		void reset() const;
		void resumePlayback() const;
		void selectAudioPresentation(jint arg0, jint arg1) const;
		...
		void setInteractiveAppNotificationEnabled(jboolean arg0) const;
		...
		void setTvMessageEnabled(jint arg0, jboolean arg1) const;
		void setVideoFrozen(jboolean arg0) const;
		void setZOrderMediaOverlay(jboolean arg0) const;
		void setZOrderOnTop(jboolean arg0) const;
		void stopPlayback(jint arg0) const;
		...
		void timeShiftSetMode(jint arg0) const;
