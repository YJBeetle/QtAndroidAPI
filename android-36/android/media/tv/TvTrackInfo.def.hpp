...
namespace android::media::tv
{
	...
	public:
		...
		TvTrackInfo(QJniObject obj) : JObject(obj) {}
		...
		jint hashCode() const;
		jboolean isAudioDescription() const;
		jboolean isEncrypted() const;
		jboolean isHardOfHearing() const;
		jboolean isSpokenSubtitle() const;
