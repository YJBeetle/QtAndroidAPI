...
namespace android::media::tv
{
	...
	public:
		...
		static JString SESSION_DATA_KEY_AD_RESPONSE();
		static JString SESSION_DATA_KEY_BROADCAST_INFO_RESPONSE();
		static JString SESSION_DATA_KEY_CHANNEL_URI();
		static JString SESSION_DATA_KEY_TRACKS();
		static JString SESSION_DATA_KEY_TRACK_ID();
		static JString SESSION_DATA_KEY_TRACK_TYPE();
		static JString SESSION_DATA_KEY_TV_MESSAGE_TYPE();
		static JString SESSION_DATA_KEY_VIDEO_UNAVAILABLE_REASON();
		static JString SESSION_DATA_TYPE_AD_BUFFER_CONSUMED();
		static JString SESSION_DATA_TYPE_AD_RESPONSE();
		static JString SESSION_DATA_TYPE_BROADCAST_INFO_RESPONSE();
		static JString SESSION_DATA_TYPE_TRACKS_CHANGED();
		static JString SESSION_DATA_TYPE_TRACK_SELECTED();
		static JString SESSION_DATA_TYPE_TUNED();
		static JString SESSION_DATA_TYPE_TV_MESSAGE();
		static JString SESSION_DATA_TYPE_VIDEO_AVAILABLE();
		static JString SESSION_DATA_TYPE_VIDEO_UNAVAILABLE();
		...
		static jint VIDEO_UNAVAILABLE_REASON_STOPPED();
