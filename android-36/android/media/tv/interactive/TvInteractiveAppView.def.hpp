...
namespace android::media::tv::interactive
{
	...
	public:
		...
		void notifyRecordingScheduled(JString arg0, JString arg1) const;
		void notifyRecordingStarted(JString arg0, JString arg1) const;
		void notifyRecordingStopped(JString arg0) const;
		void notifyTimeShiftCurrentPositionChanged(JString arg0, jlong arg1) const;
		void notifyTimeShiftPlaybackParams(android::media::PlaybackParams arg0) const;
		void notifyTimeShiftStartPositionChanged(JString arg0, jlong arg1) const;
		void notifyTimeShiftStatusChanged(JString arg0, jint arg1) const;
		void notifyTvMessage(jint arg0, android::os::Bundle arg1) const;
		void notifyVideoFreezeUpdated(jboolean arg0) const;
		...
		void sendAvailableSpeeds(JFloatArray arg0) const;
		void sendCertificate(JString arg0, jint arg1, android::net::http::SslCertificate arg2) const;
		...
		void sendSelectedTrackInfo(JObject arg0) const;
		void sendSigningResult(JString arg0, JByteArray arg1) const;
		void sendStreamVolume(jfloat arg0) const;
		void sendTimeShiftMode(jint arg0) const;
		void sendTrackInfoList(JObject arg0) const;
		void sendTvRecordingInfo(android::media::tv::TvRecordingInfo arg0) const;
		void sendTvRecordingInfoList(JObject arg0) const;
