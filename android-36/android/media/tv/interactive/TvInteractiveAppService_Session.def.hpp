...
namespace android::media::tv::interactive
{
	...
	public:
		...
		void onCertificate(JString arg0, jint arg1, android::net::http::SslCertificate arg2) const;
		...
		void onSelectedTrackInfo(JObject arg0) const;
		...
		void onVideoFreezeUpdated(jboolean arg0) const;
		...
		void requestCertificate(JString arg0, jint arg1) const;
		...
		void requestSelectedTrackInfo() const;
		void requestSigning(JString arg0, JString arg1, JString arg2, JByteArray arg3) const;
		void requestSigning(JString arg0, JString arg1, JString arg2, jint arg3, JByteArray arg4) const;
