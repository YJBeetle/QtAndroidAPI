...
namespace android::media::tv::interactive
{
	...
	inline void TvInteractiveAppView_TvInteractiveAppCallback::onRequestCertificate(JString arg0, JString arg1, jint arg2) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppView_TvInteractiveAppCallback::onRequestSelectedTrackInfo(JString arg0) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppView_TvInteractiveAppCallback::onRequestSigning(JString arg0, JString arg1, JString arg2, JString arg3, jint arg4, JByteArray arg5) const
	{
		callMethod<void>(
			"onRequestSigning",
			"(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I[B)V",
			arg0.object<jstring>(),
			arg1.object<jstring>(),
			arg2.object<jstring>(),
			arg3.object<jstring>(),
