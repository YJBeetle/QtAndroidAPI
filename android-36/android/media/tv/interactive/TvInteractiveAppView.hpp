...
namespace android::media::tv::interactive
{
	...
	inline void TvInteractiveAppView::notifyVideoFreezeUpdated(jboolean arg0) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppView::sendCertificate(JString arg0, jint arg1, android::net::http::SslCertificate arg2) const
	{
		callMethod<void>(
			"sendCertificate",
	...
	inline void TvInteractiveAppView::sendSelectedTrackInfo(JObject arg0) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppView::setZOrderMediaOverlay(jboolean arg0) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppView::setZOrderOnTop(jboolean arg0) const
	{
		callMethod<void>(
			"setZOrderOnTop",
			"(Z)V",
