...
namespace android::media::tv::interactive
{
	...
	inline void TvInteractiveAppService_Session::notifyAdBufferReady(android::media::tv::AdBuffer arg0) const
	{
		callMethod<void>(
			"notifyAdBufferReady",
	...
	inline void TvInteractiveAppService_Session::onAdBufferConsumed(android::media::tv::AdBuffer arg0) const
	{
		callMethod<void>(
			"onAdBufferConsumed",
			"(Landroid/media/tv/AdBuffer;)V",
	...
	inline void TvInteractiveAppService_Session::onAvailableSpeeds(JFloatArray arg0) const
	{
		callMethod<void>(
			"onAvailableSpeeds",
			"([F)V",
	...
	inline void TvInteractiveAppService_Session::onCertificate(JString arg0, jint arg1, android::net::http::SslCertificate arg2) const
	{
		callMethod<void>(
			"onCertificate",
			"(Ljava/lang/String;ILandroid/net/http/SslCertificate;)V",
			arg0.object<jstring>(),
			arg1,
			arg2.object()
		);
	...
	inline void TvInteractiveAppService_Session::onCurrentVideoBounds(android::graphics::Rect arg0) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppService_Session::onRecordingConnectionFailed(JString arg0, JString arg1) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppService_Session::onRecordingDisconnected(JString arg0, JString arg1) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppService_Session::onRecordingError(JString arg0, jint arg1) const
	{
		callMethod<void>(
			"onRecordingError",
	...
	inline void TvInteractiveAppService_Session::onRecordingScheduled(JString arg0, JString arg1) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppService_Session::onRecordingStarted(JString arg0, JString arg1) const
	{
		callMethod<void>(
			"onRecordingStarted",
			"(Ljava/lang/String;Ljava/lang/String;)V",
	...
	inline void TvInteractiveAppService_Session::onRecordingStopped(JString arg0) const
	{
		callMethod<void>(
			"onRecordingStopped",
			"(Ljava/lang/String;)V",
	...
	inline void TvInteractiveAppService_Session::onRecordingTuned(JString arg0, android::net::Uri arg1) const
	{
		callMethod<void>(
			"onRecordingTuned",
	...
	inline void TvInteractiveAppService_Session::onSelectedTrackInfo(JObject arg0) const
	{
		callMethod<void>(
			"onSelectedTrackInfo",
			"(Ljava/util/List;)V",
	...
	inline void TvInteractiveAppService_Session::onTimeShiftCurrentPositionChanged(JString arg0, jlong arg1) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppService_Session::onTimeShiftMode(jint arg0) const
	{
		callMethod<void>(
			"onTimeShiftMode",
			"(I)V",
	...
	inline void TvInteractiveAppService_Session::onTimeShiftPlaybackParams(android::media::PlaybackParams arg0) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppService_Session::onTimeShiftStartPositionChanged(JString arg0, jlong arg1) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppService_Session::onTimeShiftStatusChanged(JString arg0, jint arg1) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppService_Session::onTvMessage(jint arg0, android::os::Bundle arg1) const
	{
		callMethod<void>(
			"onTvMessage",
	...
	inline void TvInteractiveAppService_Session::onTvRecordingInfo(android::media::tv::TvRecordingInfo arg0) const
	{
		callMethod<void>(
			"onTvRecordingInfo",
	...
	inline void TvInteractiveAppService_Session::onTvRecordingInfoList(JObject arg0) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppService_Session::onVideoFreezeUpdated(jboolean arg0) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppService_Session::requestAvailableSpeeds() const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppService_Session::requestCertificate(JString arg0, jint arg1) const
	{
		callMethod<void>(
			"requestCertificate",
			"(Ljava/lang/String;I)V",
	...
	inline void TvInteractiveAppService_Session::requestCurrentVideoBounds() const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppService_Session::requestScheduleRecording(JString arg0, JString arg1, android::net::Uri arg2, android::net::Uri arg3, android::os::Bundle arg4) const
	{
		callMethod<void>(
			"requestScheduleRecording",
			"(Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;Landroid/net/Uri;Landroid/os/Bundle;)V",
			arg0.object<jstring>(),
			arg1.object<jstring>(),
			arg2.object(),
			arg3.object(),
	...
	inline void TvInteractiveAppService_Session::requestScheduleRecording(JString arg0, JString arg1, android::net::Uri arg2, jlong arg3, jlong arg4, jint arg5, android::os::Bundle arg6) const
	{
		callMethod<void>(
			"requestScheduleRecording",
			"(Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;JJILandroid/os/Bundle;)V",
			arg0.object<jstring>(),
			arg1.object<jstring>(),
			arg2.object(),
			arg3,
	...
	inline void TvInteractiveAppService_Session::requestSelectedTrackInfo() const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppService_Session::requestSigning(JString arg0, JString arg1, JString arg2, jint arg3, JByteArray arg4) const
	{
		callMethod<void>(
			"requestSigning",
			"(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I[B)V",
			arg0.object<jstring>(),
			arg1.object<jstring>(),
			arg2.object<jstring>(),
			arg3,
	...
	inline void TvInteractiveAppService_Session::requestStartRecording(JString arg0, android::net::Uri arg1) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppService_Session::requestStopRecording(JString arg0) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppService_Session::requestTimeShiftMode() const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppService_Session::requestTvRecordingInfo(JString arg0) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppService_Session::requestTvRecordingInfoList(jint arg0) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppService_Session::sendTimeShiftCommandRequest(JString arg0, android::os::Bundle arg1) const
	{
		callMethod<void>(
	...
	inline void TvInteractiveAppService_Session::setTvRecordingInfo(JString arg0, android::media::tv::TvRecordingInfo arg1) const
	{
		callMethod<void>(
			"setTvRecordingInfo",
			"(Ljava/lang/String;Landroid/media/tv/TvRecordingInfo;)V",
			arg0.object<jstring>(),
			arg1.object()
		);
	}
