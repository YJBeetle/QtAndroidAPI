...
namespace android::media::tv
{
	...
	inline void TvInputService_Session::notifyVideoFreezeUpdated(jboolean arg0) const
	{
		callMethod<void>(
	...
	inline void TvInputService_Session::onResumePlayback() const
	{
		callMethod<void>(
			"onResumePlayback",
			"()V"
	...
	inline void TvInputService_Session::onStopPlayback(jint arg0) const
	{
		callMethod<void>(
			"onStopPlayback",
			"(I)V",
	...
	inline void TvInputService_Session::onTvAdSessionData(JString arg0, android::os::Bundle arg1) const
	{
		callMethod<void>(
			"onTvAdSessionData",
			"(Ljava/lang/String;Landroid/os/Bundle;)V",
	...
	inline void TvInputService_Session::sendTvInputSessionData(JString arg0, android::os::Bundle arg1) const
	{
		callMethod<void>(
			"sendTvInputSessionData",
			"(Ljava/lang/String;Landroid/os/Bundle;)V",
			arg0.object<jstring>(),
			arg1.object()
		);
