...
namespace android::media::tv
{
	...
	public:
		// Fields
		static jint BROADCAST_VISIBILITY_TYPE_INVISIBLE();
		static jint BROADCAST_VISIBILITY_TYPE_NUMERIC_SELECTABLE_ONLY();
		static jint BROADCAST_VISIBILITY_TYPE_VISIBLE();
		...
		static JString COLUMN_BROADCAST_VISIBILITY_TYPE();
		static JString COLUMN_BROWSABLE();
		static JString COLUMN_CHANNEL_LIST_ID();
		...
		static JString COLUMN_REMOTE_CONTROL_KEY_PRESET_NUMBER();
		static JString COLUMN_SCRAMBLED();
		...
		static JString COLUMN_VIDEO_RESOLUTION();
