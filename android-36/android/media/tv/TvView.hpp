...
namespace android::media::tv
{
	...
	inline JObject TvView::getAudioPresentations() const
	{
	...
	inline void TvView::overrideTvAppAttributionSource(android::content::AttributionSource arg0) const
	{
		callMethod<void>(
	...
	inline void TvView::resumePlayback() const
	{
		callMethod<void>(
			"resumePlayback",
			"()V"
	...
	inline void TvView::selectAudioPresentation(jint arg0, jint arg1) const
	{
		callMethod<void>(
	...
	inline void TvView::setTvMessageEnabled(jint arg0, jboolean arg1) const
	{
		callMethod<void>(
			"setTvMessageEnabled",
			"(IZ)V",
	...
	inline void TvView::setVideoFrozen(jboolean arg0) const
	{
		callMethod<void>(
			"setVideoFrozen",
			"(Z)V",
	...
	inline void TvView::stopPlayback(jint arg0) const
	{
		callMethod<void>(
			"stopPlayback",
			"(I)V",
	...
	inline void TvView::timeShiftSetMode(jint arg0) const
	{
		callMethod<void>(
			"timeShiftSetMode",
			"(I)V",
