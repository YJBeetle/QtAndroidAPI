...
namespace android::media
{
	...
	inline android::media::RoutingSessionInfo_Builder RoutingSessionInfo_Builder::setTransferInitiator(android::os::UserHandle arg0, JString arg1) const
	{
		return callObjectMethod(
			"setTransferInitiator",
			"(Landroid/os/UserHandle;Ljava/lang/String;)Landroid/media/RoutingSessionInfo$Builder;",
			arg0.object(),
			arg1.object<jstring>()
		);
	}
	inline android::media::RoutingSessionInfo_Builder RoutingSessionInfo_Builder::setTransferReason(jint arg0) const
	{
		return callObjectMethod(
			"setTransferReason",
