...
{
	// Fields
	inline jint AudioTrack::DUAL_MONO_MODE_LL()
	{
	...
	inline jint AudioTrack::DUAL_MONO_MODE_LR()
	{
		return getStaticField<jint>(
			"android.media.AudioTrack",
			"DUAL_MONO_MODE_LR"
	...
	inline jint AudioTrack::DUAL_MONO_MODE_OFF()
	{
		return getStaticField<jint>(
			"android.media.AudioTrack",
			"DUAL_MONO_MODE_OFF"
	...
	inline jint AudioTrack::DUAL_MONO_MODE_RR()
	{
		return getStaticField<jint>(
			"android.media.AudioTrack",
			"DUAL_MONO_MODE_RR"
	...
	inline jint AudioTrack::ENCAPSULATION_METADATA_TYPE_DVB_AD_DESCRIPTOR()
	{
		return getStaticField<jint>(
			"android.media.AudioTrack",
	...
	inline jint AudioTrack::ENCAPSULATION_METADATA_TYPE_FRAMEWORK_TUNER()
	{
		return getStaticField<jint>(
			"android.media.AudioTrack",
	...
	inline jint AudioTrack::ENCAPSULATION_METADATA_TYPE_SUPPLEMENTARY_AUDIO_PLACEMENT()
	{
		return getStaticField<jint>(
			"android.media.AudioTrack",
	...
	inline jint AudioTrack::ENCAPSULATION_MODE_ELEMENTARY_STREAM()
	{
		return getStaticField<jint>(
			"android.media.AudioTrack",
	...
	inline jint AudioTrack::ENCAPSULATION_MODE_NONE()
	{
		return getStaticField<jint>(
			"android.media.AudioTrack",
	...
	inline jint AudioTrack::SUPPLEMENTARY_AUDIO_PLACEMENT_LEFT()
	{
		return getStaticField<jint>(
			"android.media.AudioTrack",
	...
	inline jint AudioTrack::SUPPLEMENTARY_AUDIO_PLACEMENT_NORMAL()
	{
		return getStaticField<jint>(
			"android.media.AudioTrack",
	...
	inline jint AudioTrack::SUPPLEMENTARY_AUDIO_PLACEMENT_RIGHT()
	{
		return getStaticField<jint>(
			"android.media.AudioTrack",
	...
	inline jboolean AudioTrack::isDirectPlaybackSupported(android::media::AudioFormat arg0, android::media::AudioAttributes arg1)
	{
	...
	inline void AudioTrack::addOnCodecFormatChangedListener(JObject arg0, JObject arg1) const
	{
		callMethod<void>(
	...
	inline android::media::AudioAttributes AudioTrack::getAudioAttributes() const
	{
		return callObjectMethod(
			"getAudioAttributes",
	...
	inline jfloat AudioTrack::getAudioDescriptionMixLeveldB() const
	{
	...
	inline jint AudioTrack::getDualMonoMode() const
	{
		return callMethod<jint>(
			"getDualMonoMode",
			"()I"
	...
	inline android::media::metrics::LogSessionId AudioTrack::getLogSessionId() const
	{
		return callObjectMethod(
			"getLogSessionId",
	...
	inline jint AudioTrack::getOffloadDelay() const
	{
		return callMethod<jint>(
			"getOffloadDelay",
			"()I"
	...
	inline jint AudioTrack::getOffloadPadding() const
	{
		return callMethod<jint>(
			"getOffloadPadding",
			"()I"
	...
	inline JObject AudioTrack::getRoutedDevices() const
	{
		return callObjectMethod(
			"getRoutedDevices",
			"()Ljava/util/List;"
	...
	inline jint AudioTrack::getStartThresholdInFrames() const
	{
		return callMethod<jint>(
	...
	inline jboolean AudioTrack::isOffloadedPlayback() const
	{
		return callMethod<jboolean>(
			"isOffloadedPlayback",
			"()Z"
	...
	inline void AudioTrack::registerStreamEventCallback(JObject arg0, android::media::AudioTrack_StreamEventCallback arg1) const
	{
		callMethod<void>(
	...
	inline void AudioTrack::removeOnCodecFormatChangedListener(JObject arg0) const
	{
		callMethod<void>(
	...
	inline jboolean AudioTrack::setAudioDescriptionMixLeveldB(jfloat arg0) const
	{
		return callMethod<jboolean>(
	...
	inline jboolean AudioTrack::setDualMonoMode(jint arg0) const
	{
		return callMethod<jboolean>(
			"setDualMonoMode",
			"(I)Z",
	...
	inline void AudioTrack::setLogSessionId(android::media::metrics::LogSessionId arg0) const
	{
		callMethod<void>(
			"setLogSessionId",
	...
	inline void AudioTrack::setOffloadDelayPadding(jint arg0, jint arg1) const
	{
		callMethod<void>(
	...
	inline void AudioTrack::setOffloadEndOfStream() const
	{
		callMethod<void>(
	...
	inline jint AudioTrack::setStartThresholdInFrames(jint arg0) const
	{
		return callMethod<jint>(
	...
	inline void AudioTrack::unregisterStreamEventCallback(android::media::AudioTrack_StreamEventCallback arg0) const
	{
		callMethod<void>(
