...
namespace android::media
{
	...
	public:
		...
		AudioAttributes_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::media::AudioAttributes_Builder setIsContentSpatialized(jboolean arg0) const;
		android::media::AudioAttributes_Builder setLegacyStreamType(jint arg0) const;
		android::media::AudioAttributes_Builder setSpatializationBehavior(jint arg0) const;
