...
namespace android::media
{
	...
	public:
		...
		AudioTrack_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::media::AudioTrack_Builder setContext(android::content::Context arg0) const;
		android::media::AudioTrack_Builder setEncapsulationMode(jint arg0) const;
		android::media::AudioTrack_Builder setOffloadedPlayback(jboolean arg0) const;
