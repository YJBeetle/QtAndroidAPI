...
namespace android::media
{
	...
	public:
		...
		RoutingSessionInfo_Builder(QJniObject obj) : JObject(obj) {}
		...
		android::media::RoutingSessionInfo_Builder setTransferInitiator(android::os::UserHandle arg0, JString arg1) const;
		android::media::RoutingSessionInfo_Builder setTransferReason(jint arg0) const;
