...
namespace android::media
{
	...
	public:
		...
		static jint COLOR_FormatYUVP010();
		static jint COLOR_FormatYUVP210();
		...
		static JString FEATURE_DetachedSurface();
		static JString FEATURE_DynamicColorAspects();
		static JString FEATURE_DynamicTimestamp();
		static JString FEATURE_EncodingStatistics();
		static JString FEATURE_FrameParsing();
		static JString FEATURE_HdrEditing();
		static JString FEATURE_HlgEditing();
		...
		MediaCodecInfo_CodecCapabilities(QJniObject obj) : JObject(obj) {}
