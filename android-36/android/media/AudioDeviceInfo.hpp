...
namespace android::media
{
	...
	inline jint AudioDeviceInfo::TYPE_DOCK_ANALOG()
	{
		return getStaticField<jint>(
			"android.media.AudioDeviceInfo",
			"TYPE_DOCK_ANALOG"
	...
	inline jint AudioDeviceInfo::TYPE_MULTICHANNEL_GROUP()
	{
		return getStaticField<jint>(
			"android.media.AudioDeviceInfo",
	...
	inline jint AudioDeviceInfo::getSpeakerLayoutChannelMask() const
	{
		return callMethod<jint>(
