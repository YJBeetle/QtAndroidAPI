...
namespace android::media
{
	...
	inline android::media::metrics::LogSessionId AudioRecord::getLogSessionId() const
	{
		return callObjectMethod(
			"getLogSessionId",
	...
	inline JObject AudioRecord::getRoutedDevices() const
	{
		return callObjectMethod(
			"getRoutedDevices",
			"()Ljava/util/List;"
	...
	inline jboolean AudioRecord::isPrivacySensitive() const
	{
	...
	inline void AudioRecord::setLogSessionId(android::media::metrics::LogSessionId arg0) const
	{
		callMethod<void>(
			"setLogSessionId",
