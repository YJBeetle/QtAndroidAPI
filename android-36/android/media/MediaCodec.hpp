...
namespace android::media
{
	...
	inline jint MediaCodec::CONFIGURE_FLAG_DETACHED_SURFACE()
	{
		return getStaticField<jint>(
			"android.media.MediaCodec",
	...
	inline JString MediaCodec::PARAMETER_KEY_QP_OFFSET_MAP()
	{
		return getStaticObjectField(
			"android.media.MediaCodec",
	...
	inline JString MediaCodec::PARAMETER_KEY_QP_OFFSET_RECTS()
	{
		return getStaticObjectField(
			"android.media.MediaCodec",
	...
	inline void MediaCodec::detachOutputSurface() const
	{
		callMethod<void>(
			"detachOutputSurface",
			"()V"
	...
	inline void MediaCodec::queueInputBuffers(jint arg0, java::util::ArrayDeque arg1) const
	{
		callMethod<void>(
			"queueInputBuffers",
			"(ILjava/util/ArrayDeque;)V",
			arg0,
			arg1.object()
		);
	}
	...
	inline void MediaCodec::queueSecureInputBuffers(jint arg0, java::util::ArrayDeque arg1, java::util::ArrayDeque arg2) const
	{
		callMethod<void>(
			"queueSecureInputBuffers",
			"(ILjava/util/ArrayDeque;Ljava/util/ArrayDeque;)V",
			arg0,
			arg1.object(),
			arg2.object()
		);
