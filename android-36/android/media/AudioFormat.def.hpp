...
namespace android::media
{
	...
	public:
		...
		static jint CHANNEL_OUT_5POINT1POINT2();
		static jint CHANNEL_OUT_5POINT1POINT4();
		static jint CHANNEL_OUT_6POINT1();
		static jint CHANNEL_OUT_7POINT1();
		static jint CHANNEL_OUT_7POINT1POINT2();
		static jint CHANNEL_OUT_7POINT1POINT4();
		static jint CHANNEL_OUT_7POINT1_SURROUND();
		static jint CHANNEL_OUT_9POINT1POINT4();
		static jint CHANNEL_OUT_9POINT1POINT6();
		static jint CHANNEL_OUT_BACK_CENTER();
		static jint CHANNEL_OUT_BACK_LEFT();
		static jint CHANNEL_OUT_BACK_RIGHT();
		static jint CHANNEL_OUT_BOTTOM_FRONT_CENTER();
		static jint CHANNEL_OUT_BOTTOM_FRONT_LEFT();
		static jint CHANNEL_OUT_BOTTOM_FRONT_RIGHT();
		...
		static jint CHANNEL_OUT_FRONT_WIDE_LEFT();
		static jint CHANNEL_OUT_FRONT_WIDE_RIGHT();
		static jint CHANNEL_OUT_LOW_FREQUENCY();
		static jint CHANNEL_OUT_LOW_FREQUENCY_2();
		...
		static jint CHANNEL_OUT_TOP_BACK_CENTER();
		static jint CHANNEL_OUT_TOP_BACK_LEFT();
		static jint CHANNEL_OUT_TOP_BACK_RIGHT();
		static jint CHANNEL_OUT_TOP_CENTER();
		static jint CHANNEL_OUT_TOP_FRONT_CENTER();
		static jint CHANNEL_OUT_TOP_FRONT_LEFT();
		static jint CHANNEL_OUT_TOP_FRONT_RIGHT();
		static jint CHANNEL_OUT_TOP_SIDE_LEFT();
		static jint CHANNEL_OUT_TOP_SIDE_RIGHT();
		...
		static jint ENCODING_DRA();
		static jint ENCODING_DSD();
		static jint ENCODING_DTS();
		static jint ENCODING_DTS_HD();
		static jint ENCODING_DTS_HD_MA();
		static jint ENCODING_DTS_UHD();
		static jint ENCODING_DTS_UHD_P1();
		static jint ENCODING_DTS_UHD_P2();
		static jint ENCODING_E_AC3();
		static jint ENCODING_E_AC3_JOC();
		static jint ENCODING_IAMF_BASE_ENHANCED_PROFILE_AAC();
		static jint ENCODING_IAMF_BASE_ENHANCED_PROFILE_FLAC();
		static jint ENCODING_IAMF_BASE_ENHANCED_PROFILE_OPUS();
		static jint ENCODING_IAMF_BASE_ENHANCED_PROFILE_PCM();
		static jint ENCODING_IAMF_BASE_PROFILE_AAC();
		static jint ENCODING_IAMF_BASE_PROFILE_FLAC();
		static jint ENCODING_IAMF_BASE_PROFILE_OPUS();
		static jint ENCODING_IAMF_BASE_PROFILE_PCM();
		static jint ENCODING_IAMF_SIMPLE_PROFILE_AAC();
		static jint ENCODING_IAMF_SIMPLE_PROFILE_FLAC();
		static jint ENCODING_IAMF_SIMPLE_PROFILE_OPUS();
		static jint ENCODING_IAMF_SIMPLE_PROFILE_PCM();
		static jint ENCODING_IEC61937();
		static jint ENCODING_INVALID();
		static jint ENCODING_MP3();
		static jint ENCODING_MPEGH_BL_L3();
		static jint ENCODING_MPEGH_BL_L4();
		static jint ENCODING_MPEGH_LC_L3();
		static jint ENCODING_MPEGH_LC_L4();
		static jint ENCODING_OPUS();
		static jint ENCODING_PCM_16BIT();
		static jint ENCODING_PCM_24BIT_PACKED();
		static jint ENCODING_PCM_32BIT();
		...
		AudioFormat(QJniObject obj) : JObject(obj) {}
