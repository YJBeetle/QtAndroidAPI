...
namespace android::media
{
	...
	inline MediaRecorder::MediaRecorder(android::content::Context arg0)
		: JObject(
			"android.media.MediaRecorder",
	...
	inline android::media::metrics::LogSessionId MediaRecorder::getLogSessionId() const
	{
		return callObjectMethod(
			"getLogSessionId",
	...
	inline JObject MediaRecorder::getRoutedDevices() const
	{
		return callObjectMethod(
			"getRoutedDevices",
			"()Ljava/util/List;"
	...
	inline void MediaRecorder::setAudioProfile(android::media::EncoderProfiles_AudioProfile arg0) const
	{
		callMethod<void>(
			"setAudioProfile",
			"(Landroid/media/EncoderProfiles$AudioProfile;)V",
			arg0.object()
		);
	}
	...
	inline void MediaRecorder::setLogSessionId(android::media::metrics::LogSessionId arg0) const
	{
		callMethod<void>(
			"setLogSessionId",
	...
	inline void MediaRecorder::setVideoProfile(android::media::EncoderProfiles_VideoProfile arg0) const
	{
		callMethod<void>(
			"setVideoProfile",
			"(Landroid/media/EncoderProfiles$VideoProfile;)V",
			arg0.object()
		);
	}
