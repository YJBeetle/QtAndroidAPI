...
namespace android::media
{
	...
	inline jint MediaFormat::FLAG_SECURITY_MODEL_MEMORY_SAFE()
	{
		return getStaticField<jint>(
			"android.media.MediaFormat",
	...
	inline jint MediaFormat::FLAG_SECURITY_MODEL_SANDBOXED()
	{
		return getStaticField<jint>(
			"android.media.MediaFormat",
	...
	inline JString MediaFormat::KEY_BUFFER_BATCH_MAX_OUTPUT_SIZE()
	{
		return getStaticObjectField(
			"android.media.MediaFormat",
	...
	inline JString MediaFormat::KEY_BUFFER_BATCH_THRESHOLD_OUTPUT_SIZE()
	{
		return getStaticObjectField(
			"android.media.MediaFormat",
	...
	inline JString MediaFormat::KEY_IMPORTANCE()
	{
		return getStaticObjectField(
			"android.media.MediaFormat",
			"KEY_IMPORTANCE",
	...
	inline JString MediaFormat::KEY_PICTURE_PROFILE_ID()
	{
		return getStaticObjectField(
			"android.media.MediaFormat",
			"KEY_PICTURE_PROFILE_ID",
			"Ljava/lang/String;"
		);
	}
	inline JString MediaFormat::KEY_PICTURE_PROFILE_INSTANCE()
	{
		return getStaticObjectField(
			"android.media.MediaFormat",
	...
	inline JString MediaFormat::KEY_SECURITY_MODEL()
	{
		return getStaticObjectField(
			"android.media.MediaFormat",
			"KEY_SECURITY_MODEL",
	...
	inline JString MediaFormat::MIMETYPE_AUDIO_IAMF()
	{
		return getStaticObjectField(
			"android.media.MediaFormat",
			"MIMETYPE_AUDIO_IAMF",
	...
	inline JString MediaFormat::MIMETYPE_VIDEO_APV()
	{
		return getStaticObjectField(
			"android.media.MediaFormat",
			"MIMETYPE_VIDEO_APV",
