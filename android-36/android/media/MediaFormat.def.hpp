...
namespace android::media
{
	...
	public:
		...
		static jint FLAG_SECURITY_MODEL_MEMORY_SAFE();
		static jint FLAG_SECURITY_MODEL_SANDBOXED();
		...
		static JString KEY_BUFFER_BATCH_MAX_OUTPUT_SIZE();
		static JString KEY_BUFFER_BATCH_THRESHOLD_OUTPUT_SIZE();
		...
		static JString KEY_CROP_BOTTOM();
		static JString KEY_CROP_LEFT();
		static JString KEY_CROP_RIGHT();
		static JString KEY_CROP_TOP();
		...
		static JString KEY_MAX_OUTPUT_CHANNEL_COUNT();
		...
		static JString KEY_PICTURE_PROFILE_ID();
		static JString KEY_PICTURE_PROFILE_INSTANCE();
		static JString KEY_PICTURE_TYPE();
		...
		static JString KEY_SECURITY_MODEL();
		...
		static JString KEY_VIDEO_ENCODING_STATISTICS_LEVEL();
		static JString KEY_VIDEO_QP_AVERAGE();
		...
		static JString LOG_SESSION_ID();
		static JString MIMETYPE_AUDIO_AAC();
		static JString MIMETYPE_AUDIO_AAC_ELD();
		static JString MIMETYPE_AUDIO_AAC_HE_V1();
		static JString MIMETYPE_AUDIO_AAC_HE_V2();
		static JString MIMETYPE_AUDIO_AAC_LC();
		static JString MIMETYPE_AUDIO_AAC_XHE();
		...
		static JString MIMETYPE_AUDIO_DOLBY_MAT();
		static JString MIMETYPE_AUDIO_DOLBY_TRUEHD();
		static JString MIMETYPE_AUDIO_DRA();
		static JString MIMETYPE_AUDIO_DTS();
		static JString MIMETYPE_AUDIO_DTS_HD();
		static JString MIMETYPE_AUDIO_DTS_UHD();
		...
		static JString MIMETYPE_AUDIO_IAMF();
		static JString MIMETYPE_AUDIO_IEC61937();
		static JString MIMETYPE_AUDIO_MPEG();
		static JString MIMETYPE_AUDIO_MPEGH_BL_L3();
		static JString MIMETYPE_AUDIO_MPEGH_BL_L4();
		static JString MIMETYPE_AUDIO_MPEGH_LC_L3();
		static JString MIMETYPE_AUDIO_MPEGH_LC_L4();
		...
		static JString MIMETYPE_IMAGE_AVIF();
		...
		static JString MIMETYPE_VIDEO_APV();
		...
		static jint PICTURE_TYPE_B();
		static jint PICTURE_TYPE_I();
		static jint PICTURE_TYPE_P();
		static jint PICTURE_TYPE_UNKNOWN();
		...
		static jint VIDEO_ENCODING_STATISTICS_LEVEL_1();
		static jint VIDEO_ENCODING_STATISTICS_LEVEL_NONE();
		...
		jboolean containsFeature(JString arg0) const;
		jboolean containsKey(JString arg0) const;
		java::nio::ByteBuffer getByteBuffer(JString arg0) const;
		java::nio::ByteBuffer getByteBuffer(JString arg0, java::nio::ByteBuffer arg1) const;
		...
		jint getInteger(JString arg0, jint arg1) const;
		JObject getKeys() const;
		jlong getLong(JString arg0) const;
		jlong getLong(JString arg0, jlong arg1) const;
		java::lang::Number getNumber(JString arg0) const;
		java::lang::Number getNumber(JString arg0, java::lang::Number arg1) const;
		JString getString(JString arg0) const;
		JString getString(JString arg0, JString arg1) const;
		jint getValueTypeForKey(JString arg0) const;
		void removeFeature(JString arg0) const;
		void removeKey(JString arg0) const;
