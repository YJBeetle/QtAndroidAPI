...
namespace android::media
{
	...
	public:
		...
		static jint ENCAPSULATION_METADATA_TYPE_SUPPLEMENTARY_AUDIO_PLACEMENT();
		...
		static jint SUCCESS();
		static jint SUPPLEMENTARY_AUDIO_PLACEMENT_LEFT();
		static jint SUPPLEMENTARY_AUDIO_PLACEMENT_NORMAL();
		static jint SUPPLEMENTARY_AUDIO_PLACEMENT_RIGHT();
		...
		JObject getRoutedDevices() const;
