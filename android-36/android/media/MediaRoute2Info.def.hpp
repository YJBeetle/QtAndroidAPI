...
namespace android::media
{
	...
	public:
		...
		static jint SUITABILITY_STATUS_NOT_SUITABLE_FOR_TRANSFER();
		static jint SUITABILITY_STATUS_SUITABLE_FOR_DEFAULT_TRANSFER();
		static jint SUITABILITY_STATUS_SUITABLE_FOR_MANUAL_TRANSFER();
		...
		static jint TYPE_MULTICHANNEL_SPEAKER_GROUP();
		static jint TYPE_REMOTE_AUDIO_VIDEO_RECEIVER();
		static jint TYPE_REMOTE_CAR();
		static jint TYPE_REMOTE_COMPUTER();
		static jint TYPE_REMOTE_GAME_CONSOLE();
		static jint TYPE_REMOTE_SMARTPHONE();
		static jint TYPE_REMOTE_SMARTWATCH();
		static jint TYPE_REMOTE_SPEAKER();
		static jint TYPE_REMOTE_TABLET();
		static jint TYPE_REMOTE_TABLET_DOCKED();
		...
		jint getSuitabilityStatus() const;
		jint getType() const;
