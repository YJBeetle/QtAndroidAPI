...
namespace android::media
{
	...
	// Methods
	inline void MediaCodec_Callback::onCryptoError(android::media::MediaCodec arg0, android::media::MediaCodec_CryptoException arg1) const
	{
		callMethod<void>(
			"onCryptoError",
			"(Landroid/media/MediaCodec;Landroid/media/MediaCodec$CryptoException;)V",
			arg0.object(),
			arg1.object()
		);
	}
	...
	inline void MediaCodec_Callback::onMetricsFlushed(android::media::MediaCodec arg0, android::os::PersistableBundle arg1) const
	{
		callMethod<void>(
			"onMetricsFlushed",
			"(Landroid/media/MediaCodec;Landroid/os/PersistableBundle;)V",
			arg0.object(),
			arg1.object()
		);
	}
	...
	inline void MediaCodec_Callback::onOutputBuffersAvailable(android::media::MediaCodec arg0, jint arg1, java::util::ArrayDeque arg2) const
	{
		callMethod<void>(
			"onOutputBuffersAvailable",
			"(Landroid/media/MediaCodec;ILjava/util/ArrayDeque;)V",
			arg0.object(),
			arg1,
			arg2.object()
		);
