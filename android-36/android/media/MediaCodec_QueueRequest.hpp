...
#include "../../java/util/ArrayDeque.def.hpp"
...
namespace android::media
{
	...
	inline android::media::MediaCodec_QueueRequest MediaCodec_QueueRequest::setMultiFrameEncryptedLinearBlock(android::media::MediaCodec_LinearBlock arg0, java::util::ArrayDeque arg1, java::util::ArrayDeque arg2) const
	{
		return callObjectMethod(
			"setMultiFrameEncryptedLinearBlock",
			"(Landroid/media/MediaCodec$LinearBlock;Ljava/util/ArrayDeque;Ljava/util/ArrayDeque;)Landroid/media/MediaCodec$QueueRequest;",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
	}
	inline android::media::MediaCodec_QueueRequest MediaCodec_QueueRequest::setMultiFrameLinearBlock(android::media::MediaCodec_LinearBlock arg0, java::util::ArrayDeque arg1) const
	{
		return callObjectMethod(
			"setMultiFrameLinearBlock",
			"(Landroid/media/MediaCodec$LinearBlock;Ljava/util/ArrayDeque;)Landroid/media/MediaCodec$QueueRequest;",
			arg0.object(),
			arg1.object()
		);
	}
