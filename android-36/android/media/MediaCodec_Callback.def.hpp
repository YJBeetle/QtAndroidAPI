...
namespace android::media
{
	class MediaCodec_CryptoException;
}
namespace android::media
{
	class MediaFormat;
...
namespace android::media
{
	...
	public:
		...
		MediaCodec_Callback(QJniObject obj) : JObject(obj) {}
		
		// Constructors
		MediaCodec_Callback();
		
		// Methods
		void onCryptoError(android::media::MediaCodec arg0, android::media::MediaCodec_CryptoException arg1) const;
		...
		void onMetricsFlushed(android::media::MediaCodec arg0, android::os::PersistableBundle arg1) const;
		void onOutputBufferAvailable(android::media::MediaCodec arg0, jint arg1, android::media::MediaCodec_BufferInfo arg2) const;
		void onOutputBuffersAvailable(android::media::MediaCodec arg0, jint arg1, java::util::ArrayDeque arg2) const;
