...
namespace android::media
{
	...
	inline jint MediaRoute2Info::SUITABILITY_STATUS_NOT_SUITABLE_FOR_TRANSFER()
	{
		return getStaticField<jint>(
			"android.media.MediaRoute2Info",
	...
	inline jint MediaRoute2Info::SUITABILITY_STATUS_SUITABLE_FOR_DEFAULT_TRANSFER()
	{
		return getStaticField<jint>(
			"android.media.MediaRoute2Info",
	...
	inline jint MediaRoute2Info::SUITABILITY_STATUS_SUITABLE_FOR_MANUAL_TRANSFER()
	{
		return getStaticField<jint>(
			"android.media.MediaRoute2Info",
	...
	inline jint MediaRoute2Info::TYPE_AUX_LINE()
	{
		return getStaticField<jint>(
			"android.media.MediaRoute2Info",
			"TYPE_AUX_LINE"
	...
	inline jint MediaRoute2Info::TYPE_HDMI_ARC()
	{
		return getStaticField<jint>(
			"android.media.MediaRoute2Info",
			"TYPE_HDMI_ARC"
	...
	inline jint MediaRoute2Info::TYPE_HDMI_EARC()
	{
		return getStaticField<jint>(
			"android.media.MediaRoute2Info",
			"TYPE_HDMI_EARC"
	...
	inline jint MediaRoute2Info::TYPE_LINE_ANALOG()
	{
		return getStaticField<jint>(
			"android.media.MediaRoute2Info",
			"TYPE_LINE_ANALOG"
	...
	inline jint MediaRoute2Info::TYPE_LINE_DIGITAL()
	{
		return getStaticField<jint>(
			"android.media.MediaRoute2Info",
			"TYPE_LINE_DIGITAL"
	...
	inline jint MediaRoute2Info::TYPE_MULTICHANNEL_SPEAKER_GROUP()
	{
		return getStaticField<jint>(
			"android.media.MediaRoute2Info",
	...
	inline jint MediaRoute2Info::TYPE_REMOTE_CAR()
	{
		return getStaticField<jint>(
			"android.media.MediaRoute2Info",
			"TYPE_REMOTE_CAR"
	...
	inline jint MediaRoute2Info::TYPE_REMOTE_COMPUTER()
	{
		return getStaticField<jint>(
			"android.media.MediaRoute2Info",
	...
	inline jint MediaRoute2Info::TYPE_REMOTE_GAME_CONSOLE()
	{
		return getStaticField<jint>(
			"android.media.MediaRoute2Info",
	...
	inline jint MediaRoute2Info::TYPE_REMOTE_SMARTPHONE()
	{
		return getStaticField<jint>(
			"android.media.MediaRoute2Info",
	...
	inline jint MediaRoute2Info::TYPE_REMOTE_SMARTWATCH()
	{
		return getStaticField<jint>(
			"android.media.MediaRoute2Info",
	...
	inline jint MediaRoute2Info::TYPE_REMOTE_TABLET()
	{
		return getStaticField<jint>(
			"android.media.MediaRoute2Info",
			"TYPE_REMOTE_TABLET"
	...
	inline jint MediaRoute2Info::TYPE_REMOTE_TABLET_DOCKED()
	{
		return getStaticField<jint>(
			"android.media.MediaRoute2Info",
	...
	inline jint MediaRoute2Info::getSuitabilityStatus() const
	{
		return callMethod<jint>(
