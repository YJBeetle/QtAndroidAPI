...
namespace android::media
{
	...
	public:
		...
		static jint TYPE_BLE_BROADCAST();
		...
		static jint TYPE_MULTICHANNEL_GROUP();
		...
		AudioDeviceInfo(QJniObject obj) : JObject(obj) {}
		...
		JObject getAudioDescriptors() const;
		...
		jint getSpeakerLayoutChannelMask() const;
		jint getType() const;
		jint hashCode() const;
