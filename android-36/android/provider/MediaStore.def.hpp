...
namespace android::provider
{
	...
	public:
		// Fields
		static JString ACCESS_MEDIA_OWNER_PACKAGE_NAME_PERMISSION();
		static JString ACCESS_OEM_METADATA_PERMISSION();
		static JString ACTION_IMAGE_CAPTURE();
		static JString ACTION_IMAGE_CAPTURE_SECURE();
		static JString ACTION_MOTION_PHOTO_CAPTURE();
		static JString ACTION_MOTION_PHOTO_CAPTURE_SECURE();
		...
		static JString EXTRA_PICKER_PRE_SELECTION_URIS();
		static JString EXTRA_PICK_IMAGES_ACCENT_COLOR();
		static JString EXTRA_PICK_IMAGES_IN_ORDER();
		static JString EXTRA_PICK_IMAGES_LAUNCH_TAB();
		...
		MediaStore(QJniObject obj) : JObject(obj) {}
		...
		static void markIsFavoriteStatus(android::content::ContentResolver arg0, JObject arg1, jboolean arg2);
		static void notifyCloudMediaChangedEvent(android::content::ContentResolver arg0, JString arg1, JString arg2);
		static android::content::res::AssetFileDescriptor openAssetFileDescriptor(android::content::ContentResolver arg0, android::net::Uri arg1, JString arg2, android::os::CancellationSignal arg3);
		static android::os::ParcelFileDescriptor openFileDescriptor(android::content::ContentResolver arg0, android::net::Uri arg1, JString arg2, android::os::CancellationSignal arg3);
		static android::content::res::AssetFileDescriptor openTypedAssetFileDescriptor(android::content::ContentResolver arg0, android::net::Uri arg1, JString arg2, android::os::Bundle arg3, android::os::CancellationSignal arg4);
