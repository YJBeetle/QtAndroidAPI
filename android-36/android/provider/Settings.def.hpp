...
namespace android::provider
{
	...
	public:
		...
		static JString ACTION_ADVANCED_MEMORY_PROTECTION_SETTINGS();
		static JString ACTION_AIRPLANE_MODE_SETTINGS();
		static JString ACTION_ALL_APPS_NOTIFICATION_SETTINGS();
		...
		static JString ACTION_APP_LOCALE_SETTINGS();
		static JString ACTION_APP_NOTIFICATION_BUBBLE_SETTINGS();
		static JString ACTION_APP_NOTIFICATION_PROMOTION_SETTINGS();
		...
		static JString ACTION_AUTOMATIC_ZEN_RULE_SETTINGS();
		...
		static JString ACTION_CREDENTIAL_PROVIDER();
		...
		static JString ACTION_FIRST_DAY_OF_WEEK_SETTINGS();
		...
		static JString ACTION_TEMPERATURE_UNIT_SETTINGS();
		...
		static JString EXTRA_SUPERVISOR_RESTRICTED_SETTING_KEY();
		...
		static jint SUPERVISOR_VERIFICATION_SETTING_BIOMETRICS();
		static jint SUPERVISOR_VERIFICATION_SETTING_UNKNOWN();
