...
namespace android::provider
{
	...
	inline android::provider::CloudMediaProviderContract_Capabilities CloudMediaProvider::onGetCapabilities() const
	{
		return callObjectMethod(
			"onGetCapabilities",
	...
	inline JObject CloudMediaProvider::onQueryMediaCategories(JString arg0, android::os::Bundle arg1, android::os::CancellationSignal arg2) const
	{
		return callObjectMethod(
			"onQueryMediaCategories",
			"(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Landroid/database/Cursor;",
			arg0.object<jstring>(),
			arg1.object(),
			arg2.object()
		);
	}
	inline JObject CloudMediaProvider::onQueryMediaInMediaSet(JString arg0, android::os::Bundle arg1, android::os::CancellationSignal arg2) const
	{
		return callObjectMethod(
	...
	inline JObject CloudMediaProvider::onQueryMediaSets(JString arg0, android::os::Bundle arg1, android::os::CancellationSignal arg2) const
	{
		return callObjectMethod(
			"onQueryMediaSets",
			"(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Landroid/database/Cursor;",
	...
	inline JObject CloudMediaProvider::onQuerySearchSuggestions(JString arg0, android::os::Bundle arg1, android::os::CancellationSignal arg2) const
	{
		return callObjectMethod(
	...
	inline JObject CloudMediaProvider::onSearchMedia(JString arg0, android::os::Bundle arg1, android::os::CancellationSignal arg2) const
	{
		return callObjectMethod(
			"onSearchMedia",
			"(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Landroid/database/Cursor;",
	...
	inline JObject CloudMediaProvider::onSearchMedia(JString arg0, JString arg1, android::os::Bundle arg2, android::os::CancellationSignal arg3) const
	{
		return callObjectMethod(
			"onSearchMedia",
