...
{
	// Fields
	inline JString MediaStore::ACCESS_MEDIA_OWNER_PACKAGE_NAME_PERMISSION()
	{
	...
	inline JString MediaStore::ACCESS_OEM_METADATA_PERMISSION()
	{
		return getStaticObjectField(
			"android.provider.MediaStore",
	...
	inline JString MediaStore::ACTION_MOTION_PHOTO_CAPTURE()
	{
		return getStaticObjectField(
			"android.provider.MediaStore",
	...
	inline JString MediaStore::ACTION_MOTION_PHOTO_CAPTURE_SECURE()
	{
		return getStaticObjectField(
			"android.provider.MediaStore",
	...
	inline JString MediaStore::ACTION_PICK_IMAGES()
	{
		return getStaticObjectField(
			"android.provider.MediaStore",
			"ACTION_PICK_IMAGES",
	...
	inline JString MediaStore::ACTION_PICK_IMAGES_SETTINGS()
	{
		return getStaticObjectField(
			"android.provider.MediaStore",
	...
	inline JString MediaStore::EXTRA_ACCEPT_ORIGINAL_MEDIA_FORMAT()
	{
		return getStaticObjectField(
			"android.provider.MediaStore",
	...
	inline JString MediaStore::EXTRA_MEDIA_CAPABILITIES()
	{
		return getStaticObjectField(
			"android.provider.MediaStore",
	...
	inline JString MediaStore::EXTRA_MEDIA_CAPABILITIES_UID()
	{
		return getStaticObjectField(
			"android.provider.MediaStore",
	...
	inline JString MediaStore::EXTRA_PICKER_PRE_SELECTION_URIS()
	{
		return getStaticObjectField(
			"android.provider.MediaStore",
	...
	inline JString MediaStore::EXTRA_PICK_IMAGES_ACCENT_COLOR()
	{
		return getStaticObjectField(
			"android.provider.MediaStore",
	...
	inline JString MediaStore::EXTRA_PICK_IMAGES_IN_ORDER()
	{
		return getStaticObjectField(
			"android.provider.MediaStore",
	...
	inline JString MediaStore::EXTRA_PICK_IMAGES_LAUNCH_TAB()
	{
		return getStaticObjectField(
			"android.provider.MediaStore",
	...
	inline JString MediaStore::EXTRA_PICK_IMAGES_MAX()
	{
		return getStaticObjectField(
			"android.provider.MediaStore",
	...
	inline jint MediaStore::PICK_IMAGES_TAB_ALBUMS()
	{
		return getStaticField<jint>(
			"android.provider.MediaStore",
	...
	inline jint MediaStore::PICK_IMAGES_TAB_IMAGES()
	{
		return getStaticField<jint>(
			"android.provider.MediaStore",
	...
	inline JString MediaStore::QUERY_ARG_INCLUDE_RECENTLY_UNMOUNTED_VOLUMES()
	{
		return getStaticObjectField(
			"android.provider.MediaStore",
	...
	inline JString MediaStore::QUERY_ARG_LATEST_SELECTION_ONLY()
	{
		return getStaticObjectField(
			"android.provider.MediaStore",
	...
	inline JString MediaStore::QUERY_ARG_MEDIA_STANDARD_SORT_ORDER()
	{
		return getStaticObjectField(
			"android.provider.MediaStore",
	...
	// Methods
	inline jboolean MediaStore::canManageMedia(android::content::Context arg0)
	{
	...
	inline android::os::ParcelFileDescriptor MediaStore::getOriginalMediaFormatFileDescriptor(android::content::Context arg0, android::os::ParcelFileDescriptor arg1)
	{
		return callStaticObjectMethod(
			"android.provider.MediaStore",
			"getOriginalMediaFormatFileDescriptor",
			"(Landroid/content/Context;Landroid/os/ParcelFileDescriptor;)Landroid/os/ParcelFileDescriptor;",
			arg0.object(),
			arg1.object()
		);
	}
	inline jint MediaStore::getPickImagesMaxLimit()
	{
	...
	inline android::net::Uri MediaStore::getRedactedUri(android::content::ContentResolver arg0, android::net::Uri arg1)
	{
		return callStaticObjectMethod(
			"android.provider.MediaStore",
			"getRedactedUri",
	...
	inline JObject MediaStore::getRedactedUri(android::content::ContentResolver arg0, JObject arg1)
	{
		return callStaticObjectMethod(
			"android.provider.MediaStore",
			"getRedactedUri",
			"(Landroid/content/ContentResolver;Ljava/util/List;)Ljava/util/List;",
			arg0.object(),
			arg1.object()
		);
	}
	...
	inline jboolean MediaStore::isCurrentCloudMediaProviderAuthority(android::content::ContentResolver arg0, JString arg1)
	{
		return callStaticMethod<jboolean>(
			"android.provider.MediaStore",
	...
	inline jboolean MediaStore::isCurrentSystemGallery(android::content::ContentResolver arg0, jint arg1, JString arg2)
	{
		return callStaticMethod<jboolean>(
			"android.provider.MediaStore",
			"isCurrentSystemGallery",
			"(Landroid/content/ContentResolver;ILjava/lang/String;)Z",
			arg0.object(),
			arg1,
			arg2.object<jstring>()
		);
	}
	inline jboolean MediaStore::isSupportedCloudMediaProviderAuthority(android::content::ContentResolver arg0, JString arg1)
	{
		return callStaticMethod<jboolean>(
			"android.provider.MediaStore",
	...
	inline void MediaStore::markIsFavoriteStatus(android::content::ContentResolver arg0, JObject arg1, jboolean arg2)
	{
		callStaticMethod<void>(
			"android.provider.MediaStore",
			"markIsFavoriteStatus",
			"(Landroid/content/ContentResolver;Ljava/util/Collection;Z)V",
			arg0.object(),
			arg1.object(),
			arg2
		);
	}
	inline void MediaStore::notifyCloudMediaChangedEvent(android::content::ContentResolver arg0, JString arg1, JString arg2)
	{
		callStaticMethod<void>(
			"android.provider.MediaStore",
	...
	inline android::content::res::AssetFileDescriptor MediaStore::openAssetFileDescriptor(android::content::ContentResolver arg0, android::net::Uri arg1, JString arg2, android::os::CancellationSignal arg3)
	{
		return callStaticObjectMethod(
			"android.provider.MediaStore",
			"openAssetFileDescriptor",
			"(Landroid/content/ContentResolver;Landroid/net/Uri;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/content/res/AssetFileDescriptor;",
			arg0.object(),
			arg1.object(),
			arg2.object<jstring>(),
			arg3.object()
	...
	inline android::os::ParcelFileDescriptor MediaStore::openFileDescriptor(android::content::ContentResolver arg0, android::net::Uri arg1, JString arg2, android::os::CancellationSignal arg3)
	{
		return callStaticObjectMethod(
			"android.provider.MediaStore",
			"openFileDescriptor",
			"(Landroid/content/ContentResolver;Landroid/net/Uri;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/os/ParcelFileDescriptor;",
			arg0.object(),
			arg1.object(),
			arg2.object<jstring>(),
			arg3.object()
	...
	inline android::content::res::AssetFileDescriptor MediaStore::openTypedAssetFileDescriptor(android::content::ContentResolver arg0, android::net::Uri arg1, JString arg2, android::os::Bundle arg3, android::os::CancellationSignal arg4)
	{
		return callStaticObjectMethod(
			"android.provider.MediaStore",
			"openTypedAssetFileDescriptor",
			"(Landroid/content/ContentResolver;Landroid/net/Uri;Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Landroid/content/res/AssetFileDescriptor;",
			arg0.object(),
			arg1.object(),
			arg2.object<jstring>(),
			arg3.object(),
