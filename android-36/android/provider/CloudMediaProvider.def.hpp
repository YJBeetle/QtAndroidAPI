...
namespace android::provider
{
	...
	public:
		...
		CloudMediaProvider(QJniObject obj) : android::content::ContentProvider(obj) {}
		...
		android::provider::CloudMediaProviderContract_Capabilities onGetCapabilities() const;
		...
		JObject onQueryMediaCategories(JString arg0, android::os::Bundle arg1, android::os::CancellationSignal arg2) const;
		JObject onQueryMediaInMediaSet(JString arg0, android::os::Bundle arg1, android::os::CancellationSignal arg2) const;
		JObject onQueryMediaSets(JString arg0, android::os::Bundle arg1, android::os::CancellationSignal arg2) const;
		JObject onQuerySearchSuggestions(JString arg0, android::os::Bundle arg1, android::os::CancellationSignal arg2) const;
		JObject onSearchMedia(JString arg0, android::os::Bundle arg1, android::os::CancellationSignal arg2) const;
		JObject onSearchMedia(JString arg0, JString arg1, android::os::Bundle arg2, android::os::CancellationSignal arg3) const;
