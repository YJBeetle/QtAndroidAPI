...
namespace android::provider
{
	...
	inline android::os::Bundle DocumentsProvider::getDocumentMetadata(JString arg0) const
	{
		return callObjectMethod(
			"getDocumentMetadata",
	...
	inline JString DocumentsProvider::getTypeAnonymous(android::net::Uri arg0) const
	{
		return callObjectMethod(
			"getTypeAnonymous",
			"(Landroid/net/Uri;)Ljava/lang/String;",
	...
	inline JObject DocumentsProvider::queryRecentDocuments(JString arg0, JArray arg1, android::os::Bundle arg2, android::os::CancellationSignal arg3) const
	{
		return callObjectMethod(
			"queryRecentDocuments",
	...
	inline JObject DocumentsProvider::querySearchDocuments(JString arg0, JArray arg1, android::os::Bundle arg2) const
	{
		return callObjectMethod(
