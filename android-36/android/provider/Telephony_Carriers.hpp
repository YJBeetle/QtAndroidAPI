...
{
	// Fields
	inline JString Telephony_Carriers::ALWAYS_ON()
	{
	...
	inline JString Telephony_Carriers::MTU_V4()
	{
		return getStaticObjectField(
			"android.provider.Telephony$Carriers",
			"MTU_V4",
	...
	inline JString Telephony_Carriers::MTU_V6()
	{
		return getStaticObjectField(
			"android.provider.Telephony$Carriers",
			"MTU_V6",
	...
	inline JString Telephony_Carriers::USER_EDITABLE()
	{
		return getStaticObjectField(
			"android.provider.Telephony$Carriers",
			"USER_EDITABLE",
	...
	inline JString Telephony_Carriers::USER_VISIBLE()
	{
		return getStaticObjectField(
			"android.provider.Telephony$Carriers",
			"USER_VISIBLE",
