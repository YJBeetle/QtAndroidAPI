...
namespace android::hardware::usb
{
	...
	public:
		...
		UsbManager(QJniObject obj) : JObject(obj) {}
		...
		java::io::InputStream openAccessoryInputStream(android::hardware::usb::UsbAccessory arg0) const;
		java::io::OutputStream openAccessoryOutputStream(android::hardware::usb::UsbAccessory arg0) const;
