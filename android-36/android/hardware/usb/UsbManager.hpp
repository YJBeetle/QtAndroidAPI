...
namespace android::hardware::usb
{
	...
	inline java::io::InputStream UsbManager::openAccessoryInputStream(android::hardware::usb::UsbAccessory arg0) const
	{
		return callObjectMethod(
			"openAccessoryInputStream",
			"(Landroid/hardware/usb/UsbAccessory;)Ljava/io/InputStream;",
			arg0.object()
		);
	}
	inline java::io::OutputStream UsbManager::openAccessoryOutputStream(android::hardware::usb::UsbAccessory arg0) const
	{
		return callObjectMethod(
			"openAccessoryOutputStream",
			"(Landroid/hardware/usb/UsbAccessory;)Ljava/io/OutputStream;",
			arg0.object()
		);
	}
