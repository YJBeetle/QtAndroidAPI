...
namespace android::hardware::camera2
{
	...
	public:
		// Fields
		static android::hardware::camera2::CameraCharacteristics_Key AUTOMOTIVE_LENS_FACING();
		static android::hardware::camera2::CameraCharacteristics_Key AUTOMOTIVE_LOCATION();
		static android::hardware::camera2::CameraCharacteristics_Key COLOR_CORRECTION_AVAILABLE_ABERRATION_MODES();
		static android::hardware::camera2::CameraCharacteristics_Key COLOR_CORRECTION_AVAILABLE_MODES();
		static android::hardware::camera2::CameraCharacteristics_Key COLOR_CORRECTION_COLOR_TEMPERATURE_RANGE();
		...
		static android::hardware::camera2::CameraCharacteristics_Key CONTROL_AE_AVAILABLE_PRIORITY_MODES();
		...
		static android::hardware::camera2::CameraCharacteristics_Key CONTROL_AUTOFRAMING_AVAILABLE();
		...
		static android::hardware::camera2::CameraCharacteristics_Key CONTROL_AVAILABLE_SETTINGS_OVERRIDES();
		...
		static android::hardware::camera2::CameraCharacteristics_Key CONTROL_LOW_LIGHT_BOOST_INFO_LUMINANCE_RANGE();
		...
		static android::hardware::camera2::CameraCharacteristics_Key FLASH_INFO_STRENGTH_DEFAULT_LEVEL();
		static android::hardware::camera2::CameraCharacteristics_Key FLASH_INFO_STRENGTH_MAXIMUM_LEVEL();
		static android::hardware::camera2::CameraCharacteristics_Key FLASH_SINGLE_STRENGTH_DEFAULT_LEVEL();
		static android::hardware::camera2::CameraCharacteristics_Key FLASH_SINGLE_STRENGTH_MAX_LEVEL();
		static android::hardware::camera2::CameraCharacteristics_Key FLASH_TORCH_STRENGTH_DEFAULT_LEVEL();
		static android::hardware::camera2::CameraCharacteristics_Key FLASH_TORCH_STRENGTH_MAX_LEVEL();
		static android::hardware::camera2::CameraCharacteristics_Key HOT_PIXEL_AVAILABLE_HOT_PIXEL_MODES();
		static android::hardware::camera2::CameraCharacteristics_Key INFO_DEVICE_STATE_SENSOR_ORIENTATION_MAP();
		static android::hardware::camera2::CameraCharacteristics_Key INFO_SESSION_CONFIGURATION_QUERY_VERSION();
		...
		static android::hardware::camera2::CameraCharacteristics_Key LENS_DISTORTION_MAXIMUM_RESOLUTION();
		...
		static android::hardware::camera2::CameraCharacteristics_Key LENS_INTRINSIC_CALIBRATION_MAXIMUM_RESOLUTION();
		...
		static android::hardware::camera2::CameraCharacteristics_Key REQUEST_AVAILABLE_COLOR_SPACE_PROFILES();
		static android::hardware::camera2::CameraCharacteristics_Key REQUEST_AVAILABLE_DYNAMIC_RANGE_PROFILES();
		...
		static android::hardware::camera2::CameraCharacteristics_Key REQUEST_RECOMMENDED_TEN_BIT_DYNAMIC_RANGE_PROFILE();
		static android::hardware::camera2::CameraCharacteristics_Key SCALER_AVAILABLE_MAX_DIGITAL_ZOOM();
		static android::hardware::camera2::CameraCharacteristics_Key SCALER_AVAILABLE_ROTATE_AND_CROP_MODES();
		static android::hardware::camera2::CameraCharacteristics_Key SCALER_AVAILABLE_STREAM_USE_CASES();
		static android::hardware::camera2::CameraCharacteristics_Key SCALER_CROPPING_TYPE();
		static android::hardware::camera2::CameraCharacteristics_Key SCALER_DEFAULT_SECURE_IMAGE_SIZE();
		static android::hardware::camera2::CameraCharacteristics_Key SCALER_MANDATORY_CONCURRENT_STREAM_COMBINATIONS();
		static android::hardware::camera2::CameraCharacteristics_Key SCALER_MANDATORY_MAXIMUM_RESOLUTION_STREAM_COMBINATIONS();
		static android::hardware::camera2::CameraCharacteristics_Key SCALER_MANDATORY_PREVIEW_STABILIZATION_OUTPUT_STREAM_COMBINATIONS();
		static android::hardware::camera2::CameraCharacteristics_Key SCALER_MANDATORY_STREAM_COMBINATIONS();
		static android::hardware::camera2::CameraCharacteristics_Key SCALER_MANDATORY_TEN_BIT_OUTPUT_STREAM_COMBINATIONS();
		static android::hardware::camera2::CameraCharacteristics_Key SCALER_MANDATORY_USE_CASE_STREAM_COMBINATIONS();
		static android::hardware::camera2::CameraCharacteristics_Key SCALER_MULTI_RESOLUTION_STREAM_CONFIGURATION_MAP();
		static android::hardware::camera2::CameraCharacteristics_Key SCALER_STREAM_CONFIGURATION_MAP();
		static android::hardware::camera2::CameraCharacteristics_Key SCALER_STREAM_CONFIGURATION_MAP_MAXIMUM_RESOLUTION();
		...
		static android::hardware::camera2::CameraCharacteristics_Key SENSOR_INFO_ACTIVE_ARRAY_SIZE_MAXIMUM_RESOLUTION();
		static android::hardware::camera2::CameraCharacteristics_Key SENSOR_INFO_BINNING_FACTOR();
		...
		static android::hardware::camera2::CameraCharacteristics_Key SENSOR_INFO_PIXEL_ARRAY_SIZE_MAXIMUM_RESOLUTION();
		static android::hardware::camera2::CameraCharacteristics_Key SENSOR_INFO_PRE_CORRECTION_ACTIVE_ARRAY_SIZE();
		static android::hardware::camera2::CameraCharacteristics_Key SENSOR_INFO_PRE_CORRECTION_ACTIVE_ARRAY_SIZE_MAXIMUM_RESOLUTION();
		...
		static android::hardware::camera2::CameraCharacteristics_Key SENSOR_READOUT_TIMESTAMP();
		...
		CameraCharacteristics(QJniObject obj) : android::hardware::camera2::CameraMetadata(obj) {}
		...
		JObject getAvailableSessionCharacteristicsKeys() const;
