...
namespace android::hardware::camera2
{
	...
	public:
		...
		static android::hardware::camera2::CaptureRequest_Key COLOR_CORRECTION_COLOR_TEMPERATURE();
		static android::hardware::camera2::CaptureRequest_Key COLOR_CORRECTION_COLOR_TINT();
		...
		static android::hardware::camera2::CaptureRequest_Key CONTROL_AE_PRIORITY_MODE();
		...
		static android::hardware::camera2::CaptureRequest_Key CONTROL_AUTOFRAMING();
		...
		static android::hardware::camera2::CaptureRequest_Key CONTROL_EXTENDED_SCENE_MODE();
		...
		static android::hardware::camera2::CaptureRequest_Key CONTROL_SETTINGS_OVERRIDE();
		static android::hardware::camera2::CaptureRequest_Key CONTROL_VIDEO_STABILIZATION_MODE();
		static android::hardware::camera2::CaptureRequest_Key CONTROL_ZOOM_METHOD();
		static android::hardware::camera2::CaptureRequest_Key CONTROL_ZOOM_RATIO();
		...
		static android::hardware::camera2::CaptureRequest_Key EXTENSION_STRENGTH();
		static android::hardware::camera2::CaptureRequest_Key FLASH_MODE();
		static android::hardware::camera2::CaptureRequest_Key FLASH_STRENGTH_LEVEL();
		...
		static android::hardware::camera2::CaptureRequest_Key SCALER_ROTATE_AND_CROP();
		...
		static android::hardware::camera2::CaptureRequest_Key SENSOR_PIXEL_MODE();
		...
		CaptureRequest(QJniObject obj) : android::hardware::camera2::CameraMetadata(obj) {}
