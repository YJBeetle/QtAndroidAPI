...
namespace android::hardware::camera2
{
	...
	public:
		...
		static jint COLOR_CORRECTION_MODE_CCT();
		...
		static jint CONTROL_AE_MODE_ON_LOW_LIGHT_BOOST_BRIGHTNESS_PRIORITY();
		...
		static jint CONTROL_AE_PRIORITY_MODE_OFF();
		static jint CONTROL_AE_PRIORITY_MODE_SENSOR_EXPOSURE_TIME_PRIORITY();
		static jint CONTROL_AE_PRIORITY_MODE_SENSOR_SENSITIVITY_PRIORITY();
		...
		static jint CONTROL_LOW_LIGHT_BOOST_STATE_ACTIVE();
		static jint CONTROL_LOW_LIGHT_BOOST_STATE_INACTIVE();
		...
		static jint CONTROL_ZOOM_METHOD_AUTO();
		static jint CONTROL_ZOOM_METHOD_ZOOM_RATIO();
		...
		static jint EXTENSION_NIGHT_MODE_INDICATOR_OFF();
		static jint EXTENSION_NIGHT_MODE_INDICATOR_ON();
		static jint EXTENSION_NIGHT_MODE_INDICATOR_UNKNOWN();
