...
namespace android::hardware::camera2
{
	...
	public:
		...
		static android::hardware::camera2::CaptureResult_Key COLOR_CORRECTION_COLOR_TEMPERATURE();
		static android::hardware::camera2::CaptureResult_Key COLOR_CORRECTION_COLOR_TINT();
		...
		static android::hardware::camera2::CaptureResult_Key CONTROL_AE_PRIORITY_MODE();
		...
		static android::hardware::camera2::CaptureResult_Key CONTROL_AUTOFRAMING();
		static android::hardware::camera2::CaptureResult_Key CONTROL_AUTOFRAMING_STATE();
		...
		static android::hardware::camera2::CaptureResult_Key CONTROL_EXTENDED_SCENE_MODE();
		static android::hardware::camera2::CaptureResult_Key CONTROL_LOW_LIGHT_BOOST_STATE();
		...
		static android::hardware::camera2::CaptureResult_Key CONTROL_SETTINGS_OVERRIDE();
		static android::hardware::camera2::CaptureResult_Key CONTROL_VIDEO_STABILIZATION_MODE();
		static android::hardware::camera2::CaptureResult_Key CONTROL_ZOOM_METHOD();
		static android::hardware::camera2::CaptureResult_Key CONTROL_ZOOM_RATIO();
		...
		static android::hardware::camera2::CaptureResult_Key EXTENSION_CURRENT_TYPE();
		static android::hardware::camera2::CaptureResult_Key EXTENSION_NIGHT_MODE_INDICATOR();
		static android::hardware::camera2::CaptureResult_Key EXTENSION_STRENGTH();
		...
		static android::hardware::camera2::CaptureResult_Key FLASH_STRENGTH_LEVEL();
		...
		static android::hardware::camera2::CaptureResult_Key LOGICAL_MULTI_CAMERA_ACTIVE_PHYSICAL_ID();
		static android::hardware::camera2::CaptureResult_Key LOGICAL_MULTI_CAMERA_ACTIVE_PHYSICAL_SENSOR_CROP_REGION();
		...
		static android::hardware::camera2::CaptureResult_Key SCALER_RAW_CROP_REGION();
		static android::hardware::camera2::CaptureResult_Key SCALER_ROTATE_AND_CROP();
		...
		static android::hardware::camera2::CaptureResult_Key SENSOR_PIXEL_MODE();
		static android::hardware::camera2::CaptureResult_Key SENSOR_RAW_BINNING_FACTOR_USED();
		...
		static android::hardware::camera2::CaptureResult_Key STATISTICS_LENS_INTRINSICS_SAMPLES();
		...
		CaptureResult(QJniObject obj) : android::hardware::camera2::CameraMetadata(obj) {}
