...
namespace android::hardware::camera2
{
	...
	inline android::hardware::camera2::CameraDevice_CameraDeviceSetup CameraManager::getCameraDeviceSetup(JString arg0) const
	{
		return callObjectMethod(
			"getCameraDeviceSetup",
			"(Ljava/lang/String;)Landroid/hardware/camera2/CameraDevice$CameraDeviceSetup;",
			arg0.object<jstring>()
		);
	}
	...
	inline jint CameraManager::getTorchStrengthLevel(JString arg0) const
	{
	...
	inline jboolean CameraManager::isCameraDeviceSetupSupported(JString arg0) const
	{
	...
	inline void CameraManager::turnOnTorchWithStrengthLevel(JString arg0, jint arg1) const
	{
		callMethod<void>(
