...
namespace android::hardware::camera2::params
{
	...
	public:
		...
		OutputConfiguration(jint arg0, android::util::Size arg1);
		OutputConfiguration(jint arg0, android::view::Surface arg1);
		OutputConfiguration(jint arg0, android::util::Size arg1, jlong arg2);
		OutputConfiguration(jint arg0, jint arg1, android::util::Size arg2);
		OutputConfiguration(jint arg0, jint arg1, android::util::Size arg2, jlong arg3);
		
		// Methods
		static JObject createInstancesForMultiResolutionOutput(android::hardware::camera2::MultiResolutionImageReader arg0);
		static JObject createInstancesForMultiResolutionOutput(JObject arg0, jint arg1);
		static void setSurfacesForMultiResolutionOutput(JObject arg0, android::hardware::camera2::MultiResolutionImageReader arg1);
		...
		jint getMirrorMode(android::view::Surface arg0) const;
		...
		jint hashCode() const;
		jboolean isReadoutTimestampEnabled() const;
		...
		void setMirrorMode(android::view::Surface arg0, jint arg1) const;
		void setPhysicalCameraId(JString arg0) const;
		void setReadoutTimestampEnabled(jboolean arg0) const;
