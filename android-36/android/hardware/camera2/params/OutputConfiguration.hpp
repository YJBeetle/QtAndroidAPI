...
namespace android::hardware::camera2::params
{
	...
	inline OutputConfiguration::OutputConfiguration(jint arg0, android::util::Size arg1)
		: JObject(
			"android.hardware.camera2.params.OutputConfiguration",
	...
	inline OutputConfiguration::OutputConfiguration(jint arg0, android::util::Size arg1, jlong arg2)
		: JObject(
			"android.hardware.camera2.params.OutputConfiguration",
			"(ILandroid/util/Size;J)V",
			arg0,
			arg1.object(),
			arg2
		) {}
	inline OutputConfiguration::OutputConfiguration(jint arg0, jint arg1, android::util::Size arg2)
		: JObject(
			"android.hardware.camera2.params.OutputConfiguration",
			"(IILandroid/util/Size;)V",
			arg0,
			arg1,
			arg2.object()
		) {}
	inline OutputConfiguration::OutputConfiguration(jint arg0, jint arg1, android::util::Size arg2, jlong arg3)
		: JObject(
			"android.hardware.camera2.params.OutputConfiguration",
			"(IILandroid/util/Size;J)V",
			arg0,
			arg1,
			arg2.object(),
			arg3
	...
	inline JObject OutputConfiguration::createInstancesForMultiResolutionOutput(JObject arg0, jint arg1)
	{
		return callStaticObjectMethod(
			"android.hardware.camera2.params.OutputConfiguration",
			"createInstancesForMultiResolutionOutput",
			"(Ljava/util/Collection;I)Ljava/util/List;",
			arg0.object(),
			arg1
		);
	}
	inline void OutputConfiguration::setSurfacesForMultiResolutionOutput(JObject arg0, android::hardware::camera2::MultiResolutionImageReader arg1)
	{
		callStaticMethod<void>(
			"android.hardware.camera2.params.OutputConfiguration",
			"setSurfacesForMultiResolutionOutput",
			"(Ljava/util/Collection;Landroid/hardware/camera2/MultiResolutionImageReader;)V",
			arg0.object(),
			arg1.object()
		);
	}
	...
	inline jint OutputConfiguration::getMirrorMode(android::view::Surface arg0) const
	{
		return callMethod<jint>(
			"getMirrorMode",
	...
	inline void OutputConfiguration::setMirrorMode(android::view::Surface arg0, jint arg1) const
	{
		callMethod<void>(
			"setMirrorMode",
