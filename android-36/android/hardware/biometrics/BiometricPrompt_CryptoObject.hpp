...
#include "../../security/identity/PresentationSession.def.hpp"
...
namespace android::hardware::biometrics
{
	...
	inline BiometricPrompt_CryptoObject::BiometricPrompt_CryptoObject(android::security::identity::PresentationSession arg0)
		: JObject(
			"android.hardware.biometrics.BiometricPrompt$CryptoObject",
			"(Landroid/security/identity/PresentationSession;)V",
			arg0.object()
		) {}
	...
	inline BiometricPrompt_CryptoObject::BiometricPrompt_CryptoObject(jlong arg0)
		: JObject(
			"android.hardware.biometrics.BiometricPrompt$CryptoObject",
			"(J)V",
			arg0
	...
	inline jlong BiometricPrompt_CryptoObject::getOperationHandle() const
	{
	...
	inline android::security::identity::PresentationSession BiometricPrompt_CryptoObject::getPresentationSession() const
	{
		return callObjectMethod(
			"getPresentationSession",
			"()Landroid/security/identity/PresentationSession;"
		);
	}
