...
namespace android::hardware
{
	...
	public:
		...
		static JString STRING_TYPE_ACCELEROMETER_LIMITED_AXES();
		static JString STRING_TYPE_ACCELEROMETER_LIMITED_AXES_UNCALIBRATED();
		...
		static JString STRING_TYPE_GYROSCOPE_LIMITED_AXES();
		static JString STRING_TYPE_GYROSCOPE_LIMITED_AXES_UNCALIBRATED();
		static JString STRING_TYPE_GYROSCOPE_UNCALIBRATED();
		static JString STRING_TYPE_HEADING();
		static JString STRING_TYPE_HEAD_TRACKER();
		...
		static jint TYPE_ACCELEROMETER_LIMITED_AXES();
		static jint TYPE_ACCELEROMETER_LIMITED_AXES_UNCALIBRATED();
		...
		static jint TYPE_GYROSCOPE_LIMITED_AXES();
		static jint TYPE_GYROSCOPE_LIMITED_AXES_UNCALIBRATED();
		static jint TYPE_GYROSCOPE_UNCALIBRATED();
		static jint TYPE_HEADING();
		static jint TYPE_HEAD_TRACKER();
		...
		Sensor(QJniObject obj) : JObject(obj) {}
