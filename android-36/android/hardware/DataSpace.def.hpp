...
namespace android::hardware
{
	...
	public:
		...
		static jint DATASPACE_BT2020_HLG();
		...
		static jint DATASPACE_DEPTH();
		static jint DATASPACE_DISPLAY_P3();
		static jint DATASPACE_DYNAMIC_DEPTH();
		static jint DATASPACE_HEIF();
		static jint DATASPACE_HEIF_ULTRAHDR();
		static jint DATASPACE_JFIF();
		static jint DATASPACE_JPEG_R();
		...
		DataSpace(QJniObject obj) : JObject(obj) {}
