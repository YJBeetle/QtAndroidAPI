...
namespace android::hardware::display
{
	...
	public:
		...
		android::hardware::display::VirtualDisplayConfig_Builder setBrightnessListener(JObject arg0, JObject arg1) const;
		android::hardware::display::VirtualDisplayConfig_Builder setDefaultBrightness(jfloat arg0) const;
		android::hardware::display::VirtualDisplayConfig_Builder setDimBrightness(jfloat arg0) const;
