...
namespace android::hardware::display
{
	...
	inline jlong DisplayManager::EVENT_TYPE_DISPLAY_ADDED()
	{
	...
	inline jlong DisplayManager::EVENT_TYPE_DISPLAY_CHANGED()
	{
		return getStaticField<jlong>(
			"android.hardware.display.DisplayManager",
	...
	inline jlong DisplayManager::EVENT_TYPE_DISPLAY_REFRESH_RATE()
	{
		return getStaticField<jlong>(
			"android.hardware.display.DisplayManager",
	...
	inline jlong DisplayManager::EVENT_TYPE_DISPLAY_REMOVED()
	{
		return getStaticField<jlong>(
			"android.hardware.display.DisplayManager",
	...
	inline jlong DisplayManager::EVENT_TYPE_DISPLAY_STATE()
	{
		return getStaticField<jlong>(
			"android.hardware.display.DisplayManager",
	...
	// Methods
	inline android::hardware::display::VirtualDisplay DisplayManager::createVirtualDisplay(android::hardware::display::VirtualDisplayConfig arg0) const
	{
		return callObjectMethod(
			"createVirtualDisplay",
			"(Landroid/hardware/display/VirtualDisplayConfig;)Landroid/hardware/display/VirtualDisplay;",
			arg0.object()
		);
	}
	inline android::hardware::display::VirtualDisplay DisplayManager::createVirtualDisplay(android::hardware::display::VirtualDisplayConfig arg0, android::os::Handler arg1, android::hardware::display::VirtualDisplay_Callback arg2) const
	{
		return callObjectMethod(
			"createVirtualDisplay",
			"(Landroid/hardware/display/VirtualDisplayConfig;Landroid/os/Handler;Landroid/hardware/display/VirtualDisplay$Callback;)Landroid/hardware/display/VirtualDisplay;",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
	...
	inline android::hardware::display::HdrConversionMode DisplayManager::getHdrConversionMode() const
	{
		return callObjectMethod(
	...
	inline void DisplayManager::registerDisplayListener(JObject arg0, jlong arg1, JObject arg2) const
	{
		callMethod<void>(
			"registerDisplayListener",
			"(Ljava/util/concurrent/Executor;JLandroid/hardware/display/DisplayManager$DisplayListener;)V",
			arg0.object(),
			arg1,
			arg2.object()
		);
