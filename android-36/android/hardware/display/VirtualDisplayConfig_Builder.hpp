...
namespace android::hardware::display
{
	...
	inline android::hardware::display::VirtualDisplayConfig_Builder VirtualDisplayConfig_Builder::setBrightnessListener(JObject arg0, JObject arg1) const
	{
		return callObjectMethod(
			"setBrightnessListener",
			"(Ljava/util/concurrent/Executor;Landroid/hardware/display/VirtualDisplayConfig$BrightnessListener;)Landroid/hardware/display/VirtualDisplayConfig$Builder;",
			arg0.object(),
			arg1.object()
		);
	}
	inline android::hardware::display::VirtualDisplayConfig_Builder VirtualDisplayConfig_Builder::setDefaultBrightness(jfloat arg0) const
	{
		return callObjectMethod(
	...
	inline android::hardware::display::VirtualDisplayConfig_Builder VirtualDisplayConfig_Builder::setDimBrightness(jfloat arg0) const
	{
		return callObjectMethod(
			"setDimBrightness",
			"(F)Landroid/hardware/display/VirtualDisplayConfig$Builder;",
