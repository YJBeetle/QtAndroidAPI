...
namespace android::hardware::display
{
	...
	public:
		...
		static jlong EVENT_TYPE_DISPLAY_ADDED();
		static jlong EVENT_TYPE_DISPLAY_CHANGED();
		static jlong EVENT_TYPE_DISPLAY_REFRESH_RATE();
		static jlong EVENT_TYPE_DISPLAY_REMOVED();
		static jlong EVENT_TYPE_DISPLAY_STATE();
		...
		DisplayManager(QJniObject obj) : JObject(obj) {}
		
		// Constructors
		
		// Methods
		android::hardware::display::VirtualDisplay createVirtualDisplay(android::hardware::display::VirtualDisplayConfig arg0) const;
		android::hardware::display::VirtualDisplay createVirtualDisplay(android::hardware::display::VirtualDisplayConfig arg0, android::os::Handler arg1, android::hardware::display::VirtualDisplay_Callback arg2) const;
		...
		android::hardware::display::HdrConversionMode getHdrConversionMode() const;
		jint getMatchContentFrameRateUserPreference() const;
		void registerDisplayListener(JObject arg0, android::os::Handler arg1) const;
		void registerDisplayListener(JObject arg0, jlong arg1, JObject arg2) const;
