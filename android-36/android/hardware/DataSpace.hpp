...
namespace android::hardware
{
	...
	inline jint DataSpace::DATASPACE_BT2020_HLG()
	{
		return getStaticField<jint>(
			"android.hardware.DataSpace",
	...
	inline jint DataSpace::DATASPACE_DEPTH()
	{
		return getStaticField<jint>(
			"android.hardware.DataSpace",
			"DATASPACE_DEPTH"
	...
	inline jint DataSpace::DATASPACE_DYNAMIC_DEPTH()
	{
		return getStaticField<jint>(
			"android.hardware.DataSpace",
	...
	inline jint DataSpace::DATASPACE_HEIF()
	{
		return getStaticField<jint>(
			"android.hardware.DataSpace",
			"DATASPACE_HEIF"
	...
	inline jint DataSpace::DATASPACE_HEIF_ULTRAHDR()
	{
		return getStaticField<jint>(
			"android.hardware.DataSpace",
	...
	inline jint DataSpace::DATASPACE_JPEG_R()
	{
		return getStaticField<jint>(
			"android.hardware.DataSpace",
			"DATASPACE_JPEG_R"
