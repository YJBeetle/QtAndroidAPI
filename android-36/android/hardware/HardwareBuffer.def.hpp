...
namespace android::hardware
{
	...
	public:
		...
		static jint R_8();
		static jint S_UI8();
		static jlong USAGE_COMPOSER_OVERLAY();
		...
		static jlong USAGE_FRONT_BUFFER();
		...
		static jint YCBCR_P010();
		static jint YCBCR_P210();
		...
		HardwareBuffer(QJniObject obj) : JObject(obj) {}
