...
namespace android::appwidget
{
	...
	public:
		...
		AppWidgetManager(QJniObject obj) : JObject(obj) {}
		...
		android::widget::RemoteViews getWidgetPreview(android::content::ComponentName arg0, android::os::UserHandle arg1, jint arg2) const;
		...
		void removeWidgetPreview(android::content::ComponentName arg0, jint arg1) const;
		...
		jboolean setWidgetPreview(android::content::ComponentName arg0, jint arg1, android::widget::RemoteViews arg2) const;
