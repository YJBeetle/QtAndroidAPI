...
namespace android::appwidget
{
	...
	inline JString AppWidgetManager::OPTION_APPWIDGET_RESTORE_COMPLETED()
	{
		return getStaticObjectField(
			"android.appwidget.AppWidgetManager",
	...
	inline JString AppWidgetManager::OPTION_APPWIDGET_SIZES()
	{
		return getStaticObjectField(
			"android.appwidget.AppWidgetManager",
	...
	inline android::widget::RemoteViews AppWidgetManager::getWidgetPreview(android::content::ComponentName arg0, android::os::UserHandle arg1, jint arg2) const
	{
		return callObjectMethod(
			"getWidgetPreview",
			"(Landroid/content/ComponentName;Landroid/os/UserHandle;I)Landroid/widget/RemoteViews;",
			arg0.object(),
			arg1.object(),
			arg2
		);
	...
	inline void AppWidgetManager::removeWidgetPreview(android::content::ComponentName arg0, jint arg1) const
	{
		callMethod<void>(
			"removeWidgetPreview",
	...
	inline jboolean AppWidgetManager::setWidgetPreview(android::content::ComponentName arg0, jint arg1, android::widget::RemoteViews arg2) const
	{
		return callMethod<jboolean>(
			"setWidgetPreview",
			"(Landroid/content/ComponentName;ILandroid/widget/RemoteViews;)Z",
			arg0.object(),
			arg1,
			arg2.object()
		);
