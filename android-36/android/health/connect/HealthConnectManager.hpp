...
namespace android::health::connect
{
	...
	inline void HealthConnectManager::createMedicalDataSource(android::health::connect::CreateMedicalDataSourceRequest arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"createMedicalDataSource",
			"(Landroid/health/connect/CreateMedicalDataSourceRequest;Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
	}
	inline void HealthConnectManager::deleteMedicalDataSourceWithData(JString arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
	...
	inline void HealthConnectManager::deleteMedicalResources(android::health::connect::DeleteMedicalResourcesRequest arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"deleteMedicalResources",
			"(Landroid/health/connect/DeleteMedicalResourcesRequest;Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
	}
	inline void HealthConnectManager::deleteMedicalResources(JObject arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"deleteMedicalResources",
	...
	inline void HealthConnectManager::getMedicalDataSources(android::health::connect::GetMedicalDataSourcesRequest arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"getMedicalDataSources",
			"(Landroid/health/connect/GetMedicalDataSourcesRequest;Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
	}
	inline void HealthConnectManager::getMedicalDataSources(JObject arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"getMedicalDataSources",
			"(Ljava/util/List;Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V",
	...
	inline void HealthConnectManager::readMedicalResources(android::health::connect::ReadMedicalResourcesRequest arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"readMedicalResources",
			"(Landroid/health/connect/ReadMedicalResourcesRequest;Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		);
	}
	inline void HealthConnectManager::readMedicalResources(JObject arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
			"readMedicalResources",
			"(Ljava/util/List;Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V",
	...
	inline void HealthConnectManager::upsertMedicalResources(JObject arg0, JObject arg1, JObject arg2) const
	{
		callMethod<void>(
