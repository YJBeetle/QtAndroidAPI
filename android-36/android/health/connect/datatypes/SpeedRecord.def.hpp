...
namespace android::health::connect::datatypes
{
	...
	public:
		// Fields
		static android::health::connect::datatypes::AggregationType SPEED_AVG();
		static android::health::connect::datatypes::AggregationType SPEED_MAX();
		static android::health::connect::datatypes::AggregationType SPEED_MIN();
