...
namespace android::health::connect::datatypes
{
	...
	inline android::health::connect::datatypes::ExerciseSessionRecord_Builder ExerciseSessionRecord_Builder::setPlannedExerciseSessionId(JString arg0) const
	{
		return callObjectMethod(
			"setPlannedExerciseSessionId",
			"(Ljava/lang/String;)Landroid/health/connect/datatypes/ExerciseSessionRecord$Builder;",
			arg0.object<jstring>()
		);
	}
