...
namespace android::health::connect::datatypes
{
	...
	public:
		// Fields
		static android::health::connect::datatypes::AggregationType RPM_AVG();
		static android::health::connect::datatypes::AggregationType RPM_MAX();
		static android::health::connect::datatypes::AggregationType RPM_MIN();
