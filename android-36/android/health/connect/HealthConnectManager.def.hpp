...
namespace android::health::connect
{
	...
	public:
		...
		void createMedicalDataSource(android::health::connect::CreateMedicalDataSourceRequest arg0, JObject arg1, JObject arg2) const;
		void deleteMedicalDataSourceWithData(JString arg0, JObject arg1, JObject arg2) const;
		void deleteMedicalResources(android::health::connect::DeleteMedicalResourcesRequest arg0, JObject arg1, JObject arg2) const;
		void deleteMedicalResources(JObject arg0, JObject arg1, JObject arg2) const;
		...
		void getMedicalDataSources(android::health::connect::GetMedicalDataSourcesRequest arg0, JObject arg1, JObject arg2) const;
		void getMedicalDataSources(JObject arg0, JObject arg1, JObject arg2) const;
		void insertRecords(JObject arg0, JObject arg1, JObject arg2) const;
		void readMedicalResources(android::health::connect::ReadMedicalResourcesRequest arg0, JObject arg1, JObject arg2) const;
		void readMedicalResources(JObject arg0, JObject arg1, JObject arg2) const;
		...
		void upsertMedicalResources(JObject arg0, JObject arg1, JObject arg2) const;
	};
} // namespace android::health::connect
