...
namespace android::health::connect
{
	...
	public:
		...
		static JString READ_ACTIVITY_INTENSITY();
		...
		static JString READ_EXERCISE_ROUTES();
		static JString READ_FLOORS_CLIMBED();
		static JString READ_HEALTH_DATA_HISTORY();
		static JString READ_HEALTH_DATA_IN_BACKGROUND();
		...
		static JString READ_MEDICAL_DATA_ALLERGIES_INTOLERANCES();
		static JString READ_MEDICAL_DATA_CONDITIONS();
		static JString READ_MEDICAL_DATA_LABORATORY_RESULTS();
		static JString READ_MEDICAL_DATA_MEDICATIONS();
		static JString READ_MEDICAL_DATA_PERSONAL_DETAILS();
		static JString READ_MEDICAL_DATA_PRACTITIONER_DETAILS();
		static JString READ_MEDICAL_DATA_PREGNANCY();
		static JString READ_MEDICAL_DATA_PROCEDURES();
		static JString READ_MEDICAL_DATA_SOCIAL_HISTORY();
		static JString READ_MEDICAL_DATA_VACCINES();
		static JString READ_MEDICAL_DATA_VISITS();
		static JString READ_MEDICAL_DATA_VITAL_SIGNS();
		static JString READ_MENSTRUATION();
		static JString READ_MINDFULNESS();
		static JString READ_NUTRITION();
		static JString READ_OVULATION_TEST();
		static JString READ_OXYGEN_SATURATION();
		static JString READ_PLANNED_EXERCISE();
		...
		static JString READ_SKIN_TEMPERATURE();
		...
		static JString WRITE_ACTIVITY_INTENSITY();
		...
		static JString WRITE_SKIN_TEMPERATURE();
