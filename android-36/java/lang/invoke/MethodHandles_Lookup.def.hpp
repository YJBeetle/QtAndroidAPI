...
namespace java::lang::invoke
{
	...
	public:
		...
		MethodHandles_Lookup(QJniObject obj) : JObject(obj) {}
		...
		java::lang::invoke::VarHandle findStaticVarHandle(JClass arg0, JString arg1, JClass arg2) const;
		java::lang::invoke::VarHandle findVarHandle(JClass arg0, JString arg1, JClass arg2) const;
		...
		java::lang::invoke::VarHandle unreflectVarHandle(java::lang::reflect::Field arg0) const;
	};
} // namespace java::lang::invoke
