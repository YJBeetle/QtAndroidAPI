...
namespace android::provider
{
	...
	inline android::net::Uri CalendarContract_Instances::ENTERPRISE_CONTENT_BY_DAY_URI()
	{
		return getStaticObjectField(
			"android.provider.CalendarContract$Instances",
	...
	inline android::net::Uri CalendarContract_Instances::ENTERPRISE_CONTENT_SEARCH_BY_DAY_URI()
	{
		return getStaticObjectField(
			"android.provider.CalendarContract$Instances",
	...
	inline android::net::Uri CalendarContract_Instances::ENTERPRISE_CONTENT_SEARCH_URI()
	{
		return getStaticObjectField(
			"android.provider.CalendarContract$Instances",
	...
	inline android::net::Uri CalendarContract_Instances::ENTERPRISE_CONTENT_URI()
	{
		return getStaticObjectField(
			"android.provider.CalendarContract$Instances",
