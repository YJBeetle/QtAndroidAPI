...
namespace android::os
{
	...
	inline void PowerManager_WakeLock::setStateListener(JObject arg0, JObject arg1) const
	{
		callMethod<void>(
			"setStateListener",
			"(Ljava/util/concurrent/Executor;Landroid/os/PowerManager$WakeLockStateListener;)V",
			arg0.object(),
			arg1.object()
		);
	}
