...
namespace android::view::textclassifier
{
	...
	inline android::view::textclassifier::TextLinks_Request_Builder TextLinks_Request_Builder::setReferenceTime(java::time::ZonedDateTime arg0) const
	{
		return callObjectMethod(
			"setReferenceTime",
			"(Ljava/time/ZonedDateTime;)Landroid/view/textclassifier/TextLinks$Request$Builder;",
			arg0.object()
		);
	}
} // namespace android::view::textclassifier
