...
namespace android::view::accessibility
{
	...
	inline jint AccessibilityRecord::getDisplayId() const
	{
		return callMethod<jint>(
			"getDisplayId",
			"()I"
	...
	inline android::view::accessibility::AccessibilityNodeInfo AccessibilityRecord::getSource(jint arg0) const
	{
		return callObjectMethod(
			"getSource",
