...
namespace android::content::res
{
	...
	public:
		...
		Resources_Theme(QJniObject obj) : JObject(obj) {}
		...
		JIntArray getAttributeResolutionStack(jint arg0, jint arg1, jint arg2) const;
		jint getChangingConfigurations() const;
		android::graphics::drawable::Drawable getDrawable(jint arg0) const;
		jint getExplicitStyle(JObject arg0) const;
