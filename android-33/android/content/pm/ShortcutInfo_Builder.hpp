...
namespace android::content::pm
{
	...
	// Methods
	inline android::content::pm::ShortcutInfo_Builder ShortcutInfo_Builder::addCapabilityBinding(android::content::pm::Capability arg0, android::content::pm::CapabilityParams arg1) const
	{
		return callObjectMethod(
			"addCapabilityBinding",
			"(Landroid/content/pm/Capability;Landroid/content/pm/CapabilityParams;)Landroid/content/pm/ShortcutInfo$Builder;",
			arg0.object(),
			arg1.object()
		);
	}
	...
	inline android::content::pm::ShortcutInfo_Builder ShortcutInfo_Builder::setExcludedFromSurfaces(jint arg0) const
	{
		return callObjectMethod(
