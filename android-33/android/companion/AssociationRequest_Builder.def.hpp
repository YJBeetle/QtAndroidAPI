...
namespace android::companion
{
	...
	public:
		...
		android::companion::AssociationRequest_Builder setDisplayName(JString arg0) const;
		android::companion::AssociationRequest_Builder setForceConfirmation(jboolean arg0) const;
		android::companion::AssociationRequest_Builder setSelfManaged(jboolean arg0) const;
