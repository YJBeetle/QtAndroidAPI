...
{
	// Fields
	inline jint MeasuredText_Builder::HYPHENATION_MODE_FAST()
	{
	...
	inline jint MeasuredText_Builder::HYPHENATION_MODE_NONE()
	{
		return getStaticField<jint>(
			"android.graphics.text.MeasuredText$Builder",
	...
	inline jint MeasuredText_Builder::HYPHENATION_MODE_NORMAL()
	{
		return getStaticField<jint>(
			"android.graphics.text.MeasuredText$Builder",
	...
	inline android::graphics::text::MeasuredText_Builder MeasuredText_Builder::appendStyleRun(android::graphics::Paint arg0, android::graphics::text::LineBreakConfig arg1, jint arg2, jboolean arg3) const
	{
		return callObjectMethod(
			"appendStyleRun",
			"(Landroid/graphics/Paint;Landroid/graphics/text/LineBreakConfig;IZ)Landroid/graphics/text/MeasuredText$Builder;",
			arg0.object(),
			arg1.object(),
			arg2,
			arg3
	...
	inline android::graphics::text::MeasuredText_Builder MeasuredText_Builder::setComputeHyphenation(jint arg0) const
	{
		return callObjectMethod(
			"setComputeHyphenation",
			"(I)Landroid/graphics/text/MeasuredText$Builder;",
			arg0
		);
	}
