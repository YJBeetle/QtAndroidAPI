...
namespace android::graphics
{
	...
	inline android::graphics::RenderEffect RenderEffect::createRuntimeShaderEffect(android::graphics::RuntimeShader arg0, JString arg1)
	{
		return callStaticObjectMethod(
			"android.graphics.RenderEffect",
			"createRuntimeShaderEffect",
			"(Landroid/graphics/RuntimeShader;Ljava/lang/String;)Landroid/graphics/RenderEffect;",
			arg0.object(),
			arg1.object<jstring>()
		);
	}
