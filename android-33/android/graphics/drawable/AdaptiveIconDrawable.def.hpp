...
namespace android::graphics::drawable
{
	...
	public:
		...
		AdaptiveIconDrawable(QJniObject obj) : android::graphics::drawable::Drawable(obj) {}
		
		// Constructors
		AdaptiveIconDrawable(android::graphics::drawable::Drawable arg0, android::graphics::drawable::Drawable arg1);
		AdaptiveIconDrawable(android::graphics::drawable::Drawable arg0, android::graphics::drawable::Drawable arg1, android::graphics::drawable::Drawable arg2);
		...
		android::graphics::drawable::Drawable getMonochrome() const;
