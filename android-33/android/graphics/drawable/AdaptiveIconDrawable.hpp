...
namespace android::graphics::drawable
{
	...
	inline AdaptiveIconDrawable::AdaptiveIconDrawable(android::graphics::drawable::Drawable arg0, android::graphics::drawable::Drawable arg1, android::graphics::drawable::Drawable arg2)
		: android::graphics::drawable::Drawable(
			"android.graphics.drawable.AdaptiveIconDrawable",
			"(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V",
			arg0.object(),
			arg1.object(),
			arg2.object()
		) {}
	...
	inline android::graphics::drawable::Drawable AdaptiveIconDrawable::getMonochrome() const
	{
		return callObjectMethod(
			"getMonochrome",
			"()Landroid/graphics/drawable/Drawable;"
