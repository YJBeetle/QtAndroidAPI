...
namespace android::telephony
{
	...
	inline jint UiccCardInfo::getPhysicalSlotIndex() const
	{
		return callMethod<jint>(
	...
	inline JObject UiccCardInfo::getPorts() const
	{
		return callObjectMethod(
			"getPorts",
	...
	inline jboolean UiccCardInfo::isMultipleEnabledProfilesSupported() const
	{
		return callMethod<jboolean>(
