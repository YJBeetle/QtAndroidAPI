...
namespace android::telephony
{
	...
	inline JObject CellIdentityWcdma::getAdditionalPlmns() const
	{
	...
	inline android::telephony::ClosedSubscriberGroupInfo CellIdentityWcdma::getClosedSubscriberGroupInfo() const
	{
		return callObjectMethod(
