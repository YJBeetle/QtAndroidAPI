...
namespace android::widget
{
	...
	inline jint HorizontalScrollView::getLeftEdgeEffectColor() const
	{
	...
	inline jint HorizontalScrollView::getRightEdgeEffectColor() const
	{
		return callMethod<jint>(
	...
	inline void HorizontalScrollView::setEdgeEffectColor(jint arg0) const
	{
		callMethod<void>(
			"setEdgeEffectColor",
			"(I)V",
	...
	inline void HorizontalScrollView::setLeftEdgeEffectColor(jint arg0) const
	{
		callMethod<void>(
	...
	inline void HorizontalScrollView::setRightEdgeEffectColor(jint arg0) const
	{
		callMethod<void>(
