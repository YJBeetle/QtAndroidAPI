...
namespace android::service::carrier
{
	...
	public:
		...
		CarrierService(QAndroidJniObject obj) : android::app::Service(obj) {}
		...
		void notifyCarrierNetworkChange(jint arg0, jboolean arg1) const;
		JObject onBind(android::content::Intent arg0) const;
		android::os::PersistableBundle onLoadConfig(android::service::carrier::CarrierIdentifier arg0) const;
		android::os::PersistableBundle onLoadConfig(jint arg0, android::service::carrier::CarrierIdentifier arg1) const;
	};
} // namespace android::service::carrier
