...
namespace android::accessibilityservice
{
	...
	inline android::graphics::Region AccessibilityService_MagnificationController::getCurrentMagnificationRegion() const
	{
	...
	inline android::accessibilityservice::MagnificationConfig AccessibilityService_MagnificationController::getMagnificationConfig() const
	{
		return callObjectMethod(
	...
	inline jboolean AccessibilityService_MagnificationController::resetCurrentMagnification(jboolean arg0) const
	{
		return callMethod<jboolean>(
	...
	inline jboolean AccessibilityService_MagnificationController::setMagnificationConfig(android::accessibilityservice::MagnificationConfig arg0, jboolean arg1) const
	{
		return callMethod<jboolean>(
			"setMagnificationConfig",
			"(Landroid/accessibilityservice/MagnificationConfig;Z)Z",
			arg0.object(),
			arg1
		);
	}
