...
namespace android::icu::text
{
	...
	public:
		// Fields
		static jint MINIMUM_GROUPING_DIGITS_AUTO();
		static jint MINIMUM_GROUPING_DIGITS_MIN2();
		...
		DecimalFormat(QJniObject obj) : android::icu::text::NumberFormat(obj) {}
		...
		jint getMinimumGroupingDigits() const;
		...
		jboolean isParseCaseSensitive() const;
		jboolean isParseIntegerOnly() const;
		jboolean isParseNoExponent() const;
		jboolean isParseStrict() const;
		jboolean isScientificNotation() const;
		jboolean isSignAlwaysShown() const;
		...
		void setMinimumGroupingDigits(jint arg0) const;
		...
		void setParseCaseSensitive(jboolean arg0) const;
		void setParseIntegerOnly(jboolean arg0) const;
		void setParseMaxDigits(jint arg0) const;
		void setParseNoExponent(jboolean arg0) const;
		...
		void setSignAlwaysShown(jboolean arg0) const;
