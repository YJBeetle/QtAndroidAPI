...
namespace android::icu::text
{
	...
	inline android::icu::text::DisplayContext DateIntervalFormat::getContext(android::icu::text::DisplayContext_Type arg0) const
	{
		return callObjectMethod(
			"getContext",
	...
	inline void DateIntervalFormat::setContext(android::icu::text::DisplayContext arg0) const
	{
		callMethod<void>(
			"setContext",
