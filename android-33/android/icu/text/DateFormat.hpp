...
namespace android::icu::text
{
	...
	inline android::icu::text::DateFormat DateFormat::getInstance(android::icu::util::Calendar arg0, android::icu::util::ULocale arg1)
	{
		return callStaticObjectMethod(
			"android.icu.text.DateFormat",
			"getInstance",
			"(Landroid/icu/util/Calendar;Landroid/icu/util/ULocale;)Landroid/icu/text/DateFormat;",
			arg0.object(),
			arg1.object()
		);
	}
