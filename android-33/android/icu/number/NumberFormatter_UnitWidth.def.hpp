...
namespace android::icu::number
{
	...
	public:
		// Fields
		static android::icu::number::NumberFormatter_UnitWidth FORMAL();
		...
		static android::icu::number::NumberFormatter_UnitWidth VARIANT();
		...
		NumberFormatter_UnitWidth(QAndroidJniObject obj) : java::lang::Enum(obj) {}
