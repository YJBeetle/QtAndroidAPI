...
namespace android::media::tv
{
	...
	inline void TvInputService_RecordingSession::onPauseRecording(android::os::Bundle arg0) const
	{
		callMethod<void>(
			"onPauseRecording",
	...
	inline void TvInputService_RecordingSession::onResumeRecording(android::os::Bundle arg0) const
	{
		callMethod<void>(
			"onResumeRecording",
			"(Landroid/os/Bundle;)V",
