...
namespace android::media
{
	...
	inline android::media::ImageReader ImageReader::newInstance(jint arg0, jint arg1, jint arg2, jint arg3, jlong arg4)
	{
		return callStaticObjectMethod(
			"android.media.ImageReader",
			"newInstance",
	...
	inline jint ImageReader::getDataSpace() const
	{
	...
	inline jint ImageReader::getHardwareBufferFormat() const
	{
		return callMethod<jint>(
	...
	inline jlong ImageReader::getUsage() const
	{
