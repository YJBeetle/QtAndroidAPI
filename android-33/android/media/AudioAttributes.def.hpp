...
namespace android::media
{
	...
	public:
		...
		static jint SPATIALIZATION_BEHAVIOR_AUTO();
		static jint SPATIALIZATION_BEHAVIOR_NEVER();
		...
		AudioAttributes(QAndroidJniObject obj) : JObject(obj) {}
		...
		jint getFlags() const;
		jint getSpatializationBehavior() const;
		jint getUsage() const;
		jint getVolumeControlStream() const;
		jint hashCode() const;
		jboolean isContentSpatialized() const;
