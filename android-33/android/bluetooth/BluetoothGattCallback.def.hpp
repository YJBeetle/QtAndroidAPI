...
namespace android::bluetooth
{
	...
	public:
		...
		BluetoothGattCallback(QAndroidJniObject obj) : JObject(obj) {}
		...
		void onCharacteristicChanged(android::bluetooth::BluetoothGatt arg0, android::bluetooth::BluetoothGattCharacteristic arg1, JByteArray arg2) const;
		...
		void onCharacteristicRead(android::bluetooth::BluetoothGatt arg0, android::bluetooth::BluetoothGattCharacteristic arg1, JByteArray arg2, jint arg3) const;
		...
		void onDescriptorRead(android::bluetooth::BluetoothGatt arg0, android::bluetooth::BluetoothGattDescriptor arg1, jint arg2, JByteArray arg3) const;
