...
namespace android::bluetooth::le
{
	...
	public:
		...
		ScanFilter(QAndroidJniObject obj) : JObject(obj) {}
		...
		JByteArray getAdvertisingData() const;
		JByteArray getAdvertisingDataMask() const;
		jint getAdvertisingDataType() const;
		...
		android::os::ParcelUuid getServiceSolicitationUuid() const;
		android::os::ParcelUuid getServiceSolicitationUuidMask() const;
