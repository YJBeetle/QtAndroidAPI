...
namespace android::bluetooth::le
{
	...
	inline android::bluetooth::le::AdvertiseData_Builder AdvertiseData_Builder::addServiceSolicitationUuid(android::os::ParcelUuid arg0) const
	{
		return callObjectMethod(
	...
	inline android::bluetooth::le::AdvertiseData_Builder AdvertiseData_Builder::addTransportDiscoveryData(android::bluetooth::le::TransportDiscoveryData arg0) const
	{
		return callObjectMethod(
			"addTransportDiscoveryData",
			"(Landroid/bluetooth/le/TransportDiscoveryData;)Landroid/bluetooth/le/AdvertiseData$Builder;",
			arg0.object()
		);
	}
