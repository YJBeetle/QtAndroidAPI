...
namespace android::bluetooth::le
{
	...
	inline JByteArray ScanFilter::getAdvertisingData() const
	{
	...
	inline JByteArray ScanFilter::getAdvertisingDataMask() const
	{
		return callObjectMethod(
	...
	inline jint ScanFilter::getAdvertisingDataType() const
	{
		return callMethod<jint>(
	...
	inline android::os::ParcelUuid ScanFilter::getServiceSolicitationUuid() const
	{
		return callObjectMethod(
	...
	inline android::os::ParcelUuid ScanFilter::getServiceSolicitationUuidMask() const
	{
		return callObjectMethod(
