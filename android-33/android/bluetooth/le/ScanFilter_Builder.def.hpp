...
namespace android::bluetooth::le
{
	...
	public:
		...
		ScanFilter_Builder(QAndroidJniObject obj) : JObject(obj) {}
		...
		android::bluetooth::le::ScanFilter_Builder setAdvertisingDataType(jint arg0) const;
		android::bluetooth::le::ScanFilter_Builder setAdvertisingDataTypeWithData(jint arg0, JByteArray arg1, JByteArray arg2) const;
