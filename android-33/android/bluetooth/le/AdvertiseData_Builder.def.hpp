...
namespace android::bluetooth::le
{
	...
	public:
		...
		AdvertiseData_Builder(QAndroidJniObject obj) : JObject(obj) {}
		...
		android::bluetooth::le::AdvertiseData_Builder addTransportDiscoveryData(android::bluetooth::le::TransportDiscoveryData arg0) const;
