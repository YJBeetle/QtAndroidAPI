...
namespace android::bluetooth
{
	...
	public:
		...
		static jint PERIPHERAL_KEYBOARD();
		static jint PERIPHERAL_KEYBOARD_POINTING();
		static jint PERIPHERAL_NON_KEYBOARD_NON_POINTING();
		static jint PERIPHERAL_POINTING();
		...
		BluetoothClass_Device(QAndroidJniObject obj) : JObject(obj) {}
