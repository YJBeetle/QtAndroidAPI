...
namespace android::bluetooth
{
	...
	inline void BluetoothGattCallback::onCharacteristicChanged(android::bluetooth::BluetoothGatt arg0, android::bluetooth::BluetoothGattCharacteristic arg1, JByteArray arg2) const
	{
		callMethod<void>(
			"onCharacteristicChanged",
	...
	inline void BluetoothGattCallback::onCharacteristicRead(android::bluetooth::BluetoothGatt arg0, android::bluetooth::BluetoothGattCharacteristic arg1, JByteArray arg2, jint arg3) const
	{
		callMethod<void>(
			"onCharacteristicRead",
	...
	inline void BluetoothGattCallback::onDescriptorRead(android::bluetooth::BluetoothGatt arg0, android::bluetooth::BluetoothGattDescriptor arg1, jint arg2, JByteArray arg3) const
	{
		callMethod<void>(
			"onDescriptorRead",
			"(Landroid/bluetooth/BluetoothGatt;Landroid/bluetooth/BluetoothGattDescriptor;I[B)V",
			arg0.object(),
			arg1.object(),
			arg2,
	...
	inline void BluetoothGattCallback::onServiceChanged(android::bluetooth::BluetoothGatt arg0) const
	{
		callMethod<void>(
			"onServiceChanged",
