...
namespace android::animation
{
	...
	public:
		...
		static jfloat getDurationScale();
		...
		static jboolean registerDurationScaleChangeListener(JObject arg0);
		static void setFrameDelay(jlong arg0);
		static jboolean unregisterDurationScaleChangeListener(JObject arg0);
