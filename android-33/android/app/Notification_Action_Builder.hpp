...
namespace android::app
{
	...
	inline android::app::Notification_Action_Builder Notification_Action_Builder::setAuthenticationRequired(jboolean arg0) const
	{
		return callObjectMethod(
	...
	inline android::app::Notification_Action_Builder Notification_Action_Builder::setContextual(jboolean arg0) const
	{
		return callObjectMethod(
			"setContextual",
			"(Z)Landroid/app/Notification$Action$Builder;",
