...
namespace android::app
{
	...
	public:
		...
		KeyguardManager(QAndroidJniObject obj) : JObject(obj) {}
		
		// Constructors
		
		// Methods
		void addKeyguardLockedStateListener(JObject arg0, JObject arg1) const;
		...
		void removeKeyguardLockedStateListener(JObject arg0) const;
