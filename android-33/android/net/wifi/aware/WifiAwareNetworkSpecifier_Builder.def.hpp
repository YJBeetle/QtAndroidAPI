...
namespace android::net::wifi::aware
{
	...
	public:
		...
		WifiAwareNetworkSpecifier_Builder(QAndroidJniObject obj) : JObject(obj) {}
		...
		android::net::wifi::aware::WifiAwareNetworkSpecifier_Builder setChannelFrequencyMhz(jint arg0, jboolean arg1) const;
		android::net::wifi::aware::WifiAwareNetworkSpecifier_Builder setDataPathSecurityConfig(android::net::wifi::aware::WifiAwareDataPathSecurityConfig arg0) const;
