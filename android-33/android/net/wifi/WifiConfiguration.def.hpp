...
namespace android::net::wifi
{
	...
	public:
		...
		JString BSSID();
		JString FQDN();
		static jint RANDOMIZATION_AUTO();
		static jint RANDOMIZATION_NONE();
		static jint RANDOMIZATION_NON_PERSISTENT();
		static jint RANDOMIZATION_PERSISTENT();
		static jint SECURITY_TYPE_DPP();
		...
		WifiConfiguration(QAndroidJniObject obj) : JObject(obj) {}
		...
		jboolean isDppConfigurator() const;
		jboolean isPasspoint() const;
		void setHttpProxy(android::net::ProxyInfo arg0) const;
		void setIpConfiguration(android::net::IpConfiguration arg0) const;
		void setMacRandomizationSetting(jint arg0) const;
