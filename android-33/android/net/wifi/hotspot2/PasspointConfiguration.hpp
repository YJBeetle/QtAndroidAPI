...
namespace android::net::wifi::hotspot2
{
	...
	inline JString PasspointConfiguration::getDecoratedIdentityPrefix() const
	{
		return callObjectMethod(
	...
	inline void PasspointConfiguration::setDecoratedIdentityPrefix(JString arg0) const
	{
		callMethod<void>(
	...
	inline void PasspointConfiguration::setSubscriptionExpirationTimeInMillis(jlong arg0) const
	{
		callMethod<void>(
...
using namespace android::net::wifi::hotspot2;
#endif
