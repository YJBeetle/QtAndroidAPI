...
namespace java::util::concurrent
{
	...
	public:
		...
		LinkedTransferQueue(QJniObject obj) : java::util::AbstractQueue(obj) {}
		...
		jint getWaitingConsumerCount() const;
		jboolean hasWaitingConsumer() const;
		...
		void transfer(JObject arg0) const;
		jboolean tryTransfer(JObject arg0) const;
		jboolean tryTransfer(JObject arg0, jlong arg1, java::util::concurrent::TimeUnit arg2) const;
	};
} // namespace java::util::concurrent
