...
namespace java::lang
{
	...
	public:
		...
		StringBuffer(QJniObject obj) : JObject(obj) {}
		...
		java::lang::StringBuffer repeat(jint arg0, jint arg1) const;
		java::lang::StringBuffer repeat(JString arg0, jint arg1) const;
