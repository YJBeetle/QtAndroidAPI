...
namespace android::graphics::drawable
{
	...
	// QJniObject forward
	ShapeDrawable::ShapeDrawable(QJniObject obj) : android::graphics::drawable::Drawable(obj) {}
	...
	void ShapeDrawable::setTintMode(android::graphics::PorterDuff_Mode arg0) const
	{
		callMethod<void>(
			"setTintMode",
