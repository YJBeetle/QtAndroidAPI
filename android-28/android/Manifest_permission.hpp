...
namespace android
{
	...
	inline JString Manifest_permission::CAPTURE_SECURE_VIDEO_OUTPUT()
	{
		return getStaticObjectField(
			"android.Manifest$permission",
	...
	inline JString Manifest_permission::CAPTURE_VIDEO_OUTPUT()
	{
		return getStaticObjectField(
			"android.Manifest$permission",
	...
	inline JString Manifest_permission::READ_FRAME_BUFFER()
	{
		return getStaticObjectField(
			"android.Manifest$permission",
			"READ_FRAME_BUFFER",
