...
namespace android::database::sqlite
{
	...
	inline JObject SQLiteQueryBuilder::getProjectionGreylist() const
	{
		return callObjectMethod(
	...
	inline jlong SQLiteQueryBuilder::insert(android::database::sqlite::SQLiteDatabase arg0, android::content::ContentValues arg1) const
	{
	...
	inline jboolean SQLiteQueryBuilder::isStrictColumns() const
	{
		return callMethod<jboolean>(
			"isStrictColumns",
			"()Z"
	...
	inline jboolean SQLiteQueryBuilder::isStrictGrammar() const
	{
		return callMethod<jboolean>(
			"isStrictGrammar",
			"()Z"
	...
	inline void SQLiteQueryBuilder::setProjectionGreylist(JObject arg0) const
	{
		callMethod<void>(
	...
	inline void SQLiteQueryBuilder::setStrictColumns(jboolean arg0) const
	{
		callMethod<void>(
			"setStrictColumns",
			"(Z)V",
	...
	inline void SQLiteQueryBuilder::setStrictGrammar(jboolean arg0) const
	{
		callMethod<void>(
			"setStrictGrammar",
			"(Z)V",
