...
namespace android::graphics::drawable
{
	...
	inline android::graphics::Insets DrawableWrapper::getOpticalInsets() const
	{
		return callObjectMethod(
			"getOpticalInsets",
	...
	inline jboolean DrawableWrapper::hasFocusStateSpecified() const
	{
		return callMethod<jboolean>(
	...
	inline void DrawableWrapper::jumpToCurrentState() const
	{
		callMethod<void>(
			"jumpToCurrentState",
			"()V"
	...
	inline void DrawableWrapper::setTintBlendMode(android::graphics::BlendMode arg0) const
	{
		callMethod<void>(
			"setTintBlendMode",
