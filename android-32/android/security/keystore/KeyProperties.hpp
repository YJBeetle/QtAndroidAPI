...
{
	// Fields
	inline jint KeyProperties::AUTH_BIOMETRIC_STRONG()
	{
	...
	inline jint KeyProperties::AUTH_DEVICE_CREDENTIAL()
	{
		return getStaticField<jint>(
			"android.security.keystore.KeyProperties",
	...
	inline jint KeyProperties::PURPOSE_AGREE_KEY()
	{
		return getStaticField<jint>(
			"android.security.keystore.KeyProperties",
			"PURPOSE_AGREE_KEY"
	...
	inline jint KeyProperties::PURPOSE_ATTEST_KEY()
	{
		return getStaticField<jint>(
			"android.security.keystore.KeyProperties",
			"PURPOSE_ATTEST_KEY"
	...
	inline jint KeyProperties::SECURITY_LEVEL_SOFTWARE()
	{
		return getStaticField<jint>(
			"android.security.keystore.KeyProperties",
	...
	inline jint KeyProperties::SECURITY_LEVEL_STRONGBOX()
	{
		return getStaticField<jint>(
			"android.security.keystore.KeyProperties",
	...
	inline jint KeyProperties::SECURITY_LEVEL_TRUSTED_ENVIRONMENT()
	{
		return getStaticField<jint>(
			"android.security.keystore.KeyProperties",
	...
	inline jint KeyProperties::SECURITY_LEVEL_UNKNOWN()
	{
		return getStaticField<jint>(
			"android.security.keystore.KeyProperties",
	...
	inline jint KeyProperties::SECURITY_LEVEL_UNKNOWN_SECURE()
	{
		return getStaticField<jint>(
			"android.security.keystore.KeyProperties",
	...
	inline jint KeyProperties::UNRESTRICTED_USAGE_COUNT()
	{
		return getStaticField<jint>(
			"android.security.keystore.KeyProperties",
