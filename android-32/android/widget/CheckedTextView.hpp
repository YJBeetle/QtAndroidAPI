...
namespace android::widget
{
	...
	inline android::graphics::BlendMode CheckedTextView::getCheckMarkTintBlendMode() const
	{
		return callObjectMethod(
	...
	inline void CheckedTextView::setCheckMarkTintBlendMode(android::graphics::BlendMode arg0) const
	{
		callMethod<void>(
